...
${ve}`}],Ne=function(){(function(){function i(t){if(!t||t.__pcInit)return;t.__pcInit=!0;var a=t.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,n=0,c=!1,p=0,d=0,m=0,u=null;a.querySelectorAll("img").forEach(function(h){h.setAttribute("draggable","false")}),setTimeout(function(){var h=a.scrollWidth-a.clientWidth;if(h<=0)return;var y=Math.min(60,h),$=null;function v(S){$||($=S);var z=(S-$)/400;if(z<.5)a.scrollLeft=y*(z*2);else if(z<1)a.scrollLeft=y*(1-(z-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(v)}requestAnimationFrame(v)},400),a.scrollLeft=0;function b(){return a.scrollWidth-a.clientWidth}function s(h){return Math.max(0,Math.min(h,b()))}function g(){Math.abs(p)<.5||(p*=.92,a.scrollLeft=s(a.scrollLeft+p),u=requestAnimationFrame(g))}a.addEventListener("mousedown",function(h){h.button===0&&(u&&(cancelAnimationFrame(u),u=null),r=!0,c=!1,p=0,l=h.clientX,d=h.clientX,m=Date.now(),n=a.scrollLeft,a.style.cursor="grabbing",h.preventDefault())}),document.addEventListener("mousemove",function(h){if(r){var y=l-h.clientX;Math.abs(y)>3&&(c=!0);var $=Date.now(),v=$-m||1;p=(h.clientX-d)/v*16*-1,d=h.clientX,m=$,a.scrollLeft=s(n+y)}}),document.addEventListener("mouseup",function(h){r&&(r=!1,a.style.cursor="grab",c&&(h.stopPropagation(),u=requestAnimationFrame(g)))}),a.addEventListener("click",function(h){c&&(h.preventDefault(),h.stopPropagation(),c=!1)},!0);var k=0,j=0,w=0,E=0,L=0;a.addEventListener("touchstart",function(h){u&&(cancelAnimationFrame(u),u=null),k=h.touches[0].clientX,w=h.touches[0].clientX,E=Date.now(),j=a.scrollLeft,L=0},{passive:!0}),a.addEventListener("touchmove",function(h){var y=Date.now(),$=y-E||1,v=h.touches[0].clientX;L=(v-w)/$*16*-1,w=v,E=y;var S=k-v;a.scrollLeft=s(j+S)},{passive:!0}),a.addEventListener("touchend",function(){u=requestAnimationFrame(function h(){Math.abs(L)<.5||(L*=.92,a.scrollLeft=s(a.scrollLeft+L),u=requestAnimationFrame(h))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(t){delete t.__pcInit,i(t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Ct=`(${Ne.toString()})();`,St=`
...
</svg>`;function Tt(i){const e="product-cards-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección de Productos",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-product-cards-config":JSON.stringify(H)},components:Oe(H),script:Ne,"script-props":["data-product-cards-config"],traits:[{type:"button",label:"Productos",text:"Administrar Sección",full:!0,command:"open-product-cards-config"}],toolbar:[]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),i.Commands.add("open-product-cards-config",{run(t){const a=t.getSelected();a&&_t(t,a)}}),i.BlockManager.add("product-cards-block",{label:"Sección de productos",category:"Productos y Servicios",media:jt,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),i.on("component:mount",t=>{t.getEl()?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>de(i),400))}),i.on("component:selected",t=>{const a=t.getEl();if(!a)return;const r=a.closest(`[data-gjs-type="${e}"]`);if(r&&!a.hasAttribute("data-gjs-type")){const n=i.getWrapper().find(`[data-gjs-type="${e}"]`).find(c=>c.getEl()===r);n&&setTimeout(()=>i.select(n),0)}}),i.on("canvas:render",()=>{setTimeout(()=>de(i),600)}),i.on("storage:end:load",()=>{setTimeout(()=>de(i),800)})}const zt=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
${qt}`}],He=function(){(function(){function i(t){if(!t||t.__savInit)return;t.__savInit=!0;var a=t.querySelector(".sav-carousel-wrap");if(!a)return;a.scrollLeft=0;var r=!1,l=0,n=0,c=!1,p=0,d=0,m=0,u=null;a.querySelectorAll("img").forEach(function(h){h.setAttribute("draggable","false")}),setTimeout(function(){var h=a.scrollWidth-a.clientWidth;if(h<=0)return;var y=Math.min(60,h),$=null;function v(S){$||($=S);var z=(S-$)/400;if(z<.5)a.scrollLeft=y*(z*2);else if(z<1)a.scrollLeft=y*(1-(z-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(v)}requestAnimationFrame(v)},400);function b(){return a.scrollWidth-a.clientWidth}function s(h){return Math.max(0,Math.min(h,b()))}function g(){Math.abs(p)<.5||(p*=.92,a.scrollLeft=s(a.scrollLeft+p),u=requestAnimationFrame(g))}a.addEventListener("mousedown",function(h){h.button===0&&(u&&(cancelAnimationFrame(u),u=null),r=!0,c=!1,p=0,l=h.clientX,d=h.clientX,m=Date.now(),n=a.scrollLeft,a.style.cursor="grabbing",h.preventDefault())}),document.addEventListener("mousemove",function(h){if(r){var y=l-h.clientX;Math.abs(y)>3&&(c=!0);var $=Date.now(),v=$-m||1;p=(h.clientX-d)/v*16*-1,d=h.clientX,m=$,a.scrollLeft=s(n+y)}}),document.addEventListener("mouseup",function(h){r&&(r=!1,a.style.cursor="grab",c&&(h.stopPropagation(),u=requestAnimationFrame(g)))}),a.addEventListener("click",function(h){c&&(h.preventDefault(),h.stopPropagation(),c=!1)},!0);var k=0,j=0,w=0,E=0,L=0;a.addEventListener("touchstart",function(h){u&&(cancelAnimationFrame(u),u=null),k=h.touches[0].clientX,w=h.touches[0].clientX,E=Date.now(),j=a.scrollLeft,L=0},{passive:!0}),a.addEventListener("touchmove",function(h){var y=Date.now(),$=y-E||1,v=h.touches[0].clientX;L=(v-w)/$*16*-1,w=v,E=y;var S=k-v;a.scrollLeft=s(j+S)},{passive:!0}),a.addEventListener("touchend",function(){u=requestAnimationFrame(function h(){Math.abs(L)<.5||(L*=.92,a.scrollLeft=s(a.scrollLeft+L),u=requestAnimationFrame(h))})},{passive:!0})}function e(){document.querySelectorAll(".sav-section").forEach(function(t){delete t.__savInit,i(t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Mt=`(${He.toString()})();`,Nt=`
...
@media(max-width:480px){.sav-card{flex:0 0 75vw;}}`;function Ot(i){const e=i.img||N("images/placeholder.svg"),t=i.title||"TÍTULO DEL PRODUCTO",a=i.desc?`<p class="sav-card-desc">${i.desc}</p>`:"",r=i.href||"#",l=i.btn_label||"Solicitar";return`<div class="sav-card"><div class="sav-card-img-wrap"><img src="${e}" alt="${t}" class="sav-card-img"></div><h3 class="sav-card-title">${t}</h3>${a}<a href="${r}" class="sav-btn">${l}</a></div>`}function Pe(i){const e=i.heading||"Depósitos y Cuentas de Ahorro",t=i.subheading||"Productos diseñados para hacer crecer tu dinero de forma segura.",a=i.more_href||"#",r=i.more_label||"Ver más",l=i.show_more!==!1,c=(i.cards||[]).map(Ot).join(""),p=N("images/brand-watermark.png"),d=l?`<div class="sav-more-wrap"><a href="${a}" class="sav-more-btn">${r}</a></div>`:"";return`<section class="sav-section"><style>${Nt}</style><div class="sav-blue-box"><div class="sav-watermark"><img src="${p}" alt=""></div><div style="display:flex;flex-direction:column;gap:0.5rem;text-align:center;position:relative;z-index:1;"><h2 class="sav-heading">${e}</h2><p class="sav-subheading">${t}</p></div><div class="sav-carousel-wrap"><div class="sav-track">${c}</div></div>${d}</div></section>`}const P={heading:"Depósitos y Cuentas de Ahorro",subheading:"Productos diseñados para hacer crecer tu dinero de forma segura.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CUENTA DE AHORRO ESTÁNDAR",href:"#",btn_label:"Solicitar"},{img:"",title:"AHORRO RENTABLE",href:"#",btn_label:"Solicitar"},{img:"",title:"CUENTA DE AHORRO MÁS",href:"#",btn_label:"Solicitar"},{img:"",title:"DEPÓSITO DE PLAZO FIJO",href:"#",btn_label:"Solicitar"}]};function Ht(i,e){const t=document.getElementById("sav-config-modal");if(t&&t.remove(),!document.getElementById("sav-modal-styles")){const d=document.createElement("style");d.id="sav-modal-styles",d.textContent=`
...
</svg>`;function Ft(i){const e="savings-section-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección Fondo Azul",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-savings-config":JSON.stringify(P)},components:Pe(P),script:He,"script-props":["data-savings-config"],traits:[{type:"button",label:"Sección",text:"Administrar Sección",full:!0,command:"open-savings-config"}],toolbar:[]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),i.Commands.add("open-savings-config",{run(t){const a=t.getSelected();a&&Ht(t,a)}}),i.BlockManager.add("savings-section-block",{label:"Sección Fondo Azul",category:"Productos y Servicios",media:Pt,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),i.on("component:mount",t=>{t.getEl()?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>fe(i),400))}),i.on("component:selected",t=>{const a=t.getEl();if(!a)return;const r=a.closest(`[data-gjs-type="${e}"]`);if(r&&!a.hasAttribute("data-gjs-type")){const l=i.getWrapper().find(`[data-gjs-type="${e}"]`).find(n=>n.getEl()===r);l&&setTimeout(()=>i.select(l),0)}}),i.on("canvas:render",()=>setTimeout(()=>fe(i),600)),i.on("storage:end:load",()=>setTimeout(()=>fe(i),800))}const ke=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
`,_i=[{id:"contact-form",label:"Formulario de contacto",category:"Formularios",media:Si,content:`
...
<\/script>`}],ji=`<svg viewBox="0 0 32 32" width="32" height="32">
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
        ...
        </tr>`,i.headers?.length&&(a+="<tr>",i.headers.forEach((n,c)=>{const p=c<i.headers.length-1?`border-r border-[${t.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${t.subheaderBg} ${t.subheaderText} ${p} border-b border-[${t.borderColor}] text-${n.align||"center"}">${n.text||""}</th>`}),a+="</tr>"),a+="</thead>"):i.headers?.length&&(a+="<thead><tr>",i.headers.forEach((n,c)=>{const p=c<i.headers.length-1?`border-r border-[${t.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${t.headerBg} ${t.headerText} ${p} border-b border-[${t.borderColor}] text-${n.align||"center"}">${n.text||""}</th>`}),a+="</tr></thead>"),a+="<tbody>";const r=i.rows.length,l={};return i.rows.forEach((n,c)=>{a+="<tr>";let p=0;n.forEach(d=>{for(;l[`${c}-${p}`];)p++;const m=d.colspan||1,u=d.rowspan||1;for(let v=c;v<c+u;v++)for(let S=p;S<p+m;S++)(v!==c||S!==p)&&(l[`${v}-${S}`]=!0);const b=m>1?`colspan="${m}"`:"",s=u>1?`rowspan="${u}"`:"",g=d.isHeader?t.labelBg:c%2===0?t.rowEvenBg:t.rowOddBg,k=d.isHeader?"font-semibold":"font-normal",j=d.isHeader?t.labelText:t.rowText,w=`text-${d.align||"center"}`,E=c+u>=r,h=p+m>=i.cols?"":`border-r border-[${t.borderColor}]`,y=E?"":`border-b border-[${t.borderColor}]`,$=`${h} ${y} p-3 align-middle text-sm ${g} ${k} ${j} ${w}`;d.image?a+=`<td ${b} ${s} class="${$}">
...
</svg>`;function ia(){return function(){const i=this,e="agencies-map-component",t="/api/agencies/active",a="agencies";let r=[],l=[],n={},c=null,p=[];const d=async()=>{try{m(),await b(),await k(),j(),$(),A(),Y(),u()}catch(o){console.error("Error initializing map:",o),ae("Error al cargar las agencias"),u()}};function m(){const o=i.querySelector(`.${e}-list`);o&&(o.innerHTML=`
