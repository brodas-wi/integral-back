import{L as e}from"./leaflet-Cwhsrwv-.js";function d(){const t=document.getElementById("agency-map");if(!t)return;const a=parseFloat(t.dataset.latitude),o=parseFloat(t.dataset.longitude),s=t.dataset.name,i=t.dataset.municipality,r=t.dataset.department;if(!a||!o){console.error("Invalid coordinates for map");return}const n=e.map("agency-map").setView([a,o],16);e.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',maxZoom:19}).addTo(n);const c=e.divIcon({className:"custom-marker",html:`
