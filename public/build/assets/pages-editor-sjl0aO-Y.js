...
${xe}`}],qe=function(){(function(){function i(t){if(!t||t.__pcInit)return;t.__pcInit=!0;var r=t.querySelector(".pc-carousel-wrap");if(!r)return;var a=!1,l=0,s=0,d=!1,h=0,f=0,u=0,x=null;r.querySelectorAll("img").forEach(function(b){b.setAttribute("draggable","false")});function m(){return r.scrollWidth-r.clientWidth}function n(b){return Math.max(0,Math.min(b,m()))}function g(){Math.abs(h)<.5||(h*=.92,r.scrollLeft=n(r.scrollLeft+h),x=requestAnimationFrame(g))}r.addEventListener("mousedown",function(b){b.button===0&&(x&&(cancelAnimationFrame(x),x=null),a=!0,d=!1,h=0,l=b.clientX,f=b.clientX,u=Date.now(),s=r.scrollLeft,r.style.cursor="grabbing",b.preventDefault())}),document.addEventListener("mousemove",function(b){if(a){var B=l-b.clientX;Math.abs(B)>3&&(d=!0);var L=Date.now(),y=L-u||1;h=(b.clientX-f)/y*16*-1,f=b.clientX,u=L,r.scrollLeft=n(s+B)}}),document.addEventListener("mouseup",function(b){a&&(a=!1,r.style.cursor="grab",d&&(b.stopPropagation(),x=requestAnimationFrame(g)))}),r.addEventListener("click",function(b){d&&(b.preventDefault(),b.stopPropagation(),d=!1)},!0);var w=0,z=0,v=0,$=0,S=0;r.addEventListener("touchstart",function(b){x&&(cancelAnimationFrame(x),x=null),w=b.touches[0].clientX,v=b.touches[0].clientX,$=Date.now(),z=r.scrollLeft,S=0},{passive:!0}),r.addEventListener("touchmove",function(b){var B=Date.now(),L=B-$||1,y=b.touches[0].clientX;S=(y-v)/L*16*-1,v=y,$=B;var j=w-y;r.scrollLeft=n(z+j)},{passive:!0}),r.addEventListener("touchend",function(){x=requestAnimationFrame(function b(){Math.abs(S)<.5||(S*=.92,r.scrollLeft=n(r.scrollLeft+S),x=requestAnimationFrame(b))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(t){delete t.__pcInit,i(t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Bt=`(${qe.toString()})();`,Et=`
...
@media(max-width:480px){.pc-card{flex:0 0 80vw;}}`;function $t(i){const e=i.img||N("images/placeholder.svg"),t=i.title||"TÍTULO DEL PRODUCTO",r=i.desc||"Descripción breve del producto financiero.",a=i.href||"#",l=i.btn_label||"Solicitar";return`<div class="pc-card"><div class="pc-card-img-wrap"><img src="${e}" alt="${t}" class="pc-card-img"></div><div class="pc-card-body"><h3 class="pc-card-title">${t}</h3><p class="pc-card-desc">${r}</p></div><a href="${a}" class="pc-btn">${l}</a></div>`}function Me(i){const e=i.heading||"Créditos",t=i.subheading||"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",r=i.more_href||"#",a=i.more_label||"Ver más",s=(i.cards||[]).map($t).join("");return`<section class="pc-section"><style>${Et}</style><div style="text-align:center;margin-bottom:2rem;"><h2 class="pc-section-heading">${e}</h2><p class="pc-section-subheading">${t}</p></div><div class="pc-carousel-wrap"><div class="pc-track">${s}</div></div><div class="pc-more-wrap"><a href="${r}" class="pc-more-btn">${a}</a></div></section>`}const M={heading:"Créditos",subheading:"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CREDINVIERTE",desc:"Adquiere activos fijos",href:"#",btn_label:"Solicitar"},{img:"",title:"SOLUCIONES INTEGRALES",desc:"Financiamiento PYME",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDI-CONFIAMOS",desc:"Rápido y sin fiador",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDILÍNEA",desc:"Línea rotativa",href:"#",btn_label:"Solicitar"}]};function Ct(i,e){const t=document.getElementById("pc-config-modal");if(t&&t.remove(),!document.getElementById("pc-modal-styles")){const f=document.createElement("style");f.id="pc-modal-styles",f.textContent=`
        ...
        <div class="pc-modal-footer">
            ...
            <button id="pc-modal-save" class="pc-btn-save"><i class="ri-check-line"></i> Aplicar cambios</button>
        </div>`,l.appendChild(s),document.body.appendChild(l),s.querySelectorAll(".pc-tab-btn").forEach(f=>{f.addEventListener("click",()=>{s.querySelectorAll(".pc-tab-btn").forEach(u=>u.classList.remove("active")),s.querySelectorAll(".pc-tab-panel").forEach(u=>u.classList.remove("active")),f.classList.add("active"),s.querySelector(`#pc-panel-${f.dataset.tab}`).classList.add("active")})});function d(){const f=s.querySelector("#pc-cards-list");f.innerHTML="",a.cards.forEach((u,x)=>{const m=document.createElement("div");m.className="pc-card-config";const n=u.img?`<img class="pc-img-preview" src="${u.img}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>';m.innerHTML=`
                ...
                </div>`,m.querySelectorAll("[data-field]").forEach(g=>{g.addEventListener("input",()=>{if(u[g.dataset.field]=g.value,g.dataset.field==="img"){const w=m.querySelector(`#pc-img-wrap-${x}`);w.innerHTML=g.value?`<img class="pc-img-preview" src="${g.value}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>'}})}),m.querySelector(".pc-pick-img").addEventListener("click",()=>{Fe({type:"image",title:"Seleccionar imagen de tarjeta",onSelect:g=>{u.img=g,m.querySelector("[data-field='img']").value=g,m.querySelector(`#pc-img-wrap-${x}`).innerHTML=`<img class="pc-img-preview" src="${g}" alt="">`}})}),m.querySelector(".pc-remove-card").addEventListener("click",()=>{a.cards.splice(x,1),d()}),f.appendChild(m)})}d(),s.querySelector("#pc-add-card").addEventListener("click",()=>{a.cards.push({img:"",title:"NUEVO PRODUCTO",desc:"Descripción del producto.",href:"#",btn_label:"Solicitar"}),d(),s.querySelector("#pc-cards-list").lastElementChild?.scrollIntoView({behavior:"smooth",block:"nearest"})});const h=()=>l.remove();s.querySelector("#pc-modal-close").addEventListener("click",h),s.querySelector("#pc-modal-cancel").addEventListener("click",h),l.addEventListener("click",f=>{f.target===l&&h()}),s.querySelector("#pc-modal-save").addEventListener("click",()=>{a.heading=s.querySelector("#pc-heading").value.trim()||M.heading,a.subheading=s.querySelector("#pc-subheading").value.trim()||M.subheading,a.more_label=s.querySelector("#pc-more-label").value.trim()||M.more_label,a.more_href=s.querySelector("#pc-more-href").value.trim()||"#",e.addAttributes({"data-product-cards-config":JSON.stringify(a)}),e.components(Me(a)),setTimeout(()=>de(i),300),h()})}function de(i){try{const e=i.Canvas.getFrameEl()?.contentDocument;if(!e)return;const t=e.getElementById("pc-runtime-script");t&&t.remove(),e.querySelectorAll(".pc-section").forEach(a=>{delete a.__pcInit});const r=e.createElement("script");r.id="pc-runtime-script",r.textContent=Bt,e.head.appendChild(r)}catch(e){console.warn("[ProductCards] Error reiniciando carrusel:",e)}}const St=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</svg>`;function Lt(i){const e="product-cards-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección de Productos",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-product-cards-config":JSON.stringify(M)},components:Me(M),script:qe,"script-props":["data-product-cards-config"],traits:[{type:"button",label:"Productos",text:"Administrar Sección",full:!0,command:"open-product-cards-config"}],toolbar:[]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),i.Commands.add("open-product-cards-config",{run(t){const r=t.getSelected();r&&Ct(t,r)}}),i.BlockManager.add("product-cards-block",{label:"Sección de productos",category:"Productos y Servicios",media:St,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),i.on("component:mount",t=>{t.getEl()?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>de(i),400))}),i.on("component:selected",t=>{const r=t.getEl();if(!r)return;const a=r.closest(`[data-gjs-type="${e}"]`);if(a&&!r.hasAttribute("data-gjs-type")){const s=i.getWrapper().find(`[data-gjs-type="${e}"]`).find(d=>d.getEl()===a);s&&setTimeout(()=>i.select(s),0)}}),i.on("canvas:render",()=>{setTimeout(()=>de(i),600)}),i.on("storage:end:load",()=>{setTimeout(()=>de(i),800)})}const jt=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,Mt=[{id:"icon-grid-hero",label:"Sección de características",category:"Productos y Servicios",media:At,content:`
...
${qt}`},{id:"icon-card",label:"Tarjeta con icono",category:"Productos y Servicios",media:Dt,content:`${G}`}],we=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
<style>${ue}</style>`,Xt=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</svg>`,Y=i=>{const e=i==="light";return`
...
${ci}`,di=[{id:"stats-strip-left",label:"Franja estadísticas - izquierda",category:"Heroes",media:ni,content:$e(!0)},{id:"stats-strip-right",label:"Franja estadísticas - derecha",category:"Heroes",media:si,content:$e(!1)}],fi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
</style>`,hi=[{id:"service-cards-section",label:"Sección de servicios",category:"Productos y Servicios",media:fi,content:`
...
${Ce}`},{id:"service-card",label:"Tarjeta de servicio",category:"Productos y Servicios",media:gi,content:`${se}${Ce}`}],pi=`<svg viewBox="0 0 32 32" width="32" height="32">
...
<\/script>`}],$i=`<svg viewBox="0 0 32 32" width="32" height="32">
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
            ...
            <th colspan="${i.cols}" class="p-3 align-middle text-center text-base font-bold ${t.headerBg} ${t.headerText}">
                ...
                </td>`:r+=`<td ${m} ${n} class="${L}">${f.text||""}</td>`,h+=u}),r+="</tr>"}),r+="</tbody></table>",r}function Z(i,e){return{title:"Título de la tabla",cols:i,headers:Array.from({length:i},(t,r)=>({text:`Columna ${r+1}`,align:"center"})),rows:Array.from({length:e},()=>Array.from({length:i},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})))}}function Pe(i,e){return`<div class="w-full overflow-x-auto rounded-2xl border-2 border-[${(fe[e]||fe.blue).borderColor}]">${i}</div>`}function Le(i,e){const t={};return i.forEach((r,a)=>{let l=0;r.forEach(s=>{for(;t[`${a}-${l}`];)l++;const d=Math.min(s.colspan||1,e-l),h=s.rowspan||1;for(let f=a;f<a+h;f++)for(let u=l;u<l+d;u++)(f!==a||u!==l)&&(t[`${f}-${u}`]=`${a}-${l}`);l+=d})}),t}const Ci=`
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function Si(){if(document.getElementById("tam-img-modal"))return;const i=document.createElement("div");i.id="tam-img-modal",i.innerHTML=`
        ...
        <div class="tam-container">
        ...
        </div>`,document.body.appendChild(r);let a=null,l=null;function s(m){a=m;const n=m.get("tableData");l=n?JSON.parse(JSON.stringify(n)):Z(3,3);const g=l.cols||3;l.rows=l.rows.map((w,z)=>Array.from({length:g},($,S)=>w[S]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})),document.getElementById("tam-title").value=l.title||"",document.getElementById("tam-theme").value=m.get("tableTheme")||"blue",document.getElementById("tam-cols").value=l.cols||3,document.getElementById("tam-rows").value=l.rows.length||3,u(),x(),r.classList.add("open"),document.body.style.overflow="hidden"}function d(){r.classList.remove("open"),document.body.style.overflow="",a=null}function h(){l.title=document.getElementById("tam-title").value.trim(),l.cols=parseInt(document.getElementById("tam-cols").value)||3,l.headers=Array.from(document.querySelectorAll(".tam-header-input")).map(n=>({text:n.value,align:n.closest("th")?.querySelector(".tam-align-select")?.value||"center"})),document.querySelectorAll("#tam-tbody td.tam-cell:not(.is-spanned)").forEach(n=>{const g=parseInt(n.dataset.row),w=parseInt(n.dataset.col);l.rows[g]?.[w]&&(l.rows[g][w].text=n.querySelector(".tam-cell-input")?.value||"",l.rows[g][w].align=n.querySelector(".tam-align-select")?.value||"center",l.rows[g][w].isHeader=n.dataset.isheader==="1",l.rows[g][w].image=n.dataset.image||null)});const m=Le(l.rows,l.cols);l.rows=l.rows.map((n,g)=>n.filter((w,z)=>!m[`${g}-${z}`]))}function f(){if(r.querySelector("#tam-rebuild-notice"))return;const n=document.createElement("div");n.id="tam-rebuild-notice",n.style.cssText="background:#fef9c3;border:1.5px solid #ca8a04;border-radius:0.5rem;padding:0.5rem 1rem;font-size:0.8rem;color:#92400e;display:flex;align-items:center;gap:0.5rem;margin:0 1.5rem 0;flex-shrink:0;",n.innerHTML='<i class="ri-error-warning-line"></i> Has modificado el colspan/rowspan. Haz clic en <strong style="margin:0 4px;">Reconstruir</strong> para aplicar los cambios de fusión.',r.querySelector(".tam-toolbar").after(n)}function u(){r.querySelector("#tam-rebuild-notice")?.remove()}function x(){const m=document.getElementById("tam-thead"),n=document.getElementById("tam-tbody"),g=l.cols,w=l.rows.length,z=Le(l.rows,g);m.innerHTML=`<tr>${l.headers.map((v,$)=>`
            <th>
            ...
            </th>`).join("")}</tr>`,n.innerHTML=l.rows.map((v,$)=>`<tr>${Array.from({length:g},(b,B)=>{const L=z[`${$}-${B}`];if(L)return`<td class="tam-cell is-spanned" data-row="${$}" data-col="${B}">
                        <div class="tam-spanned-label">Combinada con [${L}]</div>
                    </td>`;const y=v[B]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null},j=y.colspan||1,P=y.rowspan||1,T=j>1||P>1;return`<td class="tam-cell ${y.isHeader?"is-header-cell":""} ${y.image?"has-image":""} ${T?"has-span":""}"
                    data-row="${$}" data-col="${B}"
                ...
                </td>`}).join("")}</tr>`).join(""),n.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(v=>{v.addEventListener("change",()=>{const $=parseInt(v.dataset.row),S=parseInt(v.dataset.col),b=Math.max(1,parseInt(v.value)||1);l.rows[$]?.[S]&&(v.dataset.action==="colspan"?l.rows[$][S].colspan=Math.min(b,g-S):l.rows[$][S].rowspan=Math.min(b,w-$),f())})}),n.querySelectorAll("button[data-action]").forEach(v=>{v.addEventListener("click",$=>{$.preventDefault(),$.stopPropagation();const S=v.dataset.action,b=parseInt(v.dataset.row),B=parseInt(v.dataset.col);if(!(isNaN(b)||isNaN(B)||!l.rows[b]?.[B])){if(S==="header"){l.rows[b][B].isHeader=!l.rows[b][B].isHeader;const L=n.querySelector(`td[data-row="${b}"][data-col="${B}"]`);L&&(L.dataset.isheader=l.rows[b][B].isHeader?"1":"0",L.classList.toggle("is-header-cell",l.rows[b][B].isHeader)),v.classList.toggle("active",l.rows[b][B].isHeader),v.textContent=l.rows[b][B].isHeader?"✓ Etiqueta":"Etiqueta";return}if(S==="image"){window.__openTableImagePicker&&window.__openTableImagePicker(L=>{l.rows[b][B].image=L;const y=n.querySelector(`td[data-row="${b}"][data-col="${B}"]`);if(y){y.dataset.image=L,y.classList.add("has-image");let j=y.querySelector(".tam-cell-img-preview");j||(j=document.createElement("img"),j.className="tam-cell-img-preview",y.insertBefore(j,y.firstChild)),j.src=L;const P=y.querySelector("[data-action=image]");if(P&&(P.innerHTML='<i class="ri-image-line"></i> Cambiar'),!y.querySelector("[data-action=clear-image]")){const T=document.createElement("button");T.type="button",T.className="tam-cell-btn tam-cell-btn-clear",T.dataset.action="clear-image",T.dataset.row=b,T.dataset.col=B,T.textContent="✕ Quitar",T.addEventListener("click",W=>{W.preventDefault(),W.stopPropagation(),l.rows[b][B].image=null,y.dataset.image="",y.classList.remove("has-image"),j.remove(),T.remove();const H=y.querySelector("[data-action=image]");H&&(H.innerHTML='<i class="ri-image-line"></i> Imagen')}),y.querySelector(".tam-cell-actions").appendChild(T)}}});return}S==="clear-image"&&(l.rows[b][B].image=null,x())}})})}document.getElementById("tam-close").addEventListener("click",d),document.getElementById("tam-cancel").addEventListener("click",d),r.addEventListener("click",m=>{m.target===r&&d()}),document.getElementById("tam-rebuild").addEventListener("click",()=>{const m=parseInt(document.getElementById("tam-cols").value)||3,n=parseInt(document.getElementById("tam-rows").value)||3;for(u(),h();l.headers.length<m;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,m),l.cols=m;l.rows.length<n;)l.rows.push(Array.from({length:m},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,n).map(g=>{for(;g.length<m;)g.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return g.slice(0,m)}),x()}),document.getElementById("tam-apply").addEventListener("click",()=>{h();const m=document.getElementById("tam-theme").value;a&&(a.set("tableData",JSON.parse(JSON.stringify(l))),a.set("tableTheme",m),a.addAttributes({"data-table-theme":m}),be(a)),d()}),window.__openTableAdminModal=s}function be(i){const e=i.get("tableData"),t=i.get("tableTheme")||"blue";e&&i.components(Pe(Ne(e,t),t))}function ji(){return function(){}}const _i=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:$i,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<a href="#"
   ...
   class="dld-simple-${e}">
    ...
    <rect x="3" y="25" width="7" height="2.5" fill="#dee2e6" rx="0.5"/>
</svg>`;function Zi(){return function(){const i=this,e="agencies-map-component",t="/api/agencies/active",r="agencies";let a=[],l=[],s={},d=null,h=[];const f=async()=>{try{u(),await m(),await w(),z(),L(),T(),W(),x()}catch(o){console.error("Error initializing map:",o),ae("Error al cargar las agencias"),x()}};function u(){const o=i.querySelector(`.${e}-list`);o&&(o.innerHTML=`
                ...
                `);const c=i.querySelector(`.${e}-map-container`);c&&(c.style.opacity="0.5")}function x(){const o=i.querySelector(`.${e}-map-container`);o&&(o.style.transition="opacity 0.3s ease",o.style.opacity="1")}async function m(){try{const c=await(await fetch(t)).json(),p=r?c[r]:c;Array.isArray(p)?(a=p.filter(k=>k.latitude&&k.longitude&&!isNaN(k.latitude)&&!isNaN(k.longitude)),l=[...a],n()):(a=[],l=[])}catch(o){console.error("Error loading items:",o),a=[],l=[]}}function n(){const o=[...new Set(a.map(p=>p.zone).filter(Boolean))].sort(),c=[...new Set(a.map(p=>p.department).filter(Boolean))].sort();s={zone:o,department:c},setTimeout(()=>{const p=i.querySelector(`.${e}-filters-container`);p&&!p.hasChildNodes()&&(p.innerHTML=`
                    ...
                    `,g())},100)}function g(){const o=i.querySelector(`.${e}-zone-filter`),c=i.querySelector(`.${e}-department-filter`);o&&s.zone&&s.zone.forEach(p=>{const k=document.createElement("option");k.value=p,k.textContent=p,o.appendChild(k)}),c&&s.department&&s.department.forEach(p=>{const k=document.createElement("option");k.value=p,k.textContent=p,c.appendChild(k)})}async function w(){if(!document.getElementById("leaflet-css")){const o=document.createElement("link");o.id="leaflet-css",o.rel="stylesheet",o.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",document.head.appendChild(o)}if(typeof window.L>"u"&&await new Promise((o,c)=>{const p=document.createElement("script");p.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",p.onload=o,p.onerror=c,document.head.appendChild(p)}),typeof window.L<"u"&&window.L.Icon&&window.L.Icon.Default){const o=window.L.icon({iconUrl:"data:image/svg+xml;base64,"+btoa(`
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 36" width="24" height="36">
                            <path fill="#f0872a" d="M12 0C7.6 0 4 3.6 4 8c0 5.4 8 16 8 16s8-10.6 8-16c0-4.4-3.6-8-8-8z"/>
                            <circle cx="12" cy="8" r="3" fill="#fff"/>
                        </svg>
                    `),iconSize:[30,45],iconAnchor:[15,45],popupAnchor:[0,-45]});window.customOrangeIcon=o}}function z(){const o=i.querySelector(`.${e}-map`);if(!o||!window.L)return;o._leaflet_id&&o._map&&(o._map.remove(),delete o._map),d=window.L.map(o).setView([13.7942,-88.8965],8),window.L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(d),o._map=d,d.whenReady(function(){v(),setTimeout(()=>{d&&d.invalidateSize&&d.invalidateSize()},300)})}function v(){$(),S(),B()}function $(){h.forEach(o=>{o.marker&&d.removeLayer(o.marker)}),h=[]}function S(){l.forEach((o,c)=>{if(o.latitude&&o.longitude){const p=b(o),k=window.L.marker([o.latitude,o.longitude],{icon:window.customOrangeIcon||new window.L.Icon.Default}).addTo(d).bindPopup(p);h.push({marker:k,item:o,index:c})}})}function b(o){let c=`<div style="min-width: 200px;"><h4 style="font-weight: 700; margin-bottom: 12px; color: #0d3f6a; font-size: 16px; border-bottom: 2px solid #f0872a; padding-bottom: 8px;">${o.name}</h4>`;if(o.address&&(c+=`<p style="margin: 8px 0 0 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-map-pin-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${o.address}</span></p>`),o.municipality||o.department){const p=[o.municipality,o.department].filter(Boolean).join(", ");c+=`<p style="margin: 0 0 8px 0; font-size: 13px; color: #6b7280; padding-left: 24px;">${p}</p>`}return o.schedule&&(c+=`<p style="margin: 8px 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-time-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${o.schedule}</span></p>`),c+="</div>",c}function B(){if(l.length>0){const o=l.filter(c=>c.latitude&&c.longitude).map(c=>[c.latitude,c.longitude]);o.length>1?d.once("moveend",function(){setTimeout(()=>{try{d&&d._loaded&&typeof d.fitBounds=="function"&&d.fitBounds(o,{padding:[50,50],maxZoom:12,animate:!1})}catch(c){console.warn("Error fitting bounds:",c)}},100)}):o.length===1&&d.setView(o[0],14)}}function L(){const o=i.querySelector(`.${e}-list`);if(!o)return;if(l.length===0){j(o);return}const c=l.map((p,k)=>y(p,k)).join("");o.innerHTML=c,P()}function y(o,c){const p=o.phones&&o.phones.length>0?o.phones.map(C=>`
                        <p class="text-gray-200 flex items-center gap-2 mt-2">
                            <i class="ri-phone-line text-primary text-lg"></i>
                            <a href="tel:${C.replace(/\s+/g,"")}" class="agency-phone-link text-white font-medium hover:underline">${C}</a>
                        </p>
            ...
            `}function P(){const o=i.querySelectorAll(`.${e}-item`);o.forEach(c=>{c.addEventListener("click",p=>{if(p.target.closest(".agency-maps-btn"))return;p.preventDefault();const k=parseInt(c.dataset.itemIndex),C=l[k];if(!C)return;o.forEach(E=>{E.classList.remove("bg-white","border-secondary","selected-agency"),E.classList.add("bg-white/10","border-white/20");const A=E.querySelector(".agency-title"),re=E.querySelectorAll("i"),le=E.querySelectorAll(".agency-phone-link"),ge=E.querySelectorAll("p:not(:has(.agency-phone-link))"),he=E.querySelector(".agency-maps-btn");A&&(A.classList.remove("text-secondary"),A.classList.add("text-white")),re.forEach(U=>{U.classList.remove("text-secondary","text-gray-300","text-white"),U.classList.add("text-primary")}),le.forEach(U=>{U.classList.remove("text-secondary"),U.classList.add("text-white")}),ge.forEach(U=>{U.classList.remove("text-secondary"),U.classList.add("text-gray-200")}),he&&(he.classList.remove("bg-secondary"),he.classList.add("bg-primary"))}),c.classList.remove("bg-white/10","border-white/20"),c.classList.add("bg-white","border-secondary","selected-agency");const q=c.querySelector(".agency-title"),F=c.querySelectorAll("i"),X=c.querySelectorAll(".agency-phone-link"),R=c.querySelectorAll("p:not(:has(.agency-phone-link))"),O=c.querySelector(".agency-maps-btn");if(q&&(q.classList.remove("text-white"),q.classList.add("text-secondary")),F.forEach(E=>{E.classList.remove("text-secondary","text-gray-300","text-white"),E.classList.add("text-primary")}),X.forEach(E=>{E.classList.remove("text-white"),E.classList.add("text-secondary")}),R.forEach(E=>{E.classList.remove("text-gray-200"),E.classList.add("text-secondary")}),O&&(O.classList.remove("bg-primary"),O.classList.add("bg-secondary")),d&&C&&d._loaded)try{d.flyTo([C.latitude,C.longitude],14,{animate:!0,duration:1});const E=h.find(A=>A.item.id===C.id);E&&E.marker&&E.marker.openPopup()}catch(E){console.warn("Error updating map view:",E)}})})}function T(){const o=i.querySelector(`.${e}-search-input`),c=i.querySelector(`.${e}-zone-filter`),p=i.querySelector(`.${e}-department-filter`),k=i.querySelector(`.${e}-no-results`),C={Occidental:["Ahuachapán","Santa Ana","Sonsonate"],Paracentral:["Chalatenango","Cuscatlán","La Paz","Cabañas","San Vicente"],Central:["La Libertad","San Salvador"],Oriental:["Usulután","San Miguel","Morazán","La Unión"]},q=()=>{if(!c||!p)return;const X=c.value,R=p.value;if(!X)p.innerHTML='<option value="">Todos los Departamentos</option>',[...new Set(a.map(E=>E.department).filter(Boolean))].sort().forEach(E=>{const A=document.createElement("option");A.value=E,A.textContent=E,p.appendChild(A)}),R&&(p.value=R);else{const O=C[X]||[];p.innerHTML='<option value="">Todos los Departamentos</option>',O.forEach(E=>{const A=document.createElement("option");A.value=E,A.textContent=E,p.appendChild(A)}),O.includes(R)&&(p.value=R)}},F=()=>{const X=o?o.value.toLowerCase().trim():"",R=c?c.value:"",O=p?p.value:"";l=a.filter(E=>{let A=!0,re=!0,le=!0;return X&&(A=Object.values(E).some(ge=>String(ge).toLowerCase().includes(X))),R&&(re=E.zone===R),O&&(le=E.department===O),A&&re&&le}),L(),v(),k&&k.classList.toggle("hidden",l.length>0)};o&&o.addEventListener("input",F),c&&c.addEventListener("change",()=>{q(),F()}),p&&p.addEventListener("change",F)}function W(){const o=i.querySelector("[data-title]");if(o){const k=H("map-title")||"Nuestras Agencias";o.textContent=k}const c=i.querySelector(`.${e}-search-input`);if(c){const k=H("search-placeholder")||"Buscar...";c.setAttribute("placeholder",k)}const p=i.querySelector(`.${e}-no-results`);if(p){const k=H("no-results-text")||"No se encontraron agencias";p.textContent=k}}function H(o){return i.closest(`[data-gjs-type="${e}"]`)?.getAttribute(o)}function ae(o){const c=i.querySelector(`.${e}-list`);c&&(c.innerHTML=`
                    <div class="flex flex-col items-center justify-center p-12 text-center">
...
@media(max-width:480px){
    .banner-btn{flex:1 1 100%;min-width:0;}
            ...
            `;const o=i.ownerDocument??document;if(!o.getElementById("banner-skeleton-styles")){const c=o.createElement("style");c.id="banner-skeleton-styles",c.textContent=`
                ...
                `,o.head.appendChild(c)}}function z(o){return t[o]?t[o]:o==="outline-blue"||o==="outline-orange"?t["outline-white"]:t["fill-white"]}function v(o,c,p,k){const C=z(p),q=c?"a":"span",F=c?`href="${c}"${k?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${q} ${F}
                class="banner-btn"
                data-bg="${C.bg}"
                data-color="${C.color}"
                data-hover-bg="${C.hoverBg}"
                data-hover-color="${C.hoverColor}"
                style="background:${C.bg};color:${C.color};border:2px solid ${C.border};">
                ${o}
            </${q}>`}function $(){n.innerHTML=a.map((o,c)=>`
            ...
            `).join(""),S(),b(),B()}function S(){i.querySelectorAll(".banner-btn").forEach(o=>{const c=o.style.borderColor;o.addEventListener("mouseenter",()=>{o.style.background=o.dataset.hoverBg,o.style.color=o.dataset.hoverColor,o.style.borderColor=o.dataset.hoverBg}),o.addEventListener("mouseleave",()=>{o.style.background=o.dataset.bg,o.style.color=o.dataset.color,o.style.borderColor=c})})}function b(){n.addEventListener("mousedown",L),n.addEventListener("touchstart",L,{passive:!0}),n.addEventListener("mousemove",y),n.addEventListener("touchmove",y,{passive:!0}),n.addEventListener("mouseup",j),n.addEventListener("touchend",j),n.addEventListener("mouseleave",j)}function B(){a.forEach(o=>{const c=new Image;c.src=o.image_url})}function L(o){d=!0,h=o.touches?o.touches[0].clientX:o.clientX,f=0}function y(o){d&&(f=(o.touches?o.touches[0].clientX:o.clientX)-h)}function j(){d&&(d=!1,Math.abs(f)>=u&&(T(f<0?(l+1)%a.length:(l-1+a.length)%a.length),H()),f=0)}function P(){const o=i.querySelector(".banner-stripe");if(!o||a.length<=1)return;const c=document.createElement("div");c.className="banner-dots",a.forEach((p,k)=>{const C=document.createElement("button");C.className="banner-dot",C.dataset.index=String(k),C.setAttribute("aria-label",`Banner ${k+1}`),C.addEventListener("click",()=>{T(k),H()}),c.appendChild(C)}),o.innerHTML="",o.appendChild(c)}function T(o,c=!0){const p=n.querySelectorAll(".banner-slide"),k=i.querySelectorAll(".banner-dot");p.forEach((C,q)=>{const F=q===o;c||(C.style.transition="none"),C.classList.toggle("banner-slide--active",F),c||requestAnimationFrame(()=>{C.style.transition=""})}),k.forEach((C,q)=>{C.classList.toggle("banner-dot--active",q===o)}),l=o}function W(){a.length<=1||!x||(s=setInterval(()=>{T((l+1)%a.length)},5e3))}function H(){x&&(clearInterval(s),W())}function ae(){const o=i.querySelector(".banner-wrapper");o&&(o.innerHTML=`
                    <div style="display:flex;align-items:center;justify-content:center;
                                min-height:480px;color:rgba(255,255,255,0.5);font-size:14px;padding:40px;">
                        Sin contenido.
                    </div>`)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",g):g()}}const la=[{id:"banner-hero",label:"Banner Slider",category:"Banners",media:ia,content:{type:"banner-hero-component"}}];function oa(i){const e="banner-hero-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner Slider",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-autoplay":"true","data-category":""},components:`
