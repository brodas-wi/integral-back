import{i as D,o as F,t as H,d as U,f as N,e as _,s as P,g as G,c as O,E as R,j as J,h as V}from"./editor-commands-Bq37dEX4.js";import"./_commonjsHelpers-CqkleIqs.js";function W(){return D()}const A=`
<style>
.ft-wrapper {
...
@media (max-width: 320px) {
...
</style>`;function z(i){const t=i.logo_url?`<img src="${i.logo_url}" alt="${i.logo_alt||"Logo"}">`:'<span class="ft-logo-text">Logo</span>',r=(i.sections||[]).map((s,m)=>{const w=(s.links||[]).map(g=>{const d=g.icon?`<i class="${g.icon}"></i>`:"";return g.isText?`<li><span class="ft-text">${d}${g.label}</span></li>`:`<li><a href="${g.href||"#"}">${d}${g.label}</a></li>`}).join("");return`<div class="ft-section" data-section-index="${m}" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"><p class="ft-section-title">${s.title}</p><ul class="ft-links">${w}</ul></div>`}).join("");return`<div class="ft-inner" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"><div class="ft-logo-col" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">${t}</div>${r}</div><div class="ft-stripe" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"></div>`}function X(){return function(){}}function Q(i,t){const r=document.getElementById("footer-config-modal");if(r&&r.remove(),!document.getElementById("ft-modal-styles")){const e=document.createElement("style");e.id="ft-modal-styles",e.textContent=`
            .ft-overlay {
                position: fixed;
                inset: 0;
                z-index: 99999;
    ...
    `,d.appendChild(p),document.body.appendChild(d);const f=p.querySelector("#ft-sections-container"),T=`${document.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??""}/api/pages/search`;function S(e){if(e.dataset.autocompleteAttached)return;e.dataset.autocompleteAttached="true";const c=e.parentNode,a=c.style.position;(!a||a==="static")&&(c.style.position="relative");const n=document.createElement("ul");n.style.cssText=`
        ...
        `,a.querySelector(".ft-remove-section").onclick=()=>{m.splice(c,1),x()},a.querySelector(".ft-btn-add-link").onclick=()=>{e.links=e.links||[],e.links.push({label:"Nuevo enlace",href:"#",icon:""}),x()},a.querySelectorAll(".ft-remove-link").forEach(o=>{o.onclick=()=>{const l=parseInt(o.closest(".ft-link-row").dataset.linkIndex);e.links.splice(l,1),x()}}),a.querySelectorAll(".ft-link-href").forEach(o=>{o.closest("[style*='pointer-events:none']")||S(o)}),a.querySelectorAll(".ft-link-istext").forEach(o=>{o.addEventListener("change",()=>{const l=o.closest(".ft-link-row").querySelector(".ft-link-href");o.checked?(l.style.opacity="0.4",l.style.pointerEvents="none",l.value=""):(l.style.opacity="1",l.style.pointerEvents="auto")})}),a}function x(){f.innerHTML="",m.forEach((e,c)=>f.appendChild(L(e,c))),C(f,m,x)}x(),p.querySelector("#ft-logo-pick").addEventListener("click",()=>{F({type:"image",title:"Seleccionar logo",onSelect:e=>{p.querySelector("#ft-logo-url").value=e;let c=p.querySelector("#ft-logo-preview");if(!c||c.tagName==="DIV"){const a=document.createElement("img");a.id="ft-logo-preview",a.style.cssText="height:48px;max-width:160px;object-fit:contain;border-radius:0.375rem;border:1px solid #e2e8f0;padding:4px;background:#f8fafc;display:block;margin-bottom:0.5rem;",c?.replaceWith(a)??p.querySelector("#ft-logo-url").before(a),c=a}c.src=e,c.style.display="block"}})}),p.querySelector("#ft-add-section").onclick=()=>{m.push({title:"Nueva Sección",links:[]}),x(),f.lastElementChild?.scrollIntoView({behavior:"smooth",block:"nearest"})};function B(){const e=p.querySelector("#ft-logo-url").value.trim(),c=p.querySelector("#ft-logo-alt").value.trim(),a=[];return f.querySelectorAll("[data-section-index]").forEach(n=>{const o=n.querySelector(".ft-section-title-input").value.trim(),l=[];n.querySelectorAll(".ft-link-row").forEach(v=>{const $=v.querySelector(".ft-link-istext")?.checked??!1;l.push({icon:v.querySelector(".ft-link-icon").value.trim(),label:v.querySelector(".ft-link-label").value.trim(),href:$?"":v.querySelector(".ft-link-href").value.trim(),isText:$})}),a.push({title:o,links:l})}),{logo_url:e,logo_alt:c,sections:a}}const j=()=>d.remove();p.querySelector("#ft-modal-close").onclick=j,p.querySelector("#ft-modal-cancel").onclick=j,d.onclick=e=>{e.target===d&&j()},p.querySelector("#ft-modal-save").onclick=()=>{const e=B();t.addAttributes({"data-footer-config":JSON.stringify(e)}),t.components(z(e)+A),j()}}function Y(i){const t="footer-component";i.DomComponents.addType(t,{isComponent:r=>r.getAttribute?.("data-gjs-type")===t?{type:t}:!1,model:{defaults:{name:"Footer",tagName:"footer",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":t,class:"ft-wrapper","data-footer-config":JSON.stringify({logo_url:"",logo_alt:"Logo",sections:[{title:"Productos",links:[{label:"Créditos",href:"#",icon:""},{label:"Depósitos",href:"#",icon:""},{label:"Otros Servicios",href:"#",icon:""}]},{title:"Sobre Nosotros",links:[{label:"Historial",href:"#",icon:""},{label:"Misión y Visión",href:"#",icon:""},{label:"Red de Agencias",href:"#",icon:""}]},{title:"Contáctanos",links:[{label:"0000 - 0000",href:"tel:0000-0000",icon:"ri-phone-line"},{label:"Correo",href:"mailto:info@banco.com",icon:"ri-mail-line"},{label:"Dirección",href:"#",icon:"ri-map-pin-line"}]}]})},components:z({logo_url:"",logo_alt:"Logo",sections:[{title:"Productos",links:[{label:"Créditos",href:"#",icon:""},{label:"Depósitos",href:"#",icon:""}]},{title:"Sobre Nosotros",links:[{label:"Historial",href:"#",icon:""},{label:"Misión y Visión",href:"#",icon:""}]},{title:"Contáctanos",links:[{label:"0000-0000",href:"tel:0000",icon:"ri-phone-line"},{label:"Correo",href:"mailto:",icon:"ri-mail-line"}]}]})+A,script:X(),toolbar:[],traits:[{type:"button",label:"Footer",text:"Administrar Footer",full:!0,command:"open-footer-config"}]},init(){this.set("type",t),this.addAttributes({"data-gjs-type":t})}}}),i.Commands.add("open-footer-config",{run(r){const s=r.getSelected();s&&Q(r,s)}}),i.Commands.add("insert-default-footer",{run(r){r.DomComponents.clear(),r.addComponents({type:t})}}),i.BlockManager.add("footer-block",{label:"Footer",category:"Footer",media:`<svg viewBox="0 0 32 32" width="32" height="32">
        ...
        </svg>`,activate:!0,content:{type:t,attributes:{"data-gjs-type":t}}}),K(i,t),Z(i)}function K(i,t){i.on("storage:end:load",()=>{setTimeout(()=>q(i,t),800)}),i.on("component:mount",r=>{const s=r.getEl();s?.getAttribute?.("data-gjs-type")===t&&(r.set("type",t),setTimeout(()=>{const m=r.get("script");m&&typeof m=="function"&&m.call(s)},400))}),i.on("canvas:render",()=>{setTimeout(()=>q(i,t),600)})}function q(i,t){i.getWrapper().find(`[data-gjs-type="${t}"]`).forEach(r=>{r.set("type",t);const s=r.getEl();if(s?.isConnected){const m=r.get("script");m&&typeof m=="function"&&m.call(s)}})}function Z(i){i.on("load",()=>{const t=i.Canvas.getFrameEl();if(!t)return;const r=t.contentDocument?.head;if(r&&!r.querySelector("#footer-component-css")){const s=document.createElement("style");s.id="footer-component-css",s.textContent=`
            ...
            `,r.appendChild(s)}})}document.addEventListener("DOMContentLoaded",async()=>{const i=new R;let t=document.getElementById("footer-id")?.value||"",r=document.getElementById("footer-name")?.value||"",s=document.getElementById("footer-load-url")?.value||"",m=document.getElementById("footer-store-url")?.value||"";const w=document.getElementById("footer-is-active")?.value==="1";let g=!!t;const d=W();if(Y(d),d.on("load",()=>{H(d),U(),N(),_(d),P(d),G(d),O(d),ee(d),setTimeout(()=>{d.runCommand("sw-visibility"),d.Panels.getButton("options","sw-visibility")?.set("active",!0)},100)}),g&&s)try{await i.loadPageContent(d,s),I("Footer cargado correctamente","success")}catch{I("Error al cargar el footer","error")}document.getElementById("save-button")?.addEventListener("click",async()=>{const f=document.getElementById("save-button");f.disabled=!0,f.innerHTML='<i class="ri-loader-4-line animate-spin"></i><span>Guardando...</span>';try{!g&&!r?J({title:"Nombre del Footer",description:"Ingresa un nombre descriptivo para identificar este footer.",placeholder:"Ej: Footer Principal",icon:"ri-file-text-line",iconBg:"#dbeafe",iconColor:"#2563eb",confirmLabel:"Guardar",onConfirm:async E=>{if(!E?.trim()){I("El nombre es obligatorio","error"),f.disabled=!1,f.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>';return}try{await p(E)}catch(T){I(T.message,"error")}finally{f.disabled=!1,f.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}},onCancel:()=>{f.disabled=!1,f.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}}):(await p(r),f.disabled=!1,f.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>')}catch(E){I(E.message,"error"),f.disabled=!1,f.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}});async function p(f){const E=g?"PUT":"POST",T=i.getEditorContent(d),S=await i.savePage(d,{...T,name:f,is_active:w},m,E);if(S.success){if(i.markAsClean(),I(S.message,"success"),!g&&S.footer){t=S.footer.id,r=S.footer.name,g=!0;const C=document.getElementById("footer-id");C&&(C.value=t);const L=document.getElementById("footer-name");L&&(L.value=r);const x=document.querySelector('meta[name="app-url"]'),B=x?x.content:"";m=m.endsWith("/footers")?`${m}/${t}`:`${m.replace(/\/footers\/?$/,"")}/footers/${t}`;const e=document.getElementById("footer-store-url");e&&(e.value=m),s=`${m}/load`;const c=document.getElementById("footer-load-url");c&&(c.value=s);const a=document.getElementById("editor-title");a&&(a.textContent=`Editando Footer: ${r}`);const n=`/footers/${t}/edit`,o=B?`${B}${n}`:n;window.history.replaceState({path:o},"",o)}else if(f){r=f;const C=document.getElementById("footer-name");C&&(C.value=r);const L=document.getElementById("editor-title");L&&(L.textContent=`Editando Footer: ${r}`)}}}});function ee(i){i.Commands.add("canvas-clear",{run:t=>{V({title:"Limpiar canvas",description:"¿Estás seguro de que quieres eliminar todo el contenido del canvas? Esta acción no se puede deshacer.",icon:"ri-delete-bin-line",iconBg:"#fef2f2",iconColor:"#dc2626",confirmLabel:"Limpiar todo",confirmColor:"#dc2626",onConfirm:()=>{t.DomComponents.clear(),t.CssComposer.clear()}})}})}function I(i,t="info"){typeof window.showNotification=="function"&&window.showNotification(i,t)}
