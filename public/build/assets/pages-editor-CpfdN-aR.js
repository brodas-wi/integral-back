...
${K}`},{id:"columns-4",label:"4 Columnas",category:"Columnas",media:Rt,content:`
<div class="col-section">
...
${K}`},{id:"columns-1-3",label:"1/3 — 2/3",category:"Columnas",media:Ht,content:`
<div class="col-section">
...
${Qt}`}],st=function(){(function(){function t(i){if(!i||i.__pcInit)return;i.__pcInit=!0;var a=i.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,o=0,n=!1,d=0,s=0,c=0,b=null;a.querySelectorAll("img").forEach(function(p){p.setAttribute("draggable","false")}),setTimeout(function(){var p=a.scrollWidth-a.clientWidth;if(p<=0)return;var x=Math.min(60,p),L=null;function y(_){L||(L=_);var q=(_-L)/400;if(q<.5)a.scrollLeft=x*(q*2);else if(q<1)a.scrollLeft=x*(1-(q-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(y)}requestAnimationFrame(y)},400),a.scrollLeft=0;function h(){return a.scrollWidth-a.clientWidth}function u(p){return Math.max(0,Math.min(p,h()))}function m(){Math.abs(d)<.5||(d*=.92,a.scrollLeft=u(a.scrollLeft+d),b=requestAnimationFrame(m))}a.addEventListener("mousedown",function(p){p.button===0&&(b&&(cancelAnimationFrame(b),b=null),r=!0,n=!1,d=0,l=p.clientX,s=p.clientX,c=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",p.preventDefault())}),document.addEventListener("mousemove",function(p){if(r){var x=l-p.clientX;Math.abs(x)>3&&(n=!0);var L=Date.now(),y=L-c||1;d=(p.clientX-s)/y*16*-1,s=p.clientX,c=L,a.scrollLeft=u(o+x)}}),document.addEventListener("mouseup",function(p){r&&(r=!1,a.style.cursor="grab",n&&(p.stopPropagation(),b=requestAnimationFrame(m)))}),a.addEventListener("click",function(p){n&&(p.preventDefault(),p.stopPropagation(),n=!1)},!0);var E=0,B=0,v=0,S=0,g=0;a.addEventListener("touchstart",function(p){b&&(cancelAnimationFrame(b),b=null),E=p.touches[0].clientX,v=p.touches[0].clientX,S=Date.now(),B=a.scrollLeft,g=0},{passive:!0}),a.addEventListener("touchmove",function(p){var x=Date.now(),L=x-S||1,y=p.touches[0].clientX;g=(y-v)/L*16*-1,v=y,S=x;var _=E-y;a.scrollLeft=u(B+_)},{passive:!0}),a.addEventListener("touchend",function(){b=requestAnimationFrame(function p(){Math.abs(g)<.5||(g*=.92,a.scrollLeft=u(a.scrollLeft+g),b=requestAnimationFrame(p))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(i){delete i.__pcInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},ai=`(${st.toString()})();`,ri=`
...
</style>`,hi=[{id:"cta-section",label:"Llamada a la acción",category:"Llamadas a la acción",media:fi,content:`
...
@media(max-width:640px){.dd-btn-label{white-space:normal;}.dd-acc-title{white-space:normal;}}
    ...
    </div>`}function xi(){return function(){const t=this;if(t.__ddAccBound)return;t.__ddAccBound=!0;const e=t.querySelector(".dd-acc-header"),i=t.querySelector(".dd-acc-arrow");!e||!i||e.addEventListener("click",a=>{if(a.target.closest("a"))return;const r=t.classList.toggle("dd-acc-open");i.classList.toggle("ri-arrow-down-s-line",r),i.classList.toggle("ri-arrow-right-s-line",!r)})}}const yi=[{id:"document-download-section",label:"Sección de Documentos Descargables",category:"Documentos",media:gi,content:`
...
${ge}`},{id:"document-download-button",label:"Botón de Documento",category:"Documentos",media:mi,content:`${ke("Nombre_del_documento.pdf")}${ge}`},{id:"document-accordion-section",label:"Sección de Documentos con Acordeón",category:"Documentos",media:bi,content:`
<section class="dd-section">
    <h2 class="text-4xl font-extrabold text-[#003B71]" contenteditable="true" data-gjs-type="text" data-gjs-editable="true">Titulo principal</h2>
    <div class="dd-stripe" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"></div>
...
${ge}`},{id:"document-accordion-item",label:"Ítem de Acordeón",category:"Documentos",media:ui,content:`${je("Nombre de la sección",!1)}${ge}`}];function vi(t){const e="doc-download-button",i="doc-accordion-item";t.DomComponents.addType(e,{isComponent:a=>a.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Botón de Documento",tagName:"a",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,class:"dd-btn",href:"#"},components:`
                    <span class="dd-btn-left" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
                        <i class="ri-article-line dd-btn-icon-file" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"></i>
                ...
                `,script:xi()},init(){this.set("type",i),this.addAttributes({"data-gjs-type":i})}}}),t.Commands.add("select-doc-download-file",{run(a){const r=a.getSelected();!r||r.get("type")!==e||$e({type:"document",title:"Seleccionar documento",onSelect:(l,o)=>{r.addAttributes({href:l});const n=r.find(".dd-btn-label")[0],d=o?.name||l.split("/").pop();n&&n.components(d)}})}}),wi(t,i)}function wi(t,e){t.on("storage:end:load",()=>{setTimeout(()=>Ne(t,e),800)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},400))}),t.on("component:clone",i=>{if(i.get("type")===e){const a=i.getEl();a&&(delete a.__ddAccBound,setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},400))}}),t.on("canvas:render",()=>{setTimeout(()=>Ne(t,e),600)})}function Ne(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}const dt=function(){(function(){function t(i){if(!i||i.__savInit)return;i.__savInit=!0;var a=i.querySelector(".sav-carousel-wrap");if(!a)return;a.scrollLeft=0;var r=!1,l=0,o=0,n=!1,d=0,s=0,c=0,b=null;a.querySelectorAll("img").forEach(function(p){p.setAttribute("draggable","false")}),setTimeout(function(){var p=a.scrollWidth-a.clientWidth;if(p<=0)return;var x=Math.min(60,p),L=null;function y(_){L||(L=_);var q=(_-L)/400;if(q<.5)a.scrollLeft=x*(q*2);else if(q<1)a.scrollLeft=x*(1-(q-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(y)}requestAnimationFrame(y)},400);function h(){return a.scrollWidth-a.clientWidth}function u(p){return Math.max(0,Math.min(p,h()))}function m(){Math.abs(d)<.5||(d*=.92,a.scrollLeft=u(a.scrollLeft+d),b=requestAnimationFrame(m))}a.addEventListener("mousedown",function(p){p.button===0&&(b&&(cancelAnimationFrame(b),b=null),r=!0,n=!1,d=0,l=p.clientX,s=p.clientX,c=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",p.preventDefault())}),document.addEventListener("mousemove",function(p){if(r){var x=l-p.clientX;Math.abs(x)>3&&(n=!0);var L=Date.now(),y=L-c||1;d=(p.clientX-s)/y*16*-1,s=p.clientX,c=L,a.scrollLeft=u(o+x)}}),document.addEventListener("mouseup",function(p){r&&(r=!1,a.style.cursor="grab",n&&(p.stopPropagation(),b=requestAnimationFrame(m)))}),a.addEventListener("click",function(p){n&&(p.preventDefault(),p.stopPropagation(),n=!1)},!0);var E=0,B=0,v=0,S=0,g=0;a.addEventListener("touchstart",function(p){b&&(cancelAnimationFrame(b),b=null),E=p.touches[0].clientX,v=p.touches[0].clientX,S=Date.now(),B=a.scrollLeft,g=0},{passive:!0}),a.addEventListener("touchmove",function(p){var x=Date.now(),L=x-S||1,y=p.touches[0].clientX;g=(y-v)/L*16*-1,v=y,S=x;var _=E-y;a.scrollLeft=u(B+_)},{passive:!0}),a.addEventListener("touchend",function(){b=requestAnimationFrame(function p(){Math.abs(g)<.5||(g*=.92,a.scrollLeft=u(a.scrollLeft+g),b=requestAnimationFrame(p))})},{passive:!0})}function e(){document.querySelectorAll(".sav-section").forEach(function(i){delete i.__savInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},ki=`(${dt.toString()})();`,Bi=`
...
${Oi}`},Pi=[{id:"feature-orange-img-right",label:"Sección naranja - imagen derecha",category:"Banners",media:Di,content:Fe(!0)},{id:"feature-orange-img-left",label:"Sección naranja - imagen izquierda",category:"Banners",media:Ni,content:Fe(!1)}],Ri=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,ha=[{id:"contact-info-row",label:"Contacto en fila",category:"Contacto",media:da,content:`
...
${Te}`}],ga=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
</style>`,ba=[{id:"rich-list",label:"Lista con título y descripción",category:"Contenido",media:ga,content:`
...
<\/script>`}],Ma=`<svg viewBox="0 0 32 32" width="32" height="32">
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
        ...
        </tr>`,t.headers?.length&&(a+="<tr>",t.headers.forEach((o,n)=>{const d=n<t.headers.length-1?`border-r border-[${i.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${i.subheaderBg} ${i.subheaderText} ${d} border-b border-[${i.borderColor}] text-${o.align||"center"}">${o.text||""}</th>`}),a+="</tr>"),a+="</thead>"):t.headers?.length&&(a+="<thead><tr>",t.headers.forEach((o,n)=>{const d=n<t.headers.length-1?`border-r border-[${i.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${i.headerBg} ${i.headerText} ${d} border-b border-[${i.borderColor}] text-${o.align||"center"}">${o.text||""}</th>`}),a+="</tr></thead>"),a+="<tbody>";const r=t.rows.length,l={};return t.rows.forEach((o,n)=>{a+="<tr>";let d=0;o.forEach(s=>{for(;l[`${n}-${d}`];)d++;const c=s.colspan||1,b=s.rowspan||1;for(let y=n;y<n+b;y++)for(let _=d;_<d+c;_++)(y!==n||_!==d)&&(l[`${y}-${_}`]=!0);const h=c>1?`colspan="${c}"`:"",u=b>1?`rowspan="${b}"`:"",m=s.isHeader?i.labelBg:n%2===0?i.rowEvenBg:i.rowOddBg,E=s.isHeader?"font-semibold":"font-normal",B=s.isHeader?i.labelText:i.rowText,v=`text-${s.align||"center"}`,S=n+b>=r,p=d+c>=t.cols?"":`border-r border-[${i.borderColor}]`,x=S?"":`border-b border-[${i.borderColor}]`,L=`${p} ${x} p-3 align-middle text-sm ${m} ${E} ${B} ${v}`;s.image?a+=`<td ${h} ${u} class="${L}">
                    <img src="${s.image}" alt="${s.text||""}" class="max-w-full max-h-20 h-auto object-contain block mx-auto">
                    ${s.text?`<span class="block mt-1 text-xs ${B}">${s.text}</span>`:""}
                </td>`:a+=`<td ${h} ${u} class="${L}">${s.text||""}</td>`,d+=c}),a+="</tr>"}),a+="</tbody></table>",a}function te(t,e){return{title:"Título de la tabla",cols:t,headers:Array.from({length:t},(i,a)=>({text:`Columna ${a+1}`,align:"center"})),rows:Array.from({length:e},()=>Array.from({length:t},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})))}}function ht(t,e){return`<div class="w-full overflow-x-auto rounded-2xl border-2 border-[${(Ee[e]||Ee.blue).borderColor}]">${t}</div>`}function Qe(t,e){const i={};return t.forEach((a,r)=>{let l=0;a.forEach(o=>{for(;i[`${r}-${l}`];)l++;const n=Math.min(o.colspan||1,e-l),d=o.rowspan||1;for(let s=r;s<r+d;s++)for(let c=l;c<l+n;c++)(s!==r||c!==l)&&(i[`${s}-${c}`]=`${r}-${l}`);l+=n})}),i}const Da=`
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function Na(){if(document.getElementById("tam-img-modal"))return;const t=document.createElement("div");t.id="tam-img-modal",t.innerHTML=`
        ...
        </div>`,document.body.appendChild(t);let e=null,i=null;async function a(n=""){const d=document.getElementById("tam-img-grid");d.innerHTML='<div class="tam-img-loading"><div class="tam-img-spinner"></div><span>Cargando...</span></div>';try{const s=new URLSearchParams({type:"image",per_page:50});n&&s.append("search",n);const c=document.querySelector('meta[name="media-api-url"]')?.content??"/media/api",u=(await(await fetch(`${c}?${s}`,{headers:{"X-Requested-With":"XMLHttpRequest",Accept:"application/json"}})).json()).items||[];if(!u.length){d.innerHTML='<div class="tam-img-loading"><i class="ri-image-line" style="font-size:2rem;"></i><span>No se encontraron imágenes</span></div>';return}d.innerHTML="",u.forEach(m=>{const E=document.createElement("div");E.className="tam-img-card",E.innerHTML=`<img src="${m.url}" alt="${m.filename}"><p title="${m.filename}">${m.filename}</p>`,E.addEventListener("click",()=>{d.querySelectorAll(".tam-img-card").forEach(B=>B.classList.remove("selected")),E.classList.add("selected"),e=m.url,document.getElementById("tam-img-selected-info").textContent=`Seleccionada: ${m.filename}`,document.getElementById("tam-img-confirm").disabled=!1}),d.appendChild(E)})}catch{d.innerHTML='<div class="tam-img-loading"><i class="ri-error-warning-line" style="font-size:2rem;color:#f87171;"></i><span style="color:#dc2626;">Error al cargar imágenes</span></div>'}}function r(n){i=n,e=null,document.getElementById("tam-img-selected-info").textContent="Ninguna imagen seleccionada",document.getElementById("tam-img-confirm").disabled=!0,document.getElementById("tam-img-search-input").value="",t.classList.add("open"),a()}function l(){t.classList.remove("open"),e=null,i=null}document.getElementById("tam-img-close").addEventListener("click",l),document.getElementById("tam-img-cancel").addEventListener("click",l),document.getElementById("tam-img-confirm").addEventListener("click",()=>{e&&i&&(i(e),l())});let o;document.getElementById("tam-img-search-input").addEventListener("input",n=>{clearTimeout(o),o=setTimeout(()=>a(n.target.value),300)}),t.addEventListener("click",n=>{n.target===t&&l()}),window.__openTableImagePicker=r}function Oa(t,e){if(document.getElementById("table-admin-modal"))return;const i=document.createElement("style");i.id="table-admin-modal-styles",i.textContent=Da,document.head.appendChild(i),Na();const a=document.createElement("div");a.id="table-admin-modal",a.innerHTML=`
        <div class="tam-container">
        ...
        </div>`,document.body.appendChild(a);let r=null,l=null;function o(h){r=h;const u=h.get("tableData");l=u?JSON.parse(JSON.stringify(u)):te(3,3);const m=l.cols||3;l.rows=l.rows.map((E,B)=>Array.from({length:m},(S,g)=>E[g]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})),document.getElementById("tam-title").value=l.title||"",document.getElementById("tam-theme").value=h.get("tableTheme")||"blue",document.getElementById("tam-cols").value=l.cols||3,document.getElementById("tam-rows").value=l.rows.length||3,c(),b(),a.classList.add("open"),document.body.style.overflow="hidden"}function n(){a.classList.remove("open"),document.body.style.overflow="",r=null}function d(){l.title=document.getElementById("tam-title").value.trim(),l.cols=parseInt(document.getElementById("tam-cols").value)||3,l.headers=Array.from(document.querySelectorAll(".tam-header-input")).map(u=>({text:u.value,align:u.closest("th")?.querySelector(".tam-align-select")?.value||"center"})),document.querySelectorAll("#tam-tbody td.tam-cell:not(.is-spanned)").forEach(u=>{const m=parseInt(u.dataset.row),E=parseInt(u.dataset.col);l.rows[m]?.[E]&&(l.rows[m][E].text=u.querySelector(".tam-cell-input")?.value||"",l.rows[m][E].align=u.querySelector(".tam-align-select")?.value||"center",l.rows[m][E].isHeader=u.dataset.isheader==="1",l.rows[m][E].image=u.dataset.image||null)});const h=Qe(l.rows,l.cols);l.rows=l.rows.map((u,m)=>u.filter((E,B)=>!h[`${m}-${B}`]))}function s(){if(a.querySelector("#tam-rebuild-notice"))return;const u=document.createElement("div");u.id="tam-rebuild-notice",u.style.cssText="background:#fef9c3;border:1.5px solid #ca8a04;border-radius:0.5rem;padding:0.5rem 1rem;font-size:0.8rem;color:#92400e;display:flex;align-items:center;gap:0.5rem;margin:0 1.5rem 0;flex-shrink:0;",u.innerHTML='<i class="ri-error-warning-line"></i> Has modificado el colspan/rowspan. Haz clic en <strong style="margin:0 4px;">Reconstruir</strong> para aplicar los cambios de fusión.',a.querySelector(".tam-toolbar").after(u)}function c(){a.querySelector("#tam-rebuild-notice")?.remove()}function b(){const h=document.getElementById("tam-thead"),u=document.getElementById("tam-tbody"),m=l.cols,E=l.rows.length,B=Qe(l.rows,m);h.innerHTML=`<tr>${l.headers.map((v,S)=>`
            <th>
                <input class="tam-cell-input tam-header-input" value="${v.text||""}" placeholder="Col ${S+1}" style="font-weight:600;">
                <select class="tam-align-select" style="margin-top:4px;width:100%;font-size:0.7rem;padding:2px;">
            ...
            </th>`).join("")}</tr>`,u.innerHTML=l.rows.map((v,S)=>`<tr>${Array.from({length:m},(p,x)=>{const L=B[`${S}-${x}`];if(L)return`<td class="tam-cell is-spanned" data-row="${S}" data-col="${x}">
                        <div class="tam-spanned-label">Combinada con [${L}]</div>
                    </td>`;const y=v[x]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null},_=y.colspan||1,q=y.rowspan||1,T=_>1||q>1;return`<td class="tam-cell ${y.isHeader?"is-header-cell":""} ${y.image?"has-image":""} ${T?"has-span":""}"
                    ...
                    <div class="tam-cell-actions">
                        ...
                        <div class="tam-cell-span-group">
                            ...
                            <input type="number" class="tam-cell-span-input" min="1" max="${m-x}"
                ...
                </td>`}).join("")}</tr>`).join(""),u.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(v=>{v.addEventListener("change",()=>{const S=parseInt(v.dataset.row),g=parseInt(v.dataset.col),p=Math.max(1,parseInt(v.value)||1);l.rows[S]?.[g]&&(v.dataset.action==="colspan"?l.rows[S][g].colspan=Math.min(p,m-g):l.rows[S][g].rowspan=Math.min(p,E-S),s())})}),u.querySelectorAll("button[data-action]").forEach(v=>{v.addEventListener("click",S=>{S.preventDefault(),S.stopPropagation();const g=v.dataset.action,p=parseInt(v.dataset.row),x=parseInt(v.dataset.col);if(!(isNaN(p)||isNaN(x)||!l.rows[p]?.[x])){if(g==="header"){l.rows[p][x].isHeader=!l.rows[p][x].isHeader;const L=u.querySelector(`td[data-row="${p}"][data-col="${x}"]`);L&&(L.dataset.isheader=l.rows[p][x].isHeader?"1":"0",L.classList.toggle("is-header-cell",l.rows[p][x].isHeader)),v.classList.toggle("active",l.rows[p][x].isHeader),v.textContent=l.rows[p][x].isHeader?"✓ Etiqueta":"Etiqueta";return}if(g==="image"){window.__openTableImagePicker&&window.__openTableImagePicker(L=>{l.rows[p][x].image=L;const y=u.querySelector(`td[data-row="${p}"][data-col="${x}"]`);if(y){y.dataset.image=L,y.classList.add("has-image");let _=y.querySelector(".tam-cell-img-preview");_||(_=document.createElement("img"),_.className="tam-cell-img-preview",y.insertBefore(_,y.firstChild)),_.src=L;const q=y.querySelector("[data-action=image]");if(q&&(q.innerHTML='<i class="ri-image-line"></i> Cambiar'),!y.querySelector("[data-action=clear-image]")){const T=document.createElement("button");T.type="button",T.className="tam-cell-btn tam-cell-btn-clear",T.dataset.action="clear-image",T.dataset.row=p,T.dataset.col=x,T.textContent="✕ Quitar",T.addEventListener("click",D=>{D.preventDefault(),D.stopPropagation(),l.rows[p][x].image=null,y.dataset.image="",y.classList.remove("has-image"),_.remove(),T.remove();const M=y.querySelector("[data-action=image]");M&&(M.innerHTML='<i class="ri-image-line"></i> Imagen')}),y.querySelector(".tam-cell-actions").appendChild(T)}}});return}g==="clear-image"&&(l.rows[p][x].image=null,b())}})})}document.getElementById("tam-close").addEventListener("click",n),document.getElementById("tam-cancel").addEventListener("click",n),a.addEventListener("click",h=>{h.target===a&&n()}),document.getElementById("tam-rebuild").addEventListener("click",()=>{const h=parseInt(document.getElementById("tam-cols").value)||3,u=parseInt(document.getElementById("tam-rows").value)||3;for(c(),d();l.headers.length<h;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,h),l.cols=h;l.rows.length<u;)l.rows.push(Array.from({length:h},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,u).map(m=>{for(;m.length<h;)m.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return m.slice(0,h)}),b()}),document.getElementById("tam-apply").addEventListener("click",()=>{d();const h=document.getElementById("tam-theme").value;r&&(r.set("tableData",JSON.parse(JSON.stringify(l))),r.set("tableTheme",h),r.addAttributes({"data-table-theme":h}),ze(r)),n()}),window.__openTableAdminModal=o}function ze(t){const e=t.get("tableData"),i=t.get("tableTheme")||"blue";e&&t.components(ht(pt(e,i),i))}function Pa(){return function(){}}const Ra=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:Ma,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<a href="#"
   ...
   class="dld-simple-${e}">
    ...
    <rect x="3" y="25" width="7" height="2.5" fill="#dee2e6" rx="0.5"/>
</svg>`;function sr(){return function(){const t=this,e="agencies-map-component",i="/api/agencies/active",a="agencies";let r=[],l=[],o={},n=null,d=[];const s=async()=>{try{c(),await h(),await E(),B(),L(),T(),D(),b()}catch(f){console.error("Error initializing map:",f),V("Error al cargar las agencias"),b()}};function c(){const f=t.querySelector(`.${e}-list`);f&&(f.innerHTML=`
                ...
                `);const w=t.querySelector(`.${e}-map-container`);w&&(w.style.opacity="0.5")}function b(){const f=t.querySelector(`.${e}-map-container`);f&&(f.style.transition="opacity 0.3s ease",f.style.opacity="1")}async function h(){try{const w=await(await fetch(i)).json(),$=a?w[a]:w;Array.isArray($)?(r=$.filter(z=>z.latitude&&z.longitude&&!isNaN(z.latitude)&&!isNaN(z.longitude)),l=[...r],u()):(r=[],l=[])}catch(f){console.error("Error loading items:",f),r=[],l=[]}}function u(){const f=[...new Set(r.map($=>$.zone).filter(Boolean))].sort(),w=[...new Set(r.map($=>$.department).filter(Boolean))].sort();o={zone:f,department:w},setTimeout(()=>{const $=t.querySelector(`.${e}-filters-container`);$&&!$.hasChildNodes()&&($.innerHTML=`
                    ...
                    `,m())},100)}function m(){const f=t.querySelector(`.${e}-zone-filter`),w=t.querySelector(`.${e}-department-filter`);f&&o.zone&&o.zone.forEach($=>{const z=document.createElement("option");z.value=$,z.textContent=$,f.appendChild(z)}),w&&o.department&&o.department.forEach($=>{const z=document.createElement("option");z.value=$,z.textContent=$,w.appendChild(z)})}async function E(){if(!document.getElementById("leaflet-css")){const f=document.createElement("link");f.id="leaflet-css",f.rel="stylesheet",f.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",document.head.appendChild(f)}if(typeof window.L>"u"&&await new Promise((f,w)=>{const $=document.createElement("script");$.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",$.onload=f,$.onerror=w,document.head.appendChild($)}),typeof window.L<"u"&&window.L.Icon&&window.L.Icon.Default){const f=window.L.icon({iconUrl:"data:image/svg+xml;base64,"+btoa(`
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 36" width="24" height="36">
                            <path fill="#f0872a" d="M12 0C7.6 0 4 3.6 4 8c0 5.4 8 16 8 16s8-10.6 8-16c0-4.4-3.6-8-8-8z"/>
                            <circle cx="12" cy="8" r="3" fill="#fff"/>
                        </svg>
                    `),iconSize:[30,45],iconAnchor:[15,45],popupAnchor:[0,-45]});window.customOrangeIcon=f}}function B(){const f=t.querySelector(`.${e}-map`);if(!f||!window.L)return;f._leaflet_id&&f._map&&(f._map.remove(),delete f._map),n=window.L.map(f).setView([13.7942,-88.8965],8),window.L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(n),f._map=n,n.whenReady(function(){v(),setTimeout(()=>{n&&n.invalidateSize&&n.invalidateSize()},300)})}function v(){S(),g(),x()}function S(){d.forEach(f=>{f.marker&&n.removeLayer(f.marker)}),d=[]}function g(){l.forEach((f,w)=>{if(f.latitude&&f.longitude){const $=p(f),z=window.L.marker([f.latitude,f.longitude],{icon:window.customOrangeIcon||new window.L.Icon.Default}).addTo(n).bindPopup($);d.push({marker:z,item:f,index:w})}})}function p(f){let w=`<div style="min-width: 200px;"><h4 style="font-weight: 700; margin-bottom: 12px; color: #0d3f6a; font-size: 16px; border-bottom: 2px solid #f0872a; padding-bottom: 8px;">${f.name}</h4>`;if(f.address&&(w+=`<p style="margin: 8px 0 0 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-map-pin-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${f.address}</span></p>`),f.municipality||f.department){const $=[f.municipality,f.department].filter(Boolean).join(", ");w+=`<p style="margin: 0 0 8px 0; font-size: 13px; color: #6b7280; padding-left: 24px;">${$}</p>`}return f.schedule&&(w+=`<p style="margin: 8px 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-time-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${f.schedule}</span></p>`),w+="</div>",w}function x(){if(l.length>0){const f=l.filter(w=>w.latitude&&w.longitude).map(w=>[w.latitude,w.longitude]);f.length>1?n.once("moveend",function(){setTimeout(()=>{try{n&&n._loaded&&typeof n.fitBounds=="function"&&n.fitBounds(f,{padding:[50,50],maxZoom:12,animate:!1})}catch(w){console.warn("Error fitting bounds:",w)}},100)}):f.length===1&&n.setView(f[0],14)}}function L(){const f=t.querySelector(`.${e}-list`);if(!f)return;if(l.length===0){_(f);return}const w=l.map(($,z)=>y($,z)).join("");f.innerHTML=w,q()}function y(f,w){const $=f.phones&&f.phones.length>0?f.phones.map(k=>`
                        <p class="text-gray-200 flex items-center gap-2 mt-2">
                            <i class="ri-phone-line text-primary text-lg"></i>
                            <a href="tel:${k.replace(/\s+/g,"")}" class="agency-phone-link text-white font-medium hover:underline">${k}</a>
                        </p>
                    `).join(""):"",z=`https://www.google.com/maps/search/?api=1&query=${f.latitude},${f.longitude}`;return`
                <div class="${e}-item p-5 bg-white/10 border border-white/20 rounded-2xl cursor-pointer transition-all duration-200" data-item-index="${w}">
                    ...
                    ${$}
                    <div class="mt-3">
                        <a href="${z}" target="_blank" rel="noopener noreferrer" class="agency-maps-btn block w-full text-center px-4 py-2.5 bg-primary text-white font-semibold rounded-lg hover:opacity-90 transition-all duration-200" onclick="event.stopPropagation();">
                            Ver ubicación
                        </a>
                    </div>
                </div>
            ...
            `}function q(){const f=t.querySelectorAll(`.${e}-item`);f.forEach(w=>{w.addEventListener("click",$=>{if($.target.closest(".agency-maps-btn"))return;$.preventDefault();const z=parseInt(w.dataset.itemIndex),k=l[z];if(!k)return;f.forEach(C=>{C.classList.remove("bg-white","border-secondary","selected-agency"),C.classList.add("bg-white/10","border-white/20");const U=C.querySelector(".agency-title"),pe=C.querySelectorAll("i"),he=C.querySelectorAll(".agency-phone-link"),Se=C.querySelectorAll("p:not(:has(.agency-phone-link))"),Le=C.querySelector(".agency-maps-btn");U&&(U.classList.remove("text-secondary"),U.classList.add("text-white")),pe.forEach(Z=>{Z.classList.remove("text-secondary","text-gray-300","text-white"),Z.classList.add("text-primary")}),he.forEach(Z=>{Z.classList.remove("text-secondary"),Z.classList.add("text-white")}),Se.forEach(Z=>{Z.classList.remove("text-secondary"),Z.classList.add("text-gray-200")}),Le&&(Le.classList.remove("bg-secondary"),Le.classList.add("bg-primary"))}),w.classList.remove("bg-white/10","border-white/20"),w.classList.add("bg-white","border-secondary","selected-agency");const A=w.querySelector(".agency-title"),X=w.querySelectorAll("i"),O=w.querySelectorAll(".agency-phone-link"),R=w.querySelectorAll("p:not(:has(.agency-phone-link))"),H=w.querySelector(".agency-maps-btn");if(A&&(A.classList.remove("text-white"),A.classList.add("text-secondary")),X.forEach(C=>{C.classList.remove("text-secondary","text-gray-300","text-white"),C.classList.add("text-primary")}),O.forEach(C=>{C.classList.remove("text-white"),C.classList.add("text-secondary")}),R.forEach(C=>{C.classList.remove("text-gray-200"),C.classList.add("text-secondary")}),H&&(H.classList.remove("bg-primary"),H.classList.add("bg-secondary")),n&&k&&n._loaded)try{n.flyTo([k.latitude,k.longitude],14,{animate:!0,duration:1});const C=d.find(U=>U.item.id===k.id);C&&C.marker&&C.marker.openPopup()}catch(C){console.warn("Error updating map view:",C)}})})}function T(){const f=t.querySelector(`.${e}-search-input`),w=t.querySelector(`.${e}-zone-filter`),$=t.querySelector(`.${e}-department-filter`),z=t.querySelector(`.${e}-no-results`),k={Occidental:["Ahuachapán","Santa Ana","Sonsonate"],Paracentral:["Chalatenango","Cuscatlán","La Paz","Cabañas","San Vicente"],Central:["La Libertad","San Salvador"],Oriental:["Usulután","San Miguel","Morazán","La Unión"]},A=()=>{if(!w||!$)return;const O=w.value,R=$.value;if(!O)$.innerHTML='<option value="">Todos los Departamentos</option>',[...new Set(r.map(C=>C.department).filter(Boolean))].sort().forEach(C=>{const U=document.createElement("option");U.value=C,U.textContent=C,$.appendChild(U)}),R&&($.value=R);else{const H=k[O]||[];$.innerHTML='<option value="">Todos los Departamentos</option>',H.forEach(C=>{const U=document.createElement("option");U.value=C,U.textContent=C,$.appendChild(U)}),H.includes(R)&&($.value=R)}},X=()=>{const O=f?f.value.toLowerCase().trim():"",R=w?w.value:"",H=$?$.value:"";l=r.filter(C=>{let U=!0,pe=!0,he=!0;return O&&(U=Object.values(C).some(Se=>String(Se).toLowerCase().includes(O))),R&&(pe=C.zone===R),H&&(he=C.department===H),U&&pe&&he}),L(),v(),z&&z.classList.toggle("hidden",l.length>0)};f&&f.addEventListener("input",X),w&&w.addEventListener("change",()=>{A(),X()}),$&&$.addEventListener("change",X)}function D(){const f=t.querySelector("[data-title]");if(f){const z=M("map-title")||"Nuestras Agencias";f.textContent=z}const w=t.querySelector(`.${e}-search-input`);if(w){const z=M("search-placeholder")||"Buscar...";w.setAttribute("placeholder",z)}const $=t.querySelector(`.${e}-no-results`);if($){const z=M("no-results-text")||"No se encontraron agencias";$.textContent=z}}function M(f){return t.closest(`[data-gjs-type="${e}"]`)?.getAttribute(f)}function V(f){const w=t.querySelector(`.${e}-list`);w&&(w.innerHTML=`
                    <div class="flex flex-col items-center justify-center p-12 text-center">
...
.mp-map-wrapper{height:320px;}
}`;function gr(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]).replace(/\*\*(.+?)\*\*/g,'<span class="mp-num">$1</span>')}function gt(t,e){e=e||"mp"+Math.random().toString(36).slice(2,7);const i=(t.filters||[]).map((a,r)=>{const l=(a.options||[]).map(o=>`<button type="button" class="mp-filter-option" data-filter-index="${r}">${o}</button>`).join("");return`<div class="mp-filter" data-filter-index="${r}">
        ...
        <p class="mp-stats">${gr(t.stats_text)}</p>
        ...
        `,document.head.appendChild(h)}const a=(()=>{try{return JSON.parse(e.getAttributes()["data-map-config"]||"{}")}catch{return{}}})(),r=a.title||fe.title,l=a.stats_text||fe.stats_text,o=JSON.parse(JSON.stringify(a.filters||fe.filters)),n=document.createElement("div");n.id="map-filter-config-modal",n.className="mp-overlay-modal";const d=document.createElement("div");d.className="mp-modal",d.innerHTML=`
        ...
        </div>`,n.appendChild(d),document.body.appendChild(n),d.querySelectorAll(".mp-tab-btn").forEach(h=>{h.addEventListener("click",()=>{d.querySelectorAll(".mp-tab-btn").forEach(u=>u.classList.remove("active")),d.querySelectorAll(".mp-tab-panel").forEach(u=>u.classList.remove("active")),h.classList.add("active"),d.querySelector(`#mp-panel-${h.dataset.tab}`).classList.add("active")})});const s=d.querySelector("#mp-filters-list");function c(){s.innerHTML="",o.forEach((h,u)=>{const m=document.createElement("div");m.className="mp-filter-card",m.innerHTML=`
...
`)}</textarea>
            `,m.querySelector("[data-filter-field='label']").addEventListener("input",E=>{h.label=E.target.value}),m.querySelector("[data-filter-field='options']").addEventListener("input",E=>{h.options=E.target.value.split(`
`).map(B=>B.trim()).filter(Boolean)}),m.querySelector("[data-remove-filter]").addEventListener("click",()=>{o.splice(u,1),c()}),s.appendChild(m)})}c(),d.querySelector("#mp-add-filter").addEventListener("click",()=>{o.push({label:"Nuevo filtro",options:["Opción 1","Opción 2"]}),c()});const b=()=>n.remove();d.querySelector("#mp-modal-close").onclick=b,d.querySelector("#mp-modal-cancel").onclick=b,n.onclick=h=>{h.target===n&&b()},d.querySelector("#mp-modal-save").onclick=()=>{const h={title:d.querySelector("#mp-title").value.trim(),stats_text:d.querySelector("#mp-stats").value.trim(),filters:o.filter(E=>E.label)},m=e.getEl()?.querySelector("[id^='mp-root-']")?.id?.replace("mp-root-","")||"mp"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-map-config":JSON.stringify(h)}),e.components(gt(h,m)+`<style>${Ie}</style>`),b()}}const ur=[{id:"map-filter-block",label:"Mapa con Filtros",category:"Interactivos",media:hr,content:{type:"map-filter-component"}}];function xr(t){const e="map-filter-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Mapa con Filtros",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-map-config":JSON.stringify(fe)},components:gt(fe)+`<style>${Ie}</style>`,script:mr(),toolbar:[],traits:[{type:"button",label:"Mapa con Filtros",text:"Administrar Mapa y Filtros",full:!0,command:"open-map-filter-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-map-filter-config",{run(i){const a=i.getSelected();a&&br(i,a)}}),yr(t,e),vr(t,e)}function yr(t,e){t.on("storage:end:load",()=>{setTimeout(()=>rt(t,e),1e3)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},500))}),t.on("component:clone",i=>{if(i.get("type")===e){const a=i.getEl();if(a){const r=a.querySelector("[data-mp-map]");r&&r._map&&(r._map.remove(),delete r._map,delete r.__mpMapInit),setTimeout(()=>{const l=i.get("script");l&&typeof l=="function"&&l.call(a)},500)}}}),t.on("canvas:render",()=>{setTimeout(()=>rt(t,e),800)}),t.on("storage:start:store",()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e),i.addAttributes({"data-gjs-type":e})})})}function rt(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}function vr(t,e){t.on("load",()=>{const i=t.Canvas.getFrameEl();if(!i)return;const a=i.contentDocument?.head;if(a){if(!a.querySelector("#leaflet-css")){const r=document.createElement("link");r.id="leaflet-css",r.rel="stylesheet",r.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",a.appendChild(r)}if(!a.querySelector("#mp-filter-styles")){const r=document.createElement("style");r.id="mp-filter-styles",r.textContent=Ie,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=".leaflet-container{height:100%;width:100%;border-radius:inherit;z-index:0;}",a.appendChild(r)}}})}const wr=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
@media(max-width:768px){.bsk-buttons{flex-direction:column;}}`;function Er(){return function(){const t=this,e=t.ownerDocument??document,i="/adminintegral",a=(e.defaultView??window).location.origin,r=e.querySelector('meta[name="api-banners-url"]')?.content||`${a}${i}/api/banners/active`,l=["fill-blue","outline-blue","fill-orange","outline-orange","fill-white","outline-white"],o=".banner-wrapper{position:relative;width:100%;background:#003B71;overflow:hidden;}.banner-slide-container{position:relative;width:100%;user-select:none;cursor:grab;display:grid;}.banner-slide-container:active{cursor:grabbing;}.banner-slide{grid-area:1/1;opacity:0;pointer-events:none;transition:opacity 0.7s ease;visibility:hidden;display:flex;flex-direction:column;}.banner-slide.banner-slide--active{opacity:1;pointer-events:auto;visibility:visible;}.banner-slide-inner{position:relative;width:100%;flex:1;min-height:480px;display:flex;align-items:center;}.banner-bg{position:absolute;inset:0;z-index:0;}.banner-bg img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;}.banner-overlay{position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,59,113,0.85) 0%,rgba(0,59,113,0.65) 50%,rgba(0,59,113,0.2) 100%);z-index:1;}.banner-content{position:relative;z-index:10;display:flex;flex-direction:column;justify-content:center;padding:64px 64px 96px;max-width:60%;}.banner-category-badge{display:inline-block;margin-bottom:18px;padding:7px 20px;border-radius:999px;border:2px solid rgba(255,255,255,0.65);color:#fff;font-size:13px;font-weight:500;letter-spacing:0.04em;align-self:flex-start;}.banner-title{font-size:clamp(1.8rem,3.2vw,3rem);font-weight:800;color:#fff;line-height:1.15;margin:0 0 20px;}.banner-description{color:rgba(255,255,255,0.9);font-size:clamp(0.95rem,1.4vw,1.1rem);line-height:1.7;margin:0 0 36px;max-width:520px;}.banner-buttons{display:flex;flex-wrap:wrap;gap:16px;align-items:center;}.banner-btn{display:inline-block;padding:12px 32px;border-radius:999px;font-size:15px;font-weight:600;cursor:pointer;transition:background .2s,color .2s,border-color .2s;text-decoration:none;white-space:nowrap;line-height:1.4;box-sizing:border-box;}.banner-btn--fill-blue{background:#003B71;color:#ffffff;border:2px solid #003B71;}.banner-btn--fill-blue:hover{background:#002a52;border-color:#002a52;color:#ffffff;}.banner-btn--outline-blue{background:transparent;color:#003B71;border:2px solid #003B71;}.banner-btn--outline-blue:hover{background:#003B71;border-color:#003B71;color:#ffffff;}.banner-btn--fill-orange{background:#E97300;color:#ffffff;border:2px solid #E97300;}.banner-btn--fill-orange:hover{background:#c96200;border-color:#c96200;color:#ffffff;}.banner-btn--outline-orange{background:transparent;color:#E97300;border:2px solid #E97300;}.banner-btn--outline-orange:hover{background:#E97300;border-color:#E97300;color:#ffffff;}.banner-btn--fill-white{background:#ffffff;color:#003B71;border:2px solid #ffffff;}.banner-btn--fill-white:hover{background:#dce8f5;border-color:#dce8f5;color:#003B71;}.banner-btn--outline-white{background:transparent;color:#ffffff;border:2px solid #ffffff;}.banner-btn--outline-white:hover{background:#ffffff;border-color:#ffffff;color:#003B71;}.banner-dots-wrapper{display:none;}.banner-stripe{position:relative;width:100%;height:26px;background:#E97300;z-index:20;display:flex;align-items:center;justify-content:center;}.banner-dots{display:flex;gap:8px;align-items:center;}.banner-dot{width:10px;height:10px;border-radius:999px;border:none;cursor:pointer;background:rgba(255,255,255,0.5);transition:all 0.3s ease;padding:0;flex-shrink:0;}.banner-dot--active{width:28px;background:#ffffff;}.banner-empty{display:flex;align-items:center;justify-content:center;min-height:480px;color:rgba(255,255,255,0.5);font-size:14px;padding:40px;}@media(max-width:768px){.banner-slide-inner{min-height:340px;}.banner-bg img{object-position:right center;}.banner-content{max-width:100%;width:100%;padding:32px 24px 80px;}.banner-buttons{flex-wrap:wrap;gap:12px;}.banner-btn{flex:1 1 45%;min-width:140px;text-align:center;white-space:normal;word-break:break-word;}}@media(max-width:480px){.banner-btn{flex:1 1 100%;min-width:0;}}",n="@keyframes bsk-shimmer{0%{background-position:-600px 0}100%{background-position:600px 0}}.bsk-badge{width:120px;height:32px;margin-bottom:20px;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title{height:40px;margin-bottom:12px;border-radius:8px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title--short{width:60%;}.bsk-line{height:16px;margin-bottom:10px;border-radius:6px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-line--short{width:55%;}.bsk-buttons{display:flex;gap:16px;margin-top:36px;}.bsk-btn{height:48px;flex:1;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-bg-img{background:linear-gradient(90deg,rgba(255,255,255,0.04) 25%,rgba(255,255,255,0.09) 50%,rgba(255,255,255,0.04) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}@media(max-width:768px){.bsk-buttons{flex-direction:column;}}";(function(){if(!e.getElementById("banner-hero-styles")){const A=e.createElement("style");A.id="banner-hero-styles",A.textContent=o,e.head.appendChild(A)}if(!e.getElementById("banner-skeleton-styles")){const A=e.createElement("style");A.id="banner-skeleton-styles",A.textContent=n,e.head.appendChild(A)}})();let d=[],s=0,c=null,b=!1,h=0,u=0;const m=50,E=t.dataset.autoplay!=="false",B=t.dataset.category??"",v=t.querySelector(".banner-slide-container"),S=t.querySelector(".banner-stripe");if(!v||!S)return;function g(k){return l.indexOf(k)!==-1?k:k==="outline-blue"||k==="outline-orange"?"outline-white":"fill-white"}function p(k,A,X,O){const R=g(X),H=A?"a":"span",C=A?`href="${A}"${O?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${H} ${C} class="banner-btn banner-btn--${R}">${k}</${H}>`}async function x(){if(!t.__bannerLoading){t.__bannerLoading=!0,L();try{const k=await fetch(r,{headers:{Accept:"application/json"}});if(!k.ok){z();return}const A=await k.json();if(d=Array.isArray(A)?B?A.filter(X=>X.category===B):A:[],d.length===0){z();return}y(),V(),f(0,!1),E&&w()}catch{z()}finally{t.__bannerLoading=!1}}}function L(){v.innerHTML=`
                ...
                </div>`,S.innerHTML=""}function y(){v.innerHTML=d.map((k,A)=>`
                <div class="banner-slide" data-index="${A}">
                    <div class="banner-slide-inner">
                        <div class="banner-bg">
                            <img src="${k.image_url}"
                                 alt="${k.image_alt??k.title}"
                        ...
                        <div class="banner-overlay"></div>
                        <div class="banner-content">
                            ${k.category?`<span class="banner-category-badge">${k.category}</span>`:""}
                            <h2 class="banner-title">${k.title}</h2>
                            <p class="banner-description">${k.description}</p>
                            ${k.btn_primary_text||k.btn_secondary_text?`<div class="banner-buttons">
                                    ${k.btn_primary_text?p(k.btn_primary_text,k.btn_primary_url,k.btn_primary_style,k.btn_primary_external):""}
                                    ${k.btn_secondary_text?p(k.btn_secondary_text,k.btn_secondary_url,k.btn_secondary_style,k.btn_secondary_external):""}
                                </div>`:""}
                        </div>
                    </div>
                </div>`).join(""),_(),q()}function _(){v.addEventListener("mousedown",T),v.addEventListener("touchstart",T,{passive:!0}),v.addEventListener("mousemove",D),v.addEventListener("touchmove",D,{passive:!0}),v.addEventListener("mouseup",M),v.addEventListener("touchend",M),v.addEventListener("mouseleave",M)}function q(){d.forEach(k=>{const A=new Image;A.src=k.image_url})}function T(k){b=!0,h=k.touches?k.touches[0].clientX:k.clientX,u=0}function D(k){b&&(u=(k.touches?k.touches[0].clientX:k.clientX)-h)}function M(){b&&(b=!1,Math.abs(u)>=m&&(f(u<0?(s+1)%d.length:(s-1+d.length)%d.length),$()),u=0)}function V(){if(d.length<=1){S.innerHTML="";return}const k=e.createElement("div");k.className="banner-dots",d.forEach((A,X)=>{const O=e.createElement("button");O.className="banner-dot",O.type="button",O.dataset.index=String(X),O.setAttribute("aria-label",`Banner ${X+1}`),O.addEventListener("click",()=>{f(X),$()}),k.appendChild(O)}),S.innerHTML="",S.appendChild(k)}function f(k,A=!0){const X=v.querySelectorAll(".banner-slide"),O=t.querySelectorAll(".banner-dot");X.forEach((R,H)=>{const C=H===k;A||(R.style.transition="none"),R.classList.toggle("banner-slide--active",C),A||requestAnimationFrame(()=>{R.style.transition=""})}),O.forEach((R,H)=>R.classList.toggle("banner-dot--active",H===k)),s=k}function w(){d.length<=1||!E||(c=setInterval(()=>f((s+1)%d.length),5e3))}function $(){E&&(clearInterval(c),w())}function z(){clearInterval(c),v.innerHTML=`
                <div class="banner-slide banner-slide--active">
                    <div class="banner-empty">Sin contenido.</div>
                </div>`,S.innerHTML=""}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",x):x()}}function $r(t,e){const i=document.getElementById("banner-hero-config-modal");if(i&&i.remove(),!document.getElementById("bnr-modal-styles")){const m=document.createElement("style");m.id="bnr-modal-styles",m.textContent=`
        ...
        </div>`,o.appendChild(n),document.body.appendChild(o);const d=n.querySelector("#bnr-autoplay"),s=n.querySelector("#bnr-autoplay-slider"),c=n.querySelector("#bnr-autoplay-knob"),b=()=>{s.style.background=d.checked?"#003B71":"#cbd5e1",c.style.left=d.checked?"21px":"3px"};b(),d.addEventListener("change",b);const h=n.querySelector("#bnr-category");(async()=>{try{const E=document.querySelector('meta[name="api-banners-url"]')?.content||`${window.location.origin}/adminintegral/api/banners/active`,B=await fetch(E,{headers:{Accept:"application/json"}});if(!B.ok)return;const v=await B.json();if(!Array.isArray(v))return;[...new Set(v.map(g=>g.category).filter(Boolean))].sort().forEach(g=>{const p=document.createElement("option");p.value=g,p.textContent=g,h.appendChild(p)}),h.value=l}catch{}})();const u=()=>o.remove();n.querySelector("#bnr-modal-close").onclick=u,n.querySelector("#bnr-modal-cancel").onclick=u,o.onclick=m=>{m.target===o&&u()},n.querySelector("#bnr-modal-save").onclick=()=>{e.addAttributes({"data-autoplay":d.checked?"true":"false","data-category":h.value||""}),u()}}const Sr=[{id:"banner-hero",label:"Banner Slider",category:"Banners",media:wr,content:{type:"banner-hero-component"}}];function Lr(t){const e="banner-hero-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner Slider",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-autoplay":"true","data-category":""},components:`
    ...
    <circle cx="26" cy="27.8" r="1.3" fill="#003B71"/>
</svg>`;function Tr(){return function(){const t=this,e=t.ownerDocument??document,i="/adminintegral",a=(e.defaultView??window).location.origin,r=e.querySelector('meta[name="api-assets-url"]')?.content||`${a}${i}/api/assets/active`;if(!e.getElementById("assets-block-styles")){const B=e.createElement("style");B.id="assets-block-styles",B.textContent=".ast-section{width:100%;background:#ffffff;padding:3rem 4rem;font-family:'Poppins',sans-serif;}.ast-header{font-size:1.125rem;font-weight:700;color:#003B71;margin:0 0 1.25rem;}.ast-stripe{width:100%;height:3px;background:#E97300;margin-bottom:1.5rem;}.ast-tabs{display:flex;flex-wrap:wrap;border-bottom:2px solid #E97300;margin-bottom:1.25rem;}.ast-tab{padding:1rem 1.5rem;background:#ffffff;border:none;font-size:1.0625rem;font-weight:700;color:#003B71;cursor:pointer;font-family:inherit;transition:background 0.15s,color 0.15s;}.ast-tab--active{background:#E97300;color:#ffffff;}.ast-subtitle{font-size:1.0625rem;font-weight:700;color:#003B71;margin:0 0 0.5rem;}.ast-subtitle-stripe{width:120px;height:2px;background:#E97300;margin-bottom:1.5rem;}.ast-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1.5rem;}.ast-card{display:block;background:#ffffff;border-radius:0.5rem;box-shadow:0 4px 16px rgba(0,0,0,0.1);overflow:hidden;text-decoration:none;transition:box-shadow 0.2s ease;}.ast-card:hover{box-shadow:0 8px 26px rgba(0,0,0,0.16);}.ast-card-img{width:100%;aspect-ratio:4/3;object-fit:cover;display:block;}.ast-card-body{padding:0.75rem 0.875rem;}.ast-card-name{font-size:0.8125rem;font-weight:700;color:#003B71;line-height:1.4;margin:0 0 0.25rem;}.ast-card-desc{font-size:0.75rem;color:#003B71;line-height:1.4;margin:0;}.ast-empty{padding:3rem 1rem;text-align:center;color:#94a3b8;font-size:0.875rem;}@media(max-width:1280px){.ast-section{padding:3rem 2.5rem;}}@media(max-width:992px){.ast-section{padding:2.5rem 1.5rem;}.ast-tab{padding:0.75rem 1.125rem;font-size:0.9375rem;}}",e.head.appendChild(B)}const l=t.querySelector("[data-ast-tabs]"),o=t.querySelector("[data-ast-subtitle]"),n=t.querySelector("[data-ast-grid]");if(!l||!n)return;const d=t.dataset.defaultCategory||"";let s=[],c="";function b(B,v){return B?B.length>v?`${B.slice(0,v).trim()}...`:B:""}function h(B){const v=B.link_is_external?' target="_blank" rel="noopener noreferrer"':"",S=B.name||b(B.short_description,60),g=B.name||B.short_description||"Activo extraordinario";return`<a href="${B.link_url}"${v} class="ast-card">
                <img src="${B.image_url}" alt="${g}" class="ast-card-img" loading="lazy">
                <div class="ast-card-body">
                    <p class="ast-card-name">${S}</p>
                    ${B.name&&B.short_description?`<p class="ast-card-desc">${B.short_description}</p>`:""}
                </div>
            </a>`}function u(){const B=c?s.filter(v=>v.category_slug===c):s;if(o){const v=c?B[0]?.category||"":"Todos";o.innerHTML=`<p class="ast-subtitle">${v}</p><div class="ast-subtitle-stripe"></div>`}if(B.length===0){n.innerHTML='<div class="ast-empty">No hay activos disponibles en esta categoría.</div>';return}n.innerHTML=B.map(h).join("")}function m(){const B=[],v=new Set;s.forEach(g=>{v.has(g.category_slug)||(v.add(g.category_slug),B.push({slug:g.category_slug,name:g.category}))});const S=['<button type="button" class="ast-tab ast-tab--active" data-tab-slug="">Todos</button>',...B.map(g=>`<button type="button" class="ast-tab" data-tab-slug="${g.slug}">${g.name}</button>`)].join("");if(l.innerHTML=S,l.querySelectorAll("[data-tab-slug]").forEach(g=>{g.addEventListener("click",()=>{l.querySelectorAll(".ast-tab").forEach(p=>p.classList.remove("ast-tab--active")),g.classList.add("ast-tab--active"),c=g.dataset.tabSlug,u()})}),d){const g=l.querySelector(`[data-tab-slug="${d}"]`);g&&g.click()}}async function E(){n.innerHTML='<div class="ast-empty">Cargando activos...</div>';try{const B=await fetch(r,{headers:{Accept:"application/json"}});if(!B.ok){n.innerHTML='<div class="ast-empty">No se pudieron cargar los activos.</div>';return}if(s=await B.json(),!Array.isArray(s)||s.length===0){l.innerHTML='<button type="button" class="ast-tab ast-tab--active">Todos</button>',n.innerHTML='<div class="ast-empty">No hay activos disponibles.</div>';return}m(),u()}catch{n.innerHTML='<div class="ast-empty">No se pudieron cargar los activos.</div>'}}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",E):E()}}const zr=[{id:"assets-catalog",label:"Catálogo de Activos",category:"Interactivos",media:_r,content:{type:"assets-catalog-component"}}];function Ar(t){const e="assets-catalog-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Catálogo de Activos",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-default-category":"",class:"ast-section"},components:`
                ...
                `,script:Tr(),toolbar:[],traits:[{type:"text",name:"data-default-category",label:"Categoría inicial (slug)",placeholder:"Déjalo vacío para mostrar 'Todos'"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",()=>{const i=this.getEl();if(!i)return;const a=this.get("script");a&&typeof a=="function"&&setTimeout(()=>a.call(i),100)})}}}),Ir(t,e)}function Ir(t,e){t.on("storage:end:load",()=>{setTimeout(()=>ot(t,e),1e3)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},500))}),t.on("canvas:render",()=>{setTimeout(()=>ot(t,e),800)}),t.on("storage:start:store",()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e),i.addAttributes({"data-gjs-type":e})})})}function ot(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}const qr="/bancaintegral",mt=`
<style>
...
.hb-btn{width:100%;text-align:center;}
...
</style>`;function bt(t,e){e=e||"hb"+Math.random().toString(36).slice(2,7);const i=t.bg_image||P("images/placeholder.svg"),a=t.btn_primary||{},r=t.btn_secondary||{},l=a.color||"white",o=r.color||"white",n=a.enabled?`<a href="${a.href||"#"}" class="hb-btn hb-btn-${l}-solid">${a.label||"Conoce más"}</a>`:"",d=r.enabled?`<a href="${r.href||"#"}" class="hb-btn hb-btn-${o}-outline">${r.label||"Solicitar"}</a>`:"";return`<section id="hb-root-${e}" class="hb-section" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
        ...
        </div>`,s.appendChild(c),document.body.appendChild(s);const h=`${document.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??""}/api/pages/search`;function u(g){if(g.dataset.autocompleteAttached)return;g.dataset.autocompleteAttached="true";const p=g.parentNode;(!p.style.position||p.style.position==="static")&&(p.style.position="relative");const x=document.createElement("ul");x.style.cssText="position:absolute;top:calc(100% + 2px);left:0;right:0;z-index:999999;background:#fff;border:1px solid #e2e8f0;border-radius:0.5rem;box-shadow:0 8px 24px rgba(0,0,0,0.1);list-style:none;margin:0;padding:0.25rem;max-height:200px;overflow-y:auto;display:none;",p.appendChild(x);let L=null;async function y(T){if(T.length<1){x.style.display="none";return}try{const M=await(await fetch(`${h}?q=${encodeURIComponent(T)}`,{headers:{Accept:"application/json","X-Requested-With":"XMLHttpRequest"}})).json();q(M,T)}catch{x.style.display="none"}}function _(T,D){return D?T.replace(new RegExp(`(${D.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")})`,"gi"),'<mark style="background:#fef3c7;color:#92400e;border-radius:2px;padding:0 1px;">$1</mark>'):T}function q(T,D){if(x.innerHTML="",!T.length){x.style.display="none";return}T.forEach(M=>{const V=document.createElement("li");V.style.cssText="padding:0.375rem 0.625rem;border-radius:0.375rem;cursor:pointer;display:flex;flex-direction:column;gap:0.125rem;",V.innerHTML=`<span style="font-size:0.8rem;font-weight:600;color:#1e293b;">${_(M.title,D)}</span><span style="font-size:0.7rem;color:#64748b;">/${M.slug}</span>`,V.addEventListener("mouseenter",()=>V.style.background="#f1f5f9"),V.addEventListener("mouseleave",()=>V.style.background=""),V.addEventListener("mousedown",f=>{f.preventDefault(),g.value=`${qr}/${M.slug}`,g.dispatchEvent(new Event("input")),x.style.display="none"}),x.appendChild(V)}),x.style.display="block"}g.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>y(g.value.trim()),220)}),g.addEventListener("focus",()=>{g.select(),g.value.trim()&&y(g.value.trim())}),g.addEventListener("blur",()=>{setTimeout(()=>{x.style.display="none"},150)}),g.addEventListener("keydown",T=>{if(x.style.display==="none")return;const D=x.querySelectorAll("li"),M=x.querySelector("li.hb-ac-active");let V=Array.from(D).indexOf(M);if(T.key==="ArrowDown"){T.preventDefault(),M?.classList.remove("hb-ac-active");const f=D[V+1]||D[0];f?.classList.add("hb-ac-active"),f&&(f.style.background="#f1f5f9")}else if(T.key==="ArrowUp"){T.preventDefault(),M?.classList.remove("hb-ac-active");const f=D[V-1]||D[D.length-1];f?.classList.add("hb-ac-active"),f&&(f.style.background="#f1f5f9")}else T.key==="Enter"&&M?(T.preventDefault(),M.dispatchEvent(new MouseEvent("mousedown"))):T.key==="Escape"&&(x.style.display="none")})}u(c.querySelector("#hb-btn1-href")),u(c.querySelector("#hb-btn2-href"));let m=n.color||"white",E=d.color||"white";function B(g,p,x){const L=c.querySelector(`#${g}`);L.querySelectorAll("[data-color]").forEach(y=>{y.classList.toggle("hb-color-inactive",y.dataset.color!==p),y.addEventListener("click",()=>{L.querySelectorAll("[data-color]").forEach(_=>_.classList.toggle("hb-color-inactive",_.dataset.color!==y.dataset.color)),x(y.dataset.color)})})}B("hb-btn1-colors",m,g=>m=g),B("hb-btn2-colors",E,g=>E=g);function v(g,p,x){const L=c.querySelector(`#${g}`),y=c.querySelector(`#${p}`),_=c.querySelector(`#${x}`),q=()=>{y.style.background=L.checked?"#003B71":"#cbd5e1",_.style.left=L.checked?"21px":"3px"};q(),L.addEventListener("change",q)}v("hb-btn1-enabled","hb-btn1-slider","hb-btn1-knob"),v("hb-btn2-enabled","hb-btn2-slider","hb-btn2-knob"),c.querySelectorAll(".hb-tab-btn").forEach(g=>{g.addEventListener("click",()=>{c.querySelectorAll(".hb-tab-btn").forEach(p=>p.classList.remove("active")),c.querySelectorAll(".hb-tab-panel").forEach(p=>p.classList.remove("active")),g.classList.add("active"),c.querySelector(`#hb-panel-${g.dataset.tab}`).classList.add("active")})}),c.querySelector("#hb-bg-pick").addEventListener("click",()=>{$e({type:"image",title:"Seleccionar imagen de fondo",onSelect:g=>{c.querySelector("#hb-bg-url").value=g,c.querySelector("#hb-bg-preview").src=g}})}),c.querySelector("#hb-bg-url").addEventListener("input",g=>{c.querySelector("#hb-bg-preview").src=g.target.value});const S=()=>s.remove();c.querySelector("#hb-modal-close").onclick=S,c.querySelector("#hb-modal-cancel").onclick=S,s.onclick=g=>{g.target===s&&S()},c.querySelector("#hb-modal-save").onclick=()=>{const g={bg_image:c.querySelector("#hb-bg-url").value.trim()||Q.bg_image,title:c.querySelector("#hb-title").value.trim(),subtitle:c.querySelector("#hb-subtitle").value.trim(),btn_primary:{enabled:c.querySelector("#hb-btn1-enabled").checked,label:c.querySelector("#hb-btn1-label").value.trim(),href:c.querySelector("#hb-btn1-href").value.trim()||"#",color:m},btn_secondary:{enabled:c.querySelector("#hb-btn2-enabled").checked,label:c.querySelector("#hb-btn2-label").value.trim(),href:c.querySelector("#hb-btn2-href").value.trim()||"#",color:E}},x=e.getEl()?.querySelector("[id^='hb-root-']")?.id?.replace("hb-root-","")||"hb"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-hero-banner-config":JSON.stringify(g)}),e.components(bt(g,x)+mt),S()}}function Dr(t){const e="hero-banner-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-hero-banner-config":JSON.stringify(Q)},components:bt(Q)+mt,toolbar:[],traits:[{type:"button",label:"Banner",text:"Administrar Banner",full:!0,command:"open-hero-banner-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-hero-banner-config",{run(i){const a=i.getSelected();a&&Mr(i,a)}}),t.BlockManager.add("hero-banner-block",{label:"Banner",category:"Banners",media:`<svg viewBox="0 0 32 32" width="32" height="32">
        ...
        </svg>`,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}})}function Nr(t){I.registerBlocks(Dt),I.registerBlocks(Xt),I.registerBlocks(Sr),I.registerBlocks(oa),I.registerBlocks(Vi),I.registerBlocks(Kt),I.registerBlocks(ii),I.registerBlocks(_i),I.registerBlocks(Ai),I.registerBlocks(di),I.registerBlocks(ia),I.registerBlocks(hi),I.registerBlocks(yi),I.registerBlocks(Mi),I.registerBlocks(Pi),I.registerBlocks(ca),I.registerBlocks(ha),I.registerBlocks(ba),I.registerBlocks(za),I.registerBlocks(qa),I.registerBlocks(Ra),I.registerBlocks(tr),I.registerBlocks(or),I.registerBlocks(Sa),I.registerBlocks(ja),I.registerBlocks(cr),I.registerBlocks(ur),I.registerBlocks(zr),I.applyToEditor(t),dr(t),xr(t),Lr(t),Dr(t),Li(t),si(t),ir(t),Xi(t),Ha(t),vi(t),Ar(t)}function Or(t,e,i){t.on("component:add",()=>e.markAsDirty()),t.on("component:remove",()=>e.markAsDirty()),t.on("component:update",()=>e.markAsDirty()),t.on("style:update",()=>e.markAsDirty());const a=document.getElementById("save-button");a&&a.addEventListener("click",async()=>{await Pr(t,e,i,a)}),document.addEventListener("keydown",r=>{(r.ctrlKey||r.metaKey)&&r.key==="s"&&(r.preventDefault(),a&&!a.disabled&&a.click())})}async function Pr(t,e,i,a){a.disabled=!0,a.innerHTML='<i class="ri-loader-4-line animate-spin"></i><span>Guardando...</span>';try{i.needsTitle()?await Rr(t,e,i):await ut(t,e,i)}catch(r){xt(r.message,"error")}finally{a.disabled=!1,a.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}}async function Rr(t,e,i){return new Promise((a,r)=>{vt({title:"Título de la Página",description:"Ingresa un título descriptivo para identificar esta página",placeholder:"Ej: Acerca de Nosotros",icon:"ri-file-text-line",iconBg:"#dbeafe",iconColor:"#2563eb",confirmLabel:"Guardar",onConfirm:async l=>{if(!l?.trim()){r(new Error("El título es obligatorio"));return}try{await ut(t,e,i,l),a()}catch(o){r(o)}},onCancel:()=>{r(new Error("Guardado cancelado"))}})})}async function ut(t,e,i,a=null){const l={...e.getEditorContent(t),is_published:i.isPublished};a&&(l.title=a);const o=await e.savePage(t,l,i.storeUrl,i.getHttpMethod());o.success&&(e.markAsClean(),xt(o.message,"success"),!i.isEditMode&&o.page?(i.updatePageInfo(o),i.updateTitle(o.page.title)):a&&i.updateTitle(a))}function xt(t,e){typeof window.showNotification=="function"&&window.showNotification(t,e)}document.addEventListener("DOMContentLoaded",async()=>{const t=new wt,e=new At;new It(t);const i=kt();if(i.on("load",()=>{Nr(i),Bt(i),Et(),$t(),St(i),Lt(i),Ct(i),jt(i),_t(i),Tt(i),Hr(i),Fr(i),Ur(i),setTimeout(()=>{i.runCommand("sw-visibility"),i.Panels.getButton("options","sw-visibility")?.set("active",!0)},100)}),e.isEditMode)try{await t.loadPageContent(i,e.loadUrl),nt("Contenido cargado correctamente","success")}catch(a){nt("Error al cargar el contenido","error"),console.error(a)}Or(i,t,e)});function Hr(t){const e=[{cmd:"set-device-desktop",device:"Desktop"},{cmd:"set-device-tablet",device:"Tablet"},{cmd:"set-device-mobile",device:"Mobile"}];e.forEach(({cmd:i,device:a})=>{t.Commands.add(i,{run:r=>{r.setDevice(a),e.forEach(({cmd:l})=>{r.Panels.getButton("devices-c",l)?.set("active",l===i)})}})})}function Fr(t){t.Commands.add("canvas-clear",{run:e=>{zt({title:"Limpiar canvas",description:"¿Estás seguro de que quieres eliminar todo el contenido del canvas? Esta acción no se puede deshacer.",icon:"ri-delete-bin-line",iconBg:"#fef2f2",iconColor:"#dc2626",confirmLabel:"Limpiar todo",confirmColor:"#dc2626",onConfirm:()=>{e.DomComponents.clear(),e.CssComposer.clear()}})}})}function Ur(t){const e=t.Canvas.getFrameEl();if(!e?.contentDocument?.head)return;const i=e.contentDocument.createElement("style");i.id="gjs-dashed-fix",i.textContent="body,body.gjs-dashed{margin:0!important;padding:0 0 160px 0!important;}",e.contentDocument.head.appendChild(i)}function nt(t,e="info"){typeof window.showNotification=="function"&&window.showNotification(t,e)}
