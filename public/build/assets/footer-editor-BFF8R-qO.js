...
<div class="ft-stripe"
    ...
    `,n.appendChild(r),document.body.appendChild(n);const f=r.querySelector("#ft-sections-container");function C(a,m){const c=document.createElement("div");c.style.cssText="background:#0f172a;border:1px solid #334155;border-radius:0.625rem;overflow:hidden;",c.dataset.sectionIndex=m;const y=(a.links||[]).map((u,p)=>`
