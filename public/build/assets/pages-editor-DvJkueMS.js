/* empty css                   *//* empty css                    *//* empty css                          *//* empty css                           */import{o as Re,M as Ze,j as Ke,E as Qe,i as et,t as tt,d as it,f as at,e as rt,s as lt,g as ot,c as nt,b as st,a as ct,h as dt}from"./editor-commands-Bq37dEX4.js";import{a as N}from"./url-DaqOO3yL.js";import"./_commonjsHelpers-CqkleIqs.js";class ft{constructor(){this.pageId=this.getElementValue("page-id"),this.pageSlug=this.getElementValue("page-slug"),this.pageTitle=this.getPageTitle(),this.loadUrl=this.getElementValue("page-load-url"),this.storeUrl=this.getElementValue("page-store-url"),this.isPublished=this.getElementValue("page-is-published")==="1",this.isEditMode=!!this.pageId,this.appUrl=(document.querySelector('meta[name="app-url"]')?.content??"").replace(/\/$/,"")}getElementValue(e,t=""){const a=document.getElementById(e);return a?a.value.trim():t}getPageTitle(){const e=document.getElementById("editor-title");if(!e)return"";const a=e.textContent.match(/(?:Editando:|Nueva Página)\s*(.+)?/);return a&&a[1]?a[1].trim():""}updatePageInfo(e){if(e.page)if(this.pageId=e.page.id,this.pageSlug=e.page.slug,this.pageTitle=e.page.title,this.isEditMode=!0,document.getElementById("page-id").value=this.pageId,document.getElementById("page-slug").value=this.pageSlug,e.page.update_url?this.storeUrl=e.page.update_url:this.storeUrl=`${this.appUrl}/pages/${this.pageSlug}`,document.getElementById("page-store-url").value=this.storeUrl,e.page.load_url?this.loadUrl=e.page.load_url:this.loadUrl=`${this.appUrl}/pages/${this.pageSlug}/load`,document.getElementById("page-load-url").value=this.loadUrl,e.page.edit_url)window.history.replaceState(null,"",e.page.edit_url);else try{const t=new URL(window.location.href);t.pathname=t.pathname.replace(/\/pages\/create\/?$/,`/pages/${this.pageSlug}/edit`),window.history.replaceState(null,"",t.toString())}catch(t){console.error("Error updating browser URL:",t)}}updateTitle(e){this.pageTitle=e;const t=document.getElementById("editor-title");t&&(t.textContent=`Editando: ${e}`),document.title=`Editar: ${e} - Editor`}getHttpMethod(){return this.isEditMode?"PUT":"POST"}needsTitle(){return!this.isEditMode}}class gt{constructor(e){this.editorService=e,this.setupBackButton(),this.setupBeforeUnload()}setupBackButton(){const e=document.querySelector("#editor-navbar a[href]");e&&e.addEventListener("click",t=>{this.editorService.shouldPreventUnload()&&(t.preventDefault(),this.showUnsavedChangesModal(()=>{this.editorService.startNavigation(),window.location.href=e.href}))})}setupBeforeUnload(){window.addEventListener("beforeunload",e=>{if(this.editorService.shouldPreventUnload())return e.preventDefault(),e.returnValue="Tienes cambios sin guardar. ¿Estás seguro de que quieres salir?",e.returnValue})}showUnsavedChangesModal(e){const t=document.createElement("div");t.style.cssText=`
            position: fixed;
            inset: 0;
            z-index: 9999;
            display: flex;
        ...
        `;const c=document.createElement("button");c.textContent="Salir sin guardar",c.style.cssText=`
            ...
            font-family: inherit;
        `,[n,c].forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.opacity="0.85"}),d.addEventListener("mouseleave",()=>{d.style.opacity="1"})});const p=()=>t.remove();n.addEventListener("click",p),c.addEventListener("click",()=>{p(),e()}),t.addEventListener("click",d=>{d.target===t&&p()}),l.appendChild(n),l.appendChild(c),a.appendChild(r),a.appendChild(l),t.appendChild(a),document.body.appendChild(t)}}const pt="Básico";class ht{constructor(){this.blocks=new Map}registerBlock(e,t){this.blocks.has(t.category)||this.blocks.set(t.category,[]),this.blocks.get(t.category).push({id:e,...t})}registerBlocks(e){e.forEach(t=>{this.registerBlock(t.id,t)})}applyToEditor(e){this.blocks.forEach(t=>{t.forEach(a=>{const{id:r,...l}=a;e.BlockManager.add(r,l)})}),this.applyCollapseSettings(e),this.hideDefaultCategories(e)}applyCollapseSettings(e){setTimeout(()=>{e.BlockManager.getCategories().each(t=>{t.set("open",t.get("label")===pt)})},500)}hideDefaultCategories(e){setTimeout(()=>{const t=["Basic","Extra"];document.querySelectorAll(".gjs-block-category").forEach(a=>{const r=a.querySelector(".gjs-title");r&&t.includes(r.textContent.trim())&&(a.style.display="none")})},100)}}const _=new ht,mt=[{id:"heading1",label:"Título H1",category:"Básico",media:`<svg viewBox="0 0 32 32" width="32" height="32">
        ...
        </svg>`,content:'<div class="h-12 w-full"></div>'}],ut=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,Et=[{id:"columns-1",label:"1 Columna",category:"Columnas",media:ut,content:`
<div class="col-section">
    <div class="col-cell"></div>
</div>
${X}`},{id:"columns-2",label:"2 Columnas",category:"Columnas",media:bt,content:`
<div class="col-section">
...
${X}`},{id:"columns-3",label:"3 Columnas",category:"Columnas",media:xt,content:`
<div class="col-section">
...
${X}`},{id:"columns-4",label:"4 Columnas",category:"Columnas",media:yt,content:`
<div class="col-section">
...
${X}`},{id:"columns-1-3",label:"1/3 — 2/3",category:"Columnas",media:vt,content:`
<div class="col-section">
...
${X}`},{id:"columns-3-1",label:"2/3 — 1/3",category:"Columnas",media:wt,content:`
<div class="col-section">
...
${X}`},{id:"columns-1-2",label:"1/4 — 1/4 — 1/2",category:"Columnas",media:kt,content:`
<div class="col-section">
...
${X}`},{id:"columns-2-1",label:"1/2 — 1/4 — 1/4",category:"Columnas",media:Bt,content:`
<div class="col-section">
...
${X}`}],$t=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,_t=[{id:"about-section",label:"Nuestra Historia",category:"Contenido",media:$t,content:`
...
${Ee}`},{id:"about-mvv-section",label:"Misión, Visión y Valores",category:"Contenido",media:Ct,content:`
...
${Ee}`}],Fe=function(){(function(){function i(t){if(!t||t.__pcInit)return;t.__pcInit=!0;var a=t.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,n=0,c=!1,p=0,d=0,m=0,u=null;a.querySelectorAll("img").forEach(function(h){h.setAttribute("draggable","false")}),setTimeout(function(){var h=a.scrollWidth-a.clientWidth;if(h<=0)return;var v=Math.min(60,h),$=null;function y(S){$||($=S);var z=(S-$)/400;if(z<.5)a.scrollLeft=v*(z*2);else if(z<1)a.scrollLeft=v*(1-(z-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(y)}requestAnimationFrame(y)},400),a.scrollLeft=0;function b(){return a.scrollWidth-a.clientWidth}function s(h){return Math.max(0,Math.min(h,b()))}function g(){Math.abs(p)<.5||(p*=.92,a.scrollLeft=s(a.scrollLeft+p),u=requestAnimationFrame(g))}a.addEventListener("mousedown",function(h){h.button===0&&(u&&(cancelAnimationFrame(u),u=null),r=!0,c=!1,p=0,l=h.clientX,d=h.clientX,m=Date.now(),n=a.scrollLeft,a.style.cursor="grabbing",h.preventDefault())}),document.addEventListener("mousemove",function(h){if(r){var v=l-h.clientX;Math.abs(v)>3&&(c=!0);var $=Date.now(),y=$-m||1;p=(h.clientX-d)/y*16*-1,d=h.clientX,m=$,a.scrollLeft=s(n+v)}}),document.addEventListener("mouseup",function(h){r&&(r=!1,a.style.cursor="grab",c&&(h.stopPropagation(),u=requestAnimationFrame(g)))}),a.addEventListener("click",function(h){c&&(h.preventDefault(),h.stopPropagation(),c=!1)},!0);var k=0,T=0,w=0,E=0,L=0;a.addEventListener("touchstart",function(h){u&&(cancelAnimationFrame(u),u=null),k=h.touches[0].clientX,w=h.touches[0].clientX,E=Date.now(),T=a.scrollLeft,L=0},{passive:!0}),a.addEventListener("touchmove",function(h){var v=Date.now(),$=v-E||1,y=h.touches[0].clientX;L=(y-w)/$*16*-1,w=y,E=v;var S=k-y;a.scrollLeft=s(T+S)},{passive:!0}),a.addEventListener("touchend",function(){u=requestAnimationFrame(function h(){Math.abs(L)<.5||(L*=.92,a.scrollLeft=s(a.scrollLeft+L),u=requestAnimationFrame(h))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(t){delete t.__pcInit,i(t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Tt=`(${Fe.toString()})();`,zt=`
...
@media(max-width:480px){.pc-card{flex:0 0 80vw;}}`;function It(i){const e=i.img||N("images/placeholder.svg"),t=i.title||"TÍTULO DEL PRODUCTO",a=i.desc||"Descripción breve del producto financiero.",r=i.href||"#",l=i.btn_label||"Solicitar";return`<div class="pc-card"><div class="pc-card-img-wrap"><img src="${e}" alt="${t}" class="pc-card-img"></div><div class="pc-card-body"><h3 class="pc-card-title">${t}</h3><p class="pc-card-desc">${a}</p></div><a href="${r}" class="pc-btn">${l}</a></div>`}function Ue(i){const e=i.heading||"Créditos",t=i.subheading||"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",a=i.more_href||"#",r=i.more_label||"Ver más",l=i.show_more!==!1,c=(i.cards||[]).map(It).join(""),p=l?`<div class="pc-more-wrap"><a href="${a}" class="pc-more-btn">${r}</a></div>`:"";return`<section class="pc-section"><style>${zt}</style><div style="text-align:center;margin-bottom:2rem;"><h2 class="pc-section-heading">${e}</h2><p class="pc-section-subheading">${t}</p></div><div class="pc-carousel-wrap"><div class="pc-track">${c}</div></div>${p}</section>`}const P={heading:"Créditos",subheading:"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CREDINVIERTE",desc:"Adquiere activos fijos",href:"#",btn_label:"Solicitar"},{img:"",title:"SOLUCIONES INTEGRALES",desc:"Financiamiento PYME",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDI-CONFIAMOS",desc:"Rápido y sin fiador",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDILÍNEA",desc:"Línea rotativa",href:"#",btn_label:"Solicitar"}]};function At(i,e){const t=document.getElementById("pc-config-modal");if(t&&t.remove(),!document.getElementById("pc-modal-styles")){const d=document.createElement("style");d.id="pc-modal-styles",d.textContent=`
...
</svg>`;function Dt(i){const e="product-cards-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección de Productos",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-product-cards-config":JSON.stringify(P)},components:Ue(P),script:Fe,"script-props":["data-product-cards-config"],traits:[{type:"button",label:"Productos",text:"Administrar Sección",full:!0,command:"open-product-cards-config"}],toolbar:[]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),i.Commands.add("open-product-cards-config",{run(t){const a=t.getSelected();a&&At(t,a)}}),i.BlockManager.add("product-cards-block",{label:"Sección de productos",category:"Productos y Servicios",media:qt,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),i.on("component:mount",t=>{t.getEl()?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>ge(i),400))}),i.on("component:selected",t=>{const a=t.getEl();if(!a)return;const r=a.closest(`[data-gjs-type="${e}"]`);if(r&&!a.hasAttribute("data-gjs-type")){const n=i.getWrapper().find(`[data-gjs-type="${e}"]`).find(c=>c.getEl()===r);n&&setTimeout(()=>i.select(n),0)}}),i.on("canvas:render",()=>{setTimeout(()=>ge(i),600)}),i.on("storage:end:load",()=>{setTimeout(()=>ge(i),800)})}const Mt=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,Nt=[{id:"dual-card-section",label:"Sección dos tarjetas",category:"Productos y Servicios",media:Mt,content:`
...
${be}`},{id:"dual-card-dark",label:"Tarjeta azul oscuro",category:"Productos y Servicios",media:`<svg viewBox="0 0 32 32" width="32" height="32">
        ...
        </svg>`,content:`${$e}${be}`},{id:"dual-card-light",label:"Tarjeta blanca",category:"Productos y Servicios",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
        ...
        </svg>`,content:`${Ce}${be}`}],Ot=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,Ht=[{id:"cta-section",label:"Llamada a la acción",category:"Llamadas a la acción",media:Ot,content:`
...
${Pt}`}],Ve=function(){(function(){function i(t){if(!t||t.__savInit)return;t.__savInit=!0;var a=t.querySelector(".sav-carousel-wrap");if(!a)return;a.scrollLeft=0;var r=!1,l=0,n=0,c=!1,p=0,d=0,m=0,u=null;a.querySelectorAll("img").forEach(function(h){h.setAttribute("draggable","false")}),setTimeout(function(){var h=a.scrollWidth-a.clientWidth;if(h<=0)return;var v=Math.min(60,h),$=null;function y(S){$||($=S);var z=(S-$)/400;if(z<.5)a.scrollLeft=v*(z*2);else if(z<1)a.scrollLeft=v*(1-(z-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(y)}requestAnimationFrame(y)},400);function b(){return a.scrollWidth-a.clientWidth}function s(h){return Math.max(0,Math.min(h,b()))}function g(){Math.abs(p)<.5||(p*=.92,a.scrollLeft=s(a.scrollLeft+p),u=requestAnimationFrame(g))}a.addEventListener("mousedown",function(h){h.button===0&&(u&&(cancelAnimationFrame(u),u=null),r=!0,c=!1,p=0,l=h.clientX,d=h.clientX,m=Date.now(),n=a.scrollLeft,a.style.cursor="grabbing",h.preventDefault())}),document.addEventListener("mousemove",function(h){if(r){var v=l-h.clientX;Math.abs(v)>3&&(c=!0);var $=Date.now(),y=$-m||1;p=(h.clientX-d)/y*16*-1,d=h.clientX,m=$,a.scrollLeft=s(n+v)}}),document.addEventListener("mouseup",function(h){r&&(r=!1,a.style.cursor="grab",c&&(h.stopPropagation(),u=requestAnimationFrame(g)))}),a.addEventListener("click",function(h){c&&(h.preventDefault(),h.stopPropagation(),c=!1)},!0);var k=0,T=0,w=0,E=0,L=0;a.addEventListener("touchstart",function(h){u&&(cancelAnimationFrame(u),u=null),k=h.touches[0].clientX,w=h.touches[0].clientX,E=Date.now(),T=a.scrollLeft,L=0},{passive:!0}),a.addEventListener("touchmove",function(h){var v=Date.now(),$=v-E||1,y=h.touches[0].clientX;L=(y-w)/$*16*-1,w=y,E=v;var S=k-y;a.scrollLeft=s(T+S)},{passive:!0}),a.addEventListener("touchend",function(){u=requestAnimationFrame(function h(){Math.abs(L)<.5||(L*=.92,a.scrollLeft=s(a.scrollLeft+L),u=requestAnimationFrame(h))})},{passive:!0})}function e(){document.querySelectorAll(".sav-section").forEach(function(t){delete t.__savInit,i(t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Rt=`(${Ve.toString()})();`,Ft=`
...
@media(max-width:480px){.sav-card{flex:0 0 75vw;}}`;function Ut(i){const e=i.img||N("images/placeholder.svg"),t=i.title||"TÍTULO DEL PRODUCTO",a=i.desc?`<p class="sav-card-desc">${i.desc}</p>`:"",r=i.href||"#",l=i.btn_label||"Solicitar";return`<div class="sav-card"><div class="sav-card-img-wrap"><img src="${e}" alt="${t}" class="sav-card-img"></div><h3 class="sav-card-title">${t}</h3>${a}<a href="${r}" class="sav-btn">${l}</a></div>`}function Xe(i){const e=i.heading||"Depósitos y Cuentas de Ahorro",t=i.subheading||"Productos diseñados para hacer crecer tu dinero de forma segura.",a=i.more_href||"#",r=i.more_label||"Ver más",l=i.show_more!==!1,c=(i.cards||[]).map(Ut).join(""),p=N("images/brand-watermark.png"),d=l?`<div class="sav-more-wrap"><a href="${a}" class="sav-more-btn">${r}</a></div>`:"";return`<section class="sav-section"><style>${Ft}</style><div class="sav-blue-box"><div class="sav-watermark"><img src="${p}" alt=""></div><div style="display:flex;flex-direction:column;gap:0.5rem;text-align:center;position:relative;z-index:1;"><h2 class="sav-heading">${e}</h2><p class="sav-subheading">${t}</p></div><div class="sav-carousel-wrap"><div class="sav-track">${c}</div></div>${d}</div></section>`}const H={heading:"Depósitos y Cuentas de Ahorro",subheading:"Productos diseñados para hacer crecer tu dinero de forma segura.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CUENTA DE AHORRO ESTÁNDAR",href:"#",btn_label:"Solicitar"},{img:"",title:"AHORRO RENTABLE",href:"#",btn_label:"Solicitar"},{img:"",title:"CUENTA DE AHORRO MÁS",href:"#",btn_label:"Solicitar"},{img:"",title:"DEPÓSITO DE PLAZO FIJO",href:"#",btn_label:"Solicitar"}]};function Vt(i,e){const t=document.getElementById("sav-config-modal");if(t&&t.remove(),!document.getElementById("sav-modal-styles")){const d=document.createElement("style");d.id="sav-modal-styles",d.textContent=`
...
</svg>`;function Wt(i){const e="savings-section-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección Fondo Azul",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-savings-config":JSON.stringify(H)},components:Xe(H),script:Ve,"script-props":["data-savings-config"],traits:[{type:"button",label:"Sección",text:"Administrar Sección",full:!0,command:"open-savings-config"}],toolbar:[]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),i.Commands.add("open-savings-config",{run(t){const a=t.getSelected();a&&Vt(t,a)}}),i.BlockManager.add("savings-section-block",{label:"Sección Fondo Azul",category:"Productos y Servicios",media:Xt,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),i.on("component:mount",t=>{t.getEl()?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>pe(i),400))}),i.on("component:selected",t=>{const a=t.getEl();if(!a)return;const r=a.closest(`[data-gjs-type="${e}"]`);if(r&&!a.hasAttribute("data-gjs-type")){const l=i.getWrapper().find(`[data-gjs-type="${e}"]`).find(n=>n.getEl()===r);l&&setTimeout(()=>i.select(l),0)}}),i.on("canvas:render",()=>setTimeout(()=>pe(i),600)),i.on("storage:end:load",()=>setTimeout(()=>pe(i),800))}const Se=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
</style>`,Jt=[{id:"product-link-cards",label:"Tarjetas de productos con enlace",category:"Productos y Servicios",media:Se,content:`
...
${xe}`},{id:"product-link-card-orange",label:"Tarjeta producto naranja",category:"Productos y Servicios",media:Se,media:Yt,content:`${K}${xe}`},{id:"product-link-card-blue",label:"Tarjeta producto azul",category:"Productos y Servicios",media:Gt,content:`${Q}${xe}`}],Zt=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,Qt=[{id:"icon-links-strip",label:"Iconos con enlace",category:"Productos y Servicios",media:Zt,content:`
...
${Le}`},{id:"icon-link-item",label:"Icono con enlace",category:"Productos y Servicios",media:Kt,content:`${ee}${Le}`}],ei=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
</style>`,ii=[{id:"promo-cta",label:"Promo con CTA y precio",category:"Llamadas a la acción",media:ei,content:`
...
${ti}`}],ai=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<style>${Be}</style>`,oi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</svg>`,ni=[{id:"tabs-cards",label:"Sección con tabs",category:"Contenido",media:ai,content:{type:"tabs-cards-component"}},{id:"tab-card-single",label:"Tarjeta de tab",category:"Contenido",media:oi,content:`${D()}`}];function si(i){const e="tabs-cards-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección con tabs",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!0,removable:!0,attributes:{"data-gjs-type":e,"data-tab-count":"5"},components:li,script:ri(),traits:[{type:"number",name:"data-tab-count",label:"Número de tabs (2-10)",min:2,max:10,changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",(t,a)=>{const r=parseInt(a["data-tab-count"]);isNaN(r)||this.updateTabCount(r)})},updateTabCount(t){const a=Math.min(10,Math.max(2,t)),r=l=>{const n=Array.from({length:l},()=>'<button class="tabs-btn inline-block px-6 py-2 rounded-full border-2 border-[#003B71] bg-transparent text-[#003B71] text-sm font-medium">Lorem Ipsum</button>').join(`
...
</div>`,mi=i=>{const e=i==="light";return`
...
${wi}`,ki=[{id:"stats-strip-left",label:"Franja estadísticas - izquierda",category:"Heroes",media:yi,content:_e(!0)},{id:"stats-strip-right",label:"Franja estadísticas - derecha",category:"Heroes",media:vi,content:_e(!1)}],Bi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
</style>`,$i=[{id:"service-cards-section",label:"Sección de servicios con iconos",category:"Productos y Servicios",media:Bi,content:`
...
${Te}`},{id:"service-card-item",label:"Ítem de servicio con icono",category:"Productos y Servicios",media:Ei,content:`${ie}${Te}`}],Ci=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,ji=[{id:"contact-info-row",label:"Contacto en fila",category:"Contacto",media:Ci,content:`
...
${ye}`},{id:"contact-info-col",label:"Contacto en columna",category:"Contacto",media:Si,content:`
<section class="ci-section">
...
${ye}`},{id:"contact-info-item",label:"Ítem de contacto",category:"Contacto",media:Li,content:`
<section class="ci-section">
    <div class="ci-row-wrap">
        <div class="ci-pill-row">
            ${ae("ri-phone-fill","Contáctenos","(503)-2250-6090","tel:+50322506090")}
...
${ye}`}],_i=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
</style>`,zi=[{id:"rich-list",label:"Lista con título y descripción",category:"Contenido",media:_i,content:`
...
${ze}`},{id:"rich-list-item",label:"Ítem de lista con descripción",category:"Contenido",media:Ti,content:`
<section class="rl-section">
    <div class="rl-list">
        ${re}
    </div>
</section>
${ze}`}],ve=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</li>`,fe='<p class="text-sm text-[#6b7280] leading-relaxed text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>',we=`
<style>
...
</style>`,Ii=[{id:"product-detail-section",label:"Detalle de producto",category:"Productos y Servicios",media:ve,content:`
...
${we}`},{id:"product-detail-bullet",label:"Ítem de ventaja",category:"Productos y Servicios",media:ve,content:`<ul class="pd-bullet-list" style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:0.75rem;">${J}</ul>${we}`},{id:"product-detail-footnote",label:"Nota al pie",category:"Productos y Servicios",media:ve,content:`${fe}${we}`}],Ai=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</div>`,Di=[{id:"news-grid-section",label:"Noticias y Publicaciones",category:"Contenido",media:Ai,content:`
...
${Ie}`},{id:"news-card",label:"Tarjeta de noticia",category:"Contenido",media:qi,content:`${le}${Ie}`}],Mi=`<svg viewBox="0 0 32 32" width="32" height="32">
...
`,Oi=[{id:"contact-form",label:"Formulario de contacto",category:"Formularios",media:Mi,content:`
...
<\/script>`}],Pi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
            ...
            <th colspan="${i.cols}" class="p-3 align-middle text-center text-base font-bold ${t.headerBg} ${t.headerText}">
                ...
                </td>`:a+=`<td ${b} ${s} class="${$}">${d.text||""}</td>`,p+=m}),a+="</tr>"}),a+="</tbody></table>",a}function Z(i,e){return{title:"Título de la tabla",cols:i,headers:Array.from({length:i},(t,a)=>({text:`Columna ${a+1}`,align:"center"})),rows:Array.from({length:e},()=>Array.from({length:i},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})))}}function Ye(i,e){return`<div class="w-full overflow-x-auto rounded-2xl border-2 border-[${(he[e]||he.blue).borderColor}]">${i}</div>`}function Ae(i,e){const t={};return i.forEach((a,r)=>{let l=0;a.forEach(n=>{for(;t[`${r}-${l}`];)l++;const c=Math.min(n.colspan||1,e-l),p=n.rowspan||1;for(let d=r;d<r+p;d++)for(let m=l;m<l+c;m++)(d!==r||m!==l)&&(t[`${d}-${m}`]=`${r}-${l}`);l+=c})}),t}const Hi=`
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function Ri(){if(document.getElementById("tam-img-modal"))return;const i=document.createElement("div");i.id="tam-img-modal",i.innerHTML=`
        ...
        <div class="tam-container">
            ...
            <th>
            ...
            </th>`).join("")}</tr>`,s.innerHTML=l.rows.map((w,E)=>`<tr>${Array.from({length:g},(h,v)=>{const $=T[`${E}-${v}`];if($)return`<td class="tam-cell is-spanned" data-row="${E}" data-col="${v}">
                ...
                </td>`}).join("")}</tr>`).join(""),s.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(w=>{w.addEventListener("change",()=>{const E=parseInt(w.dataset.row),L=parseInt(w.dataset.col),h=Math.max(1,parseInt(w.value)||1);l.rows[E]?.[L]&&(w.dataset.action==="colspan"?l.rows[E][L].colspan=Math.min(h,g-L):l.rows[E][L].rowspan=Math.min(h,k-E),d())})}),s.querySelectorAll("button[data-action]").forEach(w=>{w.addEventListener("click",E=>{E.preventDefault(),E.stopPropagation();const L=w.dataset.action,h=parseInt(w.dataset.row),v=parseInt(w.dataset.col);if(!(isNaN(h)||isNaN(v)||!l.rows[h]?.[v])){if(L==="header"){l.rows[h][v].isHeader=!l.rows[h][v].isHeader;const $=s.querySelector(`td[data-row="${h}"][data-col="${v}"]`);$&&($.dataset.isheader=l.rows[h][v].isHeader?"1":"0",$.classList.toggle("is-header-cell",l.rows[h][v].isHeader)),w.classList.toggle("active",l.rows[h][v].isHeader),w.textContent=l.rows[h][v].isHeader?"✓ Etiqueta":"Etiqueta";return}if(L==="image"){window.__openTableImagePicker&&window.__openTableImagePicker($=>{l.rows[h][v].image=$;const y=s.querySelector(`td[data-row="${h}"][data-col="${v}"]`);if(y){y.dataset.image=$,y.classList.add("has-image");let S=y.querySelector(".tam-cell-img-preview");S||(S=document.createElement("img"),S.className="tam-cell-img-preview",y.insertBefore(S,y.firstChild)),S.src=$;const z=y.querySelector("[data-action=image]");if(z&&(z.innerHTML='<i class="ri-image-line"></i> Cambiar'),!y.querySelector("[data-action=clear-image]")){const A=document.createElement("button");A.type="button",A.className="tam-cell-btn tam-cell-btn-clear",A.dataset.action="clear-image",A.dataset.row=h,A.dataset.col=v,A.textContent="✕ Quitar",A.addEventListener("click",Y=>{Y.preventDefault(),Y.stopPropagation(),l.rows[h][v].image=null,y.dataset.image="",y.classList.remove("has-image"),S.remove(),A.remove();const R=y.querySelector("[data-action=image]");R&&(R.innerHTML='<i class="ri-image-line"></i> Imagen')}),y.querySelector(".tam-cell-actions").appendChild(A)}}});return}L==="clear-image"&&(l.rows[h][v].image=null,u())}})})}document.getElementById("tam-close").addEventListener("click",c),document.getElementById("tam-cancel").addEventListener("click",c),a.addEventListener("click",b=>{b.target===a&&c()}),document.getElementById("tam-rebuild").addEventListener("click",()=>{const b=parseInt(document.getElementById("tam-cols").value)||3,s=parseInt(document.getElementById("tam-rows").value)||3;for(m(),p();l.headers.length<b;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,b),l.cols=b;l.rows.length<s;)l.rows.push(Array.from({length:b},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,s).map(g=>{for(;g.length<b;)g.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return g.slice(0,b)}),u()}),document.getElementById("tam-apply").addEventListener("click",()=>{p();const b=document.getElementById("tam-theme").value;r&&(r.set("tableData",JSON.parse(JSON.stringify(l))),r.set("tableTheme",b),r.addAttributes({"data-table-theme":b}),ke(r)),c()}),window.__openTableAdminModal=n}function ke(i){const e=i.get("tableData"),t=i.get("tableTheme")||"blue";e&&i.components(Ye(We(e,t),t))}function Ui(){return function(){}}const Vi=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:Pi,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
            ...
            `,a.appendChild(r)}})}const Gi=`<svg viewBox="0 0 80 32" width="80" height="32">
...
</svg>`,qe=i=>{const e=i==="#003B71"?"blue":"orange";return`
...
</div>`},De=i=>{const e=i==="#003B71"?"blue":"orange";return`
   ...
   class="dld-simple-${e}">
    ...
    <rect x="3" y="25" width="7" height="2.5" fill="#dee2e6" rx="0.5"/>
</svg>`;function ga(){return function(){const i=this,e="agencies-map-component",t="/api/agencies/active",a="agencies";let r=[],l=[],n={},c=null,p=[];const d=async()=>{try{m(),await b(),await k(),T(),$(),A(),Y(),u()}catch(o){console.error("Error initializing map:",o),oe("Error al cargar las agencias"),u()}};function m(){const o=i.querySelector(`.${e}-list`);o&&(o.innerHTML=`
            ...
            `}function z(){const o=i.querySelectorAll(`.${e}-item`);o.forEach(f=>{f.addEventListener("click",x=>{if(x.target.closest(".agency-maps-btn"))return;x.preventDefault();const B=parseInt(f.dataset.itemIndex),j=l[B];if(!j)return;o.forEach(C=>{C.classList.remove("bg-white","border-secondary","selected-agency"),C.classList.add("bg-white/10","border-white/20");const q=C.querySelector(".agency-title"),ne=C.querySelectorAll("i"),se=C.querySelectorAll(".agency-phone-link"),me=C.querySelectorAll("p:not(:has(.agency-phone-link))"),ue=C.querySelector(".agency-maps-btn");q&&(q.classList.remove("text-secondary"),q.classList.add("text-white")),ne.forEach(V=>{V.classList.remove("text-secondary","text-gray-300","text-white"),V.classList.add("text-primary")}),se.forEach(V=>{V.classList.remove("text-secondary"),V.classList.add("text-white")}),me.forEach(V=>{V.classList.remove("text-secondary"),V.classList.add("text-gray-200")}),ue&&(ue.classList.remove("bg-secondary"),ue.classList.add("bg-primary"))}),f.classList.remove("bg-white/10","border-white/20"),f.classList.add("bg-white","border-secondary","selected-agency");const M=f.querySelector(".agency-title"),F=f.querySelectorAll("i"),G=f.querySelectorAll(".agency-phone-link"),U=f.querySelectorAll("p:not(:has(.agency-phone-link))"),O=f.querySelector(".agency-maps-btn");if(M&&(M.classList.remove("text-white"),M.classList.add("text-secondary")),F.forEach(C=>{C.classList.remove("text-secondary","text-gray-300","text-white"),C.classList.add("text-primary")}),G.forEach(C=>{C.classList.remove("text-white"),C.classList.add("text-secondary")}),U.forEach(C=>{C.classList.remove("text-gray-200"),C.classList.add("text-secondary")}),O&&(O.classList.remove("bg-primary"),O.classList.add("bg-secondary")),c&&j&&c._loaded)try{c.flyTo([j.latitude,j.longitude],14,{animate:!0,duration:1});const C=p.find(q=>q.item.id===j.id);C&&C.marker&&C.marker.openPopup()}catch(C){console.warn("Error updating map view:",C)}})})}function A(){const o=i.querySelector(`.${e}-search-input`),f=i.querySelector(`.${e}-zone-filter`),x=i.querySelector(`.${e}-department-filter`),B=i.querySelector(`.${e}-no-results`),j={Occidental:["Ahuachapán","Santa Ana","Sonsonate"],Paracentral:["Chalatenango","Cuscatlán","La Paz","Cabañas","San Vicente"],Central:["La Libertad","San Salvador"],Oriental:["Usulután","San Miguel","Morazán","La Unión"]},M=()=>{if(!f||!x)return;const G=f.value,U=x.value;if(!G)x.innerHTML='<option value="">Todos los Departamentos</option>',[...new Set(r.map(C=>C.department).filter(Boolean))].sort().forEach(C=>{const q=document.createElement("option");q.value=C,q.textContent=C,x.appendChild(q)}),U&&(x.value=U);else{const O=j[G]||[];x.innerHTML='<option value="">Todos los Departamentos</option>',O.forEach(C=>{const q=document.createElement("option");q.value=C,q.textContent=C,x.appendChild(q)}),O.includes(U)&&(x.value=U)}},F=()=>{const G=o?o.value.toLowerCase().trim():"",U=f?f.value:"",O=x?x.value:"";l=r.filter(C=>{let q=!0,ne=!0,se=!0;return G&&(q=Object.values(C).some(me=>String(me).toLowerCase().includes(G))),U&&(ne=C.zone===U),O&&(se=C.department===O),q&&ne&&se}),$(),w(),B&&B.classList.toggle("hidden",l.length>0)};o&&o.addEventListener("input",F),f&&f.addEventListener("change",()=>{M(),F()}),x&&x.addEventListener("change",F)}function Y(){const o=i.querySelector("[data-title]");if(o){const B=R("map-title")||"Nuestras Agencias";o.textContent=B}const f=i.querySelector(`.${e}-search-input`);if(f){const B=R("search-placeholder")||"Buscar...";f.setAttribute("placeholder",B)}const x=i.querySelector(`.${e}-no-results`);if(x){const B=R("no-results-text")||"No se encontraron agencias";x.textContent=B}}function R(o){return i.closest(`[data-gjs-type="${e}"]`)?.getAttribute(o)}function oe(o){const f=i.querySelector(`.${e}-list`);f&&(f.innerHTML=`
                ...
                `)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",d):d()}}const pa=[{id:"agencies-map",label:"Mapa de Agencias",category:"Interactivos",media:fa,content:{type:"agencies-map-component"}}];function ha(i){const e="agencies-map-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute&&t.getAttribute("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Mapa de Agencias",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{class:"py-12 bg-secondary","data-gjs-type":e},components:`
                ...
                `,script:ga()},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),ma(i,e),ua(i,e)}function ma(i,e){i.on("component:selected",t=>{if(t.get("type")===e){const a=t.getEl();if(a){const r=a.querySelector(`.${e}-map`);r&&r._map&&setTimeout(()=>{r._map.invalidateSize()},100)}}}),i.on("storage:end:load",()=>{setTimeout(()=>{Ne(i,e)},1e3)}),i.on("component:mount",t=>{const a=t.getEl();a&&a.getAttribute&&a.getAttribute("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&a&&r.call(a)},500))}),i.on("component:clone",t=>{if(t.get("type")===e){const a=t.getEl();if(a){const r=a.querySelector(`.${e}-map`);r&&r._map&&(r._map.remove(),delete r._map),setTimeout(()=>{const l=t.get("script");l&&typeof l=="function"&&l.call(a)},500)}}}),i.on("canvas:render",()=>{setTimeout(()=>{Ne(i,e)},800)}),i.on("storage:start:store",()=>{i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(r=>{r.set("type",e),r.addAttributes({"data-gjs-type":e})})})}function Ne(i,e){i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(r=>{r.set("type",e);const l=r.getEl();if(l&&l.isConnected){const n=r.get("script");n&&typeof n=="function"&&n.call(l)}})}function ua(i,e){i.on("load",()=>{const t=i.Canvas.getFrameEl();if(!t)return;const a=t.contentDocument.head;if(!a.querySelector("#leaflet-css")){const r=document.createElement("link");r.id="leaflet-css",r.rel="stylesheet",r.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",a.appendChild(r)}if(!a.querySelector(`#${e}-css`)){const r=document.createElement("style");r.id=`${e}-css`,r.innerHTML=`
                .leaflet-container {
                    height: 100%;
                    width: 100%;
            ...
            `,a.appendChild(r)}})}const ba=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
@media(max-width:480px){
    .banner-btn{flex:1 1 100%;min-width:0;}
            ...
            `).join(""),L(),h(),v()}function L(){i.querySelectorAll(".banner-btn").forEach(o=>{const f=o.style.borderColor;o.addEventListener("mouseenter",()=>{o.style.background=o.dataset.hoverBg,o.style.color=o.dataset.hoverColor,o.style.borderColor=o.dataset.hoverBg}),o.addEventListener("mouseleave",()=>{o.style.background=o.dataset.bg,o.style.color=o.dataset.color,o.style.borderColor=f})})}function h(){s.addEventListener("mousedown",$),s.addEventListener("touchstart",$,{passive:!0}),s.addEventListener("mousemove",y),s.addEventListener("touchmove",y,{passive:!0}),s.addEventListener("mouseup",S),s.addEventListener("touchend",S),s.addEventListener("mouseleave",S)}function v(){r.forEach(o=>{const f=new Image;f.src=o.image_url})}function $(o){c=!0,p=o.touches?o.touches[0].clientX:o.clientX,d=0}function y(o){c&&(d=(o.touches?o.touches[0].clientX:o.clientX)-p)}function S(){c&&(c=!1,Math.abs(d)>=m&&(A(d<0?(l+1)%r.length:(l-1+r.length)%r.length),R()),d=0)}function z(){const o=i.querySelector(".banner-stripe");if(!o||r.length<=1)return;const f=document.createElement("div");f.className="banner-dots",r.forEach((x,B)=>{const j=document.createElement("button");j.className="banner-dot",j.dataset.index=String(B),j.setAttribute("aria-label",`Banner ${B+1}`),j.addEventListener("click",()=>{A(B),R()}),f.appendChild(j)}),o.innerHTML="",o.appendChild(f)}function A(o,f=!0){const x=s.querySelectorAll(".banner-slide"),B=i.querySelectorAll(".banner-dot");x.forEach((j,M)=>{const F=M===o;f||(j.style.transition="none"),j.classList.toggle("banner-slide--active",F),f||requestAnimationFrame(()=>{j.style.transition=""})}),B.forEach((j,M)=>{j.classList.toggle("banner-dot--active",M===o)}),l=o}function Y(){r.length<=1||!u||(n=setInterval(()=>{A((l+1)%r.length)},5e3))}function R(){u&&(clearInterval(n),Y())}function oe(){const o=i.querySelector(".banner-wrapper");o&&(o.innerHTML=`
                ...
                `,script:ya(),traits:[{type:"select",name:"data-autoplay",label:"Avance automático",options:[{id:"true",name:"Activado"},{id:"false",name:"Desactivado"}],changeProp:!1},{type:"select",name:"data-category",label:"Filtrar por categoría",options:[{id:"",name:"Todas las categorías"}],changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",()=>{const t=this.getEl();if(!t)return;const a=this.get("script");a&&typeof a=="function"&&setTimeout(()=>a.call(t),100)})}}}),Ba(i,e),Ea(i,e),ka(i,e)}async function ka(i,e){try{const t=document.querySelector('meta[name="api-banners-url"]')?.content??"/api/banners/active",r=await(await fetch(t)).json();if(!Array.isArray(r))return;const l=[...new Set(r.map(d=>d.category).filter(Boolean))].sort();if(l.length===0)return;const n=i.DomComponents.getType(e);if(!n)return;const p=n.model.prototype.defaults.traits.find(d=>d.name==="data-category");if(!p)return;p.options=[{id:"",name:"Todas las categorías"},...l.map(d=>({id:d,name:d}))]}catch{}}function Ba(i,e){i.on("storage:end:load",()=>{setTimeout(()=>Oe(i,e),1e3)}),i.on("component:mount",t=>{const a=t.getEl();a?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},500))}),i.on("component:clone",t=>{if(t.get("type")===e){const a=t.getEl();a&&setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},500)}}),i.on("canvas:render",()=>{setTimeout(()=>Oe(i,e),800)}),i.on("storage:start:store",()=>{i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e),t.addAttributes({"data-gjs-type":e})})})}function Oe(i,e){i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e);const a=t.getEl();if(a?.isConnected){const r=t.get("script");r&&typeof r=="function"&&r.call(a)}})}function Ea(i,e){i.on("load",()=>{const t=i.Canvas.getFrameEl();if(!t)return;const a=t.contentDocument?.head;if(a){if(!a.querySelector("#banner-hero-styles")){const r=document.createElement("style");r.id="banner-hero-styles",r.textContent=xa,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=`
                [data-gjs-type="${e}"] * { pointer-events: none !important; }
                [data-gjs-type="${e}"].gjs-selected,
                [data-gjs-type="${e}"].gjs-hovered {
            ...
            `,a.appendChild(r)}}})}const $a=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
    <rect x="1" y="6" width="30" height="20" fill="#003B71" rx="2"/>
    <rect x="1" y="22" width="30" height="4" fill="#E97300" rx="0"/>
    <rect x="3" y="9" width="12" height="2" fill="rgba(255,255,255,0.9)" rx="1"/>
...
@media(max-width:480px){
    .bsingle-btn{flex:1 1 100%;min-width:0;}
                ...
                </div>`}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()}}const La=[{id:"banner-single",label:"Banner Individual",category:"Banners",media:$a,content:{type:"banner-single-component"}}];function ja(i){const e="banner-single-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner Individual",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-banner-id":""},components:`
                ...
                `,script:Sa(),traits:[{type:"select",name:"data-banner-id",label:"Banner a mostrar",options:[{id:"",name:"Cargando banners..."}],changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",()=>{const t=this.getEl();if(!t)return;const a=this.get("script");a&&typeof a=="function"&&setTimeout(()=>a.call(t),100)})}}}),Ta(i,e),za(i,e),_a(i,e)}async function _a(i,e){try{const t=document.querySelector('meta[name="api-banners-url"]')?.content??"/api/banners/active",r=await(await fetch(t)).json();if(!Array.isArray(r)||r.length===0)return;const l=i.DomComponents.getType(e);if(!l)return;const c=l.model.prototype.defaults.traits.find(p=>p.name==="data-banner-id");if(!c)return;c.options=[{id:"",name:"— Seleccionar banner —"},...r.map(p=>({id:String(p.id),name:p.category?`[${p.category}] ${p.title}`:p.title}))]}catch{}}function Ta(i,e){i.on("storage:end:load",()=>{setTimeout(()=>Pe(i,e),1e3)}),i.on("component:mount",t=>{const a=t.getEl();a?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},500))}),i.on("component:clone",t=>{if(t.get("type")===e){const a=t.getEl();a&&setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},500)}}),i.on("canvas:render",()=>{setTimeout(()=>Pe(i,e),800)}),i.on("storage:start:store",()=>{i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e),t.addAttributes({"data-gjs-type":e})})})}function Pe(i,e){i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e);const a=t.getEl();if(a?.isConnected){const r=t.get("script");r&&typeof r=="function"&&r.call(a)}})}function za(i,e){i.on("load",()=>{const t=i.Canvas.getFrameEl();if(!t)return;const a=t.contentDocument?.head;if(a){if(!a.querySelector("#banner-single-styles")){const r=document.createElement("style");r.id="banner-single-styles",r.textContent=Ca,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=`
                [data-gjs-type="${e}"] * { pointer-events: none !important; }
                [data-gjs-type="${e}"].gjs-selected,
                [data-gjs-type="${e}"].gjs-hovered {
                    outline: 2px dashed rgba(240,135,42,0.6) !important;
            ...
            `,a.appendChild(r)}}})}function Ia(i){_.registerBlocks(mt),_.registerBlocks(Et),_.registerBlocks(va),_.registerBlocks(La),_.registerBlocks(ki),_.registerBlocks(ni),_.registerBlocks(_t),_.registerBlocks(Jt),_.registerBlocks(Qt),_.registerBlocks(Nt),_.registerBlocks(xi),_.registerBlocks(Ht),_.registerBlocks(ii),_.registerBlocks($i),_.registerBlocks(ji),_.registerBlocks(zi),_.registerBlocks(Di),_.registerBlocks(Oi),_.registerBlocks(Vi),_.registerBlocks(la),_.registerBlocks(da),_.registerBlocks(Ii),_.registerBlocks(pa),_.applyToEditor(i),ha(i),wa(i),ja(i),Wt(i),Dt(i),oa(i),si(i),Xi(i)}function Aa(i,e,t){i.on("component:add",()=>e.markAsDirty()),i.on("component:remove",()=>e.markAsDirty()),i.on("component:update",()=>e.markAsDirty()),i.on("style:update",()=>e.markAsDirty());const a=document.getElementById("save-button");a&&a.addEventListener("click",async()=>{await qa(i,e,t,a)}),document.addEventListener("keydown",r=>{(r.ctrlKey||r.metaKey)&&r.key==="s"&&(r.preventDefault(),a&&!a.disabled&&a.click())})}async function qa(i,e,t,a){a.disabled=!0,a.innerHTML='<i class="ri-loader-4-line animate-spin"></i><span>Guardando...</span>';try{t.needsTitle()?await Da(i,e,t):await Ge(i,e,t)}catch(r){Je(r.message,"error")}finally{a.disabled=!1,a.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}}async function Da(i,e,t){return new Promise((a,r)=>{Ke({title:"Título de la Página",description:"Ingresa un título descriptivo para identificar esta página",placeholder:"Ej: Acerca de Nosotros",icon:"ri-file-text-line",iconBg:"#dbeafe",iconColor:"#2563eb",confirmLabel:"Guardar",onConfirm:async l=>{if(!l?.trim()){r(new Error("El título es obligatorio"));return}try{await Ge(i,e,t,l),a()}catch(n){r(n)}},onCancel:()=>{r(new Error("Guardado cancelado"))}})})}async function Ge(i,e,t,a=null){const l={...e.getEditorContent(i),is_published:t.isPublished};a&&(l.title=a);const n=await e.savePage(i,l,t.storeUrl,t.getHttpMethod());n.success&&(e.markAsClean(),Je(n.message,"success"),!t.isEditMode&&n.page?(t.updatePageInfo(n),t.updateTitle(n.page.title)):a&&t.updateTitle(a))}function Je(i,e){typeof window.showNotification=="function"&&window.showNotification(i,e)}document.addEventListener("DOMContentLoaded",async()=>{const i=new Qe,e=new ft;new gt(i);const t=et();if(t.on("load",()=>{Ia(t),tt(t),it(),at(),rt(t),lt(t),ot(t),nt(t),st(t),ct(t),Ma(t),Na(t),Oa(t),setTimeout(()=>{t.runCommand("sw-visibility"),t.Panels.getButton("options","sw-visibility")?.set("active",!0)},100)}),e.isEditMode)try{await i.loadPageContent(t,e.loadUrl),He("Contenido cargado correctamente","success")}catch(a){He("Error al cargar el contenido","error"),console.error(a)}Aa(t,i,e)});function Ma(i){const e=[{cmd:"set-device-desktop",device:"Desktop"},{cmd:"set-device-tablet",device:"Tablet"},{cmd:"set-device-mobile",device:"Mobile"}];e.forEach(({cmd:t,device:a})=>{i.Commands.add(t,{run:r=>{r.setDevice(a),e.forEach(({cmd:l})=>{r.Panels.getButton("devices-c",l)?.set("active",l===t)})}})})}function Na(i){i.Commands.add("canvas-clear",{run:e=>{dt({title:"Limpiar canvas",description:"¿Estás seguro de que quieres eliminar todo el contenido del canvas? Esta acción no se puede deshacer.",icon:"ri-delete-bin-line",iconBg:"#fef2f2",iconColor:"#dc2626",confirmLabel:"Limpiar todo",confirmColor:"#dc2626",onConfirm:()=>{e.DomComponents.clear(),e.CssComposer.clear()}})}})}function Oa(i){const e=i.Canvas.getFrameEl();if(!e?.contentDocument?.head)return;const t=e.contentDocument.createElement("style");t.id="gjs-dashed-fix",t.textContent="body,body.gjs-dashed{margin:0!important;padding:0 0 160px 0!important;}",e.contentDocument.head.appendChild(t)}function He(i,e="info"){typeof window.showNotification=="function"&&window.showNotification(i,e)}
