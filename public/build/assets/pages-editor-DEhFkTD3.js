...
${G}`},{id:"columns-3",label:"3 Columnas",category:"Columnas",media:jt,content:`
<div class="col-section">
...
${G}`},{id:"columns-4",label:"4 Columnas",category:"Columnas",media:_t,content:`
<div class="col-section">
...
${Le}`}],et=function(){(function(){function t(i){if(!i||i.__pcInit)return;i.__pcInit=!0;var a=i.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,n=0,c=!1,h=0,d=0,m=0,u=null;a.querySelectorAll("img").forEach(function(p){p.setAttribute("draggable","false")}),setTimeout(function(){var p=a.scrollWidth-a.clientWidth;if(p<=0)return;var v=Math.min(60,p),$=null;function y(L){$||($=L);var z=(L-$)/400;if(z<.5)a.scrollLeft=v*(z*2);else if(z<1)a.scrollLeft=v*(1-(z-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(y)}requestAnimationFrame(y)},400),a.scrollLeft=0;function b(){return a.scrollWidth-a.clientWidth}function s(p){return Math.max(0,Math.min(p,b()))}function g(){Math.abs(h)<.5||(h*=.92,a.scrollLeft=s(a.scrollLeft+h),u=requestAnimationFrame(g))}a.addEventListener("mousedown",function(p){p.button===0&&(u&&(cancelAnimationFrame(u),u=null),r=!0,c=!1,h=0,l=p.clientX,d=p.clientX,m=Date.now(),n=a.scrollLeft,a.style.cursor="grabbing",p.preventDefault())}),document.addEventListener("mousemove",function(p){if(r){var v=l-p.clientX;Math.abs(v)>3&&(c=!0);var $=Date.now(),y=$-m||1;h=(p.clientX-d)/y*16*-1,d=p.clientX,m=$,a.scrollLeft=s(n+v)}}),document.addEventListener("mouseup",function(p){r&&(r=!1,a.style.cursor="grab",c&&(p.stopPropagation(),u=requestAnimationFrame(g)))}),a.addEventListener("click",function(p){c&&(p.preventDefault(),p.stopPropagation(),c=!1)},!0);var k=0,I=0,w=0,E=0,j=0;a.addEventListener("touchstart",function(p){u&&(cancelAnimationFrame(u),u=null),k=p.touches[0].clientX,w=p.touches[0].clientX,E=Date.now(),I=a.scrollLeft,j=0},{passive:!0}),a.addEventListener("touchmove",function(p){var v=Date.now(),$=v-E||1,y=p.touches[0].clientX;j=(y-w)/$*16*-1,w=y,E=v;var L=k-y;a.scrollLeft=s(I+L)},{passive:!0}),a.addEventListener("touchend",function(){u=requestAnimationFrame(function p(){Math.abs(j)<.5||(j*=.92,a.scrollLeft=s(a.scrollLeft+j),u=requestAnimationFrame(p))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(i){delete i.__pcInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Ht=`(${et.toString()})();`,Ft=`
...
@media(max-width:480px){.pc-card{flex:0 0 80vw;}}`;function Ut(t){const e=t.img||N("images/placeholder.svg"),i=t.title||"TÍTULO DEL PRODUCTO",a=t.desc||"Descripción breve del producto financiero.",r=t.href||"#",l=t.btn_label||"Solicitar";return`<div class="pc-card"><div class="pc-card-img-wrap"><img src="${e}" alt="${i}" class="pc-card-img"></div><div class="pc-card-body"><h3 class="pc-card-title">${i}</h3><p class="pc-card-desc">${a}</p></div><a href="${r}" class="pc-btn">${l}</a></div>`}function tt(t){const e=t.heading||"Créditos",i=t.subheading||"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",a=t.more_href||"#",r=t.more_label||"Ver más",l=t.show_more!==!1,c=(t.cards||[]).map(Ut).join(""),h=l?`<div class="pc-more-wrap"><a href="${a}" class="pc-more-btn">${r}</a></div>`:"";return`<section class="pc-section"><style>${Ft}</style><div style="text-align:center;margin-bottom:2rem;"><h2 class="pc-section-heading">${e}</h2><p class="pc-section-subheading">${i}</p></div><div class="pc-carousel-wrap"><div class="pc-track">${c}</div></div>${h}</section>`}const H={heading:"Créditos",subheading:"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CREDINVIERTE",desc:"Adquiere activos fijos",href:"#",btn_label:"Solicitar"},{img:"",title:"SOLUCIONES INTEGRALES",desc:"Financiamiento PYME",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDI-CONFIAMOS",desc:"Rápido y sin fiador",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDILÍNEA",desc:"Línea rotativa",href:"#",btn_label:"Solicitar"}]};function Vt(t,e){const i=document.getElementById("pc-config-modal");if(i&&i.remove(),!document.getElementById("pc-modal-styles")){const d=document.createElement("style");d.id="pc-modal-styles",d.textContent=`
        ...
        <div class="pc-modal-footer">
            ...
            <button id="pc-modal-save" class="pc-btn-save"><i class="ri-check-line"></i> Aplicar cambios</button>
        </div>`,l.appendChild(n),document.body.appendChild(l),n.querySelectorAll(".pc-tab-btn").forEach(d=>{d.addEventListener("click",()=>{n.querySelectorAll(".pc-tab-btn").forEach(m=>m.classList.remove("active")),n.querySelectorAll(".pc-tab-panel").forEach(m=>m.classList.remove("active")),d.classList.add("active"),n.querySelector(`#pc-panel-${d.dataset.tab}`).classList.add("active")})}),n.querySelector("#pc-show-more").addEventListener("change",function(){r.show_more=this.checked,n.querySelector("#pc-more-fields").style.display=this.checked?"flex":"none"});function c(){const d=n.querySelector("#pc-cards-list");d.innerHTML="",r.cards.forEach((m,u)=>{const b=document.createElement("div");b.className="pc-card-config";const s=m.img?`<img class="pc-img-preview" src="${m.img}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>';b.innerHTML=`
                ...
                </div>`,b.querySelectorAll("[data-field]").forEach(g=>{g.addEventListener("input",()=>{if(m[g.dataset.field]=g.value,g.dataset.field==="img"){const k=b.querySelector(`#pc-img-wrap-${u}`);k.innerHTML=g.value?`<img class="pc-img-preview" src="${g.value}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>'}})}),b.querySelector(".pc-pick-img").addEventListener("click",()=>{Qe({type:"image",title:"Seleccionar imagen de tarjeta",onSelect:g=>{m.img=g,b.querySelector("[data-field='img']").value=g,b.querySelector(`#pc-img-wrap-${u}`).innerHTML=`<img class="pc-img-preview" src="${g}" alt="">`}})}),b.querySelector(".pc-remove-card").addEventListener("click",()=>{r.cards.splice(u,1),c()}),d.appendChild(b)})}c(),n.querySelector("#pc-add-card").addEventListener("click",()=>{r.cards.push({img:"",title:"NUEVO PRODUCTO",desc:"Descripción del producto.",href:"#",btn_label:"Solicitar"}),c(),n.querySelector("#pc-cards-list").lastElementChild?.scrollIntoView({behavior:"smooth",block:"nearest"})});const h=()=>l.remove();n.querySelector("#pc-modal-close").addEventListener("click",h),n.querySelector("#pc-modal-cancel").addEventListener("click",h),l.addEventListener("click",d=>{d.target===l&&h()}),n.querySelector("#pc-modal-save").addEventListener("click",()=>{r.heading=n.querySelector("#pc-heading").value.trim()||H.heading,r.subheading=n.querySelector("#pc-subheading").value.trim()||H.subheading,r.show_more=n.querySelector("#pc-show-more").checked,r.more_label=n.querySelector("#pc-more-label").value.trim()||H.more_label,r.more_href=n.querySelector("#pc-more-href").value.trim()||"#",e.addAttributes({"data-product-cards-config":JSON.stringify(r)}),e.components(tt(r)),setTimeout(()=>xe(t),300),h()})}function xe(t){try{const e=t.Canvas.getFrameEl()?.contentDocument;if(!e)return;const i=e.getElementById("pc-runtime-script");i&&i.remove(),e.querySelectorAll(".pc-section").forEach(r=>{delete r.__pcInit});const a=e.createElement("script");a.id="pc-runtime-script",a.textContent=Ht,e.head.appendChild(a)}catch(e){console.warn("[ProductCards] Error reiniciando carrusel:",e)}}const Xt=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
${Be}`},{id:"dual-card-dark",label:"Tarjeta azul oscuro",category:"Productos y Servicios",media:`<svg viewBox="0 0 32 32" width="32" height="32">
        ...
        </svg>`,content:`${je}${Be}`},{id:"dual-card-light",label:"Tarjeta blanca",category:"Productos y Servicios",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
        ...
        </svg>`,content:`${_e}${Be}`}],Jt=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
${Zt}`}],it=function(){(function(){function t(i){if(!i||i.__savInit)return;i.__savInit=!0;var a=i.querySelector(".sav-carousel-wrap");if(!a)return;a.scrollLeft=0;var r=!1,l=0,n=0,c=!1,h=0,d=0,m=0,u=null;a.querySelectorAll("img").forEach(function(p){p.setAttribute("draggable","false")}),setTimeout(function(){var p=a.scrollWidth-a.clientWidth;if(p<=0)return;var v=Math.min(60,p),$=null;function y(L){$||($=L);var z=(L-$)/400;if(z<.5)a.scrollLeft=v*(z*2);else if(z<1)a.scrollLeft=v*(1-(z-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(y)}requestAnimationFrame(y)},400);function b(){return a.scrollWidth-a.clientWidth}function s(p){return Math.max(0,Math.min(p,b()))}function g(){Math.abs(h)<.5||(h*=.92,a.scrollLeft=s(a.scrollLeft+h),u=requestAnimationFrame(g))}a.addEventListener("mousedown",function(p){p.button===0&&(u&&(cancelAnimationFrame(u),u=null),r=!0,c=!1,h=0,l=p.clientX,d=p.clientX,m=Date.now(),n=a.scrollLeft,a.style.cursor="grabbing",p.preventDefault())}),document.addEventListener("mousemove",function(p){if(r){var v=l-p.clientX;Math.abs(v)>3&&(c=!0);var $=Date.now(),y=$-m||1;h=(p.clientX-d)/y*16*-1,d=p.clientX,m=$,a.scrollLeft=s(n+v)}}),document.addEventListener("mouseup",function(p){r&&(r=!1,a.style.cursor="grab",c&&(p.stopPropagation(),u=requestAnimationFrame(g)))}),a.addEventListener("click",function(p){c&&(p.preventDefault(),p.stopPropagation(),c=!1)},!0);var k=0,I=0,w=0,E=0,j=0;a.addEventListener("touchstart",function(p){u&&(cancelAnimationFrame(u),u=null),k=p.touches[0].clientX,w=p.touches[0].clientX,E=Date.now(),I=a.scrollLeft,j=0},{passive:!0}),a.addEventListener("touchmove",function(p){var v=Date.now(),$=v-E||1,y=p.touches[0].clientX;j=(y-w)/$*16*-1,w=y,E=v;var L=k-y;a.scrollLeft=s(I+L)},{passive:!0}),a.addEventListener("touchend",function(){u=requestAnimationFrame(function p(){Math.abs(j)<.5||(j*=.92,a.scrollLeft=s(a.scrollLeft+j),u=requestAnimationFrame(p))})},{passive:!0})}function e(){document.querySelectorAll(".sav-section").forEach(function(i){delete i.__savInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Qt=`(${it.toString()})();`,ei=`
...
@media(max-width:480px){.sav-card{flex:0 0 75vw;}}`;function ti(t){const e=t.img||N("images/placeholder.svg"),i=t.title||"TÍTULO DEL PRODUCTO",a=t.desc?`<p class="sav-card-desc">${t.desc}</p>`:"",r=t.href||"#",l=t.btn_label||"Solicitar";return`<div class="sav-card"><div class="sav-card-img-wrap"><img src="${e}" alt="${i}" class="sav-card-img"></div><h3 class="sav-card-title">${i}</h3>${a}<a href="${r}" class="sav-btn">${l}</a></div>`}function at(t){const e=t.heading||"Depósitos y Cuentas de Ahorro",i=t.subheading||"Productos diseñados para hacer crecer tu dinero de forma segura.",a=t.more_href||"#",r=t.more_label||"Ver más",l=t.show_more!==!1,c=(t.cards||[]).map(ti).join(""),h=N("images/brand-watermark.png"),d=l?`<div class="sav-more-wrap"><a href="${a}" class="sav-more-btn">${r}</a></div>`:"";return`<section class="sav-section"><style>${ei}</style><div class="sav-blue-box"><div class="sav-watermark"><img src="${h}" alt=""></div><div style="display:flex;flex-direction:column;gap:0.5rem;text-align:center;position:relative;z-index:1;"><h2 class="sav-heading">${e}</h2><p class="sav-subheading">${i}</p></div><div class="sav-carousel-wrap"><div class="sav-track">${c}</div></div>${d}</div></section>`}const F={heading:"Depósitos y Cuentas de Ahorro",subheading:"Productos diseñados para hacer crecer tu dinero de forma segura.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CUENTA DE AHORRO ESTÁNDAR",href:"#",btn_label:"Solicitar"},{img:"",title:"AHORRO RENTABLE",href:"#",btn_label:"Solicitar"},{img:"",title:"CUENTA DE AHORRO MÁS",href:"#",btn_label:"Solicitar"},{img:"",title:"DEPÓSITO DE PLAZO FIJO",href:"#",btn_label:"Solicitar"}]};function ii(t,e){const i=document.getElementById("sav-config-modal");if(i&&i.remove(),!document.getElementById("sav-modal-styles")){const d=document.createElement("style");d.id="sav-modal-styles",d.textContent=`
        ...
        <div class="sav-modal-footer">
            ...
            <button id="sav-modal-save" class="sav-btn-save"><i class="ri-check-line"></i> Aplicar cambios</button>
        </div>`,l.appendChild(n),document.body.appendChild(l),l.addEventListener("click",d=>{d.target===l&&h()}),n.querySelectorAll(".sav-tab-btn").forEach(d=>{d.addEventListener("click",()=>{n.querySelectorAll(".sav-tab-btn").forEach(m=>m.classList.remove("active")),n.querySelectorAll(".sav-tab-panel").forEach(m=>m.classList.remove("active")),d.classList.add("active"),n.querySelector(`#sav-panel-${d.dataset.tab}`).classList.add("active")})}),n.querySelector("#sav-show-more").addEventListener("change",function(){r.show_more=this.checked,n.querySelector("#sav-more-fields").style.display=this.checked?"flex":"none"});function c(){const d=n.querySelector("#sav-cards-list");d.innerHTML="",r.cards.forEach((m,u)=>{const b=document.createElement("div");b.className="sav-card-config";const s=m.img?`<img class="sav-img-preview" src="${m.img}" alt="">`:'<div class="sav-img-placeholder"><i class="ri-image-line"></i></div>';b.innerHTML=`
                ...
                </div>`,b.querySelectorAll("[data-field]").forEach(g=>{g.addEventListener("input",()=>{if(m[g.dataset.field]=g.value,g.dataset.field==="img"){const k=b.querySelector(`#sav-img-wrap-${u}`);k.innerHTML=g.value?`<img class="sav-img-preview" src="${g.value}" alt="">`:'<div class="sav-img-placeholder"><i class="ri-image-line"></i></div>'}})}),b.querySelector(".sav-pick-img").addEventListener("click",()=>{Qe({type:"image",title:"Seleccionar imagen de tarjeta",onSelect:g=>{m.img=g,b.querySelector("[data-field='img']").value=g,b.querySelector(`#sav-img-wrap-${u}`).innerHTML=`<img class="sav-img-preview" src="${g}" alt="">`}})}),b.querySelector(".sav-remove-card").addEventListener("click",()=>{r.cards.splice(u,1),c()}),d.appendChild(b)})}c(),n.querySelector("#sav-add-card").addEventListener("click",()=>{r.cards.push({img:"",title:"NUEVO PRODUCTO",desc:"",href:"#",btn_label:"Solicitar"}),c(),n.querySelector("#sav-cards-list").lastElementChild?.scrollIntoView({behavior:"smooth",block:"nearest"})});const h=()=>l.remove();n.querySelector("#sav-modal-close").addEventListener("click",h),n.querySelector("#sav-modal-cancel").addEventListener("click",h),n.querySelector("#sav-modal-save").addEventListener("click",()=>{r.heading=n.querySelector("#sav-heading").value.trim()||F.heading,r.subheading=n.querySelector("#sav-subheading").value.trim()||F.subheading,r.show_more=n.querySelector("#sav-show-more").checked,r.more_label=n.querySelector("#sav-more-label").value.trim()||F.more_label,r.more_href=n.querySelector("#sav-more-href").value.trim()||"#",e.addAttributes({"data-savings-config":JSON.stringify(r)}),e.components(at(r)),setTimeout(()=>ye(t),300),h()})}function ye(t){try{const e=t.Canvas.getFrameEl()?.contentDocument;if(!e)return;const i=e.getElementById("sav-runtime-script");i&&i.remove(),e.querySelectorAll(".sav-section").forEach(r=>{delete r.__savInit});const a=e.createElement("script");a.id="sav-runtime-script",a.textContent=Qt,e.head.appendChild(a)}catch(e){console.warn("[Savings] Error reiniciando carrusel:",e)}}const ai=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
</svg>`;function ri(t){const e="savings-section-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección Fondo Azul",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-savings-config":JSON.stringify(F)},components:at(F),script:it,"script-props":["data-savings-config"],traits:[{type:"button",label:"Sección",text:"Administrar Sección",full:!0,command:"open-savings-config"}],toolbar:[]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-savings-config",{run(i){const a=i.getSelected();a&&ii(i,a)}}),t.BlockManager.add("savings-section-block",{label:"Sección Fondo Azul",category:"Productos y Servicios",media:ai,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),t.on("component:mount",i=>{i.getEl()?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>ye(t),400))}),t.on("component:selected",i=>{const a=i.getEl();if(!a)return;const r=a.closest(`[data-gjs-type="${e}"]`);if(r&&!a.hasAttribute("data-gjs-type")){const l=t.getWrapper().find(`[data-gjs-type="${e}"]`).find(n=>n.getEl()===r);l&&setTimeout(()=>t.select(l),0)}}),t.on("canvas:render",()=>setTimeout(()=>ye(t),600)),t.on("storage:end:load",()=>setTimeout(()=>ye(t),800))}const Te=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
${Ee}`},{id:"product-link-card-orange",label:"Tarjeta producto naranja",category:"Productos y Servicios",media:Te,media:li,content:`${ee}${Ee}`},{id:"product-link-card-blue",label:"Tarjeta producto azul",category:"Productos y Servicios",media:oi,content:`${te}${Ee}`}],si=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
`);return`
            ...
            `,a.appendChild(r)}}})}const Si=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</div>`,_i=t=>{const e=t==="light";return`
<div class="flex flex-col gap-4">
    <h2 class="text-4xl font-bold leading-tight flex flex-wrap items-center gap-2">
...
${Ne}`},{id:"service-card-item",label:"Ítem de servicio con icono",category:"Productos y Servicios",media:Oi,content:`${re}${Ne}`}],Ri=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<section class="ci-section">
    <div class="ci-row-wrap">
        <div class="ci-pill-row">
            ${le("ri-phone-fill","Contáctenos","(503)-2250-6090","tel:+50322506090")}
            <div class="ci-divider"></div>
            ${le("ri-mail-fill","Correo","servicio.cliente@bancointegral.com","mailto:servicio.cliente@bancointegral.com")}
        </div>
    </div>
</section>
...
</style>`,ra=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</div>`,oa=[{id:"financing-section",label:"Sección de financiamiento",category:"Productos y Servicios",media:la,content:`
<section class="w-full bg-white px-16 py-12">
    <div class="flex flex-col gap-4">
...
${Fe}`},{id:"financing-card",label:"Tarjeta de financiamiento",category:"Productos y Servicios",media:ra,content:`
<div class="fc-cards-grid">
    ${ne("Lorem ipsum dolor sit amet consectetur adipiscing elit, sed do eiusmod")}
</div>
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function ma(){if(document.getElementById("tam-img-modal"))return;const t=document.createElement("div");t.id="tam-img-modal",t.innerHTML=`
        ...
        <div class="tam-container">
        ...
        </div>`,document.body.appendChild(a);let r=null,l=null;function n(b){r=b;const s=b.get("tableData");l=s?JSON.parse(JSON.stringify(s)):Q(3,3);const g=l.cols||3;l.rows=l.rows.map((k,I)=>Array.from({length:g},(E,j)=>k[j]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})),document.getElementById("tam-title").value=l.title||"",document.getElementById("tam-theme").value=b.get("tableTheme")||"blue",document.getElementById("tam-cols").value=l.cols||3,document.getElementById("tam-rows").value=l.rows.length||3,m(),u(),a.classList.add("open"),document.body.style.overflow="hidden"}function c(){a.classList.remove("open"),document.body.style.overflow="",r=null}function h(){l.title=document.getElementById("tam-title").value.trim(),l.cols=parseInt(document.getElementById("tam-cols").value)||3,l.headers=Array.from(document.querySelectorAll(".tam-header-input")).map(s=>({text:s.value,align:s.closest("th")?.querySelector(".tam-align-select")?.value||"center"})),document.querySelectorAll("#tam-tbody td.tam-cell:not(.is-spanned)").forEach(s=>{const g=parseInt(s.dataset.row),k=parseInt(s.dataset.col);l.rows[g]?.[k]&&(l.rows[g][k].text=s.querySelector(".tam-cell-input")?.value||"",l.rows[g][k].align=s.querySelector(".tam-align-select")?.value||"center",l.rows[g][k].isHeader=s.dataset.isheader==="1",l.rows[g][k].image=s.dataset.image||null)});const b=Ve(l.rows,l.cols);l.rows=l.rows.map((s,g)=>s.filter((k,I)=>!b[`${g}-${I}`]))}function d(){if(a.querySelector("#tam-rebuild-notice"))return;const s=document.createElement("div");s.id="tam-rebuild-notice",s.style.cssText="background:#fef9c3;border:1.5px solid #ca8a04;border-radius:0.5rem;padding:0.5rem 1rem;font-size:0.8rem;color:#92400e;display:flex;align-items:center;gap:0.5rem;margin:0 1.5rem 0;flex-shrink:0;",s.innerHTML='<i class="ri-error-warning-line"></i> Has modificado el colspan/rowspan. Haz clic en <strong style="margin:0 4px;">Reconstruir</strong> para aplicar los cambios de fusión.',a.querySelector(".tam-toolbar").after(s)}function m(){a.querySelector("#tam-rebuild-notice")?.remove()}function u(){const b=document.getElementById("tam-thead"),s=document.getElementById("tam-tbody"),g=l.cols,k=l.rows.length,I=Ve(l.rows,g);b.innerHTML=`<tr>${l.headers.map((w,E)=>`
            <th>
            ...
            </th>`).join("")}</tr>`,s.innerHTML=l.rows.map((w,E)=>`<tr>${Array.from({length:g},(p,v)=>{const $=I[`${E}-${v}`];if($)return`<td class="tam-cell is-spanned" data-row="${E}" data-col="${v}">
                ...
                </td>`}).join("")}</tr>`).join(""),s.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(w=>{w.addEventListener("change",()=>{const E=parseInt(w.dataset.row),j=parseInt(w.dataset.col),p=Math.max(1,parseInt(w.value)||1);l.rows[E]?.[j]&&(w.dataset.action==="colspan"?l.rows[E][j].colspan=Math.min(p,g-j):l.rows[E][j].rowspan=Math.min(p,k-E),d())})}),s.querySelectorAll("button[data-action]").forEach(w=>{w.addEventListener("click",E=>{E.preventDefault(),E.stopPropagation();const j=w.dataset.action,p=parseInt(w.dataset.row),v=parseInt(w.dataset.col);if(!(isNaN(p)||isNaN(v)||!l.rows[p]?.[v])){if(j==="header"){l.rows[p][v].isHeader=!l.rows[p][v].isHeader;const $=s.querySelector(`td[data-row="${p}"][data-col="${v}"]`);$&&($.dataset.isheader=l.rows[p][v].isHeader?"1":"0",$.classList.toggle("is-header-cell",l.rows[p][v].isHeader)),w.classList.toggle("active",l.rows[p][v].isHeader),w.textContent=l.rows[p][v].isHeader?"✓ Etiqueta":"Etiqueta";return}if(j==="image"){window.__openTableImagePicker&&window.__openTableImagePicker($=>{l.rows[p][v].image=$;const y=s.querySelector(`td[data-row="${p}"][data-col="${v}"]`);if(y){y.dataset.image=$,y.classList.add("has-image");let L=y.querySelector(".tam-cell-img-preview");L||(L=document.createElement("img"),L.className="tam-cell-img-preview",y.insertBefore(L,y.firstChild)),L.src=$;const z=y.querySelector("[data-action=image]");if(z&&(z.innerHTML='<i class="ri-image-line"></i> Cambiar'),!y.querySelector("[data-action=clear-image]")){const D=document.createElement("button");D.type="button",D.className="tam-cell-btn tam-cell-btn-clear",D.dataset.action="clear-image",D.dataset.row=p,D.dataset.col=v,D.textContent="✕ Quitar",D.addEventListener("click",Z=>{Z.preventDefault(),Z.stopPropagation(),l.rows[p][v].image=null,y.dataset.image="",y.classList.remove("has-image"),L.remove(),D.remove();const U=y.querySelector("[data-action=image]");U&&(U.innerHTML='<i class="ri-image-line"></i> Imagen')}),y.querySelector(".tam-cell-actions").appendChild(D)}}});return}j==="clear-image"&&(l.rows[p][v].image=null,u())}})})}document.getElementById("tam-close").addEventListener("click",c),document.getElementById("tam-cancel").addEventListener("click",c),a.addEventListener("click",b=>{b.target===a&&c()}),document.getElementById("tam-rebuild").addEventListener("click",()=>{const b=parseInt(document.getElementById("tam-cols").value)||3,s=parseInt(document.getElementById("tam-rows").value)||3;for(m(),h();l.headers.length<b;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,b),l.cols=b;l.rows.length<s;)l.rows.push(Array.from({length:b},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,s).map(g=>{for(;g.length<b;)g.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return g.slice(0,b)}),u()}),document.getElementById("tam-apply").addEventListener("click",()=>{h();const b=document.getElementById("tam-theme").value;r&&(r.set("tableData",JSON.parse(JSON.stringify(l))),r.set("tableTheme",b),r.addAttributes({"data-table-theme":b}),Se(r)),c()}),window.__openTableAdminModal=n}function Se(t){const e=t.get("tableData"),i=t.get("tableTheme")||"blue";e&&t.components(lt(rt(e,i),i))}function ba(){return function(){}}const xa=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:ha,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<a href="#"
   ...
   class="dld-simple-${e}">
    ...
    <rect x="3" y="25" width="7" height="2.5" fill="#dee2e6" rx="0.5"/>
</svg>`;function Oa(){return function(){const t=this,e="agencies-map-component",i="/api/agencies/active",a="agencies";let r=[],l=[],n={},c=null,h=[];const d=async()=>{try{m(),await b(),await k(),I(),$(),D(),Z(),u()}catch(o){console.error("Error initializing map:",o),ce("Error al cargar las agencias"),u()}};function m(){const o=t.querySelector(`.${e}-list`);o&&(o.innerHTML=`
                ...
                `);const f=t.querySelector(`.${e}-map-container`);f&&(f.style.opacity="0.5")}function u(){const o=t.querySelector(`.${e}-map-container`);o&&(o.style.transition="opacity 0.3s ease",o.style.opacity="1")}async function b(){try{const f=await(await fetch(i)).json(),x=a?f[a]:f;Array.isArray(x)?(r=x.filter(B=>B.latitude&&B.longitude&&!isNaN(B.latitude)&&!isNaN(B.longitude)),l=[...r],s()):(r=[],l=[])}catch(o){console.error("Error loading items:",o),r=[],l=[]}}function s(){const o=[...new Set(r.map(x=>x.zone).filter(Boolean))].sort(),f=[...new Set(r.map(x=>x.department).filter(Boolean))].sort();n={zone:o,department:f},setTimeout(()=>{const x=t.querySelector(`.${e}-filters-container`);x&&!x.hasChildNodes()&&(x.innerHTML=`
            ...
            `}function z(){const o=t.querySelectorAll(`.${e}-item`);o.forEach(f=>{f.addEventListener("click",x=>{if(x.target.closest(".agency-maps-btn"))return;x.preventDefault();const B=parseInt(f.dataset.itemIndex),_=l[B];if(!_)return;o.forEach(C=>{C.classList.remove("bg-white","border-secondary","selected-agency"),C.classList.add("bg-white/10","border-white/20");const M=C.querySelector(".agency-title"),de=C.querySelectorAll("i"),fe=C.querySelectorAll(".agency-phone-link"),we=C.querySelectorAll("p:not(:has(.agency-phone-link))"),ke=C.querySelector(".agency-maps-btn");M&&(M.classList.remove("text-secondary"),M.classList.add("text-white")),de.forEach(Y=>{Y.classList.remove("text-secondary","text-gray-300","text-white"),Y.classList.add("text-primary")}),fe.forEach(Y=>{Y.classList.remove("text-secondary"),Y.classList.add("text-white")}),we.forEach(Y=>{Y.classList.remove("text-secondary"),Y.classList.add("text-gray-200")}),ke&&(ke.classList.remove("bg-secondary"),ke.classList.add("bg-primary"))}),f.classList.remove("bg-white/10","border-white/20"),f.classList.add("bg-white","border-secondary","selected-agency");const P=f.querySelector(".agency-title"),V=f.querySelectorAll("i"),K=f.querySelectorAll(".agency-phone-link"),X=f.querySelectorAll("p:not(:has(.agency-phone-link))"),R=f.querySelector(".agency-maps-btn");if(P&&(P.classList.remove("text-white"),P.classList.add("text-secondary")),V.forEach(C=>{C.classList.remove("text-secondary","text-gray-300","text-white"),C.classList.add("text-primary")}),K.forEach(C=>{C.classList.remove("text-white"),C.classList.add("text-secondary")}),X.forEach(C=>{C.classList.remove("text-gray-200"),C.classList.add("text-secondary")}),R&&(R.classList.remove("bg-primary"),R.classList.add("bg-secondary")),c&&_&&c._loaded)try{c.flyTo([_.latitude,_.longitude],14,{animate:!0,duration:1});const C=h.find(M=>M.item.id===_.id);C&&C.marker&&C.marker.openPopup()}catch(C){console.warn("Error updating map view:",C)}})})}function D(){const o=t.querySelector(`.${e}-search-input`),f=t.querySelector(`.${e}-zone-filter`),x=t.querySelector(`.${e}-department-filter`),B=t.querySelector(`.${e}-no-results`),_={Occidental:["Ahuachapán","Santa Ana","Sonsonate"],Paracentral:["Chalatenango","Cuscatlán","La Paz","Cabañas","San Vicente"],Central:["La Libertad","San Salvador"],Oriental:["Usulután","San Miguel","Morazán","La Unión"]},P=()=>{if(!f||!x)return;const K=f.value,X=x.value;if(!K)x.innerHTML='<option value="">Todos los Departamentos</option>',[...new Set(r.map(C=>C.department).filter(Boolean))].sort().forEach(C=>{const M=document.createElement("option");M.value=C,M.textContent=C,x.appendChild(M)}),X&&(x.value=X);else{const R=_[K]||[];x.innerHTML='<option value="">Todos los Departamentos</option>',R.forEach(C=>{const M=document.createElement("option");M.value=C,M.textContent=C,x.appendChild(M)}),R.includes(X)&&(x.value=X)}},V=()=>{const K=o?o.value.toLowerCase().trim():"",X=f?f.value:"",R=x?x.value:"";l=r.filter(C=>{let M=!0,de=!0,fe=!0;return K&&(M=Object.values(C).some(we=>String(we).toLowerCase().includes(K))),X&&(de=C.zone===X),R&&(fe=C.department===R),M&&de&&fe}),$(),w(),B&&B.classList.toggle("hidden",l.length>0)};o&&o.addEventListener("input",V),f&&f.addEventListener("change",()=>{P(),V()}),x&&x.addEventListener("change",V)}function Z(){const o=t.querySelector("[data-title]");if(o){const B=U("map-title")||"Nuestras Agencias";o.textContent=B}const f=t.querySelector(`.${e}-search-input`);if(f){const B=U("search-placeholder")||"Buscar...";f.setAttribute("placeholder",B)}const x=t.querySelector(`.${e}-no-results`);if(x){const B=U("no-results-text")||"No se encontraron agencias";x.textContent=B}}function U(o){return t.closest(`[data-gjs-type="${e}"]`)?.getAttribute(o)}function ce(o){const f=t.querySelector(`.${e}-list`);f&&(f.innerHTML=`
                ...
                `,script:Oa()},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),Ha(t,e),Fa(t,e)}function Ha(t,e){t.on("component:selected",i=>{if(i.get("type")===e){const a=i.getEl();if(a){const r=a.querySelector(`.${e}-map`);r&&r._map&&setTimeout(()=>{r._map.invalidateSize()},100)}}}),t.on("storage:end:load",()=>{setTimeout(()=>{Ge(t,e)},1e3)}),t.on("component:mount",i=>{const a=i.getEl();a&&a.getAttribute&&a.getAttribute("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&a&&r.call(a)},500))}),t.on("component:clone",i=>{if(i.get("type")===e){const a=i.getEl();if(a){const r=a.querySelector(`.${e}-map`);r&&r._map&&(r._map.remove(),delete r._map),setTimeout(()=>{const l=i.get("script");l&&typeof l=="function"&&l.call(a)},500)}}}),t.on("canvas:render",()=>{setTimeout(()=>{Ge(t,e)},800)}),t.on("storage:start:store",()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(r=>{r.set("type",e),r.addAttributes({"data-gjs-type":e})})})}function Ge(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(r=>{r.set("type",e);const l=r.getEl();if(l&&l.isConnected){const n=r.get("script");n&&typeof n=="function"&&n.call(l)}})}function Fa(t,e){t.on("load",()=>{const i=t.Canvas.getFrameEl();if(!i)return;const a=i.contentDocument.head;if(!a.querySelector("#leaflet-css")){const r=document.createElement("link");r.id="leaflet-css",r.rel="stylesheet",r.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",a.appendChild(r)}if(!a.querySelector(`#${e}-css`)){const r=document.createElement("style");r.id=`${e}-css`,r.innerHTML=`
                .leaflet-container {
                    height: 100%;
                    width: 100%;
...
@media(max-width:480px){
    .banner-btn{flex:1 1 100%;min-width:0;}
            ...
            `;const o=t.ownerDocument??document;if(!o.getElementById("banner-skeleton-styles")){const f=o.createElement("style");f.id="banner-skeleton-styles",f.textContent=`
                ...
                `,o.head.appendChild(f)}}function I(o){return i[o]?i[o]:o==="outline-blue"||o==="outline-orange"?i["outline-white"]:i["fill-white"]}function w(o,f,x,B){const _=I(x),P=f?"a":"span",V=f?`href="${f}"${B?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${P} ${V}
                class="banner-btn"
                data-bg="${_.bg}"
                data-color="${_.color}"
                data-hover-bg="${_.hoverBg}"
                data-hover-color="${_.hoverColor}"
                style="background:${_.bg};color:${_.color};border:2px solid ${_.border};">
                ${o}
            </${P}>`}function E(){s.innerHTML=r.map((o,f)=>`
            ...
            `).join(""),j(),p(),v()}function j(){t.querySelectorAll(".banner-btn").forEach(o=>{const f=o.style.borderColor;o.addEventListener("mouseenter",()=>{o.style.background=o.dataset.hoverBg,o.style.color=o.dataset.hoverColor,o.style.borderColor=o.dataset.hoverBg}),o.addEventListener("mouseleave",()=>{o.style.background=o.dataset.bg,o.style.color=o.dataset.color,o.style.borderColor=f})})}function p(){s.addEventListener("mousedown",$),s.addEventListener("touchstart",$,{passive:!0}),s.addEventListener("mousemove",y),s.addEventListener("touchmove",y,{passive:!0}),s.addEventListener("mouseup",L),s.addEventListener("touchend",L),s.addEventListener("mouseleave",L)}function v(){r.forEach(o=>{const f=new Image;f.src=o.image_url})}function $(o){c=!0,h=o.touches?o.touches[0].clientX:o.clientX,d=0}function y(o){c&&(d=(o.touches?o.touches[0].clientX:o.clientX)-h)}function L(){c&&(c=!1,Math.abs(d)>=m&&(D(d<0?(l+1)%r.length:(l-1+r.length)%r.length),U()),d=0)}function z(){const o=t.querySelector(".banner-stripe");if(!o||r.length<=1)return;const f=document.createElement("div");f.className="banner-dots",r.forEach((x,B)=>{const _=document.createElement("button");_.className="banner-dot",_.dataset.index=String(B),_.setAttribute("aria-label",`Banner ${B+1}`),_.addEventListener("click",()=>{D(B),U()}),f.appendChild(_)}),o.innerHTML="",o.appendChild(f)}function D(o,f=!0){const x=s.querySelectorAll(".banner-slide"),B=t.querySelectorAll(".banner-dot");x.forEach((_,P)=>{const V=P===o;f||(_.style.transition="none"),_.classList.toggle("banner-slide--active",V),f||requestAnimationFrame(()=>{_.style.transition=""})}),B.forEach((_,P)=>{_.classList.toggle("banner-dot--active",P===o)}),l=o}function Z(){r.length<=1||!u||(n=setInterval(()=>{D((l+1)%r.length)},5e3))}function U(){u&&(clearInterval(n),Z())}function ce(){const o=t.querySelector(".banner-wrapper");o&&(o.innerHTML=`
            ...
            `,a.appendChild(r)}}})}const Ka=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
    <rect x="1" y="6" width="30" height="20" fill="#003B71" rx="2"/>
    <rect x="1" y="22" width="30" height="4" fill="#E97300" rx="0"/>
    <rect x="3" y="9" width="12" height="2" fill="rgba(255,255,255,0.9)" rx="1"/>
...
@media(max-width:480px){
    .bsingle-btn{flex:1 1 100%;min-width:0;}
                ...
                </div>`,u()}function u(){t.querySelectorAll(".bsingle-btn").forEach(s=>{const g=s.style.borderColor;s.addEventListener("mouseenter",()=>{s.style.background=s.dataset.hoverBg,s.style.color=s.dataset.hoverColor,s.style.borderColor=s.dataset.hoverBg}),s.addEventListener("mouseleave",()=>{s.style.background=s.dataset.bg,s.style.color=s.dataset.color,s.style.borderColor=g})})}function b(){l.innerHTML=`
                <div style="display:flex;align-items:center;justify-content:center;
                            min-height:480px;color:rgba(255,255,255,0.5);font-size:14px;padding:40px;">
                    No hay banner seleccionado o no está activo.
                </div>`}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()}}const tr=[{id:"banner-single",label:"Banner Individual",category:"Banners",media:Ka,content:{type:"banner-single-component"}}];function ir(t){const e="banner-single-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner Individual",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-banner-id":""},components:`
                ...
                `,script:er(),traits:[{type:"select",name:"data-banner-id",label:"Banner a mostrar",options:[{id:"",name:"Cargando banners..."}],changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",()=>{const i=this.getEl();if(!i)return;const a=this.get("script");a&&typeof a=="function"&&setTimeout(()=>a.call(i),100)})}}}),rr(t,e),lr(t,e),ar(t,e)}async function ar(t,e){try{const i=document.querySelector('meta[name="api-banners-url"]')?.content??"/api/banners/active",r=await(await fetch(i)).json();if(!Array.isArray(r)||r.length===0)return;const l=t.DomComponents.getType(e);if(!l)return;const c=l.model.prototype.defaults.traits.find(h=>h.name==="data-banner-id");if(!c)return;c.options=[{id:"",name:"— Seleccionar banner —"},...r.map(h=>({id:String(h.id),name:h.category?`[${h.category}] ${h.title}`:h.title}))]}catch{}}function rr(t,e){t.on("storage:end:load",()=>{setTimeout(()=>Ze(t,e),1e3)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},500))}),t.on("component:clone",i=>{if(i.get("type")===e){const a=i.getEl();a&&setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},500)}}),t.on("canvas:render",()=>{setTimeout(()=>Ze(t,e),800)}),t.on("storage:start:store",()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e),i.addAttributes({"data-gjs-type":e})})})}function Ze(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}function lr(t,e){t.on("load",()=>{const i=t.Canvas.getFrameEl();if(!i)return;const a=i.contentDocument?.head;if(a){if(!a.querySelector("#banner-single-styles")){const r=document.createElement("style");r.id="banner-single-styles",r.textContent=Qa,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=`
                [data-gjs-type="${e}"] * { pointer-events: none !important; }
                [data-gjs-type="${e}"].gjs-selected,
                [data-gjs-type="${e}"].gjs-hovered {
                    outline: 2px dashed rgba(240,135,42,0.6) !important;
            ...
            `,a.appendChild(r)}}})}function or(t){T.registerBlocks(St),T.registerBlocks(Dt),T.registerBlocks(Wa),T.registerBlocks(tr),T.registerBlocks(Mi),T.registerBlocks(ki),T.registerBlocks(Rt),T.registerBlocks(ni),T.registerBlocks(di),T.registerBlocks(Gt),T.registerBlocks(zi),T.registerBlocks(Kt),T.registerBlocks(hi),T.registerBlocks(bi),T.registerBlocks(Pi),T.registerBlocks(Ui),T.registerBlocks(Wi),T.registerBlocks(ca),T.registerBlocks(ga),T.registerBlocks(xa),T.registerBlocks(Ia),T.registerBlocks(Ma),T.registerBlocks(aa),T.registerBlocks(oa),T.registerBlocks(Pa),T.applyToEditor(t),Ra(t),Ya(t),ir(t),ri(t),Wt(t),za(t),Bi(t),ya(t)}function nr(t,e,i){t.on("component:add",()=>e.markAsDirty()),t.on("component:remove",()=>e.markAsDirty()),t.on("component:update",()=>e.markAsDirty()),t.on("style:update",()=>e.markAsDirty());const a=document.getElementById("save-button");a&&a.addEventListener("click",async()=>{await sr(t,e,i,a)}),document.addEventListener("keydown",r=>{(r.ctrlKey||r.metaKey)&&r.key==="s"&&(r.preventDefault(),a&&!a.disabled&&a.click())})}async function sr(t,e,i,a){a.disabled=!0,a.innerHTML='<i class="ri-loader-4-line animate-spin"></i><span>Guardando...</span>';try{i.needsTitle()?await cr(t,e,i):await ot(t,e,i)}catch(r){nt(r.message,"error")}finally{a.disabled=!1,a.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}}async function cr(t,e,i){return new Promise((a,r)=>{ct({title:"Título de la Página",description:"Ingresa un título descriptivo para identificar esta página",placeholder:"Ej: Acerca de Nosotros",icon:"ri-file-text-line",iconBg:"#dbeafe",iconColor:"#2563eb",confirmLabel:"Guardar",onConfirm:async l=>{if(!l?.trim()){r(new Error("El título es obligatorio"));return}try{await ot(t,e,i,l),a()}catch(n){r(n)}},onCancel:()=>{r(new Error("Guardado cancelado"))}})})}async function ot(t,e,i,a=null){const l={...e.getEditorContent(t),is_published:i.isPublished};a&&(l.title=a);const n=await e.savePage(t,l,i.storeUrl,i.getHttpMethod());n.success&&(e.markAsClean(),nt(n.message,"success"),!i.isEditMode&&n.page?(i.updatePageInfo(n),i.updateTitle(n.page.title)):a&&i.updateTitle(a))}function nt(t,e){typeof window.showNotification=="function"&&window.showNotification(t,e)}document.addEventListener("DOMContentLoaded",async()=>{const t=new dt,e=new kt;new Bt(t);const i=ft();if(i.on("load",()=>{or(i),gt(i),ht(),pt(),mt(i),ut(i),bt(i),xt(i),yt(i),vt(i),dr(i),fr(i),gr(i),setTimeout(()=>{i.runCommand("sw-visibility"),i.Panels.getButton("options","sw-visibility")?.set("active",!0)},100)}),e.isEditMode)try{await t.loadPageContent(i,e.loadUrl),Ke("Contenido cargado correctamente","success")}catch(a){Ke("Error al cargar el contenido","error"),console.error(a)}nr(i,t,e)});function dr(t){const e=[{cmd:"set-device-desktop",device:"Desktop"},{cmd:"set-device-tablet",device:"Tablet"},{cmd:"set-device-mobile",device:"Mobile"}];e.forEach(({cmd:i,device:a})=>{t.Commands.add(i,{run:r=>{r.setDevice(a),e.forEach(({cmd:l})=>{r.Panels.getButton("devices-c",l)?.set("active",l===i)})}})})}function fr(t){t.Commands.add("canvas-clear",{run:e=>{wt({title:"Limpiar canvas",description:"¿Estás seguro de que quieres eliminar todo el contenido del canvas? Esta acción no se puede deshacer.",icon:"ri-delete-bin-line",iconBg:"#fef2f2",iconColor:"#dc2626",confirmLabel:"Limpiar todo",confirmColor:"#dc2626",onConfirm:()=>{e.DomComponents.clear(),e.CssComposer.clear()}})}})}function gr(t){const e=t.Canvas.getFrameEl();if(!e?.contentDocument?.head)return;const i=e.contentDocument.createElement("style");i.id="gjs-dashed-fix",i.textContent="body,body.gjs-dashed{margin:0!important;padding:0 0 160px 0!important;}",e.contentDocument.head.appendChild(i)}function Ke(t,e="info"){typeof window.showNotification=="function"&&window.showNotification(t,e)}
