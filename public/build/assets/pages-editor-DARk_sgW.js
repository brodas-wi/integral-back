...
${ei}`}],st=function(){(function(){function t(i){if(!i||i.__pcInit)return;i.__pcInit=!0;var a=i.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,o=0,c=!1,s=0,d=0,g=0,y=null;a.querySelectorAll("img").forEach(function(f){f.setAttribute("draggable","false")}),setTimeout(function(){var f=a.scrollWidth-a.clientWidth;if(f<=0)return;var w=Math.min(60,f),S=null;function k(C){S||(S=C);var q=(C-S)/400;if(q<.5)a.scrollLeft=w*(q*2);else if(q<1)a.scrollLeft=w*(1-(q-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(k)}requestAnimationFrame(k)},400),a.scrollLeft=0;function v(){return a.scrollWidth-a.clientWidth}function x(f){return Math.max(0,Math.min(f,v()))}function u(){Math.abs(s)<.5||(s*=.92,a.scrollLeft=x(a.scrollLeft+s),y=requestAnimationFrame(u))}a.addEventListener("mousedown",function(f){f.button===0&&(y&&(cancelAnimationFrame(y),y=null),r=!0,c=!1,s=0,l=f.clientX,d=f.clientX,g=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",f.preventDefault())}),document.addEventListener("mousemove",function(f){if(r){var w=l-f.clientX;Math.abs(w)>3&&(c=!0);var S=Date.now(),k=S-g||1;s=(f.clientX-d)/k*16*-1,d=f.clientX,g=S,a.scrollLeft=x(o+w)}}),document.addEventListener("mouseup",function(f){r&&(r=!1,a.style.cursor="grab",c&&(f.stopPropagation(),y=requestAnimationFrame(u)))}),a.addEventListener("click",function(f){c&&(f.preventDefault(),f.stopPropagation(),c=!1)},!0);var L=0,A=0,b=0,E=0,h=0;a.addEventListener("touchstart",function(f){y&&(cancelAnimationFrame(y),y=null),L=f.touches[0].clientX,b=f.touches[0].clientX,E=Date.now(),A=a.scrollLeft,h=0},{passive:!0}),a.addEventListener("touchmove",function(f){var w=Date.now(),S=w-E||1,k=f.touches[0].clientX;h=(k-b)/S*16*-1,b=k,E=w;var C=L-k;a.scrollLeft=x(A+C)},{passive:!0}),a.addEventListener("touchend",function(){y=requestAnimationFrame(function f(){Math.abs(h)<.5||(h*=.92,a.scrollLeft=x(a.scrollLeft+h),y=requestAnimationFrame(f))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(i){delete i.__pcInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},ri=`(${st.toString()})();`,li=`
...
@media(max-width:480px){.pc-card{flex:0 0 80vw;}}`;function oi(t){const e=t.img||P("images/placeholder.svg"),i=t.title||"TÍTULO DEL PRODUCTO",a=t.desc||"Descripción breve del producto financiero.",r=t.href||"#",l=t.btn_label||"Solicitar";return`<div class="pc-card"><div class="pc-card-img-wrap"><img src="${e}" alt="${i}" class="pc-card-img"></div><div class="pc-card-body"><h3 class="pc-card-title">${i}</h3><p class="pc-card-desc">${a}</p></div><a href="${r}" class="pc-btn">${l}</a></div>`}function ct(t){const e=t.heading||"Créditos",i=t.subheading||"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",a=t.more_href||"#",r=t.more_label||"Ver más",l=t.show_more!==!1,c=(t.cards||[]).map(oi).join(""),s=l?`<div class="pc-more-wrap"><a href="${a}" class="pc-more-btn">${r}</a></div>`:"";return`<section class="pc-section"><style>${li}</style><div style="text-align:center;margin-bottom:2rem;"><h2 class="pc-section-heading">${e}</h2><p class="pc-section-subheading">${i}</p></div><div class="pc-carousel-wrap"><div class="pc-track">${c}</div></div>${s}</section>`}const Y={heading:"Créditos",subheading:"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CREDINVIERTE",desc:"Adquiere activos fijos",href:"#",btn_label:"Solicitar"},{img:"",title:"SOLUCIONES INTEGRALES",desc:"Financiamiento PYME",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDI-CONFIAMOS",desc:"Rápido y sin fiador",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDILÍNEA",desc:"Línea rotativa",href:"#",btn_label:"Solicitar"}]};function ni(t,e){const i=document.getElementById("pc-config-modal");if(i&&i.remove(),!document.getElementById("pc-modal-styles")){const d=document.createElement("style");d.id="pc-modal-styles",d.textContent=`
        ...
        <div class="pc-modal-footer">
            ...
            <button id="pc-modal-save" class="pc-btn-save"><i class="ri-check-line"></i> Aplicar cambios</button>
        </div>`,l.appendChild(o),document.body.appendChild(l),o.querySelectorAll(".pc-tab-btn").forEach(d=>{d.addEventListener("click",()=>{o.querySelectorAll(".pc-tab-btn").forEach(g=>g.classList.remove("active")),o.querySelectorAll(".pc-tab-panel").forEach(g=>g.classList.remove("active")),d.classList.add("active"),o.querySelector(`#pc-panel-${d.dataset.tab}`).classList.add("active")})}),o.querySelector("#pc-show-more").addEventListener("change",function(){r.show_more=this.checked,o.querySelector("#pc-more-fields").style.display=this.checked?"flex":"none"});function c(){const d=o.querySelector("#pc-cards-list");d.innerHTML="",r.cards.forEach((g,y)=>{const v=document.createElement("div");v.className="pc-card-config";const x=g.img?`<img class="pc-img-preview" src="${g.img}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>';v.innerHTML=`
                ...
                </div>`,v.querySelectorAll("[data-field]").forEach(u=>{u.addEventListener("input",()=>{if(g[u.dataset.field]=u.value,u.dataset.field==="img"){const L=v.querySelector(`#pc-img-wrap-${y}`);L.innerHTML=u.value?`<img class="pc-img-preview" src="${u.value}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>'}})}),v.querySelector(".pc-pick-img").addEventListener("click",()=>{$e({type:"image",title:"Seleccionar imagen de tarjeta",onSelect:u=>{g.img=u,v.querySelector("[data-field='img']").value=u,v.querySelector(`#pc-img-wrap-${y}`).innerHTML=`<img class="pc-img-preview" src="${u}" alt="">`}})}),v.querySelector(".pc-remove-card").addEventListener("click",()=>{r.cards.splice(y,1),c()}),d.appendChild(v)})}c(),o.querySelector("#pc-add-card").addEventListener("click",()=>{r.cards.push({img:"",title:"NUEVO PRODUCTO",desc:"Descripción del producto.",href:"#",btn_label:"Solicitar"}),c(),o.querySelector("#pc-cards-list").lastElementChild?.scrollIntoView({behavior:"smooth",block:"nearest"})});const s=()=>l.remove();o.querySelector("#pc-modal-close").addEventListener("click",s),o.querySelector("#pc-modal-cancel").addEventListener("click",s),l.addEventListener("click",d=>{d.target===l&&s()}),o.querySelector("#pc-modal-save").addEventListener("click",()=>{r.heading=o.querySelector("#pc-heading").value.trim()||Y.heading,r.subheading=o.querySelector("#pc-subheading").value.trim()||Y.subheading,r.show_more=o.querySelector("#pc-show-more").checked,r.more_label=o.querySelector("#pc-more-label").value.trim()||Y.more_label,r.more_href=o.querySelector("#pc-more-href").value.trim()||"#",e.addAttributes({"data-product-cards-config":JSON.stringify(r)}),e.components(ct(r)),setTimeout(()=>ve(t),300),s()})}function ve(t){try{const e=t.Canvas.getFrameEl()?.contentDocument;if(!e)return;const i=e.getElementById("pc-runtime-script");i&&i.remove(),e.querySelectorAll(".pc-section").forEach(r=>{delete r.__pcInit});const a=e.createElement("script");a.id="pc-runtime-script",a.textContent=ri,e.head.appendChild(a)}catch(e){console.warn("[ProductCards] Error reiniciando carrusel:",e)}}const si=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
${ge}`},{id:"document-accordion-item",label:"Ítem de Acordeón",category:"Documentos",media:xi,content:`${je("Nombre de la sección",!1)}${ge}`}];function wi(t){const e="doc-download-button",i="doc-accordion-item";t.DomComponents.addType(e,{isComponent:a=>a.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Botón de Documento",tagName:"a",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,class:"dd-btn",href:"#"},components:`
                ...
                `,script:yi()},init(){this.set("type",i),this.addAttributes({"data-gjs-type":i})}}}),t.Commands.add("select-doc-download-file",{run(a){const r=a.getSelected();!r||r.get("type")!==e||$e({type:"document",title:"Seleccionar documento",onSelect:(l,o)=>{r.addAttributes({href:l});const c=r.find(".dd-btn-label")[0],s=o?.name||l.split("/").pop();c&&c.components(s)}})}}),ki(t,i)}function ki(t,e){t.on("storage:end:load",()=>{setTimeout(()=>Ne(t,e),800)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},400))}),t.on("component:clone",i=>{if(i.get("type")===e){const a=i.getEl();a&&(delete a.__ddAccBound,setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},400))}}),t.on("canvas:render",()=>{setTimeout(()=>Ne(t,e),600)})}function Ne(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}const dt=function(){(function(){function t(i){if(!i||i.__savInit)return;i.__savInit=!0;var a=i.querySelector(".sav-carousel-wrap");if(!a)return;a.scrollLeft=0;var r=!1,l=0,o=0,c=!1,s=0,d=0,g=0,y=null;a.querySelectorAll("img").forEach(function(f){f.setAttribute("draggable","false")}),setTimeout(function(){var f=a.scrollWidth-a.clientWidth;if(f<=0)return;var w=Math.min(60,f),S=null;function k(C){S||(S=C);var q=(C-S)/400;if(q<.5)a.scrollLeft=w*(q*2);else if(q<1)a.scrollLeft=w*(1-(q-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(k)}requestAnimationFrame(k)},400);function v(){return a.scrollWidth-a.clientWidth}function x(f){return Math.max(0,Math.min(f,v()))}function u(){Math.abs(s)<.5||(s*=.92,a.scrollLeft=x(a.scrollLeft+s),y=requestAnimationFrame(u))}a.addEventListener("mousedown",function(f){f.button===0&&(y&&(cancelAnimationFrame(y),y=null),r=!0,c=!1,s=0,l=f.clientX,d=f.clientX,g=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",f.preventDefault())}),document.addEventListener("mousemove",function(f){if(r){var w=l-f.clientX;Math.abs(w)>3&&(c=!0);var S=Date.now(),k=S-g||1;s=(f.clientX-d)/k*16*-1,d=f.clientX,g=S,a.scrollLeft=x(o+w)}}),document.addEventListener("mouseup",function(f){r&&(r=!1,a.style.cursor="grab",c&&(f.stopPropagation(),y=requestAnimationFrame(u)))}),a.addEventListener("click",function(f){c&&(f.preventDefault(),f.stopPropagation(),c=!1)},!0);var L=0,A=0,b=0,E=0,h=0;a.addEventListener("touchstart",function(f){y&&(cancelAnimationFrame(y),y=null),L=f.touches[0].clientX,b=f.touches[0].clientX,E=Date.now(),A=a.scrollLeft,h=0},{passive:!0}),a.addEventListener("touchmove",function(f){var w=Date.now(),S=w-E||1,k=f.touches[0].clientX;h=(k-b)/S*16*-1,b=k,E=w;var C=L-k;a.scrollLeft=x(A+C)},{passive:!0}),a.addEventListener("touchend",function(){y=requestAnimationFrame(function f(){Math.abs(h)<.5||(h*=.92,a.scrollLeft=x(a.scrollLeft+h),y=requestAnimationFrame(f))})},{passive:!0})}function e(){document.querySelectorAll(".sav-section").forEach(function(i){delete i.__savInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Bi=`(${dt.toString()})();`,Ei=`
...
@media(max-width:480px){.sav-card{flex:0 0 75vw;}}`;function $i(t){const e=t.img||P("images/placeholder.svg"),i=t.title||"TÍTULO DEL PRODUCTO",a=t.desc?`<p class="sav-card-desc">${t.desc}</p>`:"",r=t.href||"#",l=t.btn_label||"Solicitar";return`<div class="sav-card"><div class="sav-card-img-wrap"><img src="${e}" alt="${i}" class="sav-card-img"></div><h3 class="sav-card-title">${i}</h3>${a}<a href="${r}" class="sav-btn">${l}</a></div>`}function ft(t){const e=t.heading||"Depósitos y Cuentas de Ahorro",i=t.subheading||"Productos diseñados para hacer crecer tu dinero de forma segura.",a=t.more_href||"#",r=t.more_label||"Ver más",l=t.show_more!==!1,c=(t.cards||[]).map($i).join(""),s=P("images/brand-watermark.png"),d=l?`<div class="sav-more-wrap"><a href="${a}" class="sav-more-btn">${r}</a></div>`:"";return`<section class="sav-section"><style>${Ei}</style><div class="sav-blue-box"><div class="sav-watermark"><img src="${s}" alt=""></div><div style="display:flex;flex-direction:column;gap:0.5rem;text-align:center;position:relative;z-index:1;"><h2 class="sav-heading">${e}</h2><p class="sav-subheading">${i}</p></div><div class="sav-carousel-wrap"><div class="sav-track">${c}</div></div>${d}</div></section>`}const G={heading:"Depósitos y Cuentas de Ahorro",subheading:"Productos diseñados para hacer crecer tu dinero de forma segura.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CUENTA DE AHORRO ESTÁNDAR",href:"#",btn_label:"Solicitar"},{img:"",title:"AHORRO RENTABLE",href:"#",btn_label:"Solicitar"},{img:"",title:"CUENTA DE AHORRO MÁS",href:"#",btn_label:"Solicitar"},{img:"",title:"DEPÓSITO DE PLAZO FIJO",href:"#",btn_label:"Solicitar"}]};function Si(t,e){const i=document.getElementById("sav-config-modal");if(i&&i.remove(),!document.getElementById("sav-modal-styles")){const d=document.createElement("style");d.id="sav-modal-styles",d.textContent=`
        ...
        <div class="sav-modal-footer">
            ...
            <button id="sav-modal-save" class="sav-btn-save"><i class="ri-check-line"></i> Aplicar cambios</button>
        </div>`,l.appendChild(o),document.body.appendChild(l),l.addEventListener("click",d=>{d.target===l&&s()}),o.querySelectorAll(".sav-tab-btn").forEach(d=>{d.addEventListener("click",()=>{o.querySelectorAll(".sav-tab-btn").forEach(g=>g.classList.remove("active")),o.querySelectorAll(".sav-tab-panel").forEach(g=>g.classList.remove("active")),d.classList.add("active"),o.querySelector(`#sav-panel-${d.dataset.tab}`).classList.add("active")})}),o.querySelector("#sav-show-more").addEventListener("change",function(){r.show_more=this.checked,o.querySelector("#sav-more-fields").style.display=this.checked?"flex":"none"});function c(){const d=o.querySelector("#sav-cards-list");d.innerHTML="",r.cards.forEach((g,y)=>{const v=document.createElement("div");v.className="sav-card-config";const x=g.img?`<img class="sav-img-preview" src="${g.img}" alt="">`:'<div class="sav-img-placeholder"><i class="ri-image-line"></i></div>';v.innerHTML=`
                ...
                </div>`,v.querySelectorAll("[data-field]").forEach(u=>{u.addEventListener("input",()=>{if(g[u.dataset.field]=u.value,u.dataset.field==="img"){const L=v.querySelector(`#sav-img-wrap-${y}`);L.innerHTML=u.value?`<img class="sav-img-preview" src="${u.value}" alt="">`:'<div class="sav-img-placeholder"><i class="ri-image-line"></i></div>'}})}),v.querySelector(".sav-pick-img").addEventListener("click",()=>{$e({type:"image",title:"Seleccionar imagen de tarjeta",onSelect:u=>{g.img=u,v.querySelector("[data-field='img']").value=u,v.querySelector(`#sav-img-wrap-${y}`).innerHTML=`<img class="sav-img-preview" src="${u}" alt="">`}})}),v.querySelector(".sav-remove-card").addEventListener("click",()=>{r.cards.splice(y,1),c()}),d.appendChild(v)})}c(),o.querySelector("#sav-add-card").addEventListener("click",()=>{r.cards.push({img:"",title:"NUEVO PRODUCTO",desc:"",href:"#",btn_label:"Solicitar"}),c(),o.querySelector("#sav-cards-list").lastElementChild?.scrollIntoView({behavior:"smooth",block:"nearest"})});const s=()=>l.remove();o.querySelector("#sav-modal-close").addEventListener("click",s),o.querySelector("#sav-modal-cancel").addEventListener("click",s),o.querySelector("#sav-modal-save").addEventListener("click",()=>{r.heading=o.querySelector("#sav-heading").value.trim()||G.heading,r.subheading=o.querySelector("#sav-subheading").value.trim()||G.subheading,r.show_more=o.querySelector("#sav-show-more").checked,r.more_label=o.querySelector("#sav-more-label").value.trim()||G.more_label,r.more_href=o.querySelector("#sav-more-href").value.trim()||"#",e.addAttributes({"data-savings-config":JSON.stringify(r)}),e.components(ft(r)),setTimeout(()=>ke(t),300),s()})}function ke(t){try{const e=t.Canvas.getFrameEl()?.contentDocument;if(!e)return;const i=e.getElementById("sav-runtime-script");i&&i.remove(),e.querySelectorAll(".sav-section").forEach(r=>{delete r.__savInit});const a=e.createElement("script");a.id="sav-runtime-script",a.textContent=Bi,e.head.appendChild(a)}catch(e){console.warn("[Savings] Error reiniciando carrusel:",e)}}const Li=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
<\/script>`}],Da=`<svg viewBox="0 0 32 32" width="32" height="32">
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
            ...
            <th colspan="${t.cols}" class="p-3 align-middle text-center text-base font-bold ${i.headerBg} ${i.headerText}">
        ...
        </tr>`,t.headers?.length&&(a+="<tr>",t.headers.forEach((o,c)=>{const s=c<t.headers.length-1?`border-r border-[${i.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${i.subheaderBg} ${i.subheaderText} ${s} border-b border-[${i.borderColor}] text-${o.align||"center"}">${o.text||""}</th>`}),a+="</tr>"),a+="</thead>"):t.headers?.length&&(a+="<thead><tr>",t.headers.forEach((o,c)=>{const s=c<t.headers.length-1?`border-r border-[${i.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${i.headerBg} ${i.headerText} ${s} border-b border-[${i.borderColor}] text-${o.align||"center"}">${o.text||""}</th>`}),a+="</tr></thead>"),a+="<tbody>";const r=t.rows.length,l={};return t.rows.forEach((o,c)=>{a+="<tr>";let s=0;o.forEach(d=>{for(;l[`${c}-${s}`];)s++;const g=d.colspan||1,y=d.rowspan||1;for(let k=c;k<c+y;k++)for(let C=s;C<s+g;C++)(k!==c||C!==s)&&(l[`${k}-${C}`]=!0);const v=g>1?`colspan="${g}"`:"",x=y>1?`rowspan="${y}"`:"",u=d.isHeader?i.labelBg:c%2===0?i.rowEvenBg:i.rowOddBg,L=d.isHeader?"font-semibold":"font-normal",A=d.isHeader?i.labelText:i.rowText,b=`text-${d.align||"center"}`,E=c+y>=r,f=s+g>=t.cols?"":`border-r border-[${i.borderColor}]`,w=E?"":`border-b border-[${i.borderColor}]`,S=`${f} ${w} p-3 align-middle text-sm ${u} ${L} ${A} ${b}`;d.image?a+=`<td ${v} ${x} class="${S}">
                ...
                </td>`:a+=`<td ${v} ${x} class="${S}">${d.text||""}</td>`,s+=g}),a+="</tr>"}),a+="</tbody></table>",a}function te(t,e){return{title:"Título de la tabla",cols:t,headers:Array.from({length:t},(i,a)=>({text:`Columna ${a+1}`,align:"center"})),rows:Array.from({length:e},()=>Array.from({length:t},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})))}}function gt(t,e){return`<div class="w-full overflow-x-auto rounded-2xl border-2 border-[${(Be[e]||Be.blue).borderColor}]">${t}</div>`}function Qe(t,e){const i={};return t.forEach((a,r)=>{let l=0;a.forEach(o=>{for(;i[`${r}-${l}`];)l++;const c=Math.min(o.colspan||1,e-l),s=o.rowspan||1;for(let d=r;d<r+s;d++)for(let g=l;g<l+c;g++)(d!==r||g!==l)&&(i[`${d}-${g}`]=`${r}-${l}`);l+=c})}),i}const Na=`
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function Oa(){if(document.getElementById("tam-img-modal"))return;const t=document.createElement("div");t.id="tam-img-modal",t.innerHTML=`
        ...
        <div class="tam-container">
        ...
        </div>`,document.body.appendChild(a);let r=null,l=null;function o(v){r=v;const x=v.get("tableData");l=x?JSON.parse(JSON.stringify(x)):te(3,3);const u=l.cols||3;l.rows=l.rows.map((L,A)=>Array.from({length:u},(E,h)=>L[h]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})),document.getElementById("tam-title").value=l.title||"",document.getElementById("tam-theme").value=v.get("tableTheme")||"blue",document.getElementById("tam-cols").value=l.cols||3,document.getElementById("tam-rows").value=l.rows.length||3,g(),y(),a.classList.add("open"),document.body.style.overflow="hidden"}function c(){a.classList.remove("open"),document.body.style.overflow="",r=null}function s(){l.title=document.getElementById("tam-title").value.trim(),l.cols=parseInt(document.getElementById("tam-cols").value)||3,l.headers=Array.from(document.querySelectorAll(".tam-header-input")).map(x=>({text:x.value,align:x.closest("th")?.querySelector(".tam-align-select")?.value||"center"})),document.querySelectorAll("#tam-tbody td.tam-cell:not(.is-spanned)").forEach(x=>{const u=parseInt(x.dataset.row),L=parseInt(x.dataset.col);l.rows[u]?.[L]&&(l.rows[u][L].text=x.querySelector(".tam-cell-input")?.value||"",l.rows[u][L].align=x.querySelector(".tam-align-select")?.value||"center",l.rows[u][L].isHeader=x.dataset.isheader==="1",l.rows[u][L].image=x.dataset.image||null)});const v=Qe(l.rows,l.cols);l.rows=l.rows.map((x,u)=>x.filter((L,A)=>!v[`${u}-${A}`]))}function d(){if(a.querySelector("#tam-rebuild-notice"))return;const x=document.createElement("div");x.id="tam-rebuild-notice",x.style.cssText="background:#fef9c3;border:1.5px solid #ca8a04;border-radius:0.5rem;padding:0.5rem 1rem;font-size:0.8rem;color:#92400e;display:flex;align-items:center;gap:0.5rem;margin:0 1.5rem 0;flex-shrink:0;",x.innerHTML='<i class="ri-error-warning-line"></i> Has modificado el colspan/rowspan. Haz clic en <strong style="margin:0 4px;">Reconstruir</strong> para aplicar los cambios de fusión.',a.querySelector(".tam-toolbar").after(x)}function g(){a.querySelector("#tam-rebuild-notice")?.remove()}function y(){const v=document.getElementById("tam-thead"),x=document.getElementById("tam-tbody"),u=l.cols,L=l.rows.length,A=Qe(l.rows,u);v.innerHTML=`<tr>${l.headers.map((b,E)=>`
            <th>
                <input class="tam-cell-input tam-header-input" value="${b.text||""}" placeholder="Col ${E+1}" style="font-weight:600;">
                <select class="tam-align-select" style="margin-top:4px;width:100%;font-size:0.7rem;padding:2px;">
            ...
            </th>`).join("")}</tr>`,x.innerHTML=l.rows.map((b,E)=>`<tr>${Array.from({length:u},(f,w)=>{const S=A[`${E}-${w}`];if(S)return`<td class="tam-cell is-spanned" data-row="${E}" data-col="${w}">
                        <div class="tam-spanned-label">Combinada con [${S}]</div>
                    </td>`;const k=b[w]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null},C=k.colspan||1,q=k.rowspan||1,z=C>1||q>1;return`<td class="tam-cell ${k.isHeader?"is-header-cell":""} ${k.image?"has-image":""} ${z?"has-span":""}"
                    data-row="${E}" data-col="${w}"
                    ...
                    <div class="tam-cell-actions">
                        <button type="button" class="tam-cell-btn tam-cell-btn-header ${k.isHeader?"active":""}"
                            data-action="header" data-row="${E}" data-col="${w}">
                            ${k.isHeader?"✓ Etiqueta":"Etiqueta"}
                        </button>
                        <button type="button" class="tam-cell-btn tam-cell-btn-img"
                            data-action="image" data-row="${E}" data-col="${w}">
                            <i class="ri-image-line"></i> ${k.image?"Cambiar":"Imagen"}
                        </button>
                        ${k.image?`<button type="button" class="tam-cell-btn tam-cell-btn-clear" data-action="clear-image" data-row="${E}" data-col="${w}">✕ Quitar</button>`:""}
                        <div class="tam-cell-span-group">
                            <label title="Columnas que ocupa">CS</label>
                            <input type="number" class="tam-cell-span-input" min="1" max="${u-w}"
                                value="${C}" data-action="colspan" data-row="${E}" data-col="${w}">
                            <label title="Filas que ocupa">RS</label>
                            <input type="number" class="tam-cell-span-input" min="1" max="${L-E}"
                                value="${q}" data-action="rowspan" data-row="${E}" data-col="${w}">
                        </div>
                    </div>
                </td>`}).join("")}</tr>`).join(""),x.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(b=>{b.addEventListener("change",()=>{const E=parseInt(b.dataset.row),h=parseInt(b.dataset.col),f=Math.max(1,parseInt(b.value)||1);l.rows[E]?.[h]&&(b.dataset.action==="colspan"?l.rows[E][h].colspan=Math.min(f,u-h):l.rows[E][h].rowspan=Math.min(f,L-E),d())})}),x.querySelectorAll("button[data-action]").forEach(b=>{b.addEventListener("click",E=>{E.preventDefault(),E.stopPropagation();const h=b.dataset.action,f=parseInt(b.dataset.row),w=parseInt(b.dataset.col);if(!(isNaN(f)||isNaN(w)||!l.rows[f]?.[w])){if(h==="header"){l.rows[f][w].isHeader=!l.rows[f][w].isHeader;const S=x.querySelector(`td[data-row="${f}"][data-col="${w}"]`);S&&(S.dataset.isheader=l.rows[f][w].isHeader?"1":"0",S.classList.toggle("is-header-cell",l.rows[f][w].isHeader)),b.classList.toggle("active",l.rows[f][w].isHeader),b.textContent=l.rows[f][w].isHeader?"✓ Etiqueta":"Etiqueta";return}if(h==="image"){window.__openTableImagePicker&&window.__openTableImagePicker(S=>{l.rows[f][w].image=S;const k=x.querySelector(`td[data-row="${f}"][data-col="${w}"]`);if(k){k.dataset.image=S,k.classList.add("has-image");let C=k.querySelector(".tam-cell-img-preview");C||(C=document.createElement("img"),C.className="tam-cell-img-preview",k.insertBefore(C,k.firstChild)),C.src=S;const q=k.querySelector("[data-action=image]");if(q&&(q.innerHTML='<i class="ri-image-line"></i> Cambiar'),!k.querySelector("[data-action=clear-image]")){const z=document.createElement("button");z.type="button",z.className="tam-cell-btn tam-cell-btn-clear",z.dataset.action="clear-image",z.dataset.row=f,z.dataset.col=w,z.textContent="✕ Quitar",z.addEventListener("click",D=>{D.preventDefault(),D.stopPropagation(),l.rows[f][w].image=null,k.dataset.image="",k.classList.remove("has-image"),C.remove(),z.remove();const M=k.querySelector("[data-action=image]");M&&(M.innerHTML='<i class="ri-image-line"></i> Imagen')}),k.querySelector(".tam-cell-actions").appendChild(z)}}});return}h==="clear-image"&&(l.rows[f][w].image=null,y())}})})}document.getElementById("tam-close").addEventListener("click",c),document.getElementById("tam-cancel").addEventListener("click",c),a.addEventListener("click",v=>{v.target===a&&c()}),document.getElementById("tam-rebuild").addEventListener("click",()=>{const v=parseInt(document.getElementById("tam-cols").value)||3,x=parseInt(document.getElementById("tam-rows").value)||3;for(g(),s();l.headers.length<v;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,v),l.cols=v;l.rows.length<x;)l.rows.push(Array.from({length:v},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,x).map(u=>{for(;u.length<v;)u.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return u.slice(0,v)}),y()}),document.getElementById("tam-apply").addEventListener("click",()=>{s();const v=document.getElementById("tam-theme").value;r&&(r.set("tableData",JSON.parse(JSON.stringify(l))),r.set("tableTheme",v),r.addAttributes({"data-table-theme":v}),ze(r)),c()}),window.__openTableAdminModal=o}function ze(t){const e=t.get("tableData"),i=t.get("tableTheme")||"blue";e&&t.components(gt(pt(e,i),i))}function Ha(){return function(){}}const Ra=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:Da,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<a href="#"
   ...
   class="dld-simple-${e}">
    ...
    <rect x="3" y="25" width="7" height="2.5" fill="#dee2e6" rx="0.5"/>
</svg>`;function cr(){return function(){const t=this,e="agencies-map-component",i="/api/agencies/active",a="agencies";let r=[],l=[],o={},c=null,s=[];const d=async()=>{try{g(),await v(),await L(),A(),S(),z(),D(),y()}catch(p){console.error("Error initializing map:",p),H("Error al cargar las agencias"),y()}};function g(){const p=t.querySelector(`.${e}-list`);p&&(p.innerHTML=`
                ...
                `);const n=t.querySelector(`.${e}-map-container`);n&&(n.style.opacity="0.5")}function y(){const p=t.querySelector(`.${e}-map-container`);p&&(p.style.transition="opacity 0.3s ease",p.style.opacity="1")}async function v(){try{const n=await(await fetch(i)).json(),m=a?n[a]:n;Array.isArray(m)?(r=m.filter($=>$.latitude&&$.longitude&&!isNaN($.latitude)&&!isNaN($.longitude)),l=[...r],x()):(r=[],l=[])}catch(p){console.error("Error loading items:",p),r=[],l=[]}}function x(){const p=[...new Set(r.map(m=>m.zone).filter(Boolean))].sort(),n=[...new Set(r.map(m=>m.department).filter(Boolean))].sort();o={zone:p,department:n},setTimeout(()=>{const m=t.querySelector(`.${e}-filters-container`);m&&!m.hasChildNodes()&&(m.innerHTML=`
                    ...
                    `,u())},100)}function u(){const p=t.querySelector(`.${e}-zone-filter`),n=t.querySelector(`.${e}-department-filter`);p&&o.zone&&o.zone.forEach(m=>{const $=document.createElement("option");$.value=m,$.textContent=m,p.appendChild($)}),n&&o.department&&o.department.forEach(m=>{const $=document.createElement("option");$.value=m,$.textContent=m,n.appendChild($)})}async function L(){if(!document.getElementById("leaflet-css")){const p=document.createElement("link");p.id="leaflet-css",p.rel="stylesheet",p.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",document.head.appendChild(p)}if(typeof window.L>"u"&&await new Promise((p,n)=>{const m=document.createElement("script");m.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",m.onload=p,m.onerror=n,document.head.appendChild(m)}),typeof window.L<"u"&&window.L.Icon&&window.L.Icon.Default){const p=window.L.icon({iconUrl:"data:image/svg+xml;base64,"+btoa(`
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 36" width="24" height="36">
                            <path fill="#f0872a" d="M12 0C7.6 0 4 3.6 4 8c0 5.4 8 16 8 16s8-10.6 8-16c0-4.4-3.6-8-8-8z"/>
                            <circle cx="12" cy="8" r="3" fill="#fff"/>
                        </svg>
                    `),iconSize:[30,45],iconAnchor:[15,45],popupAnchor:[0,-45]});window.customOrangeIcon=p}}function A(){const p=t.querySelector(`.${e}-map`);if(!p||!window.L)return;p._leaflet_id&&p._map&&(p._map.remove(),delete p._map),c=window.L.map(p).setView([13.7942,-88.8965],8),window.L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(c),p._map=c,c.whenReady(function(){b(),setTimeout(()=>{c&&c.invalidateSize&&c.invalidateSize()},300)})}function b(){E(),h(),w()}function E(){s.forEach(p=>{p.marker&&c.removeLayer(p.marker)}),s=[]}function h(){l.forEach((p,n)=>{if(p.latitude&&p.longitude){const m=f(p),$=window.L.marker([p.latitude,p.longitude],{icon:window.customOrangeIcon||new window.L.Icon.Default}).addTo(c).bindPopup(m);s.push({marker:$,item:p,index:n})}})}function f(p){let n=`<div style="min-width: 200px;"><h4 style="font-weight: 700; margin-bottom: 12px; color: #0d3f6a; font-size: 16px; border-bottom: 2px solid #f0872a; padding-bottom: 8px;">${p.name}</h4>`;if(p.address&&(n+=`<p style="margin: 8px 0 0 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-map-pin-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${p.address}</span></p>`),p.municipality||p.department){const m=[p.municipality,p.department].filter(Boolean).join(", ");n+=`<p style="margin: 0 0 8px 0; font-size: 13px; color: #6b7280; padding-left: 24px;">${m}</p>`}return p.schedule&&(n+=`<p style="margin: 8px 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-time-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${p.schedule}</span></p>`),n+="</div>",n}function w(){if(l.length>0){const p=l.filter(n=>n.latitude&&n.longitude).map(n=>[n.latitude,n.longitude]);p.length>1?c.once("moveend",function(){setTimeout(()=>{try{c&&c._loaded&&typeof c.fitBounds=="function"&&c.fitBounds(p,{padding:[50,50],maxZoom:12,animate:!1})}catch(n){console.warn("Error fitting bounds:",n)}},100)}):p.length===1&&c.setView(p[0],14)}}function S(){const p=t.querySelector(`.${e}-list`);if(!p)return;if(l.length===0){C(p);return}const n=l.map((m,$)=>k(m,$)).join("");p.innerHTML=n,q()}function k(p,n){const m=p.phones&&p.phones.length>0?p.phones.map(B=>`
                    ...
                    `).join(""):"",$=`https://www.google.com/maps/search/?api=1&query=${p.latitude},${p.longitude}`;return`
                <div class="${e}-item p-5 bg-white/10 border border-white/20 rounded-2xl cursor-pointer transition-all duration-200" data-item-index="${n}">
                    ...
                    ${m}
                    <div class="mt-3">
                        <a href="${$}" target="_blank" rel="noopener noreferrer" class="agency-maps-btn block w-full text-center px-4 py-2.5 bg-primary text-white font-semibold rounded-lg hover:opacity-90 transition-all duration-200" onclick="event.stopPropagation();">
                            Ver ubicación
                        </a>
                    </div>
                </div>
            `}function C(p){p.innerHTML=`
            ...
            `}function q(){const p=t.querySelectorAll(`.${e}-item`);p.forEach(n=>{n.addEventListener("click",m=>{if(m.target.closest(".agency-maps-btn"))return;m.preventDefault();const $=parseInt(n.dataset.itemIndex),B=l[$];if(!B)return;p.forEach(_=>{_.classList.remove("bg-white","border-secondary","selected-agency"),_.classList.add("bg-white/10","border-white/20");const X=_.querySelector(".agency-title"),fe=_.querySelectorAll("i"),pe=_.querySelectorAll(".agency-phone-link"),Se=_.querySelectorAll("p:not(:has(.agency-phone-link))"),Le=_.querySelector(".agency-maps-btn");X&&(X.classList.remove("text-secondary"),X.classList.add("text-white")),fe.forEach(K=>{K.classList.remove("text-secondary","text-gray-300","text-white"),K.classList.add("text-primary")}),pe.forEach(K=>{K.classList.remove("text-secondary"),K.classList.add("text-white")}),Se.forEach(K=>{K.classList.remove("text-secondary"),K.classList.add("text-gray-200")}),Le&&(Le.classList.remove("bg-secondary"),Le.classList.add("bg-primary"))}),n.classList.remove("bg-white/10","border-white/20"),n.classList.add("bg-white","border-secondary","selected-agency");const j=n.querySelector(".agency-title"),R=n.querySelectorAll("i"),O=n.querySelectorAll(".agency-phone-link"),F=n.querySelectorAll("p:not(:has(.agency-phone-link))"),U=n.querySelector(".agency-maps-btn");if(j&&(j.classList.remove("text-white"),j.classList.add("text-secondary")),R.forEach(_=>{_.classList.remove("text-secondary","text-gray-300","text-white"),_.classList.add("text-primary")}),O.forEach(_=>{_.classList.remove("text-white"),_.classList.add("text-secondary")}),F.forEach(_=>{_.classList.remove("text-gray-200"),_.classList.add("text-secondary")}),U&&(U.classList.remove("bg-primary"),U.classList.add("bg-secondary")),c&&B&&c._loaded)try{c.flyTo([B.latitude,B.longitude],14,{animate:!0,duration:1});const _=s.find(X=>X.item.id===B.id);_&&_.marker&&_.marker.openPopup()}catch(_){console.warn("Error updating map view:",_)}})})}function z(){const p=t.querySelector(`.${e}-search-input`),n=t.querySelector(`.${e}-zone-filter`),m=t.querySelector(`.${e}-department-filter`),$=t.querySelector(`.${e}-no-results`),B={Occidental:["Ahuachapán","Santa Ana","Sonsonate"],Paracentral:["Chalatenango","Cuscatlán","La Paz","Cabañas","San Vicente"],Central:["La Libertad","San Salvador"],Oriental:["Usulután","San Miguel","Morazán","La Unión"]},j=()=>{if(!n||!m)return;const O=n.value,F=m.value;if(!O)m.innerHTML='<option value="">Todos los Departamentos</option>',[...new Set(r.map(_=>_.department).filter(Boolean))].sort().forEach(_=>{const X=document.createElement("option");X.value=_,X.textContent=_,m.appendChild(X)}),F&&(m.value=F);else{const U=B[O]||[];m.innerHTML='<option value="">Todos los Departamentos</option>',U.forEach(_=>{const X=document.createElement("option");X.value=_,X.textContent=_,m.appendChild(X)}),U.includes(F)&&(m.value=F)}},R=()=>{const O=p?p.value.toLowerCase().trim():"",F=n?n.value:"",U=m?m.value:"";l=r.filter(_=>{let X=!0,fe=!0,pe=!0;return O&&(X=Object.values(_).some(Se=>String(Se).toLowerCase().includes(O))),F&&(fe=_.zone===F),U&&(pe=_.department===U),X&&fe&&pe}),S(),b(),$&&$.classList.toggle("hidden",l.length>0)};p&&p.addEventListener("input",R),n&&n.addEventListener("change",()=>{j(),R()}),m&&m.addEventListener("change",R)}function D(){const p=t.querySelector("[data-title]");if(p){const $=M("map-title")||"Nuestras Agencias";p.textContent=$}const n=t.querySelector(`.${e}-search-input`);if(n){const $=M("search-placeholder")||"Buscar...";n.setAttribute("placeholder",$)}const m=t.querySelector(`.${e}-no-results`);if(m){const $=M("no-results-text")||"No se encontraron agencias";m.textContent=$}}function M(p){return t.closest(`[data-gjs-type="${e}"]`)?.getAttribute(p)}function H(p){const n=t.querySelector(`.${e}-list`);n&&(n.innerHTML=`
                    <div class="flex flex-col items-center justify-center p-12 text-center">
...
.mp-map-wrapper{height:320px;}
    ...
    </section>`}const Ee={title:"Horarios y Agencias:",stats_text:"**27** agencias y más de **1000** puntos de pago distribuidos en todo el país."};function br(){return function(){const t=this,e=t.ownerDocument??document,i=".mp-section{width:100%;background:#ffffff;padding:3.5rem 4rem;font-family:'Poppins',sans-serif;}.mp-stats{font-size:1.125rem;font-weight:700;color:#003B71;margin:0 0 1.75rem;line-height:1.5;}.mp-stats .mp-num{color:#E97300;}.mp-title{font-size:1.75rem;font-weight:800;color:#E97300;margin:0 0 1.5rem;}.mp-filters{display:grid;grid-template-columns:repeat(3,1fr);gap:2.5rem;margin-bottom:2rem;position:relative;z-index:30;}.mp-filter{position:relative;}.mp-filter-btn{display:flex;align-items:center;justify-content:space-between;width:100%;background:none;border:none;border-bottom:2px solid #E97300;padding:0.5rem 0.25rem 0.625rem;cursor:pointer;font-family:inherit;}.mp-filter-label{font-size:0.9375rem;font-weight:700;color:#003B71;text-align:left;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}.mp-filter-arrow{color:#003B71;font-size:0.75rem;transition:transform 0.2s ease;flex-shrink:0;margin-left:0.75rem;}.mp-filter.mp-filter-open .mp-filter-arrow{transform:rotate(180deg);}.mp-filter-dropdown{display:none;position:absolute;top:calc(100% + 0.625rem);left:0;right:0;background:#ffffff;border-radius:0.5rem;box-shadow:0 14px 36px rgba(0,0,0,0.2);overflow:hidden;max-height:260px;overflow-y:auto;}.mp-filter.mp-filter-open .mp-filter-dropdown{display:block;}.mp-filter-option{display:block;width:100%;text-align:center;padding:0.75rem 1rem;background:none;border:none;border-bottom:2px solid #E97300;font-size:0.875rem;font-weight:700;color:#003B71;cursor:pointer;font-family:inherit;transition:background 0.15s;}.mp-filter-option:last-child{border-bottom:none;}.mp-filter-option:hover{background:#f8fafc;}.mp-filter-option:disabled{opacity:0.5;cursor:default;pointer-events:none;}.mp-map-wrapper{position:relative;width:100%;height:440px;border-radius:0.5rem;overflow:hidden;}.mp-map{width:100%;height:100%;z-index:1;}.mp-map-overlay{position:absolute;inset:0;background:rgba(0,59,113,0.4);opacity:0;pointer-events:none;transition:opacity 0.2s ease;z-index:20;}.mp-map-overlay.mp-overlay-active{opacity:1;}.mp-pin{background:transparent!important;border:none!important;}.mp-popup{font-family:'Poppins',sans-serif;min-width:180px;}.mp-popup-name{margin:0 0 0.375rem;font-size:0.875rem;font-weight:700;color:#003B71;}.mp-popup-line{margin:0 0 0.25rem;font-size:0.8125rem;color:#475569;display:flex;align-items:flex-start;gap:0.375rem;line-height:1.4;}.mp-popup-line i{color:#E97300;margin-top:0.125rem;}.mp-popup-line:last-child{margin-bottom:0;}@media(max-width:1280px){.mp-section{padding:3rem 2.5rem;}}@media(max-width:992px){.mp-section{padding:2.5rem 1.5rem;}.mp-filters{grid-template-columns:1fr;gap:1.25rem;}.mp-map-wrapper{height:320px;}}";if(!e.getElementById("mp-filter-styles")){const n=e.createElement("style");n.id="mp-filter-styles",n.textContent=i,e.head.appendChild(n)}const a=t.querySelector("[data-mp-filters]"),r=t.querySelector("[data-mp-overlay]"),l=t.querySelector("[data-mp-map]");if(!a||!l)return;const o=[13.7942,-88.8965],c=8,s={departments:[],agencies:[],paymentPoints:[],type:null,department:null,pointKey:null};let d=null,g=null,y=null;function v(){a.querySelectorAll(".mp-filter.mp-filter-open").forEach(n=>n.classList.remove("mp-filter-open")),r&&r.classList.remove("mp-overlay-active")}function x(n){return String(n??"").replace(/[&<>"']/g,m=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[m])}function u(n){return`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 42" width="30" height="42"><path d="M15 0C6.7 0 0 6.7 0 15c0 11.3 15 27 15 27s15-15.7 15-27C30 6.7 23.3 0 15 0z" fill="${n}"/><circle cx="15" cy="14" r="5.5" fill="#ffffff"/></svg>`}function L(n){return y.divIcon({className:"mp-pin",html:u(n),iconSize:[30,42],iconAnchor:[15,42],popupAnchor:[0,-38]})}function A(n){const m=[`<div class="mp-popup"><p class="mp-popup-name">${x(n.name)}</p>`];return n.address&&m.push(`<p class="mp-popup-line"><i class="ri-map-pin-2-line"></i> ${x(n.address)}</p>`),n.type==="agency"&&n.schedule&&m.push(`<p class="mp-popup-line"><i class="ri-time-line"></i> ${x(n.schedule)}</p>`),n.type==="payment_point"&&n.correspondent&&m.push(`<p class="mp-popup-line"><i class="ri-store-2-line"></i> ${x(n.correspondent)}</p>`),m.push("</div>"),m.join("")}function b(){return[...s.agencies,...s.paymentPoints]}function E(){return b().filter(n=>!(s.type&&n.type!==s.type||s.department&&n.department!==s.department))}function h(){!g||!y||(g.clearLayers(),E().forEach(n=>{const m=n.type==="agency"?"#E97300":"#003B71",$=y.marker([n.lat,n.lng],{icon:L(m)});$.bindPopup(A(n)),$.__mpKey=`${n.type}-${n.id}`,g.addLayer($)}))}function f(){d&&d.flyTo(o,c)}function w(){const n=s.departments.find(m=>m.name===s.department);d&&n&&n.lat&&n.lng&&d.flyTo([n.lat,n.lng],n.zoom||11)}function S(){if(!d||!g)return;let n=null;g.eachLayer(m=>{m.__mpKey===s.pointKey&&(n=m)}),n&&(d.flyTo(n.getLatLng(),17),setTimeout(()=>n.openPopup(),350))}function k(){h(),s.pointKey?S():s.department?w():f()}function C(){const n=a.querySelector('[data-filter-index="2"] .mp-filter-dropdown'),m=a.querySelector('[data-filter-label="2"]');if(!n)return;const $=E(),B=['<button type="button" class="mp-filter-option" data-point-key="">Todas</button>'].concat($.map(j=>`<button type="button" class="mp-filter-option" data-point-key="${j.type}-${j.id}">${x(j.name)}</button>`)).join("");n.innerHTML=B,s.pointKey=null,m&&(m.textContent="Seleccione una ubicación"),n.querySelectorAll(".mp-filter-option").forEach(j=>{j.addEventListener("click",()=>{const R=j.dataset.pointKey||"";s.pointKey=R||null,m&&(m.textContent=j.textContent),v(),k()})})}function q(){const n=a.querySelector('[data-filter-index="1"] .mp-filter-dropdown');if(!n)return;const m=['<button type="button" class="mp-filter-option" data-dept="">Todos los departamentos</button>'].concat(s.departments.map($=>`<button type="button" class="mp-filter-option" data-dept="${x($.name)}">${x($.name)}</button>`)).join("");n.innerHTML=m,n.querySelectorAll(".mp-filter-option").forEach($=>{$.addEventListener("click",()=>{s.department=$.dataset.dept||null;const B=a.querySelector('[data-filter-label="1"]');B&&(B.textContent=$.textContent),v(),C(),k()})})}function z(){const n=a.querySelector('[data-filter-index="0"] .mp-filter-dropdown');n&&n.querySelectorAll(".mp-filter-option").forEach(m=>{m.addEventListener("click",()=>{s.type=m.dataset.type||null;const $=a.querySelector('[data-filter-label="0"]');$&&($.textContent=m.textContent),v(),C(),k()})})}a.__mpBound||(a.__mpBound=!0,a.querySelectorAll("[data-filter-toggle]").forEach(n=>{n.addEventListener("click",m=>{m.stopPropagation();const $=n.closest(".mp-filter"),B=$.classList.contains("mp-filter-open");v(),B||($.classList.add("mp-filter-open"),r&&r.classList.add("mp-overlay-active"))})}),e.addEventListener("click",n=>{t.contains(n.target)&&(n.target.closest(".mp-filter")||v())}));async function D(){if(!e.getElementById("leaflet-css")){const m=e.createElement("link");m.id="leaflet-css",m.rel="stylesheet",m.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",e.head.appendChild(m)}const n=e.defaultView??window;return typeof n.L>"u"&&await new Promise((m,$)=>{const B=e.createElement("script");B.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",B.onload=m,B.onerror=$,e.head.appendChild(B)}),n.L}function M(){const n=e.querySelector('meta[name="map-locations-url"]')?.content;if(n)return n;try{const $=window.top?.document?.querySelector('meta[name="map-locations-url"]')?.content;if($)return $}catch{}return"/api/map-locations"}async function H(){try{const n=M(),m=await fetch(n,{headers:{Accept:"application/json"}});if(!m.ok)throw new Error("No se pudo cargar la información del mapa");const $=await m.json();s.departments=$.departments||[],s.agencies=$.agencies||[],s.paymentPoints=$.payment_points||[]}catch(n){console.warn("[MapFilter] Error al cargar datos:",n)}}async function p(){if(!(!l||l.__mpMapInit))try{if(y=await D(),!y||l.__mpMapInit)return;l.__mpMapInit=!0,d=y.map(l,{zoomControl:!0}).setView(o,c),l._map=d,y.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(d),g=y.layerGroup().addTo(d),d.whenReady(function(){setTimeout(()=>{d&&d.invalidateSize&&d.invalidateSize()},300)}),await H(),z(),q(),C(),k()}catch(n){console.warn("No se pudo inicializar el mapa:",n)}}p()}}function ur(t,e){const i=document.getElementById("map-filter-config-modal");if(i&&i.remove(),!document.getElementById("mp-modal-styles")){const d=document.createElement("style");d.id="mp-modal-styles",d.textContent=`
        ...
        `,document.head.appendChild(d)}const a=(()=>{try{return JSON.parse(e.getAttributes()["data-map-config"]||"{}")}catch{return{}}})(),r=a.title||Ee.title,l=a.stats_text||Ee.stats_text,o=document.createElement("div");o.id="map-filter-config-modal",o.className="mp-overlay-modal";const c=document.createElement("div");c.className="mp-modal",c.innerHTML=`
...
@media(max-width:768px){.bsk-buttons{flex-direction:column;}}`;function $r(){return function(){const t=this,e=t.ownerDocument??document,i="/adminintegral",a=(e.defaultView??window).location.origin,r=e.querySelector('meta[name="api-banners-url"]')?.content||`${a}${i}/api/banners/active`,l=["fill-blue","outline-blue","fill-orange","outline-orange","fill-white","outline-white"],o=".banner-wrapper{position:relative;width:100%;background:#003B71;overflow:hidden;}.banner-slide-container{position:relative;width:100%;user-select:none;cursor:grab;display:grid;}.banner-slide-container:active{cursor:grabbing;}.banner-slide{grid-area:1/1;opacity:0;pointer-events:none;transition:opacity 0.7s ease;visibility:hidden;display:flex;flex-direction:column;}.banner-slide.banner-slide--active{opacity:1;pointer-events:auto;visibility:visible;}.banner-slide-inner{position:relative;width:100%;flex:1;min-height:480px;display:flex;align-items:center;}.banner-bg{position:absolute;inset:0;z-index:0;}.banner-bg img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;}.banner-overlay{position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,59,113,0.85) 0%,rgba(0,59,113,0.65) 50%,rgba(0,59,113,0.2) 100%);z-index:1;}.banner-content{position:relative;z-index:10;display:flex;flex-direction:column;justify-content:center;padding:64px 64px 96px;max-width:60%;}.banner-category-badge{display:inline-block;margin-bottom:18px;padding:7px 20px;border-radius:999px;border:2px solid rgba(255,255,255,0.65);color:#fff;font-size:13px;font-weight:500;letter-spacing:0.04em;align-self:flex-start;}.banner-title{font-size:clamp(1.8rem,3.2vw,3rem);font-weight:800;color:#fff;line-height:1.15;margin:0 0 20px;}.banner-description{color:rgba(255,255,255,0.9);font-size:clamp(0.95rem,1.4vw,1.1rem);line-height:1.7;margin:0 0 36px;max-width:520px;}.banner-buttons{display:flex;flex-wrap:wrap;gap:16px;align-items:center;}.banner-btn{display:inline-block;padding:12px 32px;border-radius:999px;font-size:15px;font-weight:600;cursor:pointer;transition:background .2s,color .2s,border-color .2s;text-decoration:none;white-space:nowrap;line-height:1.4;box-sizing:border-box;}.banner-btn--fill-blue{background:#003B71;color:#ffffff;border:2px solid #003B71;}.banner-btn--fill-blue:hover{background:#002a52;border-color:#002a52;color:#ffffff;}.banner-btn--outline-blue{background:transparent;color:#003B71;border:2px solid #003B71;}.banner-btn--outline-blue:hover{background:#003B71;border-color:#003B71;color:#ffffff;}.banner-btn--fill-orange{background:#E97300;color:#ffffff;border:2px solid #E97300;}.banner-btn--fill-orange:hover{background:#c96200;border-color:#c96200;color:#ffffff;}.banner-btn--outline-orange{background:transparent;color:#E97300;border:2px solid #E97300;}.banner-btn--outline-orange:hover{background:#E97300;border-color:#E97300;color:#ffffff;}.banner-btn--fill-white{background:#ffffff;color:#003B71;border:2px solid #ffffff;}.banner-btn--fill-white:hover{background:#dce8f5;border-color:#dce8f5;color:#003B71;}.banner-btn--outline-white{background:transparent;color:#ffffff;border:2px solid #ffffff;}.banner-btn--outline-white:hover{background:#ffffff;border-color:#ffffff;color:#003B71;}.banner-dots-wrapper{display:none;}.banner-stripe{position:relative;width:100%;height:26px;background:#E97300;z-index:20;display:flex;align-items:center;justify-content:center;}.banner-dots{display:flex;gap:8px;align-items:center;}.banner-dot{width:10px;height:10px;border-radius:999px;border:none;cursor:pointer;background:rgba(255,255,255,0.5);transition:all 0.3s ease;padding:0;flex-shrink:0;}.banner-dot--active{width:28px;background:#ffffff;}.banner-empty{display:flex;align-items:center;justify-content:center;min-height:480px;color:rgba(255,255,255,0.5);font-size:14px;padding:40px;}@media(max-width:768px){.banner-slide-inner{min-height:340px;}.banner-bg img{object-position:right center;}.banner-content{max-width:100%;width:100%;padding:32px 24px 80px;}.banner-buttons{flex-wrap:wrap;gap:12px;}.banner-btn{flex:1 1 45%;min-width:140px;text-align:center;white-space:normal;word-break:break-word;}}@media(max-width:480px){.banner-btn{flex:1 1 100%;min-width:0;}}",c="@keyframes bsk-shimmer{0%{background-position:-600px 0}100%{background-position:600px 0}}.bsk-badge{width:120px;height:32px;margin-bottom:20px;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title{height:40px;margin-bottom:12px;border-radius:8px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title--short{width:60%;}.bsk-line{height:16px;margin-bottom:10px;border-radius:6px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-line--short{width:55%;}.bsk-buttons{display:flex;gap:16px;margin-top:36px;}.bsk-btn{height:48px;flex:1;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-bg-img{background:linear-gradient(90deg,rgba(255,255,255,0.04) 25%,rgba(255,255,255,0.09) 50%,rgba(255,255,255,0.04) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}@media(max-width:768px){.bsk-buttons{flex-direction:column;}}";(function(){if(!e.getElementById("banner-hero-styles")){const j=e.createElement("style");j.id="banner-hero-styles",j.textContent=o,e.head.appendChild(j)}if(!e.getElementById("banner-skeleton-styles")){const j=e.createElement("style");j.id="banner-skeleton-styles",j.textContent=c,e.head.appendChild(j)}})();let s=[],d=0,g=null,y=!1,v=0,x=0;const u=50,L=t.dataset.autoplay!=="false",A=t.dataset.category??"",b=t.querySelector(".banner-slide-container"),E=t.querySelector(".banner-stripe");if(!b||!E)return;function h(B){return l.indexOf(B)!==-1?B:B==="outline-blue"||B==="outline-orange"?"outline-white":"fill-white"}function f(B,j,R,O){const F=h(R),U=j?"a":"span",_=j?`href="${j}"${O?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${U} ${_} class="banner-btn banner-btn--${F}">${B}</${U}>`}async function w(){if(!t.__bannerLoading){t.__bannerLoading=!0,S();try{const B=await fetch(r,{headers:{Accept:"application/json"}});if(!B.ok){$();return}const j=await B.json();if(s=Array.isArray(j)?A?j.filter(R=>R.category===A):j:[],s.length===0){$();return}k(),H(),p(0,!1),L&&n()}catch{$()}finally{t.__bannerLoading=!1}}}function S(){b.innerHTML=`
                ...
                </div>`,E.innerHTML=""}function k(){b.innerHTML=s.map((B,j)=>`
                ...
                </div>`).join(""),C(),q()}function C(){b.addEventListener("mousedown",z),b.addEventListener("touchstart",z,{passive:!0}),b.addEventListener("mousemove",D),b.addEventListener("touchmove",D,{passive:!0}),b.addEventListener("mouseup",M),b.addEventListener("touchend",M),b.addEventListener("mouseleave",M)}function q(){s.forEach(B=>{const j=new Image;j.src=B.image_url})}function z(B){y=!0,v=B.touches?B.touches[0].clientX:B.clientX,x=0}function D(B){y&&(x=(B.touches?B.touches[0].clientX:B.clientX)-v)}function M(){y&&(y=!1,Math.abs(x)>=u&&(p(x<0?(d+1)%s.length:(d-1+s.length)%s.length),m()),x=0)}function H(){if(s.length<=1){E.innerHTML="";return}const B=e.createElement("div");B.className="banner-dots",s.forEach((j,R)=>{const O=e.createElement("button");O.className="banner-dot",O.type="button",O.dataset.index=String(R),O.setAttribute("aria-label",`Banner ${R+1}`),O.addEventListener("click",()=>{p(R),m()}),B.appendChild(O)}),E.innerHTML="",E.appendChild(B)}function p(B,j=!0){const R=b.querySelectorAll(".banner-slide"),O=t.querySelectorAll(".banner-dot");R.forEach((F,U)=>{const _=U===B;j||(F.style.transition="none"),F.classList.toggle("banner-slide--active",_),j||requestAnimationFrame(()=>{F.style.transition=""})}),O.forEach((F,U)=>F.classList.toggle("banner-dot--active",U===B)),d=B}function n(){s.length<=1||!L||(g=setInterval(()=>p((d+1)%s.length),5e3))}function m(){L&&(clearInterval(g),n())}function $(){clearInterval(g),b.innerHTML=`
                <div class="banner-slide banner-slide--active">
                    <div class="banner-empty">Sin contenido.</div>
                </div>`,E.innerHTML=""}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",w):w()}}function Sr(t,e){const i=document.getElementById("banner-hero-config-modal");if(i&&i.remove(),!document.getElementById("bnr-modal-styles")){const u=document.createElement("style");u.id="bnr-modal-styles",u.textContent=`
        ...
        `,document.head.appendChild(u)}const a=e.getAttributes(),r=a["data-autoplay"]!=="false",l=a["data-category"]||"",o=document.createElement("div");o.id="banner-hero-config-modal",o.className="bnr-overlay";const c=document.createElement("div");c.className="bnr-modal",c.innerHTML=`
        ...
        </div>`,o.appendChild(c),document.body.appendChild(o);const s=c.querySelector("#bnr-autoplay"),d=c.querySelector("#bnr-autoplay-slider"),g=c.querySelector("#bnr-autoplay-knob"),y=()=>{d.style.background=s.checked?"#003B71":"#cbd5e1",g.style.left=s.checked?"21px":"3px"};y(),s.addEventListener("change",y);const v=c.querySelector("#bnr-category");(async()=>{try{const L=document.querySelector('meta[name="api-banners-url"]')?.content||`${window.location.origin}/adminintegral/api/banners/active`,A=await fetch(L,{headers:{Accept:"application/json"}});if(!A.ok)return;const b=await A.json();if(!Array.isArray(b))return;[...new Set(b.map(h=>h.category).filter(Boolean))].sort().forEach(h=>{const f=document.createElement("option");f.value=h,f.textContent=h,v.appendChild(f)}),v.value=l}catch{}})();const x=()=>o.remove();c.querySelector("#bnr-modal-close").onclick=x,c.querySelector("#bnr-modal-cancel").onclick=x,o.onclick=u=>{u.target===o&&x()},c.querySelector("#bnr-modal-save").onclick=()=>{e.addAttributes({"data-autoplay":s.checked?"true":"false","data-category":v.value||""}),x()}}const Lr=[{id:"banner-hero",label:"Banner Slider",category:"Banners",media:kr,content:{type:"banner-hero-component"}}];function Cr(t){const e="banner-hero-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner Slider",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-autoplay":"true","data-category":""},components:`
...
`;if(!e.getElementById("assets-block-styles")){const b=e.createElement("style");b.id="assets-block-styles",b.textContent=r,e.head.appendChild(b)}const l=t.querySelector("[data-ast-tabs]"),o=t.querySelector("[data-ast-content]");if(!l||!o)return;const c=t.dataset.defaultCategory||"";let s=[],d="";function g(b,E){return b?b.length>E?`${b.slice(0,E).trim()}...`:b:""}function y(b){const E=b.link_is_external?' target="_blank" rel="noopener noreferrer"':"",h=b.name||g(b.short_description,60),f=b.name||b.short_description||"Activo extraordinario";return`<a href="${b.link_url}"${E} class="ast-card">
            ...
            </a>`}function v(){const b=[],E=new Set;return s.forEach(h=>{E.has(h.category_slug)||(E.add(h.category_slug),b.push({slug:h.category_slug,name:h.category}))}),b.sort((h,f)=>h.name.localeCompare(f,"es",{sensitivity:"base"}))}function x(b,E){const h=E.length?E.map(y).join(""):'<div class="ast-empty">No hay activos extraordinarios disponibles en esta categoría.</div>';return`<div class="ast-group">
                <p class="ast-subtitle">${b}</p>
                <div class="ast-subtitle-stripe"></div>
                <div class="ast-grid">${h}</div>
            </div>`}function u(){if(d){const E=s.filter(f=>f.category_slug===d),h=E[0]?.category||v().find(f=>f.slug===d)?.name||"";o.innerHTML=x(h,E);return}const b=v();o.innerHTML=b.map(E=>x(E.name,s.filter(h=>h.category_slug===E.slug))).join("")}function L(){const E=['<button type="button" class="ast-tab ast-tab--active" data-tab-slug="">Todos</button>',...v().map(h=>`<button type="button" class="ast-tab" data-tab-slug="${h.slug}">${h.name}</button>`)].join("");if(l.innerHTML=E,l.querySelectorAll("[data-tab-slug]").forEach(h=>{h.addEventListener("click",()=>{l.querySelectorAll(".ast-tab").forEach(f=>f.classList.remove("ast-tab--active")),h.classList.add("ast-tab--active"),d=h.dataset.tabSlug,u()})}),c){const h=l.querySelector(`[data-tab-slug="${c}"]`);h&&h.click()}}async function A(){if(!a){l.innerHTML='<button type="button" class="ast-tab ast-tab--active">Todos</button>',o.innerHTML='<div class="ast-empty">Vista previa del catálogo (los datos reales se cargan en el sitio publicado).</div>';return}o.innerHTML=`
                <div class="ast-loading">
                    <div class="ast-spinner"></div>
                    <span>Cargando activos extraordinarios...</span>
                </div>`;try{const b=await fetch(a,{headers:{Accept:"application/json"}});if(!b.ok){o.innerHTML='<div class="ast-empty">No se pudieron cargar los activos extraordinarios.</div>';return}if(s=await b.json(),!Array.isArray(s)||s.length===0){l.innerHTML='<button type="button" class="ast-tab ast-tab--active">Todos</button>',o.innerHTML='<div class="ast-empty">No hay activos extraordinarios disponibles.</div>';return}L(),u()}catch{o.innerHTML='<div class="ast-empty">No se pudieron cargar los activos extraordinarios.</div>'}}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",A):A()}}const Ir=[{id:"assets-catalog",label:"Catálogo de Activos Extraordinarios",category:"Interactivos",media:Tr,content:{type:"assets-catalog-component"}}];function qr(t){const e="assets-catalog-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Catálogo de Activos Extraordinarios",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-default-category":"",class:"ast-section"},components:`
...
.hb-btn{width:100%;text-align:center;}
...
</style>`;function ut(t,e){e=e||"hb"+Math.random().toString(36).slice(2,7);const i=t.bg_image||P("images/placeholder.svg"),a=t.btn_primary||{},r=t.btn_secondary||{},l=a.color||"white",o=r.color||"white",c=a.enabled?`<a href="${a.href||"#"}" class="hb-btn hb-btn-${l}-solid">${a.label||"Conoce más"}</a>`:"",s=r.enabled?`<a href="${r.href||"#"}" class="hb-btn hb-btn-${o}-outline">${r.label||"Solicitar"}</a>`:"";return`<section id="hb-root-${e}" class="hb-section" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
        ...
        `,document.head.appendChild(h)}const a=(()=>{try{return JSON.parse(e.getAttributes()["data-hero-banner-config"]||"{}")}catch{return{}}})(),r=a.bg_image||Q.bg_image,l=a.title||Q.title,o=a.subtitle||Q.subtitle,c=JSON.parse(JSON.stringify(a.btn_primary||Q.btn_primary)),s=JSON.parse(JSON.stringify(a.btn_secondary||Q.btn_secondary)),d=document.createElement("div");d.id="hero-banner-config-modal",d.className="hb-overlay";const g=document.createElement("div");g.className="hb-modal",g.innerHTML=`
        ...
        </div>`,d.appendChild(g),document.body.appendChild(d);const v=`${document.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??""}/api/pages/search`;function x(h){if(h.dataset.autocompleteAttached)return;h.dataset.autocompleteAttached="true";const f=h.parentNode;(!f.style.position||f.style.position==="static")&&(f.style.position="relative");const w=document.createElement("ul");w.style.cssText="position:absolute;top:calc(100% + 2px);left:0;right:0;z-index:999999;background:#fff;border:1px solid #e2e8f0;border-radius:0.5rem;box-shadow:0 8px 24px rgba(0,0,0,0.1);list-style:none;margin:0;padding:0.25rem;max-height:200px;overflow-y:auto;display:none;",f.appendChild(w);let S=null;async function k(z){if(z.length<1){w.style.display="none";return}try{const M=await(await fetch(`${v}?q=${encodeURIComponent(z)}`,{headers:{Accept:"application/json","X-Requested-With":"XMLHttpRequest"}})).json();q(M,z)}catch{w.style.display="none"}}function C(z,D){return D?z.replace(new RegExp(`(${D.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")})`,"gi"),'<mark style="background:#fef3c7;color:#92400e;border-radius:2px;padding:0 1px;">$1</mark>'):z}function q(z,D){if(w.innerHTML="",!z.length){w.style.display="none";return}z.forEach(M=>{const H=document.createElement("li");H.style.cssText="padding:0.375rem 0.625rem;border-radius:0.375rem;cursor:pointer;display:flex;flex-direction:column;gap:0.125rem;",H.innerHTML=`<span style="font-size:0.8rem;font-weight:600;color:#1e293b;">${C(M.title,D)}</span><span style="font-size:0.7rem;color:#64748b;">/${M.slug}</span>`,H.addEventListener("mouseenter",()=>H.style.background="#f1f5f9"),H.addEventListener("mouseleave",()=>H.style.background=""),H.addEventListener("mousedown",p=>{p.preventDefault(),h.value=`${Or}/${M.slug}`,h.dispatchEvent(new Event("input")),w.style.display="none"}),w.appendChild(H)}),w.style.display="block"}h.addEventListener("input",()=>{clearTimeout(S),S=setTimeout(()=>k(h.value.trim()),220)}),h.addEventListener("focus",()=>{h.select(),h.value.trim()&&k(h.value.trim())}),h.addEventListener("blur",()=>{setTimeout(()=>{w.style.display="none"},150)}),h.addEventListener("keydown",z=>{if(w.style.display==="none")return;const D=w.querySelectorAll("li"),M=w.querySelector("li.hb-ac-active");let H=Array.from(D).indexOf(M);if(z.key==="ArrowDown"){z.preventDefault(),M?.classList.remove("hb-ac-active");const p=D[H+1]||D[0];p?.classList.add("hb-ac-active"),p&&(p.style.background="#f1f5f9")}else if(z.key==="ArrowUp"){z.preventDefault(),M?.classList.remove("hb-ac-active");const p=D[H-1]||D[D.length-1];p?.classList.add("hb-ac-active"),p&&(p.style.background="#f1f5f9")}else z.key==="Enter"&&M?(z.preventDefault(),M.dispatchEvent(new MouseEvent("mousedown"))):z.key==="Escape"&&(w.style.display="none")})}x(g.querySelector("#hb-btn1-href")),x(g.querySelector("#hb-btn2-href"));let u=c.color||"white",L=s.color||"white";function A(h,f,w){const S=g.querySelector(`#${h}`);S.querySelectorAll("[data-color]").forEach(k=>{k.classList.toggle("hb-color-inactive",k.dataset.color!==f),k.addEventListener("click",()=>{S.querySelectorAll("[data-color]").forEach(C=>C.classList.toggle("hb-color-inactive",C.dataset.color!==k.dataset.color)),w(k.dataset.color)})})}A("hb-btn1-colors",u,h=>u=h),A("hb-btn2-colors",L,h=>L=h);function b(h,f,w){const S=g.querySelector(`#${h}`),k=g.querySelector(`#${f}`),C=g.querySelector(`#${w}`),q=()=>{k.style.background=S.checked?"#003B71":"#cbd5e1",C.style.left=S.checked?"21px":"3px"};q(),S.addEventListener("change",q)}b("hb-btn1-enabled","hb-btn1-slider","hb-btn1-knob"),b("hb-btn2-enabled","hb-btn2-slider","hb-btn2-knob"),g.querySelectorAll(".hb-tab-btn").forEach(h=>{h.addEventListener("click",()=>{g.querySelectorAll(".hb-tab-btn").forEach(f=>f.classList.remove("active")),g.querySelectorAll(".hb-tab-panel").forEach(f=>f.classList.remove("active")),h.classList.add("active"),g.querySelector(`#hb-panel-${h.dataset.tab}`).classList.add("active")})}),g.querySelector("#hb-bg-pick").addEventListener("click",()=>{$e({type:"image",title:"Seleccionar imagen de fondo",onSelect:h=>{g.querySelector("#hb-bg-url").value=h,g.querySelector("#hb-bg-preview").src=h}})}),g.querySelector("#hb-bg-url").addEventListener("input",h=>{g.querySelector("#hb-bg-preview").src=h.target.value});const E=()=>d.remove();g.querySelector("#hb-modal-close").onclick=E,g.querySelector("#hb-modal-cancel").onclick=E,d.onclick=h=>{h.target===d&&E()},g.querySelector("#hb-modal-save").onclick=()=>{const h={bg_image:g.querySelector("#hb-bg-url").value.trim()||Q.bg_image,title:g.querySelector("#hb-title").value.trim(),subtitle:g.querySelector("#hb-subtitle").value.trim(),btn_primary:{enabled:g.querySelector("#hb-btn1-enabled").checked,label:g.querySelector("#hb-btn1-label").value.trim(),href:g.querySelector("#hb-btn1-href").value.trim()||"#",color:u},btn_secondary:{enabled:g.querySelector("#hb-btn2-enabled").checked,label:g.querySelector("#hb-btn2-label").value.trim(),href:g.querySelector("#hb-btn2-href").value.trim()||"#",color:L}},w=e.getEl()?.querySelector("[id^='hb-root-']")?.id?.replace("hb-root-","")||"hb"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-hero-banner-config":JSON.stringify(h)}),e.components(ut(h,w)+bt),E()}}function Hr(t){const e="hero-banner-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-hero-banner-config":JSON.stringify(Q)},components:ut(Q)+bt,traits:[{type:"button",label:"Banner",text:"Administrar Banner",full:!0,command:"open-hero-banner-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-hero-banner-config",{run(i){const a=i.getSelected();a&&Pr(i,a)}}),t.BlockManager.add("hero-banner-block",{label:"Banner",category:"Banners",media:`<svg viewBox="0 0 32 32" width="32" height="32">
