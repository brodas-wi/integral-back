...
${_e}`}],et=function(){(function(){function t(i){if(!i||i.__pcInit)return;i.__pcInit=!0;var a=i.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,o=0,n=!1,h=0,f=0,c=0,v=null;a.querySelectorAll("img").forEach(function(d){d.setAttribute("draggable","false")}),setTimeout(function(){var d=a.scrollWidth-a.clientWidth;if(d<=0)return;var b=Math.min(60,d),E=null;function x(T){E||(E=T);var I=(T-E)/400;if(I<.5)a.scrollLeft=b*(I*2);else if(I<1)a.scrollLeft=b*(1-(I-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(x)}requestAnimationFrame(x)},400),a.scrollLeft=0;function u(){return a.scrollWidth-a.clientWidth}function y(d){return Math.max(0,Math.min(d,u()))}function p(){Math.abs(h)<.5||(h*=.92,a.scrollLeft=y(a.scrollLeft+h),v=requestAnimationFrame(p))}a.addEventListener("mousedown",function(d){d.button===0&&(v&&(cancelAnimationFrame(v),v=null),r=!0,n=!1,h=0,l=d.clientX,f=d.clientX,c=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",d.preventDefault())}),document.addEventListener("mousemove",function(d){if(r){var b=l-d.clientX;Math.abs(b)>3&&(n=!0);var E=Date.now(),x=E-c||1;h=(d.clientX-f)/x*16*-1,f=d.clientX,c=E,a.scrollLeft=y(o+b)}}),document.addEventListener("mouseup",function(d){r&&(r=!1,a.style.cursor="grab",n&&(d.stopPropagation(),v=requestAnimationFrame(p)))}),a.addEventListener("click",function(d){n&&(d.preventDefault(),d.stopPropagation(),n=!1)},!0);var $=0,C=0,B=0,S=0,m=0;a.addEventListener("touchstart",function(d){v&&(cancelAnimationFrame(v),v=null),$=d.touches[0].clientX,B=d.touches[0].clientX,S=Date.now(),C=a.scrollLeft,m=0},{passive:!0}),a.addEventListener("touchmove",function(d){var b=Date.now(),E=b-S||1,x=d.touches[0].clientX;m=(x-B)/E*16*-1,B=x,S=b;var T=$-x;a.scrollLeft=y(C+T)},{passive:!0}),a.addEventListener("touchend",function(){v=requestAnimationFrame(function d(){Math.abs(m)<.5||(m*=.92,a.scrollLeft=y(a.scrollLeft+m),v=requestAnimationFrame(d))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(i){delete i.__pcInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Ft=`(${et.toString()})();`,Vt=`
...
@media(max-width:480px){.pc-card{flex:0 0 80vw;}}`;function Xt(t){const e=t.img||P("images/placeholder.svg"),i=t.title||"TÍTULO DEL PRODUCTO",a=t.desc||"Descripción breve del producto financiero.",r=t.href||"#",l=t.btn_label||"Solicitar";return`<div class="pc-card"><div class="pc-card-img-wrap"><img src="${e}" alt="${i}" class="pc-card-img"></div><div class="pc-card-body"><h3 class="pc-card-title">${i}</h3><p class="pc-card-desc">${a}</p></div><a href="${r}" class="pc-btn">${l}</a></div>`}function tt(t){const e=t.heading||"Créditos",i=t.subheading||"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",a=t.more_href||"#",r=t.more_label||"Ver más",l=t.show_more!==!1,n=(t.cards||[]).map(Xt).join(""),h=l?`<div class="pc-more-wrap"><a href="${a}" class="pc-more-btn">${r}</a></div>`:"";return`<section class="pc-section"><style>${Vt}</style><div style="text-align:center;margin-bottom:2rem;"><h2 class="pc-section-heading">${e}</h2><p class="pc-section-subheading">${i}</p></div><div class="pc-carousel-wrap"><div class="pc-track">${n}</div></div>${h}</section>`}const Y={heading:"Créditos",subheading:"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CREDINVIERTE",desc:"Adquiere activos fijos",href:"#",btn_label:"Solicitar"},{img:"",title:"SOLUCIONES INTEGRALES",desc:"Financiamiento PYME",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDI-CONFIAMOS",desc:"Rápido y sin fiador",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDILÍNEA",desc:"Línea rotativa",href:"#",btn_label:"Solicitar"}]};function Wt(t,e){const i=document.getElementById("pc-config-modal");if(i&&i.remove(),!document.getElementById("pc-modal-styles")){const f=document.createElement("style");f.id="pc-modal-styles",f.textContent=`
        ...
        </div>`,l.appendChild(o),document.body.appendChild(l),o.querySelectorAll(".pc-tab-btn").forEach(f=>{f.addEventListener("click",()=>{o.querySelectorAll(".pc-tab-btn").forEach(c=>c.classList.remove("active")),o.querySelectorAll(".pc-tab-panel").forEach(c=>c.classList.remove("active")),f.classList.add("active"),o.querySelector(`#pc-panel-${f.dataset.tab}`).classList.add("active")})}),o.querySelector("#pc-show-more").addEventListener("change",function(){r.show_more=this.checked,o.querySelector("#pc-more-fields").style.display=this.checked?"flex":"none"});function n(){const f=o.querySelector("#pc-cards-list");f.innerHTML="",r.cards.forEach((c,v)=>{const u=document.createElement("div");u.className="pc-card-config";const y=c.img?`<img class="pc-img-preview" src="${c.img}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>';u.innerHTML=`
...
${Qt}`}],it=function(){(function(){function t(i){if(!i||i.__savInit)return;i.__savInit=!0;var a=i.querySelector(".sav-carousel-wrap");if(!a)return;a.scrollLeft=0;var r=!1,l=0,o=0,n=!1,h=0,f=0,c=0,v=null;a.querySelectorAll("img").forEach(function(d){d.setAttribute("draggable","false")}),setTimeout(function(){var d=a.scrollWidth-a.clientWidth;if(d<=0)return;var b=Math.min(60,d),E=null;function x(T){E||(E=T);var I=(T-E)/400;if(I<.5)a.scrollLeft=b*(I*2);else if(I<1)a.scrollLeft=b*(1-(I-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(x)}requestAnimationFrame(x)},400);function u(){return a.scrollWidth-a.clientWidth}function y(d){return Math.max(0,Math.min(d,u()))}function p(){Math.abs(h)<.5||(h*=.92,a.scrollLeft=y(a.scrollLeft+h),v=requestAnimationFrame(p))}a.addEventListener("mousedown",function(d){d.button===0&&(v&&(cancelAnimationFrame(v),v=null),r=!0,n=!1,h=0,l=d.clientX,f=d.clientX,c=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",d.preventDefault())}),document.addEventListener("mousemove",function(d){if(r){var b=l-d.clientX;Math.abs(b)>3&&(n=!0);var E=Date.now(),x=E-c||1;h=(d.clientX-f)/x*16*-1,f=d.clientX,c=E,a.scrollLeft=y(o+b)}}),document.addEventListener("mouseup",function(d){r&&(r=!1,a.style.cursor="grab",n&&(d.stopPropagation(),v=requestAnimationFrame(p)))}),a.addEventListener("click",function(d){n&&(d.preventDefault(),d.stopPropagation(),n=!1)},!0);var $=0,C=0,B=0,S=0,m=0;a.addEventListener("touchstart",function(d){v&&(cancelAnimationFrame(v),v=null),$=d.touches[0].clientX,B=d.touches[0].clientX,S=Date.now(),C=a.scrollLeft,m=0},{passive:!0}),a.addEventListener("touchmove",function(d){var b=Date.now(),E=b-S||1,x=d.touches[0].clientX;m=(x-B)/E*16*-1,B=x,S=b;var T=$-x;a.scrollLeft=y(C+T)},{passive:!0}),a.addEventListener("touchend",function(){v=requestAnimationFrame(function d(){Math.abs(m)<.5||(m*=.92,a.scrollLeft=y(a.scrollLeft+m),v=requestAnimationFrame(d))})},{passive:!0})}function e(){document.querySelectorAll(".sav-section").forEach(function(i){delete i.__savInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},ti=`(${it.toString()})();`,ii=`
...
@media(max-width:480px){.sav-card{flex:0 0 75vw;}}`;function ai(t){const e=t.img||P("images/placeholder.svg"),i=t.title||"TÍTULO DEL PRODUCTO",a=t.desc?`<p class="sav-card-desc">${t.desc}</p>`:"",r=t.href||"#",l=t.btn_label||"Solicitar";return`<div class="sav-card"><div class="sav-card-img-wrap"><img src="${e}" alt="${i}" class="sav-card-img"></div><h3 class="sav-card-title">${i}</h3>${a}<a href="${r}" class="sav-btn">${l}</a></div>`}function at(t){const e=t.heading||"Depósitos y Cuentas de Ahorro",i=t.subheading||"Productos diseñados para hacer crecer tu dinero de forma segura.",a=t.more_href||"#",r=t.more_label||"Ver más",l=t.show_more!==!1,n=(t.cards||[]).map(ai).join(""),h=P("images/brand-watermark.png"),f=l?`<div class="sav-more-wrap"><a href="${a}" class="sav-more-btn">${r}</a></div>`:"";return`<section class="sav-section"><style>${ii}</style><div class="sav-blue-box"><div class="sav-watermark"><img src="${h}" alt=""></div><div style="display:flex;flex-direction:column;gap:0.5rem;text-align:center;position:relative;z-index:1;"><h2 class="sav-heading">${e}</h2><p class="sav-subheading">${i}</p></div><div class="sav-carousel-wrap"><div class="sav-track">${n}</div></div>${f}</div></section>`}const G={heading:"Depósitos y Cuentas de Ahorro",subheading:"Productos diseñados para hacer crecer tu dinero de forma segura.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CUENTA DE AHORRO ESTÁNDAR",href:"#",btn_label:"Solicitar"},{img:"",title:"AHORRO RENTABLE",href:"#",btn_label:"Solicitar"},{img:"",title:"CUENTA DE AHORRO MÁS",href:"#",btn_label:"Solicitar"},{img:"",title:"DEPÓSITO DE PLAZO FIJO",href:"#",btn_label:"Solicitar"}]};function ri(t,e){const i=document.getElementById("sav-config-modal");if(i&&i.remove(),!document.getElementById("sav-modal-styles")){const f=document.createElement("style");f.id="sav-modal-styles",f.textContent=`
        ...
        </div>`,l.appendChild(o),document.body.appendChild(l),l.addEventListener("click",f=>{f.target===l&&h()}),o.querySelectorAll(".sav-tab-btn").forEach(f=>{f.addEventListener("click",()=>{o.querySelectorAll(".sav-tab-btn").forEach(c=>c.classList.remove("active")),o.querySelectorAll(".sav-tab-panel").forEach(c=>c.classList.remove("active")),f.classList.add("active"),o.querySelector(`#sav-panel-${f.dataset.tab}`).classList.add("active")})}),o.querySelector("#sav-show-more").addEventListener("change",function(){r.show_more=this.checked,o.querySelector("#sav-more-fields").style.display=this.checked?"flex":"none"});function n(){const f=o.querySelector("#sav-cards-list");f.innerHTML="",r.cards.forEach((c,v)=>{const u=document.createElement("div");u.className="sav-card-config";const y=c.img?`<img class="sav-img-preview" src="${c.img}" alt="">`:'<div class="sav-img-placeholder"><i class="ri-image-line"></i></div>';u.innerHTML=`
...
<\/script>`}],ma=`<svg viewBox="0 0 32 32" width="32" height="32">
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
        ...
        </tr>`,t.headers?.length&&(a+="<tr>",t.headers.forEach((o,n)=>{const h=n<t.headers.length-1?`border-r border-[${i.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${i.subheaderBg} ${i.subheaderText} ${h} border-b border-[${i.borderColor}] text-${o.align||"center"}">${o.text||""}</th>`}),a+="</tr>"),a+="</thead>"):t.headers?.length&&(a+="<thead><tr>",t.headers.forEach((o,n)=>{const h=n<t.headers.length-1?`border-r border-[${i.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${i.headerBg} ${i.headerText} ${h} border-b border-[${i.borderColor}] text-${o.align||"center"}">${o.text||""}</th>`}),a+="</tr></thead>"),a+="<tbody>";const r=t.rows.length,l={};return t.rows.forEach((o,n)=>{a+="<tr>";let h=0;o.forEach(f=>{for(;l[`${n}-${h}`];)h++;const c=f.colspan||1,v=f.rowspan||1;for(let x=n;x<n+v;x++)for(let T=h;T<h+c;T++)(x!==n||T!==h)&&(l[`${x}-${T}`]=!0);const u=c>1?`colspan="${c}"`:"",y=v>1?`rowspan="${v}"`:"",p=f.isHeader?i.labelBg:n%2===0?i.rowEvenBg:i.rowOddBg,$=f.isHeader?"font-semibold":"font-normal",C=f.isHeader?i.labelText:i.rowText,B=`text-${f.align||"center"}`,S=n+v>=r,d=h+c>=t.cols?"":`border-r border-[${i.borderColor}]`,b=S?"":`border-b border-[${i.borderColor}]`,E=`${d} ${b} p-3 align-middle text-sm ${p} ${$} ${C} ${B}`;f.image?a+=`<td ${u} ${y} class="${E}">
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function ua(){if(document.getElementById("tam-img-modal"))return;const t=document.createElement("div");t.id="tam-img-modal",t.innerHTML=`
        ...
        </div>`,document.body.appendChild(t);let e=null,i=null;async function a(n=""){const h=document.getElementById("tam-img-grid");h.innerHTML='<div class="tam-img-loading"><div class="tam-img-spinner"></div><span>Cargando...</span></div>';try{const f=new URLSearchParams({type:"image",per_page:50});n&&f.append("search",n);const c=document.querySelector('meta[name="media-api-url"]')?.content??"/media/api",y=(await(await fetch(`${c}?${f}`,{headers:{"X-Requested-With":"XMLHttpRequest",Accept:"application/json"}})).json()).items||[];if(!y.length){h.innerHTML='<div class="tam-img-loading"><i class="ri-image-line" style="font-size:2rem;"></i><span>No se encontraron imágenes</span></div>';return}h.innerHTML="",y.forEach(p=>{const $=document.createElement("div");$.className="tam-img-card",$.innerHTML=`<img src="${p.url}" alt="${p.filename}"><p title="${p.filename}">${p.filename}</p>`,$.addEventListener("click",()=>{h.querySelectorAll(".tam-img-card").forEach(C=>C.classList.remove("selected")),$.classList.add("selected"),e=p.url,document.getElementById("tam-img-selected-info").textContent=`Seleccionada: ${p.filename}`,document.getElementById("tam-img-confirm").disabled=!1}),h.appendChild($)})}catch{h.innerHTML='<div class="tam-img-loading"><i class="ri-error-warning-line" style="font-size:2rem;color:#f87171;"></i><span style="color:#dc2626;">Error al cargar imágenes</span></div>'}}function r(n){i=n,e=null,document.getElementById("tam-img-selected-info").textContent="Ninguna imagen seleccionada",document.getElementById("tam-img-confirm").disabled=!0,document.getElementById("tam-img-search-input").value="",t.classList.add("open"),a()}function l(){t.classList.remove("open"),e=null,i=null}document.getElementById("tam-img-close").addEventListener("click",l),document.getElementById("tam-img-cancel").addEventListener("click",l),document.getElementById("tam-img-confirm").addEventListener("click",()=>{e&&i&&(i(e),l())});let o;document.getElementById("tam-img-search-input").addEventListener("input",n=>{clearTimeout(o),o=setTimeout(()=>a(n.target.value),300)}),t.addEventListener("click",n=>{n.target===t&&l()}),window.__openTableImagePicker=r}function xa(t,e){if(document.getElementById("table-admin-modal"))return;const i=document.createElement("style");i.id="table-admin-modal-styles",i.textContent=ba,document.head.appendChild(i),ua();const a=document.createElement("div");a.id="table-admin-modal",a.innerHTML=`
        <div class="tam-container">
        ...
        </div>`,document.body.appendChild(a);let r=null,l=null;function o(u){r=u;const y=u.get("tableData");l=y?JSON.parse(JSON.stringify(y)):te(3,3);const p=l.cols||3;l.rows=l.rows.map(($,C)=>Array.from({length:p},(S,m)=>$[m]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})),document.getElementById("tam-title").value=l.title||"",document.getElementById("tam-theme").value=u.get("tableTheme")||"blue",document.getElementById("tam-cols").value=l.cols||3,document.getElementById("tam-rows").value=l.rows.length||3,c(),v(),a.classList.add("open"),document.body.style.overflow="hidden"}function n(){a.classList.remove("open"),document.body.style.overflow="",r=null}function h(){l.title=document.getElementById("tam-title").value.trim(),l.cols=parseInt(document.getElementById("tam-cols").value)||3,l.headers=Array.from(document.querySelectorAll(".tam-header-input")).map(y=>({text:y.value,align:y.closest("th")?.querySelector(".tam-align-select")?.value||"center"})),document.querySelectorAll("#tam-tbody td.tam-cell:not(.is-spanned)").forEach(y=>{const p=parseInt(y.dataset.row),$=parseInt(y.dataset.col);l.rows[p]?.[$]&&(l.rows[p][$].text=y.querySelector(".tam-cell-input")?.value||"",l.rows[p][$].align=y.querySelector(".tam-align-select")?.value||"center",l.rows[p][$].isHeader=y.dataset.isheader==="1",l.rows[p][$].image=y.dataset.image||null)});const u=We(l.rows,l.cols);l.rows=l.rows.map((y,p)=>y.filter(($,C)=>!u[`${p}-${C}`]))}function f(){if(a.querySelector("#tam-rebuild-notice"))return;const y=document.createElement("div");y.id="tam-rebuild-notice",y.style.cssText="background:#fef9c3;border:1.5px solid #ca8a04;border-radius:0.5rem;padding:0.5rem 1rem;font-size:0.8rem;color:#92400e;display:flex;align-items:center;gap:0.5rem;margin:0 1.5rem 0;flex-shrink:0;",y.innerHTML='<i class="ri-error-warning-line"></i> Has modificado el colspan/rowspan. Haz clic en <strong style="margin:0 4px;">Reconstruir</strong> para aplicar los cambios de fusión.',a.querySelector(".tam-toolbar").after(y)}function c(){a.querySelector("#tam-rebuild-notice")?.remove()}function v(){const u=document.getElementById("tam-thead"),y=document.getElementById("tam-tbody"),p=l.cols,$=l.rows.length,C=We(l.rows,p);u.innerHTML=`<tr>${l.headers.map((B,S)=>`
            <th>
                <input class="tam-cell-input tam-header-input" value="${B.text||""}" placeholder="Col ${S+1}" style="font-weight:600;">
                <select class="tam-align-select" style="margin-top:4px;width:100%;font-size:0.7rem;padding:2px;">
            ...
            </th>`).join("")}</tr>`,y.innerHTML=l.rows.map((B,S)=>`<tr>${Array.from({length:p},(d,b)=>{const E=C[`${S}-${b}`];if(E)return`<td class="tam-cell is-spanned" data-row="${S}" data-col="${b}">
                        <div class="tam-spanned-label">Combinada con [${E}]</div>
                    </td>`;const x=B[b]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null},T=x.colspan||1,I=x.rowspan||1,j=T>1||I>1;return`<td class="tam-cell ${x.isHeader?"is-header-cell":""} ${x.image?"has-image":""} ${j?"has-span":""}"
                    data-row="${S}" data-col="${b}"
                    ...
                    <div class="tam-cell-actions">
                        <button type="button" class="tam-cell-btn tam-cell-btn-header ${x.isHeader?"active":""}"
                            data-action="header" data-row="${S}" data-col="${b}">
                            ${x.isHeader?"✓ Etiqueta":"Etiqueta"}
                        </button>
                        <button type="button" class="tam-cell-btn tam-cell-btn-img"
                            data-action="image" data-row="${S}" data-col="${b}">
                            <i class="ri-image-line"></i> ${x.image?"Cambiar":"Imagen"}
                        </button>
                        ${x.image?`<button type="button" class="tam-cell-btn tam-cell-btn-clear" data-action="clear-image" data-row="${S}" data-col="${b}">✕ Quitar</button>`:""}
                        <div class="tam-cell-span-group">
                            ...
                            <input type="number" class="tam-cell-span-input" min="1" max="${p-b}"
                                value="${T}" data-action="colspan" data-row="${S}" data-col="${b}">
                            <label title="Filas que ocupa">RS</label>
                            <input type="number" class="tam-cell-span-input" min="1" max="${$-S}"
                                value="${I}" data-action="rowspan" data-row="${S}" data-col="${b}">
                        </div>
                    </div>
                </td>`}).join("")}</tr>`).join(""),y.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(B=>{B.addEventListener("change",()=>{const S=parseInt(B.dataset.row),m=parseInt(B.dataset.col),d=Math.max(1,parseInt(B.value)||1);l.rows[S]?.[m]&&(B.dataset.action==="colspan"?l.rows[S][m].colspan=Math.min(d,p-m):l.rows[S][m].rowspan=Math.min(d,$-S),f())})}),y.querySelectorAll("button[data-action]").forEach(B=>{B.addEventListener("click",S=>{S.preventDefault(),S.stopPropagation();const m=B.dataset.action,d=parseInt(B.dataset.row),b=parseInt(B.dataset.col);if(!(isNaN(d)||isNaN(b)||!l.rows[d]?.[b])){if(m==="header"){l.rows[d][b].isHeader=!l.rows[d][b].isHeader;const E=y.querySelector(`td[data-row="${d}"][data-col="${b}"]`);E&&(E.dataset.isheader=l.rows[d][b].isHeader?"1":"0",E.classList.toggle("is-header-cell",l.rows[d][b].isHeader)),B.classList.toggle("active",l.rows[d][b].isHeader),B.textContent=l.rows[d][b].isHeader?"✓ Etiqueta":"Etiqueta";return}if(m==="image"){window.__openTableImagePicker&&window.__openTableImagePicker(E=>{l.rows[d][b].image=E;const x=y.querySelector(`td[data-row="${d}"][data-col="${b}"]`);if(x){x.dataset.image=E,x.classList.add("has-image");let T=x.querySelector(".tam-cell-img-preview");T||(T=document.createElement("img"),T.className="tam-cell-img-preview",x.insertBefore(T,x.firstChild)),T.src=E;const I=x.querySelector("[data-action=image]");if(I&&(I.innerHTML='<i class="ri-image-line"></i> Cambiar'),!x.querySelector("[data-action=clear-image]")){const j=document.createElement("button");j.type="button",j.className="tam-cell-btn tam-cell-btn-clear",j.dataset.action="clear-image",j.dataset.row=d,j.dataset.col=b,j.textContent="✕ Quitar",j.addEventListener("click",q=>{q.preventDefault(),q.stopPropagation(),l.rows[d][b].image=null,x.dataset.image="",x.classList.remove("has-image"),T.remove(),j.remove();const D=x.querySelector("[data-action=image]");D&&(D.innerHTML='<i class="ri-image-line"></i> Imagen')}),x.querySelector(".tam-cell-actions").appendChild(j)}}});return}m==="clear-image"&&(l.rows[d][b].image=null,v())}})})}document.getElementById("tam-close").addEventListener("click",n),document.getElementById("tam-cancel").addEventListener("click",n),a.addEventListener("click",u=>{u.target===a&&n()}),document.getElementById("tam-rebuild").addEventListener("click",()=>{const u=parseInt(document.getElementById("tam-cols").value)||3,y=parseInt(document.getElementById("tam-rows").value)||3;for(c(),h();l.headers.length<u;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,u),l.cols=u;l.rows.length<y;)l.rows.push(Array.from({length:u},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,y).map(p=>{for(;p.length<u;)p.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return p.slice(0,u)}),v()}),document.getElementById("tam-apply").addEventListener("click",()=>{h();const u=document.getElementById("tam-theme").value;r&&(r.set("tableData",JSON.parse(JSON.stringify(l))),r.set("tableTheme",u),r.addAttributes({"data-table-theme":u}),Le(r)),n()}),window.__openTableAdminModal=o}function Le(t){const e=t.get("tableData"),i=t.get("tableTheme")||"blue";e&&t.components(lt(rt(e,i),i))}function ya(){return function(){}}const va=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:ma,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<a href="#"
   ...
   class="dld-simple-${e}">
    ...
    <rect x="3" y="25" width="7" height="2.5" fill="#dee2e6" rx="0.5"/>
</svg>`;function Ra(){return function(){const t=this,e="agencies-map-component",i="/api/agencies/active",a="agencies";let r=[],l=[],o={},n=null,h=[];const f=async()=>{try{c(),await u(),await $(),C(),E(),j(),q(),v()}catch(s){console.error("Error initializing map:",s),N("Error al cargar las agencias"),v()}};function c(){const s=t.querySelector(`.${e}-list`);s&&(s.innerHTML=`
                ...
                `);const w=t.querySelector(`.${e}-map-container`);w&&(w.style.opacity="0.5")}function v(){const s=t.querySelector(`.${e}-map-container`);s&&(s.style.transition="opacity 0.3s ease",s.style.opacity="1")}async function u(){try{const w=await(await fetch(i)).json(),k=a?w[a]:w;Array.isArray(k)?(r=k.filter(g=>g.latitude&&g.longitude&&!isNaN(g.latitude)&&!isNaN(g.longitude)),l=[...r],y()):(r=[],l=[])}catch(s){console.error("Error loading items:",s),r=[],l=[]}}function y(){const s=[...new Set(r.map(k=>k.zone).filter(Boolean))].sort(),w=[...new Set(r.map(k=>k.department).filter(Boolean))].sort();o={zone:s,department:w},setTimeout(()=>{const k=t.querySelector(`.${e}-filters-container`);k&&!k.hasChildNodes()&&(k.innerHTML=`
                    ...
                    `,p())},100)}function p(){const s=t.querySelector(`.${e}-zone-filter`),w=t.querySelector(`.${e}-department-filter`);s&&o.zone&&o.zone.forEach(k=>{const g=document.createElement("option");g.value=k,g.textContent=k,s.appendChild(g)}),w&&o.department&&o.department.forEach(k=>{const g=document.createElement("option");g.value=k,g.textContent=k,w.appendChild(g)})}async function $(){if(!document.getElementById("leaflet-css")){const s=document.createElement("link");s.id="leaflet-css",s.rel="stylesheet",s.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",document.head.appendChild(s)}if(typeof window.L>"u"&&await new Promise((s,w)=>{const k=document.createElement("script");k.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",k.onload=s,k.onerror=w,document.head.appendChild(k)}),typeof window.L<"u"&&window.L.Icon&&window.L.Icon.Default){const s=window.L.icon({iconUrl:"data:image/svg+xml;base64,"+btoa(`
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 36" width="24" height="36">
                            <path fill="#f0872a" d="M12 0C7.6 0 4 3.6 4 8c0 5.4 8 16 8 16s8-10.6 8-16c0-4.4-3.6-8-8-8z"/>
                            <circle cx="12" cy="8" r="3" fill="#fff"/>
                        </svg>
                    `),iconSize:[30,45],iconAnchor:[15,45],popupAnchor:[0,-45]});window.customOrangeIcon=s}}function C(){const s=t.querySelector(`.${e}-map`);if(!s||!window.L)return;s._leaflet_id&&s._map&&(s._map.remove(),delete s._map),n=window.L.map(s).setView([13.7942,-88.8965],8),window.L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(n),s._map=n,n.whenReady(function(){B(),setTimeout(()=>{n&&n.invalidateSize&&n.invalidateSize()},300)})}function B(){S(),m(),b()}function S(){h.forEach(s=>{s.marker&&n.removeLayer(s.marker)}),h=[]}function m(){l.forEach((s,w)=>{if(s.latitude&&s.longitude){const k=d(s),g=window.L.marker([s.latitude,s.longitude],{icon:window.customOrangeIcon||new window.L.Icon.Default}).addTo(n).bindPopup(k);h.push({marker:g,item:s,index:w})}})}function d(s){let w=`<div style="min-width: 200px;"><h4 style="font-weight: 700; margin-bottom: 12px; color: #0d3f6a; font-size: 16px; border-bottom: 2px solid #f0872a; padding-bottom: 8px;">${s.name}</h4>`;if(s.address&&(w+=`<p style="margin: 8px 0 0 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-map-pin-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${s.address}</span></p>`),s.municipality||s.department){const k=[s.municipality,s.department].filter(Boolean).join(", ");w+=`<p style="margin: 0 0 8px 0; font-size: 13px; color: #6b7280; padding-left: 24px;">${k}</p>`}return s.schedule&&(w+=`<p style="margin: 8px 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-time-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${s.schedule}</span></p>`),w+="</div>",w}function b(){if(l.length>0){const s=l.filter(w=>w.latitude&&w.longitude).map(w=>[w.latitude,w.longitude]);s.length>1?n.once("moveend",function(){setTimeout(()=>{try{n&&n._loaded&&typeof n.fitBounds=="function"&&n.fitBounds(s,{padding:[50,50],maxZoom:12,animate:!1})}catch(w){console.warn("Error fitting bounds:",w)}},100)}):s.length===1&&n.setView(s[0],14)}}function E(){const s=t.querySelector(`.${e}-list`);if(!s)return;if(l.length===0){T(s);return}const w=l.map((k,g)=>x(k,g)).join("");s.innerHTML=w,I()}function x(s,w){const k=s.phones&&s.phones.length>0?s.phones.map(_=>`
                    ...
                    `).join(""):"",g=`https://www.google.com/maps/search/?api=1&query=${s.latitude},${s.longitude}`;return`
                <div class="${e}-item p-5 bg-white/10 border border-white/20 rounded-2xl cursor-pointer transition-all duration-200" data-item-index="${w}">
                    ...
                    ${k}
                    <div class="mt-3">
                        <a href="${g}" target="_blank" rel="noopener noreferrer" class="agency-maps-btn block w-full text-center px-4 py-2.5 bg-primary text-white font-semibold rounded-lg hover:opacity-90 transition-all duration-200" onclick="event.stopPropagation();">
                            Ver ubicación
                        </a>
                    </div>
                </div>
            ...
            `}function I(){const s=t.querySelectorAll(`.${e}-item`);s.forEach(w=>{w.addEventListener("click",k=>{if(k.target.closest(".agency-maps-btn"))return;k.preventDefault();const g=parseInt(w.dataset.itemIndex),_=l[g];if(!_)return;s.forEach(z=>{z.classList.remove("bg-white","border-secondary","selected-agency"),z.classList.add("bg-white/10","border-white/20");const U=z.querySelector(".agency-title"),fe=z.querySelectorAll("i"),he=z.querySelectorAll(".agency-phone-link"),ke=z.querySelectorAll("p:not(:has(.agency-phone-link))"),Be=z.querySelector(".agency-maps-btn");U&&(U.classList.remove("text-secondary"),U.classList.add("text-white")),fe.forEach(Z=>{Z.classList.remove("text-secondary","text-gray-300","text-white"),Z.classList.add("text-primary")}),he.forEach(Z=>{Z.classList.remove("text-secondary"),Z.classList.add("text-white")}),ke.forEach(Z=>{Z.classList.remove("text-secondary"),Z.classList.add("text-gray-200")}),Be&&(Be.classList.remove("bg-secondary"),Be.classList.add("bg-primary"))}),w.classList.remove("bg-white/10","border-white/20"),w.classList.add("bg-white","border-secondary","selected-agency");const F=w.querySelector(".agency-title"),R=w.querySelectorAll("i"),V=w.querySelectorAll(".agency-phone-link"),H=w.querySelectorAll("p:not(:has(.agency-phone-link))"),X=w.querySelector(".agency-maps-btn");if(F&&(F.classList.remove("text-white"),F.classList.add("text-secondary")),R.forEach(z=>{z.classList.remove("text-secondary","text-gray-300","text-white"),z.classList.add("text-primary")}),V.forEach(z=>{z.classList.remove("text-white"),z.classList.add("text-secondary")}),H.forEach(z=>{z.classList.remove("text-gray-200"),z.classList.add("text-secondary")}),X&&(X.classList.remove("bg-primary"),X.classList.add("bg-secondary")),n&&_&&n._loaded)try{n.flyTo([_.latitude,_.longitude],14,{animate:!0,duration:1});const z=h.find(U=>U.item.id===_.id);z&&z.marker&&z.marker.openPopup()}catch(z){console.warn("Error updating map view:",z)}})})}function j(){const s=t.querySelector(`.${e}-search-input`),w=t.querySelector(`.${e}-zone-filter`),k=t.querySelector(`.${e}-department-filter`),g=t.querySelector(`.${e}-no-results`),_={Occidental:["Ahuachapán","Santa Ana","Sonsonate"],Paracentral:["Chalatenango","Cuscatlán","La Paz","Cabañas","San Vicente"],Central:["La Libertad","San Salvador"],Oriental:["Usulután","San Miguel","Morazán","La Unión"]},F=()=>{if(!w||!k)return;const V=w.value,H=k.value;if(!V)k.innerHTML='<option value="">Todos los Departamentos</option>',[...new Set(r.map(z=>z.department).filter(Boolean))].sort().forEach(z=>{const U=document.createElement("option");U.value=z,U.textContent=z,k.appendChild(U)}),H&&(k.value=H);else{const X=_[V]||[];k.innerHTML='<option value="">Todos los Departamentos</option>',X.forEach(z=>{const U=document.createElement("option");U.value=z,U.textContent=z,k.appendChild(U)}),X.includes(H)&&(k.value=H)}},R=()=>{const V=s?s.value.toLowerCase().trim():"",H=w?w.value:"",X=k?k.value:"";l=r.filter(z=>{let U=!0,fe=!0,he=!0;return V&&(U=Object.values(z).some(ke=>String(ke).toLowerCase().includes(V))),H&&(fe=z.zone===H),X&&(he=z.department===X),U&&fe&&he}),E(),B(),g&&g.classList.toggle("hidden",l.length>0)};s&&s.addEventListener("input",R),w&&w.addEventListener("change",()=>{F(),R()}),k&&k.addEventListener("change",R)}function q(){const s=t.querySelector("[data-title]");if(s){const g=D("map-title")||"Nuestras Agencias";s.textContent=g}const w=t.querySelector(`.${e}-search-input`);if(w){const g=D("search-placeholder")||"Buscar...";w.setAttribute("placeholder",g)}const k=t.querySelector(`.${e}-no-results`);if(k){const g=D("no-results-text")||"No se encontraron agencias";k.textContent=g}}function D(s){return t.closest(`[data-gjs-type="${e}"]`)?.getAttribute(s)}function N(s){const w=t.querySelector(`.${e}-list`);w&&(w.innerHTML=`
                    <div class="flex flex-col items-center justify-center p-12 text-center">
...
@media(max-width:768px){.bsk-buttons{flex-direction:column;}}`;function Ga(){return function(){const t=this,e=t.ownerDocument??document,i=e.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??"",a=e.querySelector('meta[name="api-banners-url"]')?.content||`${i}/api/banners/active`,r=["fill-blue","outline-blue","fill-orange","outline-orange","fill-white","outline-white"],l=".banner-wrapper{position:relative;width:100%;background:#003B71;overflow:hidden;}.banner-slide-container{position:relative;width:100%;user-select:none;cursor:grab;display:grid;}.banner-slide-container:active{cursor:grabbing;}.banner-slide{grid-area:1/1;opacity:0;pointer-events:none;transition:opacity 0.7s ease;visibility:hidden;display:flex;flex-direction:column;}.banner-slide.banner-slide--active{opacity:1;pointer-events:auto;visibility:visible;}.banner-slide-inner{position:relative;width:100%;flex:1;min-height:480px;display:flex;align-items:center;}.banner-bg{position:absolute;inset:0;z-index:0;}.banner-bg img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;}.banner-overlay{position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,59,113,0.85) 0%,rgba(0,59,113,0.65) 50%,rgba(0,59,113,0.2) 100%);z-index:1;}.banner-content{position:relative;z-index:10;display:flex;flex-direction:column;justify-content:center;padding:64px 64px 96px;max-width:60%;}.banner-category-badge{display:inline-block;margin-bottom:18px;padding:7px 20px;border-radius:999px;border:2px solid rgba(255,255,255,0.65);color:#fff;font-size:13px;font-weight:500;letter-spacing:0.04em;align-self:flex-start;}.banner-title{font-size:clamp(1.8rem,3.2vw,3rem);font-weight:800;color:#fff;line-height:1.15;margin:0 0 20px;}.banner-description{color:rgba(255,255,255,0.9);font-size:clamp(0.95rem,1.4vw,1.1rem);line-height:1.7;margin:0 0 36px;max-width:520px;}.banner-buttons{display:flex;flex-wrap:wrap;gap:16px;align-items:center;}.banner-btn{display:inline-block;padding:12px 32px;border-radius:999px;font-size:15px;font-weight:600;cursor:pointer;transition:background .2s,color .2s,border-color .2s;text-decoration:none;white-space:nowrap;line-height:1.4;box-sizing:border-box;}.banner-btn--fill-blue{background:#003B71;color:#ffffff;border:2px solid #003B71;}.banner-btn--fill-blue:hover{background:#002a52;border-color:#002a52;color:#ffffff;}.banner-btn--outline-blue{background:transparent;color:#003B71;border:2px solid #003B71;}.banner-btn--outline-blue:hover{background:#003B71;border-color:#003B71;color:#ffffff;}.banner-btn--fill-orange{background:#E97300;color:#ffffff;border:2px solid #E97300;}.banner-btn--fill-orange:hover{background:#c96200;border-color:#c96200;color:#ffffff;}.banner-btn--outline-orange{background:transparent;color:#E97300;border:2px solid #E97300;}.banner-btn--outline-orange:hover{background:#E97300;border-color:#E97300;color:#ffffff;}.banner-btn--fill-white{background:#ffffff;color:#003B71;border:2px solid #ffffff;}.banner-btn--fill-white:hover{background:#dce8f5;border-color:#dce8f5;color:#003B71;}.banner-btn--outline-white{background:transparent;color:#ffffff;border:2px solid #ffffff;}.banner-btn--outline-white:hover{background:#ffffff;border-color:#ffffff;color:#003B71;}.banner-dots-wrapper{display:none;}.banner-stripe{position:relative;width:100%;height:26px;background:#E97300;z-index:20;display:flex;align-items:center;justify-content:center;}.banner-dots{display:flex;gap:8px;align-items:center;}.banner-dot{width:10px;height:10px;border-radius:999px;border:none;cursor:pointer;background:rgba(255,255,255,0.5);transition:all 0.3s ease;padding:0;flex-shrink:0;}.banner-dot--active{width:28px;background:#ffffff;}.banner-empty{display:flex;align-items:center;justify-content:center;min-height:480px;color:rgba(255,255,255,0.5);font-size:14px;padding:40px;}@media(max-width:768px){.banner-slide-inner{min-height:340px;}.banner-bg img{object-position:right center;}.banner-content{max-width:100%;width:100%;padding:32px 24px 80px;}.banner-buttons{flex-wrap:wrap;gap:12px;}.banner-btn{flex:1 1 45%;min-width:140px;text-align:center;white-space:normal;word-break:break-word;}}@media(max-width:480px){.banner-btn{flex:1 1 100%;min-width:0;}}",o="@keyframes bsk-shimmer{0%{background-position:-600px 0}100%{background-position:600px 0}}.bsk-badge{width:120px;height:32px;margin-bottom:20px;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title{height:40px;margin-bottom:12px;border-radius:8px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title--short{width:60%;}.bsk-line{height:16px;margin-bottom:10px;border-radius:6px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-line--short{width:55%;}.bsk-buttons{display:flex;gap:16px;margin-top:36px;}.bsk-btn{height:48px;flex:1;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-bg-img{background:linear-gradient(90deg,rgba(255,255,255,0.04) 25%,rgba(255,255,255,0.09) 50%,rgba(255,255,255,0.04) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}@media(max-width:768px){.bsk-buttons{flex-direction:column;}}";(function(){if(!e.getElementById("banner-hero-styles")){const _=e.createElement("style");_.id="banner-hero-styles",_.textContent=l,e.head.appendChild(_)}if(!e.getElementById("banner-skeleton-styles")){const _=e.createElement("style");_.id="banner-skeleton-styles",_.textContent=o,e.head.appendChild(_)}})();let n=[],h=0,f=null,c=!1,v=0,u=0;const y=50,p=t.dataset.autoplay!=="false",$=t.dataset.category??"",C=t.querySelector(".banner-slide-container"),B=t.querySelector(".banner-stripe");if(!C||!B)return;function S(g){return r.indexOf(g)!==-1?g:g==="outline-blue"||g==="outline-orange"?"outline-white":"fill-white"}function m(g,_,F,R){const V=S(F),H=_?"a":"span",X=_?`href="${_}"${R?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${H} ${X} class="banner-btn banner-btn--${V}">${g}</${H}>`}async function d(){if(!t.__bannerLoading){t.__bannerLoading=!0,b();try{const g=await fetch(a,{headers:{Accept:"application/json"}});if(!g.ok){k();return}const _=await g.json();if(n=Array.isArray(_)?$?_.filter(F=>F.category===$):_:[],n.length===0){k();return}E(),D(),N(0,!1),p&&s()}catch{k()}finally{t.__bannerLoading=!1}}}function b(){C.innerHTML=`
                ...
                </div>`,B.innerHTML=""}function E(){C.innerHTML=n.map((g,_)=>`
                <div class="banner-slide" data-index="${_}">
                    <div class="banner-slide-inner">
                        <div class="banner-bg">
                            <img src="${g.image_url}"
                                 alt="${g.image_alt??g.title}"
                                 loading="${_===0?"eager":"lazy"}"
                                 decoding="async"
                                 fetchpriority="${_===0?"high":"low"}"
                                 draggable="false">
                        </div>
                        <div class="banner-overlay"></div>
                        <div class="banner-content">
                            ${g.category?`<span class="banner-category-badge">${g.category}</span>`:""}
                            <h2 class="banner-title">${g.title}</h2>
                            <p class="banner-description">${g.description}</p>
                            ${g.btn_primary_text||g.btn_secondary_text?`<div class="banner-buttons">
                                    ${g.btn_primary_text?m(g.btn_primary_text,g.btn_primary_url,g.btn_primary_style,g.btn_primary_external):""}
                                    ${g.btn_secondary_text?m(g.btn_secondary_text,g.btn_secondary_url,g.btn_secondary_style,g.btn_secondary_external):""}
                                </div>`:""}
                        </div>
                    </div>
                </div>`).join(""),x(),T()}function x(){C.addEventListener("mousedown",I),C.addEventListener("touchstart",I,{passive:!0}),C.addEventListener("mousemove",j),C.addEventListener("touchmove",j,{passive:!0}),C.addEventListener("mouseup",q),C.addEventListener("touchend",q),C.addEventListener("mouseleave",q)}function T(){n.forEach(g=>{const _=new Image;_.src=g.image_url})}function I(g){c=!0,v=g.touches?g.touches[0].clientX:g.clientX,u=0}function j(g){c&&(u=(g.touches?g.touches[0].clientX:g.clientX)-v)}function q(){c&&(c=!1,Math.abs(u)>=y&&(N(u<0?(h+1)%n.length:(h-1+n.length)%n.length),w()),u=0)}function D(){if(n.length<=1){B.innerHTML="";return}const g=e.createElement("div");g.className="banner-dots",n.forEach((_,F)=>{const R=e.createElement("button");R.className="banner-dot",R.type="button",R.dataset.index=String(F),R.setAttribute("aria-label",`Banner ${F+1}`),R.addEventListener("click",()=>{N(F),w()}),g.appendChild(R)}),B.innerHTML="",B.appendChild(g)}function N(g,_=!0){const F=C.querySelectorAll(".banner-slide"),R=t.querySelectorAll(".banner-dot");F.forEach((V,H)=>{const X=H===g;_||(V.style.transition="none"),V.classList.toggle("banner-slide--active",X),_||requestAnimationFrame(()=>{V.style.transition=""})}),R.forEach((V,H)=>V.classList.toggle("banner-dot--active",H===g)),h=g}function s(){n.length<=1||!p||(f=setInterval(()=>N((h+1)%n.length),5e3))}function w(){p&&(clearInterval(f),s())}function k(){clearInterval(f),C.innerHTML=`
                <div class="banner-slide banner-slide--active">
                    <div class="banner-empty">Sin contenido.</div>
                </div>`,B.innerHTML=""}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",d):d()}}function Ja(t,e){const i=document.getElementById("banner-hero-config-modal");if(i&&i.remove(),!document.getElementById("bnr-modal-styles")){const p=document.createElement("style");p.id="bnr-modal-styles",p.textContent=`
        ...
        </div>`,o.appendChild(n),document.body.appendChild(o);const h=n.querySelector("#bnr-autoplay"),f=n.querySelector("#bnr-autoplay-slider"),c=n.querySelector("#bnr-autoplay-knob"),v=()=>{f.style.background=h.checked?"#003B71":"#cbd5e1",c.style.left=h.checked?"21px":"3px"};v(),h.addEventListener("change",v);const u=n.querySelector("#bnr-category");(async()=>{try{const p=document.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??"",$=document.querySelector('meta[name="api-banners-url"]')?.content||`${p}/api/banners/active`,C=await fetch($,{headers:{Accept:"application/json"}});if(!C.ok)return;const B=await C.json();if(!Array.isArray(B))return;[...new Set(B.map(m=>m.category).filter(Boolean))].sort().forEach(m=>{const d=document.createElement("option");d.value=m,d.textContent=m,u.appendChild(d)}),u.value=l}catch{}})();const y=()=>o.remove();n.querySelector("#bnr-modal-close").onclick=y,n.querySelector("#bnr-modal-cancel").onclick=y,o.onclick=p=>{p.target===o&&y()},n.querySelector("#bnr-modal-save").onclick=()=>{e.addAttributes({"data-autoplay":h.checked?"true":"false","data-category":u.value||""}),y()}}const Za=[{id:"banner-hero",label:"Banner Slider",category:"Banners",media:Xa,content:{type:"banner-hero-component"}}];function Ka(t){const e="banner-hero-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner Slider",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-autoplay":"true","data-category":""},components:`
...
.hb-btn{width:100%;text-align:center;}
...
</style>`;function nt(t,e){e=e||"hb"+Math.random().toString(36).slice(2,7);const i=t.bg_image||P("images/placeholder.svg"),a=t.btn_primary||{},r=t.btn_secondary||{},l=a.color||"white",o=r.color||"white",n=a.enabled?`<a href="${a.href||"#"}" class="hb-btn hb-btn-${l}-solid">${a.label||"Conoce más"}</a>`:"",h=r.enabled?`<a href="${r.href||"#"}" class="hb-btn hb-btn-${o}-outline">${r.label||"Solicitar"}</a>`:"";return`<section id="hb-root-${e}" class="hb-section" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
        ...
        </div>`,f.appendChild(c),document.body.appendChild(f);const u=`${document.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??""}/api/pages/search`;function y(m){if(m.dataset.autocompleteAttached)return;m.dataset.autocompleteAttached="true";const d=m.parentNode;(!d.style.position||d.style.position==="static")&&(d.style.position="relative");const b=document.createElement("ul");b.style.cssText="position:absolute;top:calc(100% + 2px);left:0;right:0;z-index:999999;background:#fff;border:1px solid #e2e8f0;border-radius:0.5rem;box-shadow:0 8px 24px rgba(0,0,0,0.1);list-style:none;margin:0;padding:0.25rem;max-height:200px;overflow-y:auto;display:none;",d.appendChild(b);let E=null;async function x(j){if(j.length<1){b.style.display="none";return}try{const D=await(await fetch(`${u}?q=${encodeURIComponent(j)}`,{headers:{Accept:"application/json","X-Requested-With":"XMLHttpRequest"}})).json();I(D,j)}catch{b.style.display="none"}}function T(j,q){return q?j.replace(new RegExp(`(${q.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")})`,"gi"),'<mark style="background:#fef3c7;color:#92400e;border-radius:2px;padding:0 1px;">$1</mark>'):j}function I(j,q){if(b.innerHTML="",!j.length){b.style.display="none";return}j.forEach(D=>{const N=document.createElement("li");N.style.cssText="padding:0.375rem 0.625rem;border-radius:0.375rem;cursor:pointer;display:flex;flex-direction:column;gap:0.125rem;",N.innerHTML=`<span style="font-size:0.8rem;font-weight:600;color:#1e293b;">${T(D.title,q)}</span><span style="font-size:0.7rem;color:#64748b;">/${D.slug}</span>`,N.addEventListener("mouseenter",()=>N.style.background="#f1f5f9"),N.addEventListener("mouseleave",()=>N.style.background=""),N.addEventListener("mousedown",s=>{s.preventDefault(),m.value=`${tr}/${D.slug}`,m.dispatchEvent(new Event("input")),b.style.display="none"}),b.appendChild(N)}),b.style.display="block"}m.addEventListener("input",()=>{clearTimeout(E),E=setTimeout(()=>x(m.value.trim()),220)}),m.addEventListener("focus",()=>{m.select(),m.value.trim()&&x(m.value.trim())}),m.addEventListener("blur",()=>{setTimeout(()=>{b.style.display="none"},150)}),m.addEventListener("keydown",j=>{if(b.style.display==="none")return;const q=b.querySelectorAll("li"),D=b.querySelector("li.hb-ac-active");let N=Array.from(q).indexOf(D);if(j.key==="ArrowDown"){j.preventDefault(),D?.classList.remove("hb-ac-active");const s=q[N+1]||q[0];s?.classList.add("hb-ac-active"),s&&(s.style.background="#f1f5f9")}else if(j.key==="ArrowUp"){j.preventDefault(),D?.classList.remove("hb-ac-active");const s=q[N-1]||q[q.length-1];s?.classList.add("hb-ac-active"),s&&(s.style.background="#f1f5f9")}else j.key==="Enter"&&D?(j.preventDefault(),D.dispatchEvent(new MouseEvent("mousedown"))):j.key==="Escape"&&(b.style.display="none")})}y(c.querySelector("#hb-btn1-href")),y(c.querySelector("#hb-btn2-href"));let p=n.color||"white",$=h.color||"white";function C(m,d,b){const E=c.querySelector(`#${m}`);E.querySelectorAll("[data-color]").forEach(x=>{x.classList.toggle("hb-color-inactive",x.dataset.color!==d),x.addEventListener("click",()=>{E.querySelectorAll("[data-color]").forEach(T=>T.classList.toggle("hb-color-inactive",T.dataset.color!==x.dataset.color)),b(x.dataset.color)})})}C("hb-btn1-colors",p,m=>p=m),C("hb-btn2-colors",$,m=>$=m);function B(m,d,b){const E=c.querySelector(`#${m}`),x=c.querySelector(`#${d}`),T=c.querySelector(`#${b}`),I=()=>{x.style.background=E.checked?"#003B71":"#cbd5e1",T.style.left=E.checked?"21px":"3px"};I(),E.addEventListener("change",I)}B("hb-btn1-enabled","hb-btn1-slider","hb-btn1-knob"),B("hb-btn2-enabled","hb-btn2-slider","hb-btn2-knob"),c.querySelectorAll(".hb-tab-btn").forEach(m=>{m.addEventListener("click",()=>{c.querySelectorAll(".hb-tab-btn").forEach(d=>d.classList.remove("active")),c.querySelectorAll(".hb-tab-panel").forEach(d=>d.classList.remove("active")),m.classList.add("active"),c.querySelector(`#hb-panel-${m.dataset.tab}`).classList.add("active")})}),c.querySelector("#hb-bg-pick").addEventListener("click",()=>{Ce({type:"image",title:"Seleccionar imagen de fondo",onSelect:m=>{c.querySelector("#hb-bg-url").value=m,c.querySelector("#hb-bg-preview").src=m}})}),c.querySelector("#hb-bg-url").addEventListener("input",m=>{c.querySelector("#hb-bg-preview").src=m.target.value});const S=()=>f.remove();c.querySelector("#hb-modal-close").onclick=S,c.querySelector("#hb-modal-cancel").onclick=S,f.onclick=m=>{m.target===f&&S()},c.querySelector("#hb-modal-save").onclick=()=>{const m={bg_image:c.querySelector("#hb-bg-url").value.trim()||Q.bg_image,title:c.querySelector("#hb-title").value.trim(),subtitle:c.querySelector("#hb-subtitle").value.trim(),btn_primary:{enabled:c.querySelector("#hb-btn1-enabled").checked,label:c.querySelector("#hb-btn1-label").value.trim(),href:c.querySelector("#hb-btn1-href").value.trim()||"#",color:p},btn_secondary:{enabled:c.querySelector("#hb-btn2-enabled").checked,label:c.querySelector("#hb-btn2-label").value.trim(),href:c.querySelector("#hb-btn2-href").value.trim()||"#",color:$}},b=e.getEl()?.querySelector("[id^='hb-root-']")?.id?.replace("hb-root-","")||"hb"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-hero-banner-config":JSON.stringify(m)}),e.components(nt(m,b)+ot),S()}}function ar(t){const e="hero-banner-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-hero-banner-config":JSON.stringify(Q)},components:nt(Q)+ot,toolbar:[],traits:[{type:"button",label:"Banner",text:"Administrar Banner",full:!0,command:"open-hero-banner-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-hero-banner-config",{run(i){const a=i.getSelected();a&&ir(i,a)}}),t.BlockManager.add("hero-banner-block",{label:"Banner",category:"Banners",media:`<svg viewBox="0 0 32 32" width="32" height="32">
