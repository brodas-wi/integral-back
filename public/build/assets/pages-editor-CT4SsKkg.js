...
</style>`,wt=[{id:"columns-1",label:"1 Columna",category:"Columnas",media:pt,content:`
...
${ye}`}],He=function(){(function(){function i(t){if(!t||t.__pcInit)return;t.__pcInit=!0;var a=t.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,n=0,c=!1,p=0,d=0,m=0,b=null;a.querySelectorAll("img").forEach(function(h){h.setAttribute("draggable","false")}),setTimeout(function(){var h=a.scrollWidth-a.clientWidth;if(h<=0)return;var y=Math.min(60,h),$=null;function v(S){$||($=S);var z=(S-$)/400;if(z<.5)a.scrollLeft=y*(z*2);else if(z<1)a.scrollLeft=y*(1-(z-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(v)}requestAnimationFrame(v)},400),a.scrollLeft=0;function u(){return a.scrollWidth-a.clientWidth}function s(h){return Math.max(0,Math.min(h,u()))}function g(){Math.abs(p)<.5||(p*=.92,a.scrollLeft=s(a.scrollLeft+p),b=requestAnimationFrame(g))}a.addEventListener("mousedown",function(h){h.button===0&&(b&&(cancelAnimationFrame(b),b=null),r=!0,c=!1,p=0,l=h.clientX,d=h.clientX,m=Date.now(),n=a.scrollLeft,a.style.cursor="grabbing",h.preventDefault())}),document.addEventListener("mousemove",function(h){if(r){var y=l-h.clientX;Math.abs(y)>3&&(c=!0);var $=Date.now(),v=$-m||1;p=(h.clientX-d)/v*16*-1,d=h.clientX,m=$,a.scrollLeft=s(n+y)}}),document.addEventListener("mouseup",function(h){r&&(r=!1,a.style.cursor="grab",c&&(h.stopPropagation(),b=requestAnimationFrame(g)))}),a.addEventListener("click",function(h){c&&(h.preventDefault(),h.stopPropagation(),c=!1)},!0);var k=0,j=0,w=0,E=0,L=0;a.addEventListener("touchstart",function(h){b&&(cancelAnimationFrame(b),b=null),k=h.touches[0].clientX,w=h.touches[0].clientX,E=Date.now(),j=a.scrollLeft,L=0},{passive:!0}),a.addEventListener("touchmove",function(h){var y=Date.now(),$=y-E||1,v=h.touches[0].clientX;L=(v-w)/$*16*-1,w=v,E=y;var S=k-v;a.scrollLeft=s(j+S)},{passive:!0}),a.addEventListener("touchend",function(){b=requestAnimationFrame(function h(){Math.abs(L)<.5||(L*=.92,a.scrollLeft=s(a.scrollLeft+L),b=requestAnimationFrame(h))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(t){delete t.__pcInit,i(t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Lt=`(${He.toString()})();`,_t=`
...
</svg>`;function It(i){const e="product-cards-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección de Productos",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-product-cards-config":JSON.stringify(H)},components:Pe(H),script:He,"script-props":["data-product-cards-config"],traits:[{type:"button",label:"Productos",text:"Administrar Sección",full:!0,command:"open-product-cards-config"}],toolbar:[]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),i.Commands.add("open-product-cards-config",{run(t){const a=t.getSelected();a&&Tt(t,a)}}),i.BlockManager.add("product-cards-block",{label:"Sección de productos",category:"Productos y Servicios",media:zt,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),i.on("component:mount",t=>{t.getEl()?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>fe(i),400))}),i.on("component:selected",t=>{const a=t.getEl();if(!a)return;const r=a.closest(`[data-gjs-type="${e}"]`);if(r&&!a.hasAttribute("data-gjs-type")){const n=i.getWrapper().find(`[data-gjs-type="${e}"]`).find(c=>c.getEl()===r);n&&setTimeout(()=>i.select(n),0)}}),i.on("canvas:render",()=>{setTimeout(()=>fe(i),600)}),i.on("storage:end:load",()=>{setTimeout(()=>fe(i),800)})}const At=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
${Mt}`}],Fe=function(){(function(){function i(t){if(!t||t.__savInit)return;t.__savInit=!0;var a=t.querySelector(".sav-carousel-wrap");if(!a)return;a.scrollLeft=0;var r=!1,l=0,n=0,c=!1,p=0,d=0,m=0,b=null;a.querySelectorAll("img").forEach(function(h){h.setAttribute("draggable","false")}),setTimeout(function(){var h=a.scrollWidth-a.clientWidth;if(h<=0)return;var y=Math.min(60,h),$=null;function v(S){$||($=S);var z=(S-$)/400;if(z<.5)a.scrollLeft=y*(z*2);else if(z<1)a.scrollLeft=y*(1-(z-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(v)}requestAnimationFrame(v)},400);function u(){return a.scrollWidth-a.clientWidth}function s(h){return Math.max(0,Math.min(h,u()))}function g(){Math.abs(p)<.5||(p*=.92,a.scrollLeft=s(a.scrollLeft+p),b=requestAnimationFrame(g))}a.addEventListener("mousedown",function(h){h.button===0&&(b&&(cancelAnimationFrame(b),b=null),r=!0,c=!1,p=0,l=h.clientX,d=h.clientX,m=Date.now(),n=a.scrollLeft,a.style.cursor="grabbing",h.preventDefault())}),document.addEventListener("mousemove",function(h){if(r){var y=l-h.clientX;Math.abs(y)>3&&(c=!0);var $=Date.now(),v=$-m||1;p=(h.clientX-d)/v*16*-1,d=h.clientX,m=$,a.scrollLeft=s(n+y)}}),document.addEventListener("mouseup",function(h){r&&(r=!1,a.style.cursor="grab",c&&(h.stopPropagation(),b=requestAnimationFrame(g)))}),a.addEventListener("click",function(h){c&&(h.preventDefault(),h.stopPropagation(),c=!1)},!0);var k=0,j=0,w=0,E=0,L=0;a.addEventListener("touchstart",function(h){b&&(cancelAnimationFrame(b),b=null),k=h.touches[0].clientX,w=h.touches[0].clientX,E=Date.now(),j=a.scrollLeft,L=0},{passive:!0}),a.addEventListener("touchmove",function(h){var y=Date.now(),$=y-E||1,v=h.touches[0].clientX;L=(v-w)/$*16*-1,w=v,E=y;var S=k-v;a.scrollLeft=s(j+S)},{passive:!0}),a.addEventListener("touchend",function(){b=requestAnimationFrame(function h(){Math.abs(L)<.5||(L*=.92,a.scrollLeft=s(a.scrollLeft+L),b=requestAnimationFrame(h))})},{passive:!0})}function e(){document.querySelectorAll(".sav-section").forEach(function(t){delete t.__savInit,i(t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Ot=`(${Fe.toString()})();`,Ht=`
...
${bi}`,ui=[{id:"stats-strip-left",label:"Franja estadísticas - izquierda",category:"Heroes",media:hi,content:Se(!0)},{id:"stats-strip-right",label:"Franja estadísticas - derecha",category:"Heroes",media:mi,content:Se(!1)}],xi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
</style>`,yi=[{id:"service-cards-section",label:"Sección de servicios con iconos",category:"Productos y Servicios",media:xi,content:`
...
${Le}`},{id:"service-card-item",label:"Ítem de servicio con icono",category:"Productos y Servicios",media:vi,content:`${ie}${Le}`}],wi=`<svg viewBox="0 0 32 32" width="32" height="32">
...
${je}`},{id:"news-card",label:"Tarjeta de noticia",category:"Contenido",media:ji,content:`${re}${je}`}],zi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#ffffff" rx="2" stroke="#e5e7eb" stroke-width="1"/>
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function Mi(){if(document.getElementById("tam-img-modal"))return;const i=document.createElement("div");i.id="tam-img-modal",i.innerHTML=`
        ...
        <div class="tam-container">
            ...
            </th>`).join("")}</tr>`,s.innerHTML=l.rows.map((w,E)=>`<tr>${Array.from({length:g},(h,y)=>{const $=j[`${E}-${y}`];if($)return`<td class="tam-cell is-spanned" data-row="${E}" data-col="${y}">
...
</svg>`;function na(){return function(){const i=this,e="agencies-map-component",t="/api/agencies/active",a="agencies";let r=[],l=[],n={},c=null,p=[];const d=async()=>{try{m(),await u(),await k(),j(),$(),A(),Y(),b()}catch(o){console.error("Error initializing map:",o),le("Error al cargar las agencias"),b()}};function m(){const o=i.querySelector(`.${e}-list`);o&&(o.innerHTML=`
