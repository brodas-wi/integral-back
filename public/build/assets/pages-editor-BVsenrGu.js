...
${mi}`}],wt=function(){(function(){function t(i){if(!i||i.__pcInit)return;i.__pcInit=!0;var a=i.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,o=0,g=!1,f=0,c=0,n=0,s=null;a.querySelectorAll("img").forEach(function(m){m.setAttribute("draggable","false")}),setTimeout(function(){var m=a.scrollWidth-a.clientWidth;if(m<=0)return;var $=Math.min(60,m),B=null;function C(E){B||(B=E);var L=(E-B)/400;if(L<.5)a.scrollLeft=$*(L*2);else if(L<1)a.scrollLeft=$*(1-(L-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(C)}requestAnimationFrame(C)},400),a.scrollLeft=0;function h(){return a.scrollWidth-a.clientWidth}function b(m){return Math.max(0,Math.min(m,h()))}function p(){Math.abs(f)<.5||(f*=.92,a.scrollLeft=b(a.scrollLeft+f),s=requestAnimationFrame(p))}a.addEventListener("mousedown",function(m){m.button===0&&(s&&(cancelAnimationFrame(s),s=null),r=!0,g=!1,f=0,l=m.clientX,c=m.clientX,n=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",m.preventDefault())}),document.addEventListener("mousemove",function(m){if(r){var $=l-m.clientX;Math.abs($)>3&&(g=!0);var B=Date.now(),C=B-n||1;f=(m.clientX-c)/C*16*-1,c=m.clientX,n=B,a.scrollLeft=b(o+$)}}),document.addEventListener("mouseup",function(m){r&&(r=!1,a.style.cursor="grab",g&&(m.stopPropagation(),s=requestAnimationFrame(p)))}),a.addEventListener("click",function(m){g&&(m.preventDefault(),m.stopPropagation(),g=!1)},!0);var w=0,k=0,u=0,y=0,x=0;a.addEventListener("touchstart",function(m){s&&(cancelAnimationFrame(s),s=null),w=m.touches[0].clientX,u=m.touches[0].clientX,y=Date.now(),k=a.scrollLeft,x=0},{passive:!0}),a.addEventListener("touchmove",function(m){var $=Date.now(),B=$-y||1,C=m.touches[0].clientX;x=(C-u)/B*16*-1,u=C,y=$;var E=w-C;a.scrollLeft=b(k+E)},{passive:!0}),a.addEventListener("touchend",function(){s=requestAnimationFrame(function m(){Math.abs(x)<.5||(x*=.92,a.scrollLeft=b(a.scrollLeft+x),s=requestAnimationFrame(m))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(i){delete i.__pcInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},yi=`(${wt.toString()})();`,vi=`
...
${Te}`},{id:"dual-card-dark",label:"Tarjeta azul oscuro",category:"Productos y Servicios",media:`<svg viewBox="0 0 32 32" width="32" height="32">
        ...
        </svg>`,content:`${Ve}${Te}`}],Ci=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
${he}`},{id:"document-download-button",label:"Botón de Documento",category:"Documentos",media:Ti,content:`${ke("Nombre_del_documento.pdf")}${he}`},{id:"document-accordion-section",label:"Sección de Documentos con Acordeón",category:"Documentos",media:Ai,content:`
<section class="dd-section">
    <h2 class="text-4xl font-extrabold text-[#003B71]" contenteditable="true" data-gjs-type="text" data-gjs-editable="true">Titulo principal</h2>
    <div class="dd-stripe" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"></div>
...
${he}`},{id:"document-accordion-item",label:"Ítem de Acordeón",category:"Documentos",media:zi,content:`${Ae("Nombre de la sección",!1)}${he}`}];function Mi(t){const e="doc-download-button",i="doc-accordion-item";t.DomComponents.addType(e,{isComponent:a=>a.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Botón de Documento",tagName:"a",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,class:"dd-btn",href:"#"},components:`
                    <span class="dd-btn-left" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
                        <i class="ri-article-line dd-btn-icon-file" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"></i>
                ...
                `,script:Ii()},init(){this.set("type",i),this.addAttributes({"data-gjs-type":i})}}}),t.Commands.add("select-doc-download-file",{run(a){const r=a.getSelected();!r||r.get("type")!==e||Le({type:"document",title:"Seleccionar documento",onSelect:(l,o)=>{r.addAttributes({href:l});const g=r.find(".dd-btn-label")[0],f=o?.name||l.split("/").pop();g&&g.components(f)}})}}),Di(t,i)}function Di(t,e){t.on("storage:end:load",()=>{setTimeout(()=>Ye(t,e),800)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},400))}),t.on("component:clone",i=>{if(i.get("type")===e){const a=i.getEl();a&&(delete a.__ddAccBound,setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},400))}}),t.on("canvas:render",()=>{setTimeout(()=>Ye(t,e),600)})}function Ye(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}const Bt=function(){(function(){function t(i){if(!i||i.__savInit)return;i.__savInit=!0;var a=i.querySelector(".sav-carousel-wrap");if(!a)return;a.scrollLeft=0;var r=!1,l=0,o=0,g=!1,f=0,c=0,n=0,s=null;a.querySelectorAll("img").forEach(function(m){m.setAttribute("draggable","false")}),setTimeout(function(){var m=a.scrollWidth-a.clientWidth;if(m<=0)return;var $=Math.min(60,m),B=null;function C(E){B||(B=E);var L=(E-B)/400;if(L<.5)a.scrollLeft=$*(L*2);else if(L<1)a.scrollLeft=$*(1-(L-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(C)}requestAnimationFrame(C)},400);function h(){return a.scrollWidth-a.clientWidth}function b(m){return Math.max(0,Math.min(m,h()))}function p(){Math.abs(f)<.5||(f*=.92,a.scrollLeft=b(a.scrollLeft+f),s=requestAnimationFrame(p))}a.addEventListener("mousedown",function(m){m.button===0&&(s&&(cancelAnimationFrame(s),s=null),r=!0,g=!1,f=0,l=m.clientX,c=m.clientX,n=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",m.preventDefault())}),document.addEventListener("mousemove",function(m){if(r){var $=l-m.clientX;Math.abs($)>3&&(g=!0);var B=Date.now(),C=B-n||1;f=(m.clientX-c)/C*16*-1,c=m.clientX,n=B,a.scrollLeft=b(o+$)}}),document.addEventListener("mouseup",function(m){r&&(r=!1,a.style.cursor="grab",g&&(m.stopPropagation(),s=requestAnimationFrame(p)))}),a.addEventListener("click",function(m){g&&(m.preventDefault(),m.stopPropagation(),g=!1)},!0);var w=0,k=0,u=0,y=0,x=0;a.addEventListener("touchstart",function(m){s&&(cancelAnimationFrame(s),s=null),w=m.touches[0].clientX,u=m.touches[0].clientX,y=Date.now(),k=a.scrollLeft,x=0},{passive:!0}),a.addEventListener("touchmove",function(m){var $=Date.now(),B=$-y||1,C=m.touches[0].clientX;x=(C-u)/B*16*-1,u=C,y=$;var E=w-C;a.scrollLeft=b(k+E)},{passive:!0}),a.addEventListener("touchend",function(){s=requestAnimationFrame(function m(){Math.abs(x)<.5||(x*=.92,a.scrollLeft=b(a.scrollLeft+x),s=requestAnimationFrame(m))})},{passive:!0})}function e(){document.querySelectorAll(".sav-section").forEach(function(i){delete i.__savInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Ni=`(${Bt.toString()})();`,Pi=`
...
@media(max-width:480px){.sav-card{flex:0 0 75vw;}}`;function Ri(t){const e=t.img||T("images/placeholder.svg"),i=t.title||"TÍTULO DEL PRODUCTO",a=t.desc?`<p class="sav-card-desc">${t.desc}</p>`:"",r=t.href||"#",l=t.btn_label||"Solicitar";return`<div class="sav-card"><div class="sav-card-img-wrap"><img src="${e}" alt="${i}" class="sav-card-img"></div><h3 class="sav-card-title">${i}</h3>${a}<a href="${r}" class="sav-btn">${l}</a></div>`}function Et(t){const e=t.heading||"Depósitos y Cuentas de Ahorro",i=t.subheading||"Productos diseñados para hacer crecer tu dinero de forma segura.",a=t.more_href||"#",r=t.more_label||"Ver más",l=t.show_more!==!1,g=(t.cards||[]).map(Ri).join(""),f=T("images/brand-watermark.png"),c=l?`<div class="sav-more-wrap"><a href="${a}" class="sav-more-btn">${r}</a></div>`:"";return`<section class="sav-section"><style>${Pi}</style><div class="sav-blue-box"><div class="sav-watermark"><img src="${f}" alt=""></div><div style="display:flex;flex-direction:column;gap:0.5rem;text-align:center;position:relative;z-index:1;"><h2 class="sav-heading">${e}</h2><p class="sav-subheading">${i}</p></div><div class="sav-carousel-wrap"><div class="sav-track">${g}</div></div>${c}</div></section>`}const F={heading:"Depósitos y Cuentas de Ahorro",subheading:"Productos diseñados para hacer crecer tu dinero de forma segura.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CUENTA DE AHORRO ESTÁNDAR",href:"#",btn_label:"Solicitar"},{img:"",title:"AHORRO RENTABLE",href:"#",btn_label:"Solicitar"},{img:"",title:"CUENTA DE AHORRO MÁS",href:"#",btn_label:"Solicitar"},{img:"",title:"DEPÓSITO DE PLAZO FIJO",href:"#",btn_label:"Solicitar"}]};function Hi(t,e){const i=document.getElementById("sav-config-modal");if(i&&i.remove(),!document.getElementById("sav-modal-styles")){const c=document.createElement("style");c.id="sav-modal-styles",c.textContent=`
...
${ja}`,_a=[{id:"stats-strip-left",label:"Franja estadísticas - izquierda",category:"Heroes",media:Ca,content:Qe(!0)},{id:"stats-strip-right",label:"Franja estadísticas - derecha",category:"Heroes",media:La,content:Qe(!1)}],Ta=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
</style>`,Da=[{id:"contact-info-row",label:"Contacto en fila",category:"Contacto",media:Ia,content:`
...
${qe}`},{id:"contact-info-item",label:"Ítem de contacto",category:"Contacto",media:Ma,content:`
<section class="ci-section">
    <div class="ci-row-wrap">
        <div class="ci-pill-row">
            ${ne("ri-phone-fill","Contáctenos","(503)-2250-6090","tel:+50322506090")}
...
.bc-plot{height:220px;gap:0.75rem;}
...
</style>`;function je(t){const e=parseFloat(t);if(Number.isNaN(e))return 0;const i=Math.min(100,Math.max(0,e));return Math.round(i*100)/100}function gr(t){return`${je(t).toFixed(2)}%`}function Me(t){const e=t&&typeof t=="object"?t:{},i=Array.isArray(e.bars)&&e.bars.length?e.bars:Se.bars;return{title:typeof e.title=="string"&&e.title.trim()?e.title:Se.title,showLegend:e.showLegend!==!1,bars:i.slice(0,Ee).map((a,r)=>({label:typeof a?.label=="string"&&a.label.trim()?a.label:`Lorem ipsum ${r+1}`,value:je(a?.value),color:typeof a?.color=="string"&&a.color.trim()?a.color:$e[r%$e.length].value}))}}const Se={title:"Título del gráfico",showLegend:!0,bars:[{label:"Lorem ipsum",value:0,color:"#003B71"},{label:"Lorem ipsum",value:0,color:"#5C88B3"},{label:"Lorem ipsum",value:0,color:"#E97300"}]};function Ct(t){const e=Me(t),i=e.bars.map(r=>`
        ...
        ${a}`}function hr(t,e){const i=document.getElementById("bar-chart-config-modal");if(i&&i.remove(),!document.getElementById("bc-modal-styles")){const n=document.createElement("style");n.id="bc-modal-styles",n.textContent=`
        ...
        `,document.head.appendChild(n)}const a=(()=>{try{return JSON.parse(e.getAttributes()["data-bar-chart-config"]||"{}")}catch{return{}}})(),r=Me(a);let l=r.bars.map(n=>({...n}));const o=document.createElement("div");o.id="bar-chart-config-modal",o.className="bc-overlay";const g=(n,s)=>`
...
<\/script>`}],vr=`<svg viewBox="0 0 32 32" width="32" height="32">
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
            ...
            </tr>`),r&&t.headers?.length){const f=a?i.subheaderBg:i.headerBg,c=a?i.subheaderText:i.headerText;l+="<tr>",t.headers.forEach((n,s)=>{const h=s<t.headers.length-1?`border-r border-[${i.borderColor}]`:"";l+=`<th class="p-3 align-middle text-sm font-semibold ${f} ${c} ${h} border-b border-[${i.borderColor}] text-${n.align||"center"}">${n.text||""}</th>`}),l+="</tr>"}l+="</thead>"}l+="<tbody>";const o=t.rows.length,g={};return t.rows.forEach((f,c)=>{l+="<tr>";let n=0;f.forEach(s=>{for(;g[`${c}-${n}`];)n++;const h=s.colspan||1,b=s.rowspan||1;for(let L=c;L<c+b;L++)for(let z=n;z<n+h;z++)(L!==c||z!==n)&&(g[`${L}-${z}`]=!0);const p=h>1?`colspan="${h}"`:"",w=b>1?`rowspan="${b}"`:"",k=s.isHeader?`tbl-cell-highlight-${e}`:`tbl-cell-normal-${e}`,u="font-semibold",y=s.isHeader?i.labelText:i.rowText,x=`text-${s.align||"center"}`,m=c+b>=o,B=n+h>=t.cols?"":`border-r border-[${i.borderColor}]`,C=m?"":`border-b border-[${i.borderColor}]`,E=`${B} ${C} p-3 align-middle text-sm ${k} ${u} ${y} ${x}`;s.image?l+=`<td ${p} ${w} class="${E}">
                ...
                </td>`:l+=`<td ${p} ${w} class="${E}">${s.text||""}</td>`,n+=h}),l+="</tr>"}),l+="</tbody></table>",l}function Q(t,e){return{title:"Título de la tabla",showTitleRow:!0,showHeaderRow:!0,cols:t,headers:Array.from({length:t},(i,a)=>({text:`Columna ${a+1}`,align:"center"})),rows:Array.from({length:e},()=>Array.from({length:t},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})))}}function wr(t){return`<style>
.tbl-cell-normal-${t}{background-color:#ffffff;}
.tbl-cell-highlight-${t}{background-color:#e2e8f0;}
</style>`}function jt(t,e){return`<div class="w-full overflow-x-auto rounded-2xl border-2 border-[${(Ce[e]||Ce.blue).borderColor}]">${wr(e)}${t}</div>`}function gt(t,e){const i={};return t.forEach((a,r)=>{let l=0;a.forEach(o=>{for(;i[`${r}-${l}`];)l++;const g=Math.min(o.colspan||1,e-l),f=o.rowspan||1;for(let c=r;c<r+f;c++)for(let n=l;n<l+g;n++)(c!==r||n!==l)&&(i[`${c}-${n}`]=`${r}-${l}`);l+=g})}),i}const kr=`
        ...
        <div class="tam-modal">
            ...
            <th>
                ...
                <select class="tam-align-select" style="margin-top:4px;width:100%;font-size:0.7rem;padding:2px;">
                    ...
                    </td>`;const E=y[B]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null},L=E.colspan||1,z=E.rowspan||1,M=L>1||z>1;return`<td class="tam-cell ${E.isHeader?"is-header-cell":""} ${E.image?"has-image":""} ${M?"has-span":""}"
...
.mp-map-wrapper{height:320px;}
        ...
        </div>`,l.appendChild(o),document.body.appendChild(l);const g=()=>l.remove();o.querySelector("#mp-modal-close").onclick=g,o.querySelector("#mp-modal-cancel").onclick=g,l.onclick=f=>{f.target===l&&g()},o.querySelector("#mp-modal-save").onclick=()=>{const f={title:o.querySelector("#mp-title").value.trim()},n=e.getEl()?.querySelector("[id^='mp-root-']")?.id?.replace("mp-root-","")||"mp"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-map-config":JSON.stringify(f)}),e.components(_t(f,n)+`<style>${Oe}</style>`),g()}}const Jr=[{id:"map-filter-block",label:"Mapa con Filtros",category:"Interactivos",media:Yr,content:{type:"map-filter-component"}}];function Kr(t){const e="map-filter-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Mapa con Filtros",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,stylable:!1,resizable:!1,layerable:!0,highlightable:!1,attributes:{"data-gjs-type":e,"data-map-config":JSON.stringify(Ne)},components:_t(Ne)+`<style>${Oe}</style>`,script:Gr(),traits:[{type:"button",label:"Mapa con Filtros",text:"Administrar Mapa y Filtros",full:!0,command:"open-map-filter-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-map-filter-config",{run(i){const a=i.getSelected();a&&Wr(i,a)}}),Zr(t,e),Qr(t,e)}function Zr(t,e){t.on("storage:end:load",()=>{setTimeout(()=>ut(t,e),1e3)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},500))}),t.on("component:clone",i=>{if(i.get("type")===e){const a=i.getEl();if(a){const r=a.querySelector("[data-mp-map]");r&&r._map&&(r._map.remove(),delete r._map,delete r.__mpMapInit),setTimeout(()=>{const l=i.get("script");l&&typeof l=="function"&&l.call(a)},500)}}}),t.on("canvas:render",()=>{setTimeout(()=>ut(t,e),800)}),t.on("storage:start:store",()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e),i.addAttributes({"data-gjs-type":e})})})}function ut(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}function Qr(t,e){t.on("load",()=>{const i=t.Canvas.getFrameEl();if(!i)return;const a=i.contentDocument?.head;if(a){if(!a.querySelector("#leaflet-css")){const r=document.createElement("link");r.id="leaflet-css",r.rel="stylesheet",r.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",a.appendChild(r)}if(!a.querySelector("#mp-filter-styles")){const r=document.createElement("style");r.id="mp-filter-styles",r.textContent=Oe,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=".leaflet-container{height:100%;width:100%;border-radius:inherit;z-index:0;}",a.appendChild(r)}}})}const el=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
@media(max-width:768px){.bsk-buttons{flex-direction:column;}}`;function al(){return function(){const t=this,e=t.ownerDocument??document,i="/adminintegral",a=(e.defaultView??window).location.origin,r=e.querySelector('meta[name="api-banners-url"]')?.content||`${a}${i}/api/banners/active`,l=["fill-blue","outline-blue","fill-orange","outline-orange","fill-white","outline-white"],o=".banner-wrapper{position:relative;width:100%;background:#003B71;overflow:hidden;}.banner-slide-container{position:relative;width:100%;user-select:none;cursor:grab;display:grid;}.banner-slide-container:active{cursor:grabbing;}.banner-slide{grid-area:1/1;opacity:0;pointer-events:none;transition:opacity 0.7s ease;visibility:hidden;display:flex;flex-direction:column;}.banner-slide.banner-slide--active{opacity:1;pointer-events:auto;visibility:visible;}.banner-slide-inner{position:relative;width:100%;flex:1;min-height:480px;display:flex;align-items:center;}.banner-bg{position:absolute;inset:0;z-index:0;}.banner-bg img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;}.banner-overlay{position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,59,113,0.85) 0%,rgba(0,59,113,0.65) 50%,rgba(0,59,113,0.2) 100%);z-index:1;}.banner-content{position:relative;z-index:10;display:flex;flex-direction:column;justify-content:center;padding:64px 64px 96px;max-width:60%;}.banner-category-badge{display:inline-block;margin-bottom:18px;padding:7px 20px;border-radius:999px;border:2px solid rgba(255,255,255,0.65);color:#fff;font-size:13px;font-weight:500;letter-spacing:0.04em;align-self:flex-start;}.banner-title{font-size:clamp(1.8rem,3.2vw,3rem);font-weight:800;color:#fff;line-height:1.15;margin:0 0 20px;}.banner-description{color:rgba(255,255,255,0.9);font-size:clamp(0.95rem,1.4vw,1.1rem);line-height:1.7;margin:0 0 36px;max-width:520px;}.banner-buttons{display:flex;flex-wrap:wrap;gap:16px;align-items:center;}.banner-btn{display:inline-block;padding:12px 32px;border-radius:999px;font-size:15px;font-weight:600;cursor:pointer;transition:background .2s,color .2s,border-color .2s;text-decoration:none;white-space:nowrap;line-height:1.4;box-sizing:border-box;}.banner-btn--fill-blue{background:#003B71;color:#ffffff;border:2px solid #003B71;}.banner-btn--fill-blue:hover{background:#002a52;border-color:#002a52;color:#ffffff;}.banner-btn--outline-blue{background:transparent;color:#003B71;border:2px solid #003B71;}.banner-btn--outline-blue:hover{background:#003B71;border-color:#003B71;color:#ffffff;}.banner-btn--fill-orange{background:#E97300;color:#ffffff;border:2px solid #E97300;}.banner-btn--fill-orange:hover{background:#c96200;border-color:#c96200;color:#ffffff;}.banner-btn--outline-orange{background:transparent;color:#E97300;border:2px solid #E97300;}.banner-btn--outline-orange:hover{background:#E97300;border-color:#E97300;color:#ffffff;}.banner-btn--fill-white{background:#ffffff;color:#003B71;border:2px solid #ffffff;}.banner-btn--fill-white:hover{background:#dce8f5;border-color:#dce8f5;color:#003B71;}.banner-btn--outline-white{background:transparent;color:#ffffff;border:2px solid #ffffff;}.banner-btn--outline-white:hover{background:#ffffff;border-color:#ffffff;color:#003B71;}.banner-dots-wrapper{display:none;}.banner-stripe{position:relative;width:100%;height:26px;background:#E97300;z-index:20;display:flex;align-items:center;justify-content:center;}.banner-dots{display:flex;gap:8px;align-items:center;}.banner-dot{width:10px;height:10px;border-radius:999px;border:none;cursor:pointer;background:rgba(255,255,255,0.5);transition:all 0.3s ease;padding:0;flex-shrink:0;}.banner-dot--active{width:28px;background:#ffffff;}.banner-empty{display:flex;align-items:center;justify-content:center;min-height:480px;color:rgba(255,255,255,0.5);font-size:14px;padding:40px;}@media(max-width:768px){.banner-slide-inner{min-height:340px;}.banner-bg img{object-position:right center;}.banner-content{max-width:100%;width:100%;padding:32px 24px 80px;}.banner-buttons{flex-wrap:wrap;gap:12px;}.banner-btn{flex:1 1 45%;min-width:140px;text-align:center;white-space:normal;word-break:break-word;}}@media(max-width:480px){.banner-btn{flex:1 1 100%;min-width:0;}}",g="@keyframes bsk-shimmer{0%{background-position:-600px 0}100%{background-position:600px 0}}.bsk-badge{width:120px;height:32px;margin-bottom:20px;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title{height:40px;margin-bottom:12px;border-radius:8px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title--short{width:60%;}.bsk-line{height:16px;margin-bottom:10px;border-radius:6px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-line--short{width:55%;}.bsk-buttons{display:flex;gap:16px;margin-top:36px;}.bsk-btn{height:48px;flex:1;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-bg-img{background:linear-gradient(90deg,rgba(255,255,255,0.04) 25%,rgba(255,255,255,0.09) 50%,rgba(255,255,255,0.04) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}@media(max-width:768px){.bsk-buttons{flex-direction:column;}}";(function(){if(!e.getElementById("banner-hero-styles")){const v=e.createElement("style");v.id="banner-hero-styles",v.textContent=o,e.head.appendChild(v)}if(!e.getElementById("banner-skeleton-styles")){const v=e.createElement("style");v.id="banner-skeleton-styles",v.textContent=g,e.head.appendChild(v)}})();let f=[],c=0,n=null,s=!1,h=0,b=0;const p=50,w=t.dataset.autoplay!=="false",k=t.dataset.category??"",u=t.querySelector(".banner-slide-container"),y=t.querySelector(".banner-stripe");if(!u||!y)return;function x(d){return l.indexOf(d)!==-1?d:d==="outline-blue"||d==="outline-orange"?"outline-white":"fill-white"}function m(d,v,S,_){const D=x(S),X=v?"a":"span",_e=v?`href="${v}"${_?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${X} ${_e} class="banner-btn banner-btn--${D}">${d}</${X}>`}async function $(){if(!t.__bannerLoading){t.__bannerLoading=!0,B();try{const d=await fetch(r,{headers:{Accept:"application/json"}});if(!d.ok){ee();return}const v=await d.json();if(f=Array.isArray(v)?k?v.filter(S=>S.category===k):v:[],f.length===0){ee();return}C(),J(),K(0,!1),w&&pe()}catch{ee()}finally{t.__bannerLoading=!1}}}function B(){u.innerHTML=`
                    ...
                    <div class="banner-slide-inner">
                        ...
                        <div class="banner-content">
                            ...
                            ${d.btn_primary_text||d.btn_secondary_text?`<div class="banner-buttons">
                                    ${d.btn_primary_text?m(d.btn_primary_text,d.btn_primary_url,d.btn_primary_style,d.btn_primary_external):""}
                                    ${d.btn_secondary_text?m(d.btn_secondary_text,d.btn_secondary_url,d.btn_secondary_style,d.btn_secondary_external):""}
                                </div>`:""}
                        </div>
                    </div>
                </div>`).join(""),E(),L()}function E(){u.addEventListener("mousedown",z),u.addEventListener("touchstart",z,{passive:!0}),u.addEventListener("mousemove",M),u.addEventListener("touchmove",M,{passive:!0}),u.addEventListener("mouseup",Y),u.addEventListener("touchend",Y),u.addEventListener("mouseleave",Y)}function L(){f.forEach(d=>{const v=new Image;v.src=d.image_url})}function z(d){s=!0,h=d.touches?d.touches[0].clientX:d.clientX,b=0}function M(d){s&&(b=(d.touches?d.touches[0].clientX:d.clientX)-h)}function Y(){s&&(s=!1,Math.abs(b)>=p&&(K(b<0?(c+1)%f.length:(c-1+f.length)%f.length),ge()),b=0)}function J(){if(f.length<=1){y.innerHTML="";return}const d=e.createElement("div");d.className="banner-dots",f.forEach((v,S)=>{const _=e.createElement("button");_.className="banner-dot",_.type="button",_.dataset.index=String(S),_.setAttribute("aria-label",`Banner ${S+1}`),_.addEventListener("click",()=>{K(S),ge()}),d.appendChild(_)}),y.innerHTML="",y.appendChild(d)}function K(d,v=!0){const S=u.querySelectorAll(".banner-slide"),_=t.querySelectorAll(".banner-dot");S.forEach((D,X)=>{const _e=X===d;v||(D.style.transition="none"),D.classList.toggle("banner-slide--active",_e),v||requestAnimationFrame(()=>{D.style.transition=""})}),_.forEach((D,X)=>D.classList.toggle("banner-dot--active",X===d)),c=d}function pe(){f.length<=1||!w||(n=setInterval(()=>K((c+1)%f.length),5e3))}function ge(){w&&(clearInterval(n),pe())}function ee(){clearInterval(n),u.innerHTML=`
                <div class="banner-slide banner-slide--active">
        ...
        </div>`,o.appendChild(g),document.body.appendChild(o);const f=g.querySelector("#bnr-autoplay"),c=g.querySelector("#bnr-autoplay-slider"),n=g.querySelector("#bnr-autoplay-knob"),s=()=>{c.style.background=f.checked?"#003B71":"#cbd5e1",n.style.left=f.checked?"21px":"3px"};s(),f.addEventListener("change",s);const h=g.querySelector("#bnr-category");(async()=>{try{const w=document.querySelector('meta[name="api-banners-url"]')?.content||`${window.location.origin}/adminintegral/api/banners/active`,k=await fetch(w,{headers:{Accept:"application/json"}});if(!k.ok)return;const u=await k.json();if(!Array.isArray(u))return;[...new Set(u.map(x=>x.category).filter(Boolean))].sort().forEach(x=>{const m=document.createElement("option");m.value=x,m.textContent=x,h.appendChild(m)}),h.value=l}catch{}})();const b=()=>o.remove();g.querySelector("#bnr-modal-close").onclick=b,g.querySelector("#bnr-modal-cancel").onclick=b,o.onclick=p=>{p.target===o&&b()},g.querySelector("#bnr-modal-save").onclick=()=>{e.addAttributes({"data-autoplay":f.checked?"true":"false","data-category":h.value||""}),b()}}const ll=[{id:"banner-hero",label:"Banner Slider",category:"Banners",media:el,content:{type:"banner-hero-component"}}];function ol(t){const e="banner-hero-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner Slider",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-autoplay":"true","data-category":""},components:`
...
`;if(!e.getElementById("assets-block-styles")){const u=e.createElement("style");u.id="assets-block-styles",u.textContent=r,e.head.appendChild(u)}const l=t.querySelector("[data-ast-tabs]"),o=t.querySelector("[data-ast-content]");if(!l||!o)return;const g=t.dataset.defaultCategory||"";let f=[],c="";function n(u,y){return u?u.length>y?`${u.slice(0,y).trim()}...`:u:""}function s(u){const y=u.link_is_external?' target="_blank" rel="noopener noreferrer"':"",x=u.name||n(u.short_description,60),m=u.name||u.short_description||"Activo extraordinario";return`<a href="${u.link_url}"${y} class="ast-card">
                ...
                `,script:fl(),traits:[{type:"select",name:"data-default-category",label:"Categoría inicial",options:[{id:"",name:"Todas (mostrar 'Todos')"}],changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",()=>{const i=this.getEl();if(!i)return;const a=this.get("script");a&&typeof a=="function"&&setTimeout(()=>a.call(i),100)})}}}),ml(t,e),bl(t,e),hl(t,e)}async function hl(t,e){try{const i=document.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??"",a=await fetch(`${i}/api/asset-categories/all`,{headers:{Accept:"application/json"}});if(!a.ok)return;const r=await a.json();if(!Array.isArray(r)||r.length===0)return;const l=t.DomComponents.getType(e);if(!l)return;const g=l.model.prototype.defaults.traits.find(f=>f.name==="data-default-category");if(!g)return;g.options=[{id:"",name:"Todas (mostrar 'Todos')"},...r.map(f=>({id:f.slug,name:f.name}))]}catch{}}function ml(t,e){t.on("storage:end:load",()=>{setTimeout(()=>yt(t,e),1e3)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},500))}),t.on("canvas:render",()=>{setTimeout(()=>yt(t,e),800)}),t.on("storage:start:store",()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e),i.addAttributes({"data-gjs-type":e})})})}function yt(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}function bl(t,e){t.on("load",()=>{const i=t.Canvas.getFrameEl();if(!i)return;const a=i.contentDocument?.head;if(a){if(!a.querySelector("#assets-block-styles")){const r=document.createElement("style");r.id="assets-block-styles",r.textContent=dl,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=`[data-gjs-type="${e}"] * { pointer-events: none !important; } [data-gjs-type="${e}"].gjs-selected, [data-gjs-type="${e}"].gjs-hovered { outline: 2px dashed rgba(240,135,42,0.6) !important; outline-offset: 2px; }`,a.appendChild(r)}}})}const Pe={blue:{curve:"#003B71",curveLine:"#E97300",badge:"#E97300",badgeText:"#ffffff"},orange:{curve:"#E97300",curveLine:"#003B71",badge:"#003B71",badgeText:"#ffffff"},transparent:{curve:"rgba(0,59,113,0.55)",curveLine:"#E97300",badge:"#E97300",badgeText:"#ffffff"}},Tt=`
<style>
...
.hb-curve svg{height:85px;}
        ...
        </div>`,n.appendChild(s),document.body.appendChild(n);let h=Pe[g]?g:"blue";function b(){const k=s.querySelector("#hb-theme-colors");k.querySelectorAll("[data-theme]").forEach(u=>{u.classList.toggle("hb-theme-inactive",u.dataset.theme!==h),u.addEventListener("click",()=>{h=u.dataset.theme,k.querySelectorAll("[data-theme]").forEach(y=>y.classList.toggle("hb-theme-inactive",y.dataset.theme!==h))})})}b(),s.querySelectorAll(".hb-tab-btn").forEach(k=>{k.addEventListener("click",()=>{s.querySelectorAll(".hb-tab-btn").forEach(u=>u.classList.remove("active")),s.querySelectorAll(".hb-tab-panel").forEach(u=>u.classList.remove("active")),k.classList.add("active"),s.querySelector(`#hb-panel-${k.dataset.tab}`).classList.add("active")})}),s.querySelector("#hb-bg-pick").addEventListener("click",()=>{Le({type:"image",title:"Seleccionar imagen de fondo",onSelect:k=>{s.querySelector("#hb-bg-url").value=k,s.querySelector("#hb-bg-preview").src=k}})}),s.querySelector("#hb-bg-url").addEventListener("input",k=>{s.querySelector("#hb-bg-preview").src=k.target.value});function p(){const k=s.querySelector("#hb-bg-pos-x").value,u=s.querySelector("#hb-bg-pos-y").value;s.querySelector("#hb-bg-preview").style.objectPosition=`${k} ${u}`}s.querySelector("#hb-bg-pos-x").addEventListener("change",p),s.querySelector("#hb-bg-pos-y").addEventListener("change",p),p();const w=()=>n.remove();s.querySelector("#hb-modal-close").onclick=w,s.querySelector("#hb-modal-cancel").onclick=w,n.onclick=k=>{k.target===n&&w()},s.querySelector("#hb-modal-save").onclick=()=>{const k={bg_image:s.querySelector("#hb-bg-url").value.trim()||V.bg_image,bg_position_x:s.querySelector("#hb-bg-pos-x").value,bg_position_y:s.querySelector("#hb-bg-pos-y").value,theme:h,title:s.querySelector("#hb-title").value.trim(),subtitle:s.querySelector("#hb-subtitle").value.trim()},y=e.getEl()?.querySelector("[id^='hb-root-']")?.id?.replace("hb-root-","")||"hb"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-hero-banner-config":JSON.stringify(k)}),e.components(At(k,y)+Tt),w()}}function xl(t){const e="hero-banner-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-hero-banner-config":JSON.stringify(V)},components:At(V)+Tt,traits:[{type:"button",label:"Banner",text:"Administrar Banner",full:!0,command:"open-hero-banner-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-hero-banner-config",{run(i){const a=i.getSelected();a&&ul(i,a)}}),t.BlockManager.add("hero-banner-block",{label:"Banner",category:"Banners",media:`<svg viewBox="0 0 32 32" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg>`,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}})}function yl(t){j.registerBlocks(Qt),j.registerBlocks(si),j.registerBlocks(ll),j.registerBlocks(_a),j.registerBlocks(ma),j.registerBlocks(hi),j.registerBlocks(xi),j.registerBlocks(Yi),j.registerBlocks(Wi),j.registerBlocks(Qi),j.registerBlocks(aa),j.registerBlocks(Si),j.registerBlocks(Sa),j.registerBlocks(er),j.registerBlocks(ji),j.registerBlocks(qi),j.registerBlocks(oa),j.registerBlocks(da),j.registerBlocks(za),j.registerBlocks(Da),j.registerBlocks(Ra),j.registerBlocks(yr),j.registerBlocks(Sr),j.registerBlocks(Rr),j.registerBlocks(Vr),j.registerBlocks(ar),j.registerBlocks(Jr),j.registerBlocks(pl),j.applyToEditor(t),Kr(t),ol(t),pr(t),xl(t),mr(t),br(t),Fi(t),Ei(t),Hr(t),ba(t),Cr(t),Mi(t),gl(t)}function vl(t,e,i){t.on("component:add",()=>e.markAsDirty()),t.on("component:remove",()=>e.markAsDirty()),t.on("component:update",()=>e.markAsDirty()),t.on("style:update",()=>e.markAsDirty());const a=document.getElementById("save-button");a&&a.addEventListener("click",async()=>{await wl(t,e,i,a)}),document.addEventListener("keydown",r=>{(r.ctrlKey||r.metaKey)&&r.key==="s"&&(r.preventDefault(),a&&!a.disabled&&a.click())})}async function wl(t,e,i,a){a.disabled=!0,a.innerHTML='<i class="ri-loader-4-line animate-spin"></i><span>Guardando...</span>';try{i.needsTitle()?await kl(t,e,i):await zt(t,e,i)}catch(r){It(r.message,"error")}finally{a.disabled=!1,a.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}}async function kl(t,e,i){return new Promise((a,r)=>{Mt({title:"Título de la Página",description:"Ingresa un título descriptivo para identificar esta página",placeholder:"Ej: Acerca de Nosotros",icon:"ri-file-text-line",iconBg:"#dbeafe",iconColor:"#2563eb",confirmLabel:"Guardar",onConfirm:async l=>{if(!l?.trim()){r(new Error("El título es obligatorio"));return}try{await zt(t,e,i,l),a()}catch(o){r(o)}},onCancel:()=>{r(new Error("Guardado cancelado"))}})})}async function zt(t,e,i,a=null){const l={...e.getEditorContent(t),is_published:i.isPublished};a&&(l.title=a);const o=await e.savePage(t,l,i.storeUrl,i.getHttpMethod());o.success&&(e.markAsClean(),It(o.message,"success"),!i.isEditMode&&o.page?(i.updatePageInfo(o),i.updateTitle(o.page.title)):a&&i.updateTitle(a))}function It(t,e){typeof window.showNotification=="function"&&window.showNotification(t,e)}document.addEventListener("DOMContentLoaded",async()=>{const t=new Dt,e=new Wt;new Jt(t);const i=Nt(),a=new Promise(r=>{i.on("load",()=>{yl(i),Pt(i),Rt(),Ht(),Ot(i),Ft(i),Ut(i),Vt(i),Yt(i),Xt(i),Bl(i),El(i),Sl(i),setTimeout(()=>{i.runCommand("sw-visibility"),i.Panels.getButton("options","sw-visibility")?.set("active",!0)},100),r()})});if(await Promise.all([a,$l(i)]),e.isEditMode)try{await t.loadPageContent(i,e.loadUrl),vt("Contenido cargado correctamente","success")}catch(r){vt("Error al cargar el contenido","error"),console.error(r)}vl(i,t,e)});function Bl(t){const e=[{cmd:"set-device-desktop",device:"Desktop"},{cmd:"set-device-tablet",device:"Tablet"},{cmd:"set-device-mobile",device:"Mobile"}];e.forEach(({cmd:i,device:a})=>{t.Commands.add(i,{run:r=>{r.setDevice(a),e.forEach(({cmd:l})=>{r.Panels.getButton("devices-c",l)?.set("active",l===i)})}})})}function El(t){t.Commands.add("canvas-clear",{run:e=>{Gt({title:"Limpiar canvas",description:"¿Estás seguro de que quieres eliminar todo el contenido del canvas? Esta acción no se puede deshacer.",icon:"ri-delete-bin-line",iconBg:"#fef2f2",iconColor:"#dc2626",confirmLabel:"Limpiar todo",confirmColor:"#dc2626",onConfirm:()=>{e.DomComponents.clear(),e.CssComposer.clear()}})}})}function $l(t){return new Promise(e=>{const i=t.Canvas.getFrameEl();if(i?.contentDocument?.readyState==="complete"&&i.contentDocument.head?.childElementCount>0){e();return}const r=()=>{t.off("canvas:frame:load",r),e()};t.on("canvas:frame:load",r),setTimeout(()=>{t.off("canvas:frame:load",r),e()},3e3)})}function Sl(t){const e=t.Canvas.getFrameEl();if(!e?.contentDocument?.head)return;const i=e.contentDocument.createElement("style");i.id="gjs-dashed-fix",i.textContent="body,body.gjs-dashed{margin:0!important;padding:0 0 160px 0!important;}",e.contentDocument.head.appendChild(i)}function vt(t,e="info"){typeof window.showNotification=="function"&&window.showNotification(t,e)}
