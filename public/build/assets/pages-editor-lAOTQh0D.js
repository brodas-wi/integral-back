/* empty css                   *//* empty css                    *//* empty css                          *//* empty css                           */import{o as Le,M as Dt,j as Mt,h as He,E as Nt,i as Rt,t as Pt,d as Ht,f as Ot,e as Ft,s as Ut,g as Vt,c as Yt,b as Xt,a as Gt}from"./editor-commands-C-1JeoK7.js";import{a as T}from"./url-DaqOO3yL.js";import"./_commonjsHelpers-CqkleIqs.js";class Wt{constructor(){this.pageId=this.getElementValue("page-id"),this.pageSlug=this.getElementValue("page-slug"),this.pageTitle=this.getPageTitle(),this.loadUrl=this.getElementValue("page-load-url"),this.storeUrl=this.getElementValue("page-store-url"),this.isPublished=this.getElementValue("page-is-published")==="1",this.isEditMode=!!this.pageId,this.appUrl=(document.querySelector('meta[name="app-url"]')?.content??"").replace(/\/$/,"")}getElementValue(e,i=""){const a=document.getElementById(e);return a?a.value.trim():i}getPageTitle(){const e=document.getElementById("editor-title");if(!e)return"";const a=e.textContent.match(/(?:Editando:|Nueva Página)\s*(.+)?/);return a&&a[1]?a[1].trim():""}updatePageInfo(e){if(e.page)if(this.pageId=e.page.id,this.pageSlug=e.page.slug,this.pageTitle=e.page.title,this.isEditMode=!0,document.getElementById("page-id").value=this.pageId,document.getElementById("page-slug").value=this.pageSlug,e.page.update_url?this.storeUrl=e.page.update_url:this.storeUrl=`${this.appUrl}/pages/${this.pageSlug}`,document.getElementById("page-store-url").value=this.storeUrl,e.page.load_url?this.loadUrl=e.page.load_url:this.loadUrl=`${this.appUrl}/pages/${this.pageSlug}/load`,document.getElementById("page-load-url").value=this.loadUrl,e.page.edit_url)window.history.replaceState(null,"",e.page.edit_url);else try{const i=new URL(window.location.href);i.pathname=i.pathname.replace(/\/pages\/create\/?$/,`/pages/${this.pageSlug}/edit`),window.history.replaceState(null,"",i.toString())}catch(i){console.error("Error updating browser URL:",i)}}updateTitle(e){this.pageTitle=e;const i=document.getElementById("editor-title");i&&(i.textContent=`Editando: ${e}`),document.title=`Editar: ${e} - Editor`}getHttpMethod(){return this.isEditMode?"PUT":"POST"}needsTitle(){return!this.isEditMode}}class Jt{constructor(e){this.editorService=e,this.setupBackButton(),this.setupBeforeUnload()}setupBackButton(){const e=document.querySelector("#editor-navbar a[href]");e&&e.addEventListener("click",i=>{this.editorService.shouldPreventUnload()&&(i.preventDefault(),this.showUnsavedChangesModal(()=>{this.editorService.startNavigation(),window.location.href=e.href}))})}setupBeforeUnload(){window.addEventListener("beforeunload",e=>{if(this.editorService.shouldPreventUnload())return e.preventDefault(),e.returnValue="Tienes cambios sin guardar. ¿Estás seguro de que quieres salir?",e.returnValue})}showUnsavedChangesModal(e){const i=document.createElement("div");i.style.cssText=`
        ...
        `;const g=document.createElement("button");g.textContent="Salir sin guardar",g.style.cssText=`
            ...
            font-family: inherit;
        `,[o,g].forEach(c=>{c.addEventListener("mouseenter",()=>{c.style.opacity="0.85"}),c.addEventListener("mouseleave",()=>{c.style.opacity="1"})});const f=()=>i.remove();o.addEventListener("click",f),g.addEventListener("click",()=>{f(),e()}),i.addEventListener("click",c=>{c.target===i&&f()}),l.appendChild(o),l.appendChild(g),a.appendChild(r),a.appendChild(l),i.appendChild(a),document.body.appendChild(i)}}const Kt="Básico";class Qt{constructor(){this.blocks=new Map}registerBlock(e,i){this.blocks.has(i.category)||this.blocks.set(i.category,[]),this.blocks.get(i.category).push({id:e,...i})}registerBlocks(e){e.forEach(i=>{this.registerBlock(i.id,i)})}applyToEditor(e){this.blocks.forEach(i=>{i.forEach(a=>{const{id:r,...l}=a;e.BlockManager.add(r,l)})}),this.applyCollapseSettings(e),this.hideDefaultCategories(e)}applyCollapseSettings(e){setTimeout(()=>{e.BlockManager.getCategories().each(i=>{i.set("open",i.get("label")===Kt)})},500)}hideDefaultCategories(e){setTimeout(()=>{const i=["Basic","Extra"];document.querySelectorAll(".gjs-block-category").forEach(a=>{const r=a.querySelector(".gjs-title");r&&i.includes(r.textContent.trim())&&(a.style.display="none")})},100)}}const j=new Qt,Zt=[{id:"heading1",label:"Título H1",category:"Básico",media:`<svg viewBox="0 0 32 32" width="32" height="32">
        ...
        </svg>`,content:{type:"image",attributes:{src:T("images/placeholder.svg"),alt:"Imagen"},classes:["max-w-full","h-auto","block"],activeOnRender:1}},{id:"unordered-list",label:"Lista no ordenada",category:"Básico",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,mi=[{id:"about-section",label:"Nuestra Historia",category:"Contenido",media:ci,content:`
    ...
    <div class="ab-grid">
        ...
        <div class="ab-image-col">
            <div class="ab-image-wrap">
                <img src="${T("images/placeholder.svg")}" alt="Imagen de sección">
            </div>
        </div>
    </div>
</section>
${Ve}`},{id:"about-mvv-section",label:"Misión, Visión y Valores",category:"Contenido",media:di,content:`
...
<section class="w-full bg-white px-6 py-8 sm:px-8 sm:py-10 lg:px-16 lg:py-12">
    <div class="mv-grid">
        ...
        <div class="w-full h-full flex items-stretch">
            <img src="${T("images/placeholder.svg")}" alt="Misión, Visión y Valores" class="w-full h-full object-cover rounded-xl">
        </div>
    </div>
</section>
${hi}`}],kt=function(){(function(){function t(i){if(!i||i.__pcInit)return;i.__pcInit=!0;var a=i.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,o=0,g=!1,f=0,c=0,n=0,s=null;a.querySelectorAll("img").forEach(function(h){h.setAttribute("draggable","false")}),setTimeout(function(){var h=a.scrollWidth-a.clientWidth;if(h<=0)return;var $=Math.min(60,h),B=null;function C(E){B||(B=E);var L=(E-B)/400;if(L<.5)a.scrollLeft=$*(L*2);else if(L<1)a.scrollLeft=$*(1-(L-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(C)}requestAnimationFrame(C)},400),a.scrollLeft=0;function m(){return a.scrollWidth-a.clientWidth}function b(h){return Math.max(0,Math.min(h,m()))}function p(){Math.abs(f)<.5||(f*=.92,a.scrollLeft=b(a.scrollLeft+f),s=requestAnimationFrame(p))}a.addEventListener("mousedown",function(h){h.button===0&&(s&&(cancelAnimationFrame(s),s=null),r=!0,g=!1,f=0,l=h.clientX,c=h.clientX,n=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",h.preventDefault())}),document.addEventListener("mousemove",function(h){if(r){var $=l-h.clientX;Math.abs($)>3&&(g=!0);var B=Date.now(),C=B-n||1;f=(h.clientX-c)/C*16*-1,c=h.clientX,n=B,a.scrollLeft=b(o+$)}}),document.addEventListener("mouseup",function(h){r&&(r=!1,a.style.cursor="grab",g&&(h.stopPropagation(),s=requestAnimationFrame(p)))}),a.addEventListener("click",function(h){g&&(h.preventDefault(),h.stopPropagation(),g=!1)},!0);var w=0,k=0,u=0,y=0,x=0;a.addEventListener("touchstart",function(h){s&&(cancelAnimationFrame(s),s=null),w=h.touches[0].clientX,u=h.touches[0].clientX,y=Date.now(),k=a.scrollLeft,x=0},{passive:!0}),a.addEventListener("touchmove",function(h){var $=Date.now(),B=$-y||1,C=h.touches[0].clientX;x=(C-u)/B*16*-1,u=C,y=$;var E=w-C;a.scrollLeft=b(k+E)},{passive:!0}),a.addEventListener("touchend",function(){s=requestAnimationFrame(function h(){Math.abs(x)<.5||(x*=.92,a.scrollLeft=b(a.scrollLeft+x),s=requestAnimationFrame(h))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(i){delete i.__pcInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},yi=`(${kt.toString()})();`,vi=`
...
@media(max-width:480px){.pc-card{flex:0 0 80vw;}}`;function wi(t){const e=t.img||T("images/placeholder.svg"),i=t.title||"TÍTULO DEL PRODUCTO",a=t.desc||"Descripción breve del producto financiero.",r=t.href||"#",l=t.btn_label||"Solicitar";return`<div class="pc-card"><div class="pc-card-img-wrap"><img src="${e}" alt="${i}" class="pc-card-img"></div><div class="pc-card-body"><h3 class="pc-card-title">${i}</h3><p class="pc-card-desc">${a}</p></div><a href="${r}" class="pc-btn">${l}</a></div>`}function Bt(t){const e=t.heading||"Créditos",i=t.subheading||"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",a=t.more_href||"#",r=t.more_label||"Ver más",l=t.show_more!==!1,g=(t.cards||[]).map(wi).join(""),f=l?`<div class="pc-more-wrap"><a href="${a}" class="pc-more-btn">${r}</a></div>`:"";return`<section class="pc-section"><style>${vi}</style><div style="text-align:center;margin-bottom:2rem;"><h2 class="pc-section-heading">${e}</h2><p class="pc-section-subheading">${i}</p></div><div class="pc-carousel-wrap"><div class="pc-track">${g}</div></div>${f}</section>`}const O={heading:"Créditos",subheading:"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CREDINVIERTE",desc:"Adquiere activos fijos",href:"#",btn_label:"Solicitar"},{img:"",title:"SOLUCIONES INTEGRALES",desc:"Financiamiento PYME",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDI-CONFIAMOS",desc:"Rápido y sin fiador",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDILÍNEA",desc:"Línea rotativa",href:"#",btn_label:"Solicitar"}]};function ki(t,e){const i=document.getElementById("pc-config-modal");if(i&&i.remove(),!document.getElementById("pc-modal-styles")){const c=document.createElement("style");c.id="pc-modal-styles",c.textContent=`
        ...
        <div class="pc-modal-footer">
            ...
            <button id="pc-modal-save" class="pc-btn-save"><i class="ri-check-line"></i> Aplicar cambios</button>
        </div>`,l.appendChild(o),document.body.appendChild(l),o.querySelectorAll(".pc-tab-btn").forEach(c=>{c.addEventListener("click",()=>{o.querySelectorAll(".pc-tab-btn").forEach(n=>n.classList.remove("active")),o.querySelectorAll(".pc-tab-panel").forEach(n=>n.classList.remove("active")),c.classList.add("active"),o.querySelector(`#pc-panel-${c.dataset.tab}`).classList.add("active")})}),o.querySelector("#pc-show-more").addEventListener("change",function(){r.show_more=this.checked,o.querySelector("#pc-more-fields").style.display=this.checked?"flex":"none"});function g(){const c=o.querySelector("#pc-cards-list");c.innerHTML="",r.cards.forEach((n,s)=>{const m=document.createElement("div");m.className="pc-card-config";const b=n.img?`<img class="pc-img-preview" src="${n.img}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>';m.innerHTML=`
                ...
                <div class="pc-row">
                    <div id="pc-img-wrap-${s}">${b}</div>
                    <div style="flex:1;display:flex;flex-direction:column;gap:0.5rem;">
                        <input class="pc-input-sm" placeholder="URL de la imagen" value="${n.img||""}" data-field="img">
                        <button class="pc-pick-btn pc-pick-img"><i class="ri-image-line"></i> Seleccionar imagen</button>
                    </div>
                </div>
                <div>
                    <label class="pc-label">Título</label>
                    <input class="pc-input" placeholder="TÍTULO DEL PRODUCTO" value="${n.title||""}" data-field="title">
                </div>
                <div>
                    <label class="pc-label">Descripción</label>
                    <input class="pc-input" placeholder="Descripción breve" value="${n.desc||""}" data-field="desc">
                </div>
                <div class="pc-row">
                    <div style="flex:1;">
                        <label class="pc-label">URL del botón</label>
                        <input class="pc-input" placeholder="#" value="${n.href||"#"}" data-field="href">
                    </div>
                    <div style="flex:1;">
                        <label class="pc-label">Texto del botón</label>
                        <input class="pc-input" placeholder="Solicitar" value="${n.btn_label||"Solicitar"}" data-field="btn_label">
                    </div>
                </div>`,m.querySelectorAll("[data-field]").forEach(p=>{p.addEventListener("input",()=>{if(n[p.dataset.field]=p.value,p.dataset.field==="img"){const w=m.querySelector(`#pc-img-wrap-${s}`);w.innerHTML=p.value?`<img class="pc-img-preview" src="${p.value}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>'}})}),m.querySelector(".pc-pick-img").addEventListener("click",()=>{Le({type:"image",title:"Seleccionar imagen de tarjeta",onSelect:p=>{n.img=p,m.querySelector("[data-field='img']").value=p,m.querySelector(`#pc-img-wrap-${s}`).innerHTML=`<img class="pc-img-preview" src="${p}" alt="">`}})}),m.querySelector(".pc-remove-card").addEventListener("click",()=>{r.cards.splice(s,1),g()}),c.appendChild(m)})}g(),o.querySelector("#pc-add-card").addEventListener("click",()=>{r.cards.push({img:"",title:"NUEVO PRODUCTO",desc:"Descripción del producto.",href:"#",btn_label:"Solicitar"}),g(),o.querySelector("#pc-cards-list").lastElementChild?.scrollIntoView({behavior:"smooth",block:"nearest"})});const f=()=>l.remove();o.querySelector("#pc-modal-close").addEventListener("click",f),o.querySelector("#pc-modal-cancel").addEventListener("click",f),l.addEventListener("click",c=>{c.target===l&&f()}),o.querySelector("#pc-modal-save").addEventListener("click",()=>{r.heading=o.querySelector("#pc-heading").value.trim()||O.heading,r.subheading=o.querySelector("#pc-subheading").value.trim()||O.subheading,r.show_more=o.querySelector("#pc-show-more").checked,r.more_label=o.querySelector("#pc-more-label").value.trim()||O.more_label,r.more_href=o.querySelector("#pc-more-href").value.trim()||"#",e.addAttributes({"data-product-cards-config":JSON.stringify(r)}),e.components(Bt(r)),setTimeout(()=>we(t),300),f()})}function we(t){try{const e=t.Canvas.getFrameEl()?.contentDocument;if(!e)return;const i=e.getElementById("pc-runtime-script");i&&i.remove(),e.querySelectorAll(".pc-section").forEach(r=>{delete r.__pcInit});const a=e.createElement("script");a.id="pc-runtime-script",a.textContent=yi,e.head.appendChild(a)}catch(e){console.warn("[ProductCards] Error reiniciando carrusel:",e)}}const Bi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
${Te}`},{id:"dual-card-dark",label:"Tarjeta azul oscuro",category:"Productos y Servicios",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
        ...
        </svg>`,content:`${Ye}${Te}`},{id:"dual-card-light",label:"Tarjeta blanca",category:"Productos y Servicios",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
        ...
        </svg>`,content:`${Xe}${Te}`}],Ci=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<section class="cta-section">
    <div class="cta-img-wrap">
        <img src="${T("images/placeholder.svg")}" alt="Imagen CTA">
    </div>
...
@media(max-width:640px){.dd-btn-label{white-space:normal;}.dd-acc-title{white-space:normal;}}
</style>`,_i=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
    ...
    </div>`}function Ii(){return function(){const t=this;if(t.__ddAccBound)return;t.__ddAccBound=!0;const e=t.querySelector(".dd-acc-header"),i=t.querySelector(".dd-acc-arrow");!e||!i||e.addEventListener("click",a=>{if(a.target.closest("a"))return;const r=t.classList.toggle("dd-acc-open");i.classList.toggle("ri-arrow-down-s-line",r),i.classList.toggle("ri-arrow-right-s-line",!r)})}}const qi=[{id:"document-download-section",label:"Sección de Documentos Descargables",category:"Documentos",media:_i,content:`
...
${me}`},{id:"document-download-button",label:"Botón de Documento",category:"Documentos",media:Ti,content:`${ke("Nombre_del_documento.pdf")}${me}`},{id:"document-accordion-section",label:"Sección de Documentos con Acordeón",category:"Documentos",media:Ai,content:`
<section class="dd-section">
    <h2 class="text-4xl font-extrabold text-[#003B71]" contenteditable="true" data-gjs-type="text" data-gjs-editable="true">Titulo principal</h2>
    <div class="dd-stripe" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"></div>
...
${me}`},{id:"document-accordion-item",label:"Ítem de Acordeón",category:"Documentos",media:zi,content:`${Ae("Nombre de la sección",!1)}${me}`}];function Di(t){const e="doc-download-button",i="doc-accordion-item";t.DomComponents.addType(e,{isComponent:a=>a.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Botón de Documento",tagName:"a",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,class:"dd-btn",href:"#"},components:`
                    <span class="dd-btn-left" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
                        <i class="ri-article-line dd-btn-icon-file" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"></i>
                ...
                `,script:Ii()},init(){this.set("type",i),this.addAttributes({"data-gjs-type":i})}}}),t.Commands.add("select-doc-download-file",{run(a){const r=a.getSelected();!r||r.get("type")!==e||Le({type:"document",title:"Seleccionar documento",onSelect:(l,o)=>{r.addAttributes({href:l});const g=r.find(".dd-btn-label")[0],f=o?.name||l.split("/").pop();g&&g.components(f)}})}}),Mi(t,i)}function Mi(t,e){t.on("storage:end:load",()=>{setTimeout(()=>Ge(t,e),800)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},400))}),t.on("component:clone",i=>{if(i.get("type")===e){const a=i.getEl();a&&(delete a.__ddAccBound,setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},400))}}),t.on("canvas:render",()=>{setTimeout(()=>Ge(t,e),600)})}function Ge(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}const Et=function(){(function(){function t(i){if(!i||i.__savInit)return;i.__savInit=!0;var a=i.querySelector(".sav-carousel-wrap");if(!a)return;a.scrollLeft=0;var r=!1,l=0,o=0,g=!1,f=0,c=0,n=0,s=null;a.querySelectorAll("img").forEach(function(h){h.setAttribute("draggable","false")}),setTimeout(function(){var h=a.scrollWidth-a.clientWidth;if(h<=0)return;var $=Math.min(60,h),B=null;function C(E){B||(B=E);var L=(E-B)/400;if(L<.5)a.scrollLeft=$*(L*2);else if(L<1)a.scrollLeft=$*(1-(L-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(C)}requestAnimationFrame(C)},400);function m(){return a.scrollWidth-a.clientWidth}function b(h){return Math.max(0,Math.min(h,m()))}function p(){Math.abs(f)<.5||(f*=.92,a.scrollLeft=b(a.scrollLeft+f),s=requestAnimationFrame(p))}a.addEventListener("mousedown",function(h){h.button===0&&(s&&(cancelAnimationFrame(s),s=null),r=!0,g=!1,f=0,l=h.clientX,c=h.clientX,n=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",h.preventDefault())}),document.addEventListener("mousemove",function(h){if(r){var $=l-h.clientX;Math.abs($)>3&&(g=!0);var B=Date.now(),C=B-n||1;f=(h.clientX-c)/C*16*-1,c=h.clientX,n=B,a.scrollLeft=b(o+$)}}),document.addEventListener("mouseup",function(h){r&&(r=!1,a.style.cursor="grab",g&&(h.stopPropagation(),s=requestAnimationFrame(p)))}),a.addEventListener("click",function(h){g&&(h.preventDefault(),h.stopPropagation(),g=!1)},!0);var w=0,k=0,u=0,y=0,x=0;a.addEventListener("touchstart",function(h){s&&(cancelAnimationFrame(s),s=null),w=h.touches[0].clientX,u=h.touches[0].clientX,y=Date.now(),k=a.scrollLeft,x=0},{passive:!0}),a.addEventListener("touchmove",function(h){var $=Date.now(),B=$-y||1,C=h.touches[0].clientX;x=(C-u)/B*16*-1,u=C,y=$;var E=w-C;a.scrollLeft=b(k+E)},{passive:!0}),a.addEventListener("touchend",function(){s=requestAnimationFrame(function h(){Math.abs(x)<.5||(x*=.92,a.scrollLeft=b(a.scrollLeft+x),s=requestAnimationFrame(h))})},{passive:!0})}function e(){document.querySelectorAll(".sav-section").forEach(function(i){delete i.__savInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Ni=`(${Et.toString()})();`,Ri=`
...
@media(max-width:480px){.sav-card{flex:0 0 75vw;}}`;function Pi(t){const e=t.img||T("images/placeholder.svg"),i=t.title||"TÍTULO DEL PRODUCTO",a=t.desc?`<p class="sav-card-desc">${t.desc}</p>`:"",r=t.href||"#",l=t.btn_label||"Solicitar";return`<div class="sav-card"><div class="sav-card-img-wrap"><img src="${e}" alt="${i}" class="sav-card-img"></div><h3 class="sav-card-title">${i}</h3>${a}<a href="${r}" class="sav-btn">${l}</a></div>`}function $t(t){const e=t.heading||"Depósitos y Cuentas de Ahorro",i=t.subheading||"Productos diseñados para hacer crecer tu dinero de forma segura.",a=t.more_href||"#",r=t.more_label||"Ver más",l=t.show_more!==!1,g=(t.cards||[]).map(Pi).join(""),f=T("images/brand-watermark.png"),c=l?`<div class="sav-more-wrap"><a href="${a}" class="sav-more-btn">${r}</a></div>`:"";return`<section class="sav-section"><style>${Ri}</style><div class="sav-blue-box"><div class="sav-watermark"><img src="${f}" alt=""></div><div style="display:flex;flex-direction:column;gap:0.5rem;text-align:center;position:relative;z-index:1;"><h2 class="sav-heading">${e}</h2><p class="sav-subheading">${i}</p></div><div class="sav-carousel-wrap"><div class="sav-track">${g}</div></div>${c}</div></section>`}const F={heading:"Depósitos y Cuentas de Ahorro",subheading:"Productos diseñados para hacer crecer tu dinero de forma segura.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CUENTA DE AHORRO ESTÁNDAR",href:"#",btn_label:"Solicitar"},{img:"",title:"AHORRO RENTABLE",href:"#",btn_label:"Solicitar"},{img:"",title:"CUENTA DE AHORRO MÁS",href:"#",btn_label:"Solicitar"},{img:"",title:"DEPÓSITO DE PLAZO FIJO",href:"#",btn_label:"Solicitar"}]};function Hi(t,e){const i=document.getElementById("sav-config-modal");if(i&&i.remove(),!document.getElementById("sav-modal-styles")){const c=document.createElement("style");c.id="sav-modal-styles",c.textContent=`
        ...
        <div class="sav-modal-footer">
            ...
            <button id="sav-modal-save" class="sav-btn-save"><i class="ri-check-line"></i> Aplicar cambios</button>
        </div>`,l.appendChild(o),document.body.appendChild(l),l.addEventListener("click",c=>{c.target===l&&f()}),o.querySelectorAll(".sav-tab-btn").forEach(c=>{c.addEventListener("click",()=>{o.querySelectorAll(".sav-tab-btn").forEach(n=>n.classList.remove("active")),o.querySelectorAll(".sav-tab-panel").forEach(n=>n.classList.remove("active")),c.classList.add("active"),o.querySelector(`#sav-panel-${c.dataset.tab}`).classList.add("active")})}),o.querySelector("#sav-show-more").addEventListener("change",function(){r.show_more=this.checked,o.querySelector("#sav-more-fields").style.display=this.checked?"flex":"none"});function g(){const c=o.querySelector("#sav-cards-list");c.innerHTML="",r.cards.forEach((n,s)=>{const m=document.createElement("div");m.className="sav-card-config";const b=n.img?`<img class="sav-img-preview" src="${n.img}" alt="">`:'<div class="sav-img-placeholder"><i class="ri-image-line"></i></div>';m.innerHTML=`
                ...
                <div class="sav-row">
                    <div id="sav-img-wrap-${s}">${b}</div>
                    <div style="flex:1;display:flex;flex-direction:column;gap:0.5rem;">
                        <input class="sav-input-sm" placeholder="URL de la imagen" value="${n.img||""}" data-field="img">
...
</svg>`;function Fi(t){const e="savings-section-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección Fondo Azul",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-savings-config":JSON.stringify(F)},components:$t(F),script:Et,"script-props":["data-savings-config"],traits:[{type:"button",label:"Sección",text:"Administrar Sección",full:!0,command:"open-savings-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-savings-config",{run(i){const a=i.getSelected();a&&Hi(i,a)}}),t.BlockManager.add("savings-section-block",{label:"Sección Fondo Azul",category:"Productos y Servicios",media:Oi,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),t.on("component:mount",i=>{i.getEl()?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>Be(t),400))}),t.on("component:selected",i=>{const a=i.getEl();if(!a)return;const r=a.closest(`[data-gjs-type="${e}"]`);if(r&&!a.hasAttribute("data-gjs-type")){const l=t.getWrapper().find(`[data-gjs-type="${e}"]`).find(o=>o.getEl()===r);l&&setTimeout(()=>t.select(l),0)}}),t.on("canvas:render",()=>setTimeout(()=>Be(t),600)),t.on("storage:end:load",()=>setTimeout(()=>Be(t),800))}const We=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
<a href="#" class="plc-card plc-card--orange">
    ...
    <div class="plc-card__watermark">
        <img src="${T("images/brand-watermark.png")}" alt="">
    </div>
</a>`,ie=`
...
</style>`,Yi=[{id:"product-link-cards",label:"Tarjetas de productos con enlace",category:"Productos y Servicios",media:We,content:`
...
${ze}`},{id:"product-link-card-orange",label:"Tarjeta producto naranja",category:"Productos y Servicios",media:We,media:Ui,content:`${te}${ze}`},{id:"product-link-card-blue",label:"Tarjeta producto azul",category:"Productos y Servicios",media:Vi,content:`${ie}${ze}`}],Xi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<a href="#" class="flex flex-col items-center text-center gap-4 no-underline il-link-item">
    <div class="w-16 h-16 rounded-full flex items-center justify-center shrink-0 il-icon-badge">
        <img src="${T("images/placeholder.svg")}" alt="" class="w-8 h-8 object-contain">
    </div>
...
${Je}`},{id:"icon-link-item",label:"Icono con enlace",category:"Productos y Servicios",media:Gi,content:`${ae}${Je}`}],Ji=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<div class="ic-card flex items-center gap-4 sm:gap-5 md:gap-7 bg-white rounded-2xl shadow-md p-5 sm:p-6 md:p-8">
    <img src="${T("images/placeholder.svg")}" alt="Icono" class="ic-icon w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 flex-shrink-0 object-contain">
...
${Ki}`,Zi=[{id:"icon-cards-block",label:"Tarjetas con ícono",category:"Contenido",media:Ji,content:Qi()}],ea=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<div class="asc-card flex flex-col items-center text-center gap-3 bg-white rounded-2xl shadow-md p-6">
    <div class="asc-badge w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0">
        <img src="${T("images/placeholder.svg")}" alt="Icono" class="asc-icon w-8 h-8 object-contain">
    </div>
...
<div class="fb-col-image">
    <div class="fb-img-wrap">
        <img src="${T("images/placeholder.svg")}" alt="Imagen" class="fb-img">
    </div>
</div>`,ca=`
<style>
...
</style>`,Ze=t=>{const e=t?"fb-section-right":"fb-section-left",i=t?`<div class="fb-col-content">${Ke}</div>${Qe}`:`${Qe}<div class="fb-col-content">${Ke}</div>`;return`
<section class="${e}">
    <div class="fb-grid">
        ${i}
    </div>
</section>
${ca}`},da=[{id:"feature-orange-img-right",label:"Sección naranja - imagen derecha",category:"Banners",media:sa,content:Ze(!0)},{id:"feature-orange-img-left",label:"Sección naranja - imagen izquierda",category:"Banners",media:na,content:Ze(!1)}],fa=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<style>${Oe}</style>`,ma=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<div class="w-full rounded-2xl overflow-hidden">
    <img src="${T("images/placeholder.svg")}"
...
${ja}`,_a=[{id:"stats-strip-left",label:"Franja estadísticas - izquierda",category:"Heroes",media:Ca,content:tt(!0)},{id:"stats-strip-right",label:"Franja estadísticas - derecha",category:"Heroes",media:La,content:tt(!1)}],Ta=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
<div class="flex flex-col items-center gap-4 text-center">
    <div class="w-20 h-20 rounded-full flex items-center justify-center shrink-0" style="background:#166EBE;">
        <img src="${T("images/placeholder.svg")}" alt="Icono" class="w-10 h-10 object-contain">
    </div>
...
</style>`,za=[{id:"service-cards-section",label:"Sección de servicios con iconos",category:"Productos y Servicios",media:Ta,content:`
...
${it}`},{id:"service-card-item",label:"Ítem de servicio con icono",category:"Productos y Servicios",media:Aa,content:`${oe}${it}`}],Ia=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,Pa=[{id:"rich-list",label:"Lista con título y descripción",category:"Contenido",media:Na,content:`
...
${at}`},{id:"rich-list-item",label:"Ítem de lista con descripción",category:"Contenido",media:Ra,content:`
<section class="rl-section">
    <div class="rl-list">
        ${se}
    </div>
...
<div class="pd-card items-center">
    <div class="w-12 h-12 rounded-full flex items-center justify-center shrink-0 pd-btn-orange">
        <img src="${T("images/placeholder.svg")}" alt="" class="w-6 h-6 object-contain">
    </div>
    ...
    <ul class="list-none p-0 m-0 flex flex-col gap-2 w-full">
        ${Array.from({length:e},Fe).join("")}
    </ul>
</div>`,St=(t="Lorem ipsum")=>`
<div class="pd-card-simple">
    <div class="w-14 h-14 rounded-full flex items-center justify-center shrink-0 pd-btn-orange">
        <img src="${T("images/placeholder.svg")}" alt="" class="w-7 h-7 object-contain">
    </div>
...
<div class="pd-cards-row">
    ${Array.from({length:t},()=>St()).join("")}
</div>`,P=(t="Adquiere tu servicio")=>`
<a href="#" class="inline-block py-3 px-8 rounded-full pd-btn-orange text-white text-base font-bold text-center tracking-wide max-w-full transition-colors no-underline">${t}</a>`,H=(t="Nombre del Producto")=>`
<h2 class="text-4xl font-black text-[#E97300] break-words leading-tight text-center w-full">${t}</h2>`,Xa={title:"Coberturas",cols:3,headers:[{text:"Coberturas",align:"left"},{text:"Cantidad",align:"center"},{text:"Límite (US$)",align:"center"}],rows:Array.from({length:5},()=>[{text:"",align:"left",isHeader:!1,colspan:1,rowspan:1,image:null},{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null},{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null}])},st=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</svg>`,A="Detalle de Producto",er=[{id:"product-detail-section",label:"Sección: 2 columnas (texto + acción)",category:A,media:st,content:`
...
${Fa}
${q}`},{id:"product-detail-cards-grid",label:"Sección: tarjetas con lista + acción",category:A,media:ct,content:`
<section class="w-full bg-white px-16 py-12">
    <div class="pd-asymmetric-grid">
        <div class="flex flex-col gap-5">
...
${Q}
${rt}
${q}`},{id:"product-detail-cards-row",label:"Sección: fila de tarjetas simples (sin acción lateral)",category:A,media:dt,content:`
...
${lt}
${q}`},{id:"product-detail-repeat-blocks",label:"Sección: bloques título+párrafo repetidos + acción",category:A,media:st,content:`
<section class="w-full bg-white px-16 py-12">
    <div class="pd-asymmetric-grid">
...
<section class="w-full bg-white px-16 py-12 flex flex-col gap-8">
    ...
    <div class="pd-icons-cta-grid">
        <div class="w-full">
            <img src="${T("images/placeholder.svg")}" alt="Servicios disponibles" class="w-full h-auto object-contain">
        </div>
        <div class="flex flex-col items-center gap-4">
            ${H("Nombre del Producto")}
            ${P("Adquiere tu servicio")}
...
${Oa}
${q}`},{id:"product-detail-table",label:"Sección: tabla de coberturas + acción",category:A,media:ft,content:`
<section class="w-full bg-white px-16 py-12">
    <div class="pd-asymmetric-grid">
        <div class="flex flex-col gap-5">
...
${Q}
${Ua}
${q}`},{id:"product-detail-bullet-item",label:"Ítem: bullet individual",category:A,media:pt,content:`
<ul class="list-none p-0 m-0 flex flex-col gap-3">
    ${Fe()}
</ul>
${q}`},{id:"product-detail-bullet-list",label:"Ítem: lista de ventajas (con título)",category:A,media:pt,content:`
${R(4,"Ventajas:")}
${q}`},{id:"product-detail-footnote",label:"Ítem: nota al pie",category:A,media:Ka,content:`
${U(1)}
${q}`},{id:"product-detail-cta-button",label:"Ítem: botón CTA",category:A,media:Qa,content:`
${P("Adquiere tu servicio")}
${q}`},{id:"product-detail-title",label:"Ítem: título de producto",category:A,media:Za,content:`
${H("Nombre del Producto")}
...
${nt()}
${q}`},{id:"product-detail-icon-card",label:"Ítem: tarjeta con ícono + lista",category:A,media:ct,content:`
<div class="pd-cards-grid" style="grid-template-columns:1fr;max-width:320px;">
    ${ce("Lorem ipsum",3)}
</div>
${rt}
${q}`},{id:"product-detail-icon-card-simple",label:"Ítem: tarjeta simple (ícono + texto)",category:A,media:dt,content:`
<div class="pd-cards-row" style="grid-template-columns:1fr;max-width:260px;">
    ${St("Lorem ipsum")}
</div>
${lt}
${q}`},{id:"product-detail-coverage-table",label:"Ítem: tabla de coberturas",category:A,media:ft,content:'<div data-gjs-type="table-component" data-table-theme="orange" data-coverage-table-init="1"></div>'}];typeof window<"u"&&(window.__coverageTableInitialData=Xa);const gt=`
<style>
...
${gt}`},{id:"financing-card",label:"Tarjeta de financiamiento",category:"Productos y Servicios",media:tr,content:`
<div class="fc-cards-grid">
    ${de("Lorem ipsum dolor sit amet consectetur adipiscing elit, sed do eiusmod")}
</div>
${gt}`}],mt=`
...
</style>`;function fe(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function rr(t){return`
<div class="ng-card">
    <div class="ng-card-image">${t.featured_image?`<img src="${fe(t.featured_image)}" alt="${fe(t.title)}">`:'<div style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;color:#94a3b8;font-size:2rem;"><i class="ri-image-line"></i></div>'}</div>
    <div class="ng-card-body">
        ${t.category?`<span class="ng-card-category">${fe(t.category)}</span>`:""}
        <h3 class="ng-card-title">${fe(t.title)}</h3>
        <p class="ng-card-desc">${fe(t.description)}</p>
    </div>
</div>`}function lr(){return document.querySelector('meta[name="api-news-url"]')?.content??null}function or(){return document.querySelector('meta[name="api-news-categories-url"]')?.content??null}const nr=function(){const t=this,e=t.querySelector("[data-ng-grid]"),i=t.querySelector("[data-ng-more-wrap]"),a=t.querySelector("[data-ng-more-link]");async function r(){const l=window.__getNewsApiUrl?window.__getNewsApiUrl():null;if(!(!l||!e)){e.innerHTML='<div class="ng-loading">Cargando noticias...</div>';try{const o=await fetch(`${l}?per_page=6`);if(!o.ok)throw new Error("Error al cargar noticias");const f=(await o.json()).data||[];if(!f.length){e.innerHTML='<div class="ng-empty">No hay noticias disponibles por el momento.</div>';return}e.innerHTML=f.map(n=>window.__buildNewsCard(n)).join("");const c=t.getAttribute("data-ng-more-url");i&&(i.style.display=c?"flex":"none"),a&&c&&a.setAttribute("href",c)}catch{e.innerHTML='<div class="ng-error">No se pudieron cargar las noticias.</div>'}}}r()},sr=function(){const t=this,e=t.querySelector("[data-ng-grid]"),i=t.querySelector("[data-ng-category-filter]"),a=t.querySelector("[data-ng-pagination]");let r=1,l="";async function o(){const c=window.__getNewsCategoriesApiUrl?window.__getNewsCategoriesApiUrl():null;if(!(!c||!i))try{const n=await fetch(c);if(!n.ok)return;const s=await n.json();i.innerHTML='<option value="">Todas las categorías</option>'+s.map(m=>`<option value="${m.id}">${m.name}</option>`).join("")}catch{}}function g(c,n){if(!a)return;if(n<=1){a.innerHTML="";return}const s=[];s.push(`<button type="button" class="ng-page-btn" data-ng-page="${c-1}" ${c<=1?"disabled":""}>&laquo;</button>`);for(let m=1;m<=n;m+=1)s.push(`<button type="button" class="ng-page-btn ${m===c?"ng-page-active":""}" data-ng-page="${m}">${m}</button>`);s.push(`<button type="button" class="ng-page-btn" data-ng-page="${c+1}" ${c>=n?"disabled":""}>&raquo;</button>`),a.innerHTML=s.join(""),a.querySelectorAll("[data-ng-page]").forEach(m=>{m.addEventListener("click",()=>{const b=parseInt(m.dataset.ngPage,10);Number.isNaN(b)||b<1||b>n||(r=b,f())})})}async function f(){const c=window.__getNewsApiUrl?window.__getNewsApiUrl():null;if(!c||!e)return;e.innerHTML='<div class="ng-loading">Cargando noticias...</div>',a&&(a.innerHTML="");const n=new URLSearchParams({per_page:12,page:r});l&&n.set("category",l);try{const s=await fetch(`${c}?${n.toString()}`);if(!s.ok)throw new Error("Error al cargar noticias");const m=await s.json(),b=m.data||[];if(!b.length){e.innerHTML='<div class="ng-empty">No hay noticias disponibles con los filtros seleccionados.</div>';return}e.innerHTML=b.map(p=>window.__buildNewsCard(p)).join(""),g(m.current_page||1,m.last_page||1)}catch{e.innerHTML='<div class="ng-error">No se pudieron cargar las noticias.</div>'}}i&&i.addEventListener("change",()=>{l=i.value,r=1,f()}),o(),f()};function cr(){typeof window>"u"||(window.__getNewsApiUrl||(window.__getNewsApiUrl=lr),window.__getNewsCategoriesApiUrl||(window.__getNewsCategoriesApiUrl=or),window.__buildNewsCard||(window.__buildNewsCard=rr))}const dr=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</svg>`,fr=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
    ...
    <circle cx="22" cy="26" r="2" fill="#003B71" fill-opacity="0.7"/>
</svg>`;function pr(t){cr();const e="news-grid-preview-component",i="news-grid-full-component";t.DomComponents.addType(e,{isComponent:a=>a.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Noticias Recientes",tagName:"section",classes:["ng-section"],draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-ng-more-url":"#"},components:`
                    ...
                    ${mt}
                `,script:nr,traits:[{type:"text",label:"URL de 'Ver más'",name:"data-ng-more-url",changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.DomComponents.addType(i,{isComponent:a=>a.getAttribute?.("data-gjs-type")===i?{type:i}:!1,model:{defaults:{name:"Noticias (Listado Completo)",tagName:"section",classes:["ng-section"],draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":i},components:`
                    <h2 class="ng-section-heading">Noticias y Publicaciones</h2>
                    ...
                    ${mt}
                `,script:sr,traits:[]},init(){this.set("type",i),this.addAttributes({"data-gjs-type":i})}}}),t.BlockManager.add("news-grid-preview-block",{label:"Noticias Recientes",category:"Contenido",media:dr,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),t.BlockManager.add("news-grid-full-block",{label:"Noticias (Listado Completo)",category:"Contenido",media:fr,activate:!0,content:{type:i,attributes:{"data-gjs-type":i}}})}const Ee=5,$e=[{label:"Azul",value:"#003B71"},{label:"Azul claro",value:"#5C88B3"},{label:"Naranja",value:"#E97300"},{label:"Naranja claro",value:"#F2A566"},{label:"Azul transparente",value:"rgba(0,59,113,0.55)"}],Ct=`
<style>
...
.bc-plot{height:220px;gap:0.75rem;}
        ...
        ${a}`}function mr(t,e){const i=document.getElementById("bar-chart-config-modal");if(i&&i.remove(),!document.getElementById("bc-modal-styles")){const n=document.createElement("style");n.id="bc-modal-styles",n.textContent=`
        ...
        `,document.head.appendChild(n)}const a=(()=>{try{return JSON.parse(e.getAttributes()["data-bar-chart-config"]||"{}")}catch{return{}}})(),r=De(a);let l=r.bars.map(n=>({...n}));const o=document.createElement("div");o.id="bar-chart-config-modal",o.className="bc-overlay";const g=(n,s)=>`
        <div class="bc-bar-row" data-bar-row="${s}">
            ...
            <div class="bc-bar-fields">
                <div>
                    ...
                    <input type="text" class="bc-input" data-bar-field="label" data-bar-index="${s}" value="${n.label}" maxlength="60">
                </div>
                <div>
                    <label class="bc-label">Valor (0-100)</label>
                    <input type="number" class="bc-input" data-bar-field="value" data-bar-index="${s}" value="${n.value}" min="0" max="100" step="0.01">
                </div>
                <div>
                    <label class="bc-label">Color</label>
                    <input type="color" class="bc-color-input" data-bar-field="color" data-bar-index="${s}" value="${/^#[0-9a-fA-F]{6}$/.test(n.color)?n.color:"#003B71"}">
                </div>
            </div>
            ...
            </div>`,o.querySelector("#bc-modal-close").onclick=c,o.querySelector("#bc-modal-cancel").onclick=c,o.querySelector("#bc-add-bar").onclick=()=>{l.length>=Ee||(l.push({label:`Lorem ipsum ${l.length+1}`,value:0,color:$e[l.length%$e.length].value}),r.title=o.querySelector("#bc-title").value,r.showLegend=o.querySelector("#bc-show-legend").checked,f())},o.querySelectorAll("[data-remove-bar]").forEach(n=>{n.onclick=()=>{if(l.length<=1)return;const s=parseInt(n.dataset.removeBar,10);l.splice(s,1),r.title=o.querySelector("#bc-title").value,r.showLegend=o.querySelector("#bc-show-legend").checked,f()}}),o.querySelectorAll("[data-bar-field]").forEach(n=>{n.addEventListener("input",()=>{const s=parseInt(n.dataset.barIndex,10),m=n.dataset.barField;if(m==="value"){const b=o.querySelector(`[data-bar-error="${s}"]`),p=n.value,w=parseFloat(p);if(p===""||Number.isNaN(w)||w<0||w>100){b.textContent="Ingresa un valor entre 0 y 100";return}b.textContent="",l[s].value=je(w)}else l[s][m]=n.value})})},c=()=>o.remove();o.onclick=n=>{n.target===o&&c()},o.appendChild(document.createElement("div")),f(),o.addEventListener("click",n=>{if(n.target.id==="bc-modal-save"){if(o.querySelector(".bc-error-text:not(:empty)"))return;const m=De({title:o.querySelector("#bc-title").value.trim(),showLegend:o.querySelector("#bc-show-legend").checked,bars:l});e.addAttributes({"data-bar-chart-config":JSON.stringify(m)}),e.components(Lt(m)+Ct),c()}}),document.body.appendChild(o)}function hr(t){const e="bar-chart-component";t.BlockManager.add("bar-chart-section-block",{label:"Sección: Gráfico de Barras",category:"Gráficos",media:`<svg viewBox="0 0 32 32" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
        ...
        </svg>`,activate:!0,content:{type:e,attributes:{"data-gjs-type":e},classes:["bc-section","w-full","bg-white","px-16","py-12"]}})}function br(t){const e="bar-chart-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Gráfico de Barras",tagName:"div",classes:["bc-section"],draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-bar-chart-config":JSON.stringify(Se)},components:Lt(Se)+Ct,traits:[{type:"button",label:"Gráfico",text:"Administrar Barras",full:!0,command:"open-bar-chart-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-bar-chart-config",{run(i){const a=i.getSelected();a&&mr(i,a)}}),t.BlockManager.add("bar-chart-block",{label:"Gráfico de Barras",category:"Gráficos",media:`<svg viewBox="0 0 32 32" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
        ...
        </svg>`,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}})}const ur=`<svg viewBox="0 0 32 32" width="32" height="32">
...
`,yr=[{id:"contact-form",label:"Formulario de contacto",category:"Formularios",media:ur,content:`
...
<\/script>`}],vr=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
</svg>`,Ce={blue:{headerBg:"bg-[#003B71]",headerText:"text-white",subheaderBg:"bg-[#003B71]",subheaderText:"text-white",borderColor:"#003B71",rowText:"text-[#003B71]",labelText:"text-[#003B71]"},orange:{headerBg:"bg-[#E97300]",headerText:"text-white",subheaderBg:"bg-[#E97300]",subheaderText:"text-white",borderColor:"#E97300",rowText:"text-[#003B71]",labelText:"text-[#003B71]"}};function jt(t,e){const i=Ce[e]||Ce.blue,a=t.showTitleRow!==!1&&!!t.title,r=t.showHeaderRow!==!1;let l='<table class="w-full border-collapse font-[Poppins,sans-serif] table-fixed">';if(a||r){if(l+="<thead>",a&&(l+=`<tr>
                <th colspan="${t.cols}" class="p-3 align-middle text-center text-base font-bold ${i.headerBg} ${i.headerText}">
                    ${t.title}
                </th>
            </tr>`),r&&t.headers?.length){const f=a?i.subheaderBg:i.headerBg,c=a?i.subheaderText:i.headerText;l+="<tr>",t.headers.forEach((n,s)=>{const m=s<t.headers.length-1?`border-r border-[${i.borderColor}]`:"";l+=`<th class="p-3 align-middle text-sm font-semibold ${f} ${c} ${m} border-b border-[${i.borderColor}] text-${n.align||"center"}">${n.text||""}</th>`}),l+="</tr>"}l+="</thead>"}l+="<tbody>";const o=t.rows.length,g={};return t.rows.forEach((f,c)=>{l+="<tr>";let n=0;f.forEach(s=>{for(;g[`${c}-${n}`];)n++;const m=s.colspan||1,b=s.rowspan||1;for(let L=c;L<c+b;L++)for(let z=n;z<n+m;z++)(L!==c||z!==n)&&(g[`${L}-${z}`]=!0);const p=m>1?`colspan="${m}"`:"",w=b>1?`rowspan="${b}"`:"",k=s.isHeader?`tbl-cell-highlight-${e}`:`tbl-cell-normal-${e}`,u="font-semibold",y=s.isHeader?i.labelText:i.rowText,x=`text-${s.align||"center"}`,h=c+b>=o,B=n+m>=t.cols?"":`border-r border-[${i.borderColor}]`,C=h?"":`border-b border-[${i.borderColor}]`,E=`${B} ${C} p-3 align-middle text-sm ${k} ${u} ${y} ${x}`;s.image?l+=`<td ${p} ${w} class="${E}">
                ...
                </td>`:l+=`<td ${p} ${w} class="${E}">${s.text||""}</td>`,n+=m}),l+="</tr>"}),l+="</tbody></table>",l}function Z(t,e){return{title:"Título de la tabla",showTitleRow:!0,showHeaderRow:!0,cols:t,headers:Array.from({length:t},(i,a)=>({text:`Columna ${a+1}`,align:"center"})),rows:Array.from({length:e},()=>Array.from({length:t},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})))}}function wr(t){return`<style>
.tbl-cell-normal-${t}{background-color:#ffffff;}
.tbl-cell-highlight-${t}{background-color:#e2e8f0;}
</style>`}function _t(t,e){return`<div class="w-full overflow-x-auto rounded-2xl border-2 border-[${(Ce[e]||Ce.blue).borderColor}]">${wr(e)}${t}</div>`}function ht(t,e){const i={};return t.forEach((a,r)=>{let l=0;a.forEach(o=>{for(;i[`${r}-${l}`];)l++;const g=Math.min(o.colspan||1,e-l),f=o.rowspan||1;for(let c=r;c<r+f;c++)for(let n=l;n<l+g;n++)(c!==r||n!==l)&&(i[`${c}-${n}`]=`${r}-${l}`);l+=g})}),i}const kr=`
...
.tam-img-selected-info{font-size:0.8125rem;color:#64748b;}`;function Br(){if(document.getElementById("tam-img-modal"))return;const t=document.createElement("div");t.id="tam-img-modal",t.className="tam-img-overlay",t.innerHTML=`
        ...
        <div class="tam-modal">
        ...
        </div>`,document.body.appendChild(a);let r=null,l=null;function o(){const b=document.getElementById("tam-show-title-row").checked,p=document.getElementById("tam-title");p.disabled=!b,p.style.opacity=b?"1":"0.5"}function g(b){r=b;const p=b.get("tableData");l=p?JSON.parse(JSON.stringify(p)):Z(3,3);const w=l.cols||3;l.rows=l.rows.map(k=>Array.from({length:w},(u,y)=>k[y]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})),document.getElementById("tam-title").value=l.title||"",document.getElementById("tam-theme").value=b.get("tableTheme")||"blue",document.getElementById("tam-cols").value=l.cols||3,document.getElementById("tam-rows").value=l.rows.length||3,document.getElementById("tam-show-title-row").checked=l.showTitleRow!==!1,document.getElementById("tam-show-header-row").checked=l.showHeaderRow!==!1,o(),s(),m(),a.classList.add("open"),document.body.style.overflow="hidden"}function f(){a.classList.remove("open"),document.body.style.overflow="",r=null}function c(){l.title=document.getElementById("tam-title").value.trim(),l.showTitleRow=document.getElementById("tam-show-title-row").checked,l.showHeaderRow=document.getElementById("tam-show-header-row").checked,l.cols=parseInt(document.getElementById("tam-cols").value)||3,l.headers=Array.from(document.querySelectorAll(".tam-header-input")).map(p=>({text:p.value,align:p.closest("th")?.querySelector(".tam-align-select")?.value||"center"})),document.querySelectorAll("#tam-tbody td.tam-cell:not(.is-spanned)").forEach(p=>{const w=parseInt(p.dataset.row),k=parseInt(p.dataset.col);l.rows[w]?.[k]&&(l.rows[w][k].text=p.querySelector(".tam-cell-input")?.value||"",l.rows[w][k].align=p.querySelector(".tam-align-select")?.value||"center",l.rows[w][k].isHeader=p.dataset.isheader==="1",l.rows[w][k].image=p.dataset.image||null)});const b=ht(l.rows,l.cols);l.rows=l.rows.map((p,w)=>p.filter((k,u)=>!b[`${w}-${u}`]))}function n(){if(a.querySelector("#tam-rebuild-notice"))return;const p=document.createElement("div");p.id="tam-rebuild-notice",p.className="tam-rebuild-notice",p.style.margin="1rem 1.25rem 0",p.innerHTML='<i class="ri-error-warning-line"></i> Has modificado el colspan/rowspan. Haz clic en <strong style="margin:0 4px;">Reconstruir</strong> para aplicar los cambios de fusión.',a.querySelector(".tam-toolbar").after(p)}function s(){a.querySelector("#tam-rebuild-notice")?.remove()}function m(){const b=document.getElementById("tam-thead"),p=document.getElementById("tam-tbody"),w=l.cols,k=l.rows.length,u=ht(l.rows,w);b.innerHTML=`<tr>${l.headers.map((y,x)=>`
            <th>
            ...
            </th>`).join("")}</tr>`,p.innerHTML=l.rows.map((y,x)=>`<tr>${Array.from({length:w},($,B)=>{const C=u[`${x}-${B}`];if(C)return`<td class="tam-cell is-spanned" data-row="${x}" data-col="${B}">
                        <div class="tam-spanned-label">Combinada con [${C}]</div>
                    </td>`;const E=y[B]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null},L=E.colspan||1,z=E.rowspan||1,D=L>1||z>1;return`<td class="tam-cell ${E.isHeader?"is-header-cell":""} ${E.image?"has-image":""} ${D?"has-span":""}"
                    ...
                    <div class="tam-cell-actions">
                        ...
                        <div class="tam-cell-span-group">
                            ...
                            <input type="number" class="tam-cell-span-input" min="1" max="${w-B}"
                                value="${L}" data-action="colspan" data-row="${x}" data-col="${B}">
                ...
                </td>`}).join("")}</tr>`).join(""),p.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(y=>{y.addEventListener("change",()=>{const x=parseInt(y.dataset.row),h=parseInt(y.dataset.col),$=Math.max(1,parseInt(y.value)||1);l.rows[x]?.[h]&&(y.dataset.action==="colspan"?l.rows[x][h].colspan=Math.min($,w-h):l.rows[x][h].rowspan=Math.min($,k-x),n())})}),p.querySelectorAll("button[data-action]").forEach(y=>{y.addEventListener("click",x=>{x.preventDefault(),x.stopPropagation();const h=y.dataset.action,$=parseInt(y.dataset.row),B=parseInt(y.dataset.col);if(!(isNaN($)||isNaN(B)||!l.rows[$]?.[B])){if(h==="header"){l.rows[$][B].isHeader=!l.rows[$][B].isHeader;const C=p.querySelector(`td[data-row="${$}"][data-col="${B}"]`);C&&(C.dataset.isheader=l.rows[$][B].isHeader?"1":"0",C.classList.toggle("is-header-cell",l.rows[$][B].isHeader)),y.classList.toggle("active",l.rows[$][B].isHeader),y.textContent=l.rows[$][B].isHeader?"✓ Resaltar":"Resaltar";return}if(h==="image"){window.__openTableImagePicker&&window.__openTableImagePicker(C=>{l.rows[$][B].image=C;const E=p.querySelector(`td[data-row="${$}"][data-col="${B}"]`);if(E){E.dataset.image=C,E.classList.add("has-image");let L=E.querySelector(".tam-cell-img-preview");L||(L=document.createElement("img"),L.className="tam-cell-img-preview",E.insertBefore(L,E.firstChild)),L.src=C;const z=E.querySelector("[data-action=image]");if(z&&(z.innerHTML='<i class="ri-image-line"></i> Cambiar'),!E.querySelector("[data-action=clear-image]")){const D=document.createElement("button");D.type="button",D.className="tam-cell-btn tam-cell-btn-clear",D.dataset.action="clear-image",D.dataset.row=$,D.dataset.col=B,D.textContent="✕ Quitar",D.addEventListener("click",Y=>{Y.preventDefault(),Y.stopPropagation(),l.rows[$][B].image=null,E.dataset.image="",E.classList.remove("has-image"),L.remove(),D.remove();const J=E.querySelector("[data-action=image]");J&&(J.innerHTML='<i class="ri-image-line"></i> Imagen')}),E.querySelector(".tam-cell-actions").appendChild(D)}}});return}h==="clear-image"&&(l.rows[$][B].image=null,m())}})})}document.getElementById("tam-close").addEventListener("click",f),document.getElementById("tam-cancel").addEventListener("click",f),a.addEventListener("click",b=>{b.target===a&&f()}),document.getElementById("tam-show-title-row").addEventListener("change",o),document.getElementById("tam-rebuild").addEventListener("click",()=>{const b=parseInt(document.getElementById("tam-cols").value)||3,p=parseInt(document.getElementById("tam-rows").value)||3;for(s(),c();l.headers.length<b;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,b),l.cols=b;l.rows.length<p;)l.rows.push(Array.from({length:b},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,p).map(w=>{for(;w.length<b;)w.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return w.slice(0,b)}),m()}),document.getElementById("tam-apply").addEventListener("click",()=>{c();const b=document.getElementById("tam-theme").value;r&&(r.set("tableData",JSON.parse(JSON.stringify(l))),r.set("tableTheme",b),r.addAttributes({"data-table-theme":b}),Me(r)),f()}),window.__openTableAdminModal=g}function Me(t){const e=t.get("tableData"),i=t.get("tableTheme")||"blue";e&&t.components(_t(jt(e,i),i))}function $r(){return function(){}}const Sr=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:vr,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
        ...
        </svg>`,content:{type:"table-component",attributes:{"data-table-theme":"orange"}}}];function Cr(t){const e="table-component";Er(),t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Tabla",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!0,removable:!0,propagate:["editable","selectable","hoverable","droppable","highlightable"],tableData:null,tableTheme:"blue",attributes:{"data-gjs-type":e,"data-table-theme":"blue"},components:_t(jt(Z(3,3),"blue"),"blue"),script:$r(),traits:[{type:"button",name:"edit-table",label:"Editar tabla",text:"Abrir editor de tabla",command(i){const a=i.getSelected();a&&window.__openTableAdminModal&&(a.get("tableData")||a.set("tableData",Z(3,3)),window.__openTableAdminModal(a))}},{type:"select",name:"data-table-theme",label:"Color del tema",options:[{id:"blue",name:"Azul"},{id:"orange",name:"Naranja"}],changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e});const i=this.getAttributes()["data-table-theme"]||"blue";this.set("tableTheme",i),this.get("tableData")||(this.set("tableData",Z(3,3)),Me(this)),this.on("change:attributes",(a,r)=>{const l=r["data-table-theme"];l&&l!==this.get("tableTheme")&&(this.set("tableTheme",l),Me(this))})}}}),Lr(t,e),jr(t,e)}function Lr(t,e){t.on("component:mount",i=>{const a=i.getEl();if(a?.getAttribute?.("data-gjs-type")===e){i.set("type",e);const r=a.getAttribute("data-table-theme")||"blue";i.set("tableTheme",r),i.get("tableData")||i.set("tableData",Z(3,3))}}),t.on("storage:end:load",()=>{setTimeout(()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getAttributes()["data-table-theme"]||"blue";i.set("tableTheme",a),i.get("tableData")||i.set("tableData",Z(3,3))})},800)}),t.on("storage:start:store",()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e),i.addAttributes({"data-gjs-type":e})})})}function jr(t,e){t.on("load",()=>{const i=t.Canvas.getFrameEl();if(!i)return;const a=i.contentDocument?.head;if(a&&!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=`
                [data-gjs-type="${e}"] * { pointer-events: none !important; }
                [data-gjs-type="${e}"].gjs-selected,
                [data-gjs-type="${e}"].gjs-hovered {
                    outline: 2px dashed rgba(0,59,113,0.5) !important;
            ...
            `,a.appendChild(r)}})}const _r=`<svg viewBox="0 0 80 32" width="80" height="32">
...
</svg>`,qr=`<svg viewBox="0 0 80 32" width="80" height="32">
    <rect width="80" height="32" fill="#f8f9fa" rx="2"/>
...
</svg>`,bt=t=>{const e=t==="#003B71"?"blue":"orange";return`
...
</div>`},ut=t=>{const e=t==="#003B71"?"blue":"orange";return`
...
</div>`},xt={"button-fill-blue":"inline-block px-8 py-3 rounded-full text-base font-semibold leading-snug no-underline whitespace-nowrap border-2 border-[#003B71] bg-[#003B71] text-white transition-all duration-200 hover:bg-[#002a52] hover:border-[#002a52]","button-fill-orange":"inline-block px-8 py-3 rounded-full text-base font-semibold leading-snug no-underline whitespace-nowrap border-2 border-[#E97300] bg-[#E97300] text-white transition-all duration-200 hover:bg-[#c96200] hover:border-[#c96200]","button-outline-blue":"inline-block px-8 py-3 rounded-full text-base font-semibold leading-snug no-underline whitespace-nowrap border-2 border-[#003B71] bg-transparent text-[#003B71] transition-all duration-200 hover:bg-[#003B71] hover:text-white","button-outline-orange":"inline-block px-8 py-3 rounded-full text-base font-semibold leading-snug no-underline whitespace-nowrap border-2 border-[#E97300] bg-transparent text-[#E97300] transition-all duration-200 hover:bg-[#E97300] hover:text-white","button-fill-white":"inline-block px-8 py-3 rounded-full text-base font-semibold leading-snug no-underline whitespace-nowrap border-2 border-white bg-white text-[#003B71] transition-all duration-200 hover:bg-[#dce8f5] hover:border-[#dce8f5]","button-outline-white":"inline-block px-8 py-3 rounded-full text-base font-semibold leading-snug no-underline whitespace-nowrap border-2 border-white bg-transparent text-white transition-all duration-200 hover:bg-white hover:text-[#003B71]"},Pr=[{id:"button-fill-blue",label:"Botón azul sólido",category:"Botones",media:Ir,content:{type:"integral-button",attributes:{"data-btn-variant":"button-fill-blue"}}},{id:"button-fill-orange",label:"Botón naranja sólido",category:"Botones",media:qr,content:{type:"integral-button",attributes:{"data-btn-variant":"button-fill-orange"}}},{id:"button-outline-blue",label:"Botón azul outline",category:"Botones",media:Dr,content:{type:"integral-button",attributes:{"data-btn-variant":"button-outline-blue"}}},{id:"button-outline-orange",label:"Botón naranja outline",category:"Botones",media:Mr,content:{type:"integral-button",attributes:{"data-btn-variant":"button-outline-orange"}}},{id:"button-fill-white",label:"Botón blanco sólido",category:"Botones",media:Nr,content:{type:"integral-button",attributes:{"data-btn-variant":"button-fill-white"}}},{id:"button-outline-white",label:"Botón blanco outline",category:"Botones",media:Rr,content:{type:"integral-button",attributes:{"data-btn-variant":"button-outline-white"}}},{id:"button-download-full-blue",label:"Descarga completa azul",category:"Botones",media:_r,content:bt("#003B71")},{id:"button-download-full-orange",label:"Descarga completa naranja",category:"Botones",media:Tr,content:bt("#E97300")},{id:"button-download-simple-blue",label:"Descarga simple azul",category:"Botones",media:Ar,content:ut("#003B71")},{id:"button-download-simple-orange",label:"Descarga simple naranja",category:"Botones",media:zr,content:ut("#E97300")}];function Hr(t){const e=[{type:"button",label:"Documento",name:"select-document",text:"Seleccionar documento",full:!0,command:"open-document-picker"},{type:"text",name:"href",label:"URL / Enlace",placeholder:"https://..."},{type:"select",name:"target",label:"Abrir en",options:[{id:"_self",name:"Misma ventana"},{id:"_blank",name:"Nueva ventana"}]}];t.DomComponents.addType("link",{model:{defaults:{traits:e}}}),t.DomComponents.addType("integral-button",{isComponent:r=>r.tagName==="A"&&r.hasAttribute("data-btn-variant"),model:{defaults:{tagName:"a",draggable:!0,droppable:!1,editable:!0,attributes:{href:"#",target:"_self","data-btn-variant":"button-fill-blue"},components:"Texto del botón",traits:e},init(){const r=this.getAttributes()["data-btn-variant"]??"button-fill-blue",l=xt[r]??xt["button-fill-blue"];this.setClass(l.split(" "))}}});function i(r,l){if(r.getEl()?.matches?.(l))return r;let g=null;const f=r.components?.();return f?(f.each(c=>{g||(g=i(c,l))}),g):null}function a(r,l){const g={pdf:"ri-file-pdf-line",xlsx:"ri-file-excel-line",xls:"ri-file-excel-line",doc:"ri-file-word-line",docx:"ri-file-word-line"}[l]??"ri-file-line";function f(n){const s=n.getEl?.();if(s?.tagName==="I"){const p=s.parentElement;if(p&&[...p.classList].some(w=>w.includes("-icon")))return n}let m=null;const b=n.components?.();return b?(b.each(p=>{m||(m=f(p))}),m):null}const c=f(r);if(c){const n=c.getClasses().find(s=>s.startsWith("ri-"));n&&c.removeClass(n),c.addClass(g)}else{const s=r.getEl()?.querySelector("[class*='-icon'] i");if(s){const m=[...s.classList].filter(b=>!b.startsWith("ri-"));s.className=[...m,g].join(" ")}}}t.Commands.add("open-document-picker",{run(r){const l=r.getSelected();if(l){if(r._documentPicker)try{r._documentPicker.destroy()}catch{}r._documentPicker=new Dt,r._documentPicker.open(o=>{const g=o.filename.split(".").pop().toLowerCase();l.addAttributes({href:o.url});const f=l.getTrait("href");f&&f.set("value",o.url);const c=i(l,"[class*='-filename']");c&&c.components(o.filename),a(l,g)},{filters:{type:"document"}})}}})}const Or=`<svg viewBox="0 0 80 32" width="80" height="32">
    <rect width="80" height="32" fill="#f8f9fa" rx="2"/>
...
</svg>`,Vr=[{id:"badge-outline-blue",label:"Badge azul outline",category:"Badges",media:Or,content:'<span class="inline-block border border-[#003B71] rounded-full px-4 py-1 text-base font-medium bg-transparent text-[#003B71]">Etiqueta</span>'},{id:"badge-outline-orange",label:"Badge naranja outline",category:"Badges",media:Fr,content:'<span class="inline-block border border-[#E97300] rounded-full px-4 py-1 text-base font-medium bg-transparent text-[#E97300]">Etiqueta</span>'},{id:"badge-outline-white",label:"Badge blanco outline",category:"Badges",media:Ur,content:'<span class="inline-block border border-white rounded-full px-4 py-1 text-base font-medium bg-transparent text-white">Etiqueta</span>'}],Yr=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
.mp-map-wrapper{height:320px;}
    ...
    </section>`}const Ne={title:"Horarios y Agencias:"};function Gr(){return function(){const t=this,e=t.ownerDocument??document,i=".mp-section{width:100%;background:#ffffff;padding:3.5rem 4rem;font-family:'Poppins',sans-serif;}.mp-stats{font-size:1.125rem;font-weight:700;color:#003B71;margin:0 0 1.75rem;line-height:1.5;}.mp-stats .mp-num{color:#E97300;}.mp-title{font-size:1.75rem;font-weight:800;color:#E97300;margin:0 0 1.5rem;}.mp-filters{display:grid;grid-template-columns:repeat(3,1fr);gap:2.5rem;margin-bottom:2rem;position:relative;z-index:30;}.mp-filter{position:relative;}.mp-filter-btn{display:flex;align-items:center;justify-content:space-between;width:100%;background:none;border:none;border-bottom:2px solid #E97300;padding:0.5rem 0.25rem 0.625rem;cursor:pointer;font-family:inherit;}.mp-filter-label{font-size:0.9375rem;font-weight:700;color:#003B71;text-align:left;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}.mp-filter-arrow{color:#003B71;font-size:0.75rem;transition:transform 0.2s ease;flex-shrink:0;margin-left:0.75rem;}.mp-filter.mp-filter-open .mp-filter-arrow{transform:rotate(180deg);}.mp-filter-dropdown{display:none;position:absolute;top:calc(100% + 0.625rem);left:0;right:0;background:#ffffff;border-radius:0.5rem;box-shadow:0 14px 36px rgba(0,0,0,0.2);overflow:hidden;max-height:260px;overflow-y:auto;}.mp-filter.mp-filter-open .mp-filter-dropdown{display:block;}.mp-filter-option{display:block;width:100%;text-align:center;padding:0.75rem 1rem;background:none;border:none;border-bottom:2px solid #E97300;font-size:0.875rem;font-weight:700;color:#003B71;cursor:pointer;font-family:inherit;transition:background 0.15s;}.mp-filter-option:last-child{border-bottom:none;}.mp-filter-option:hover{background:#f8fafc;}.mp-filter-option:disabled{opacity:0.5;cursor:default;pointer-events:none;}.mp-map-wrapper{position:relative;width:100%;height:440px;border-radius:0.5rem;overflow:hidden;}.mp-map{width:100%;height:100%;z-index:1;}.mp-map-overlay{position:absolute;inset:0;background:rgba(0,59,113,0.4);opacity:0;pointer-events:none;transition:opacity 0.2s ease;z-index:20;}.mp-map-overlay.mp-overlay-active{opacity:1;}.mp-pin{background:transparent!important;border:none!important;}.mp-popup{font-family:'Poppins',sans-serif;min-width:180px;}.mp-popup-name{margin:0 0 0.375rem;font-size:0.875rem;font-weight:700;color:#003B71;}.mp-popup-line{margin:0 0 0.25rem;font-size:0.8125rem;color:#475569;display:flex;align-items:flex-start;gap:0.375rem;line-height:1.4;}.mp-popup-line i{color:#E97300;margin-top:0.125rem;}.mp-popup-line:last-child{margin-bottom:0;}@media(max-width:1280px){.mp-section{padding:3rem 2.5rem;}}@media(max-width:992px){.mp-section{padding:2.5rem 1.5rem;}.mp-filters{grid-template-columns:1fr;gap:1.25rem;}.mp-map-wrapper{height:320px;}}";if(!e.getElementById("mp-filter-styles")){const d=e.createElement("style");d.id="mp-filter-styles",d.textContent=i,e.head.appendChild(d)}const a=t.querySelector("[data-mp-filters]"),r=t.querySelector("[data-mp-overlay]"),l=t.querySelector("[data-mp-map]"),o=t.querySelector("[data-mp-stats]");if(!a||!l)return;const g=[13.7942,-88.8965],f=8,c={departments:[],agencies:[],paymentPoints:[],type:null,department:null,pointKey:null};let n=null,s=null,m=null;function b(){a.querySelectorAll(".mp-filter.mp-filter-open").forEach(d=>d.classList.remove("mp-filter-open")),r&&r.classList.remove("mp-overlay-active")}function p(d){return String(d??"").replace(/[&<>"']/g,v=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[v])}function w(d){return p(d).replace(/\*\*(.+?)\*\*/g,'<span class="mp-num">$1</span>')}function k(d){if(!o)return;if(!d){o.textContent="No fue posible cargar la disponibilidad de agencias y puntos de pago.";return}const v=c.agencies.length,S=c.paymentPoints.length,_=`**${v}** agencias y **${S}** puntos de pago activos distribuidos en todo el país.`;o.innerHTML=w(_)}function u(d){return`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 42" width="30" height="42"><path d="M15 0C6.7 0 0 6.7 0 15c0 11.3 15 27 15 27s15-15.7 15-27C30 6.7 23.3 0 15 0z" fill="${d}"/><circle cx="15" cy="14" r="5.5" fill="#ffffff"/></svg>`}function y(d){return m.divIcon({className:"mp-pin",html:u(d),iconSize:[30,42],iconAnchor:[15,42],popupAnchor:[0,-38]})}function x(d){const v=[`<div class="mp-popup"><p class="mp-popup-name">${p(d.name)}</p>`];return d.address&&v.push(`<p class="mp-popup-line"><i class="ri-map-pin-2-line"></i> ${p(d.address)}</p>`),d.type==="agency"&&d.schedule&&v.push(`<p class="mp-popup-line"><i class="ri-time-line"></i> ${p(d.schedule)}</p>`),d.type==="payment_point"&&d.correspondent&&v.push(`<p class="mp-popup-line"><i class="ri-store-2-line"></i> ${p(d.correspondent)}</p>`),v.push("</div>"),v.join("")}function h(){return[...c.agencies,...c.paymentPoints]}function $(){return h().filter(d=>!(c.type&&d.type!==c.type||c.department&&d.department!==c.department))}function B(){!s||!m||(s.clearLayers(),$().forEach(d=>{const v=d.type==="agency"?"#E97300":"#003B71",S=m.marker([d.lat,d.lng],{icon:y(v)});S.bindPopup(x(d)),S.__mpKey=`${d.type}-${d.id}`,s.addLayer(S)}))}function C(){n&&n.flyTo(g,f)}function E(){const d=c.departments.find(v=>v.name===c.department);n&&d&&d.lat&&d.lng&&n.flyTo([d.lat,d.lng],d.zoom||11)}function L(){if(!n||!s)return;let d=null;s.eachLayer(v=>{v.__mpKey===c.pointKey&&(d=v)}),d&&(n.flyTo(d.getLatLng(),17),setTimeout(()=>d.openPopup(),350))}function z(){B(),c.pointKey?L():c.department?E():C()}function D(){const d=a.querySelector('[data-filter-index="2"] .mp-filter-dropdown'),v=a.querySelector('[data-filter-label="2"]');if(!d)return;const S=$(),_=['<button type="button" class="mp-filter-option" data-point-key="">Todas</button>'].concat(S.map(M=>`<button type="button" class="mp-filter-option" data-point-key="${M.type}-${M.id}">${p(M.name)}</button>`)).join("");d.innerHTML=_,c.pointKey=null,v&&(v.textContent="Seleccione una ubicación"),d.querySelectorAll(".mp-filter-option").forEach(M=>{M.addEventListener("click",()=>{const X=M.dataset.pointKey||"";c.pointKey=X||null,v&&(v.textContent=M.textContent),b(),z()})})}function Y(){const d=a.querySelector('[data-filter-index="1"] .mp-filter-dropdown');if(!d)return;const v=['<button type="button" class="mp-filter-option" data-dept="">Todos los departamentos</button>'].concat(c.departments.map(S=>`<button type="button" class="mp-filter-option" data-dept="${p(S.name)}">${p(S.name)}</button>`)).join("");d.innerHTML=v,d.querySelectorAll(".mp-filter-option").forEach(S=>{S.addEventListener("click",()=>{c.department=S.dataset.dept||null;const _=a.querySelector('[data-filter-label="1"]');_&&(_.textContent=S.textContent),b(),D(),z()})})}function J(){const d=a.querySelector('[data-filter-index="0"] .mp-filter-dropdown');d&&d.querySelectorAll(".mp-filter-option").forEach(v=>{v.addEventListener("click",()=>{c.type=v.dataset.type||null;const S=a.querySelector('[data-filter-label="0"]');S&&(S.textContent=v.textContent),b(),D(),z()})})}a.__mpBound||(a.__mpBound=!0,a.querySelectorAll("[data-filter-toggle]").forEach(d=>{d.addEventListener("click",v=>{v.stopPropagation();const S=d.closest(".mp-filter"),_=S.classList.contains("mp-filter-open");b(),_||(S.classList.add("mp-filter-open"),r&&r.classList.add("mp-overlay-active"))})}),e.addEventListener("click",d=>{t.contains(d.target)&&(d.target.closest(".mp-filter")||b())}));async function K(){if(!e.getElementById("leaflet-css")){const v=e.createElement("link");v.id="leaflet-css",v.rel="stylesheet",v.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",e.head.appendChild(v)}const d=e.defaultView??window;return typeof d.L>"u"&&await new Promise((v,S)=>{const _=e.createElement("script");_.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",_.onload=v,_.onerror=S,e.head.appendChild(_)}),d.L}function pe(){const d=e.querySelector('meta[name="map-locations-url"]')?.content;if(d)return d;try{const S=window.top?.document?.querySelector('meta[name="map-locations-url"]')?.content;if(S)return S}catch{}return"/api/map-locations"}async function ge(){try{const d=pe(),v=await fetch(d,{headers:{Accept:"application/json"}});if(!v.ok)throw new Error("No se pudo cargar la información del mapa");const S=await v.json();return c.departments=S.departments||[],c.agencies=S.agencies||[],c.paymentPoints=S.payment_points||[],!0}catch(d){return console.warn("[MapFilter] Error al cargar datos:",d),!1}}async function ee(){if(!(!l||l.__mpMapInit))try{if(m=await K(),!m||l.__mpMapInit)return;l.__mpMapInit=!0,n=m.map(l,{zoomControl:!0}).setView(g,f),l._map=n,m.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(n),s=m.layerGroup().addTo(n),n.whenReady(function(){setTimeout(()=>{n&&n.invalidateSize&&n.invalidateSize()},300)});const d=await ge();k(d),J(),Y(),D(),z()}catch(d){console.warn("No se pudo inicializar el mapa:",d)}}ee()}}function Wr(t,e){const i=document.getElementById("map-filter-config-modal");if(i&&i.remove(),!document.getElementById("mp-modal-styles")){const f=document.createElement("style");f.id="mp-modal-styles",f.textContent=`
        ...
        </div>`,l.appendChild(o),document.body.appendChild(l);const g=()=>l.remove();o.querySelector("#mp-modal-close").onclick=g,o.querySelector("#mp-modal-cancel").onclick=g,l.onclick=f=>{f.target===l&&g()},o.querySelector("#mp-modal-save").onclick=()=>{const f={title:o.querySelector("#mp-title").value.trim()},n=e.getEl()?.querySelector("[id^='mp-root-']")?.id?.replace("mp-root-","")||"mp"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-map-config":JSON.stringify(f)}),e.components(Tt(f,n)+`<style>${Ue}</style>`),g()}}const Jr=[{id:"map-filter-block",label:"Mapa con Filtros",category:"Interactivos",media:Yr,content:{type:"map-filter-component"}}];function Kr(t){const e="map-filter-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Mapa con Filtros",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,stylable:!1,resizable:!1,layerable:!0,highlightable:!1,attributes:{"data-gjs-type":e,"data-map-config":JSON.stringify(Ne)},components:Tt(Ne)+`<style>${Ue}</style>`,script:Gr(),traits:[{type:"button",label:"Mapa con Filtros",text:"Administrar Mapa y Filtros",full:!0,command:"open-map-filter-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-map-filter-config",{run(i){const a=i.getSelected();a&&Wr(i,a)}}),Qr(t,e),Zr(t,e)}function Qr(t,e){t.on("storage:end:load",()=>{setTimeout(()=>yt(t,e),1e3)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},500))}),t.on("component:clone",i=>{if(i.get("type")===e){const a=i.getEl();if(a){const r=a.querySelector("[data-mp-map]");r&&r._map&&(r._map.remove(),delete r._map,delete r.__mpMapInit),setTimeout(()=>{const l=i.get("script");l&&typeof l=="function"&&l.call(a)},500)}}}),t.on("canvas:render",()=>{setTimeout(()=>yt(t,e),800)}),t.on("storage:start:store",()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e),i.addAttributes({"data-gjs-type":e})})})}function yt(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}function Zr(t,e){t.on("load",()=>{const i=t.Canvas.getFrameEl();if(!i)return;const a=i.contentDocument?.head;if(a){if(!a.querySelector("#leaflet-css")){const r=document.createElement("link");r.id="leaflet-css",r.rel="stylesheet",r.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",a.appendChild(r)}if(!a.querySelector("#mp-filter-styles")){const r=document.createElement("style");r.id="mp-filter-styles",r.textContent=Ue,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=".leaflet-container{height:100%;width:100%;border-radius:inherit;z-index:0;}",a.appendChild(r)}}})}const el=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
@media(max-width:768px){.bsk-buttons{flex-direction:column;}}`;function al(){return function(){const t=this,e=t.ownerDocument??document,i="/adminintegral",a=(e.defaultView??window).location.origin,r=e.querySelector('meta[name="api-banners-url"]')?.content||`${a}${i}/api/banners/active`,l=["fill-blue","outline-blue","fill-orange","outline-orange","fill-white","outline-white"],o=".banner-wrapper{position:relative;width:100%;background:#003B71;overflow:hidden;}.banner-slide-container{position:relative;width:100%;user-select:none;cursor:grab;display:grid;}.banner-slide-container:active{cursor:grabbing;}.banner-slide{grid-area:1/1;opacity:0;pointer-events:none;transition:opacity 0.7s ease;visibility:hidden;display:flex;flex-direction:column;}.banner-slide.banner-slide--active{opacity:1;pointer-events:auto;visibility:visible;}.banner-slide-inner{position:relative;width:100%;flex:1;min-height:480px;display:flex;align-items:center;}.banner-bg{position:absolute;inset:0;z-index:0;}.banner-bg img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;}.banner-overlay{position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,59,113,0.85) 0%,rgba(0,59,113,0.65) 50%,rgba(0,59,113,0.2) 100%);z-index:1;}.banner-content{position:relative;z-index:10;display:flex;flex-direction:column;justify-content:center;padding:64px 64px 96px;max-width:60%;}.banner-category-badge{display:inline-block;margin-bottom:18px;padding:7px 20px;border-radius:999px;border:2px solid rgba(255,255,255,0.65);color:#fff;font-size:13px;font-weight:500;letter-spacing:0.04em;align-self:flex-start;}.banner-title{font-size:clamp(1.8rem,3.2vw,3rem);font-weight:800;color:#fff;line-height:1.15;margin:0 0 20px;}.banner-description{color:rgba(255,255,255,0.9);font-size:clamp(0.95rem,1.4vw,1.1rem);line-height:1.7;margin:0 0 36px;max-width:520px;}.banner-buttons{display:flex;flex-wrap:wrap;gap:16px;align-items:center;}.banner-btn{display:inline-block;padding:12px 32px;border-radius:999px;font-size:15px;font-weight:600;cursor:pointer;transition:background .2s,color .2s,border-color .2s;text-decoration:none;white-space:nowrap;line-height:1.4;box-sizing:border-box;}.banner-btn--fill-blue{background:#003B71;color:#ffffff;border:2px solid #003B71;}.banner-btn--fill-blue:hover{background:#002a52;border-color:#002a52;color:#ffffff;}.banner-btn--outline-blue{background:transparent;color:#003B71;border:2px solid #003B71;}.banner-btn--outline-blue:hover{background:#003B71;border-color:#003B71;color:#ffffff;}.banner-btn--fill-orange{background:#E97300;color:#ffffff;border:2px solid #E97300;}.banner-btn--fill-orange:hover{background:#c96200;border-color:#c96200;color:#ffffff;}.banner-btn--outline-orange{background:transparent;color:#E97300;border:2px solid #E97300;}.banner-btn--outline-orange:hover{background:#E97300;border-color:#E97300;color:#ffffff;}.banner-btn--fill-white{background:#ffffff;color:#003B71;border:2px solid #ffffff;}.banner-btn--fill-white:hover{background:#dce8f5;border-color:#dce8f5;color:#003B71;}.banner-btn--outline-white{background:transparent;color:#ffffff;border:2px solid #ffffff;}.banner-btn--outline-white:hover{background:#ffffff;border-color:#ffffff;color:#003B71;}.banner-dots-wrapper{display:none;}.banner-stripe{position:relative;width:100%;height:26px;background:#E97300;z-index:20;display:flex;align-items:center;justify-content:center;}.banner-dots{display:flex;gap:8px;align-items:center;}.banner-dot{width:10px;height:10px;border-radius:999px;border:none;cursor:pointer;background:rgba(255,255,255,0.5);transition:all 0.3s ease;padding:0;flex-shrink:0;}.banner-dot--active{width:28px;background:#ffffff;}.banner-empty{display:flex;align-items:center;justify-content:center;min-height:480px;color:rgba(255,255,255,0.5);font-size:14px;padding:40px;}@media(max-width:768px){.banner-slide-inner{min-height:340px;}.banner-bg img{object-position:right center;}.banner-content{max-width:100%;width:100%;padding:32px 24px 80px;}.banner-buttons{flex-wrap:wrap;gap:12px;}.banner-btn{flex:1 1 45%;min-width:140px;text-align:center;white-space:normal;word-break:break-word;}}@media(max-width:480px){.banner-btn{flex:1 1 100%;min-width:0;}}",g="@keyframes bsk-shimmer{0%{background-position:-600px 0}100%{background-position:600px 0}}.bsk-badge{width:120px;height:32px;margin-bottom:20px;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title{height:40px;margin-bottom:12px;border-radius:8px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title--short{width:60%;}.bsk-line{height:16px;margin-bottom:10px;border-radius:6px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-line--short{width:55%;}.bsk-buttons{display:flex;gap:16px;margin-top:36px;}.bsk-btn{height:48px;flex:1;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-bg-img{background:linear-gradient(90deg,rgba(255,255,255,0.04) 25%,rgba(255,255,255,0.09) 50%,rgba(255,255,255,0.04) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}@media(max-width:768px){.bsk-buttons{flex-direction:column;}}";(function(){if(!e.getElementById("banner-hero-styles")){const v=e.createElement("style");v.id="banner-hero-styles",v.textContent=o,e.head.appendChild(v)}if(!e.getElementById("banner-skeleton-styles")){const v=e.createElement("style");v.id="banner-skeleton-styles",v.textContent=g,e.head.appendChild(v)}})();let f=[],c=0,n=null,s=!1,m=0,b=0;const p=50,w=t.dataset.autoplay!=="false",k=t.dataset.category??"",u=t.querySelector(".banner-slide-container"),y=t.querySelector(".banner-stripe");if(!u||!y)return;function x(d){return l.indexOf(d)!==-1?d:d==="outline-blue"||d==="outline-orange"?"outline-white":"fill-white"}function h(d,v,S,_){const M=x(S),X=v?"a":"span",_e=v?`href="${v}"${_?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${X} ${_e} class="banner-btn banner-btn--${M}">${d}</${X}>`}async function $(){if(!t.__bannerLoading){t.__bannerLoading=!0,B();try{const d=await fetch(r,{headers:{Accept:"application/json"}});if(!d.ok){ee();return}const v=await d.json();if(f=Array.isArray(v)?k?v.filter(S=>S.category===k):v:[],f.length===0){ee();return}C(),J(),K(0,!1),w&&pe()}catch{ee()}finally{t.__bannerLoading=!1}}}function B(){u.innerHTML=`
                ...
                </div>`,y.innerHTML=""}function C(){u.innerHTML=f.map((d,v)=>`
                <div class="banner-slide" data-index="${v}">
                    <div class="banner-slide-inner">
                        ...
                        <div class="banner-overlay"></div>
                        <div class="banner-content">
                            ${d.category?`<span class="banner-category-badge">${d.category}</span>`:""}
                            <h2 class="banner-title">${d.title}</h2>
                            <p class="banner-description">${d.description}</p>
                            ${d.btn_primary_text||d.btn_secondary_text?`<div class="banner-buttons">
                                    ${d.btn_primary_text?h(d.btn_primary_text,d.btn_primary_url,d.btn_primary_style,d.btn_primary_external):""}
                                    ${d.btn_secondary_text?h(d.btn_secondary_text,d.btn_secondary_url,d.btn_secondary_style,d.btn_secondary_external):""}
                                </div>`:""}
                        </div>
                    </div>
                </div>`).join(""),E(),L()}function E(){u.addEventListener("mousedown",z),u.addEventListener("touchstart",z,{passive:!0}),u.addEventListener("mousemove",D),u.addEventListener("touchmove",D,{passive:!0}),u.addEventListener("mouseup",Y),u.addEventListener("touchend",Y),u.addEventListener("mouseleave",Y)}function L(){f.forEach(d=>{const v=new Image;v.src=d.image_url})}function z(d){s=!0,m=d.touches?d.touches[0].clientX:d.clientX,b=0}function D(d){s&&(b=(d.touches?d.touches[0].clientX:d.clientX)-m)}function Y(){s&&(s=!1,Math.abs(b)>=p&&(K(b<0?(c+1)%f.length:(c-1+f.length)%f.length),ge()),b=0)}function J(){if(f.length<=1){y.innerHTML="";return}const d=e.createElement("div");d.className="banner-dots",f.forEach((v,S)=>{const _=e.createElement("button");_.className="banner-dot",_.type="button",_.dataset.index=String(S),_.setAttribute("aria-label",`Banner ${S+1}`),_.addEventListener("click",()=>{K(S),ge()}),d.appendChild(_)}),y.innerHTML="",y.appendChild(d)}function K(d,v=!0){const S=u.querySelectorAll(".banner-slide"),_=t.querySelectorAll(".banner-dot");S.forEach((M,X)=>{const _e=X===d;v||(M.style.transition="none"),M.classList.toggle("banner-slide--active",_e),v||requestAnimationFrame(()=>{M.style.transition=""})}),_.forEach((M,X)=>M.classList.toggle("banner-dot--active",X===d)),c=d}function pe(){f.length<=1||!w||(n=setInterval(()=>K((c+1)%f.length),5e3))}function ge(){w&&(clearInterval(n),pe())}function ee(){clearInterval(n),u.innerHTML=`
                <div class="banner-slide banner-slide--active">
                    <div class="banner-empty">Sin contenido.</div>
                </div>`,y.innerHTML=""}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",$):$()}}function rl(t,e){const i=document.getElementById("banner-hero-config-modal");if(i&&i.remove(),!document.getElementById("bnr-modal-styles")){const p=document.createElement("style");p.id="bnr-modal-styles",p.textContent=`
        ...
        <div class="bnr-modal-footer">
            ...
            <button id="bnr-modal-save" class="bnr-btn-save"><i class="ri-check-line"></i> Aplicar cambios</button>
        </div>`,o.appendChild(g),document.body.appendChild(o);const f=g.querySelector("#bnr-autoplay"),c=g.querySelector("#bnr-autoplay-slider"),n=g.querySelector("#bnr-autoplay-knob"),s=()=>{c.style.background=f.checked?"#003B71":"#cbd5e1",n.style.left=f.checked?"21px":"3px"};s(),f.addEventListener("change",s);const m=g.querySelector("#bnr-category");(async()=>{try{const w=document.querySelector('meta[name="api-banners-url"]')?.content||`${window.location.origin}/adminintegral/api/banners/active`,k=await fetch(w,{headers:{Accept:"application/json"}});if(!k.ok)return;const u=await k.json();if(!Array.isArray(u))return;[...new Set(u.map(x=>x.category).filter(Boolean))].sort().forEach(x=>{const h=document.createElement("option");h.value=x,h.textContent=x,m.appendChild(h)}),m.value=l}catch{}})();const b=()=>o.remove();g.querySelector("#bnr-modal-close").onclick=b,g.querySelector("#bnr-modal-cancel").onclick=b,o.onclick=p=>{p.target===o&&b()},g.querySelector("#bnr-modal-save").onclick=()=>{e.addAttributes({"data-autoplay":f.checked?"true":"false","data-category":m.value||""}),b()}}const ll=[{id:"banner-hero",label:"Banner Slider",category:"Banners",media:el,content:{type:"banner-hero-component"}}];function ol(t){const e="banner-hero-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner Slider",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-autoplay":"true","data-category":""},components:`
                ...
                `,script:al(),traits:[{type:"button",label:"Banner Slider",text:"Administrar Banner Slider",full:!0,command:"open-banner-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",()=>{const i=this.getEl();if(!i)return;const a=this.get("script");a&&typeof a=="function"&&setTimeout(()=>a.call(i),100)})}}}),t.Commands.add("open-banner-config",{run(i){const a=i.getSelected();a&&rl(i,a)}}),nl(t,e),sl(t,e)}function nl(t,e){t.on("storage:end:load",()=>{setTimeout(()=>vt(t,e),1e3)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},500))}),t.on("component:clone",i=>{if(i.get("type")===e){const a=i.getEl();a&&setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},500)}}),t.on("canvas:render",()=>{setTimeout(()=>vt(t,e),800)}),t.on("storage:start:store",()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e),i.addAttributes({"data-gjs-type":e})})})}function vt(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}function sl(t,e){t.on("load",()=>{const i=t.Canvas.getFrameEl();if(!i)return;const a=i.contentDocument?.head;if(a){if(!a.querySelector("#banner-hero-styles")){const r=document.createElement("style");r.id="banner-hero-styles",r.textContent=tl,a.appendChild(r)}if(!a.querySelector("#banner-skeleton-styles")){const r=document.createElement("style");r.id="banner-skeleton-styles",r.textContent=il,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=`[data-gjs-type="${e}"] * { pointer-events: none !important; } [data-gjs-type="${e}"].gjs-selected, [data-gjs-type="${e}"].gjs-hovered { outline: 2px dashed rgba(240,135,42,0.6) !important; outline-offset: 2px; }`,a.appendChild(r)}}})}const cl=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
`;function fl(){return function(){const t=this,e=t.ownerDocument??document;e.defaultView;const i=e.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??"",a=e.querySelector('meta[name="api-assets-url"]')?.content||(i?`${i}/api/assets/active`:""),r=`
.ast-section {
    width: 100%;
    background: #ffffff;
    padding: 3rem 4rem;
...
`;if(!e.getElementById("assets-block-styles")){const u=e.createElement("style");u.id="assets-block-styles",u.textContent=r,e.head.appendChild(u)}const l=t.querySelector("[data-ast-tabs]"),o=t.querySelector("[data-ast-content]");if(!l||!o)return;const g=t.dataset.defaultCategory||"";let f=[],c="";function n(u,y){return u?u.length>y?`${u.slice(0,y).trim()}...`:u:""}function s(u){const y=u.link_is_external?' target="_blank" rel="noopener noreferrer"':"",x=u.name||n(u.short_description,60),h=u.name||u.short_description||"Activo extraordinario";return`<a href="${u.link_url}"${y} class="ast-card">
                <img src="${u.image_url}" alt="${h}" class="ast-card-img" loading="lazy">
                <div class="ast-card-body">
                    <p class="ast-card-name">${x}</p>
                    ${u.name&&u.short_description?`<p class="ast-card-desc">${u.short_description}</p>`:""}
                </div>
            </a>`}function m(){const u=[],y=new Set;return f.forEach(x=>{y.has(x.category_slug)||(y.add(x.category_slug),u.push({slug:x.category_slug,name:x.category}))}),u.sort((x,h)=>x.name.localeCompare(h,"es",{sensitivity:"base"}))}function b(u,y){const x=y.length?y.map(s).join(""):'<div class="ast-empty">No hay activos extraordinarios disponibles en esta categoría.</div>';return`<div class="ast-group">
                <p class="ast-subtitle">${u}</p>
                <div class="ast-subtitle-stripe"></div>
                <div class="ast-grid">${x}</div>
            </div>`}function p(){if(c){const y=f.filter(h=>h.category_slug===c),x=y[0]?.category||m().find(h=>h.slug===c)?.name||"";o.innerHTML=b(x,y);return}const u=m();o.innerHTML=u.map(y=>b(y.name,f.filter(x=>x.category_slug===y.slug))).join("")}function w(){const y=['<button type="button" class="ast-tab ast-tab--active" data-tab-slug="">Todos</button>',...m().map(x=>`<button type="button" class="ast-tab" data-tab-slug="${x.slug}">${x.name}</button>`)].join("");if(l.innerHTML=y,l.querySelectorAll("[data-tab-slug]").forEach(x=>{x.addEventListener("click",()=>{l.querySelectorAll(".ast-tab").forEach(h=>h.classList.remove("ast-tab--active")),x.classList.add("ast-tab--active"),c=x.dataset.tabSlug,p()})}),g){const x=l.querySelector(`[data-tab-slug="${g}"]`);x&&x.click()}}async function k(){if(!a){l.innerHTML='<button type="button" class="ast-tab ast-tab--active">Todos</button>',o.innerHTML='<div class="ast-empty">Vista previa del catálogo (los datos reales se cargan en el sitio publicado).</div>';return}o.innerHTML=`
                <div class="ast-loading">
                    <div class="ast-spinner"></div>
                    <span>Cargando activos extraordinarios...</span>
                </div>`;try{const u=await fetch(a,{headers:{Accept:"application/json"}});if(!u.ok){o.innerHTML='<div class="ast-empty">No se pudieron cargar los activos extraordinarios.</div>';return}if(f=await u.json(),!Array.isArray(f)||f.length===0){l.innerHTML='<button type="button" class="ast-tab ast-tab--active">Todos</button>',o.innerHTML='<div class="ast-empty">No hay activos extraordinarios disponibles.</div>';return}w(),p()}catch{o.innerHTML='<div class="ast-empty">No se pudieron cargar los activos extraordinarios.</div>'}}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",k):k()}}const pl=[{id:"assets-catalog",label:"Catálogo de Activos Extraordinarios",category:"Interactivos",media:cl,content:{type:"assets-catalog-component"}}];function gl(t){const e="assets-catalog-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Catálogo de Activos Extraordinarios",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-default-category":"",class:"ast-section"},components:`
                ...
                `,script:fl(),traits:[{type:"select",name:"data-default-category",label:"Categoría inicial",options:[{id:"",name:"Todas (mostrar 'Todos')"}],changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",()=>{const i=this.getEl();if(!i)return;const a=this.get("script");a&&typeof a=="function"&&setTimeout(()=>a.call(i),100)})}}}),hl(t,e),bl(t,e),ml(t,e)}async function ml(t,e){try{const i=document.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??"",a=await fetch(`${i}/api/asset-categories/all`,{headers:{Accept:"application/json"}});if(!a.ok)return;const r=await a.json();if(!Array.isArray(r)||r.length===0)return;const l=t.DomComponents.getType(e);if(!l)return;const g=l.model.prototype.defaults.traits.find(f=>f.name==="data-default-category");if(!g)return;g.options=[{id:"",name:"Todas (mostrar 'Todos')"},...r.map(f=>({id:f.slug,name:f.name}))]}catch{}}function hl(t,e){t.on("storage:end:load",()=>{setTimeout(()=>wt(t,e),1e3)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},500))}),t.on("canvas:render",()=>{setTimeout(()=>wt(t,e),800)}),t.on("storage:start:store",()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e),i.addAttributes({"data-gjs-type":e})})})}function wt(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}function bl(t,e){t.on("load",()=>{const i=t.Canvas.getFrameEl();if(!i)return;const a=i.contentDocument?.head;if(a){if(!a.querySelector("#assets-block-styles")){const r=document.createElement("style");r.id="assets-block-styles",r.textContent=dl,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=`[data-gjs-type="${e}"] * { pointer-events: none !important; } [data-gjs-type="${e}"].gjs-selected, [data-gjs-type="${e}"].gjs-hovered { outline: 2px dashed rgba(240,135,42,0.6) !important; outline-offset: 2px; }`,a.appendChild(r)}}})}const Re={blue:{curve:"#003B71",curveLine:"#E97300",badge:"#E97300",badgeText:"#ffffff"},orange:{curve:"#E97300",curveLine:"#003B71",badge:"#003B71",badgeText:"#ffffff"},transparent:{curve:"rgba(0,59,113,0.55)",curveLine:"#E97300",badge:"#E97300",badgeText:"#ffffff"}},At=`
<style>
...
.hb-curve svg{height:85px;}
...
</style>`;function zt(t,e){e=e||"hb"+Math.random().toString(36).slice(2,7);const i=t.bg_image||T("images/placeholder.svg"),a=Re[t.theme]?t.theme:"blue",r=Re[a],l=t.bg_position_x||"center",o=t.bg_position_y||"center",g=`hb-pos-${l}-${o}`,f=t.subtitle?`<p class="hb-subtitle">${t.subtitle}</p>`:"";return`<section id="hb-root-${e}" class="hb-section" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
    ...
    </section>`}const V={bg_image:T("images/placeholder.svg"),bg_position_x:"center",bg_position_y:"center",theme:"blue",title:"Cuenta de Ahorro Electrónico",subtitle:"Recupera el control de tus finanzas. Fácil de usar, práctica para tu día a día y disponible cuando la necesites."};function ul(t,e){const i=document.getElementById("hero-banner-config-modal");if(i&&i.remove(),!document.getElementById("hb-modal-styles")){const k=document.createElement("style");k.id="hb-modal-styles",k.textContent=`
        ...
        `,document.head.appendChild(k)}const a=(()=>{try{return JSON.parse(e.getAttributes()["data-hero-banner-config"]||"{}")}catch{return{}}})(),r=a.bg_image||V.bg_image,l=a.bg_position_x||V.bg_position_x,o=a.bg_position_y||V.bg_position_y,g=a.theme||V.theme,f=a.title||V.title,c=a.subtitle??V.subtitle,n=document.createElement("div");n.id="hero-banner-config-modal",n.className="hb-overlay";const s=document.createElement("div");s.className="hb-modal",s.innerHTML=`
        ...
        <div class="hb-modal-body">
            ...
            <div class="hb-tab-panel" id="hb-panel-content">
                ...
                <div class="hb-card">
                    ...
                    <textarea id="hb-subtitle" placeholder="Déjalo vacío si no quieres subtítulo" class="hb-input">${c}</textarea>
                </div>
            </div>
        ...
        </div>`,n.appendChild(s),document.body.appendChild(n);let m=Re[g]?g:"blue";function b(){const k=s.querySelector("#hb-theme-colors");k.querySelectorAll("[data-theme]").forEach(u=>{u.classList.toggle("hb-theme-inactive",u.dataset.theme!==m),u.addEventListener("click",()=>{m=u.dataset.theme,k.querySelectorAll("[data-theme]").forEach(y=>y.classList.toggle("hb-theme-inactive",y.dataset.theme!==m))})})}b(),s.querySelectorAll(".hb-tab-btn").forEach(k=>{k.addEventListener("click",()=>{s.querySelectorAll(".hb-tab-btn").forEach(u=>u.classList.remove("active")),s.querySelectorAll(".hb-tab-panel").forEach(u=>u.classList.remove("active")),k.classList.add("active"),s.querySelector(`#hb-panel-${k.dataset.tab}`).classList.add("active")})}),s.querySelector("#hb-bg-pick").addEventListener("click",()=>{Le({type:"image",title:"Seleccionar imagen de fondo",onSelect:k=>{s.querySelector("#hb-bg-url").value=k,s.querySelector("#hb-bg-preview").src=k}})}),s.querySelector("#hb-bg-url").addEventListener("input",k=>{s.querySelector("#hb-bg-preview").src=k.target.value});function p(){const k=s.querySelector("#hb-bg-pos-x").value,u=s.querySelector("#hb-bg-pos-y").value;s.querySelector("#hb-bg-preview").style.objectPosition=`${k} ${u}`}s.querySelector("#hb-bg-pos-x").addEventListener("change",p),s.querySelector("#hb-bg-pos-y").addEventListener("change",p),p();const w=()=>n.remove();s.querySelector("#hb-modal-close").onclick=w,s.querySelector("#hb-modal-cancel").onclick=w,n.onclick=k=>{k.target===n&&w()},s.querySelector("#hb-modal-save").onclick=()=>{const k={bg_image:s.querySelector("#hb-bg-url").value.trim()||V.bg_image,bg_position_x:s.querySelector("#hb-bg-pos-x").value,bg_position_y:s.querySelector("#hb-bg-pos-y").value,theme:m,title:s.querySelector("#hb-title").value.trim(),subtitle:s.querySelector("#hb-subtitle").value.trim()},y=e.getEl()?.querySelector("[id^='hb-root-']")?.id?.replace("hb-root-","")||"hb"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-hero-banner-config":JSON.stringify(k)}),e.components(zt(k,y)+At),w()}}function xl(t){const e="hero-banner-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-hero-banner-config":JSON.stringify(V)},components:zt(V)+At,traits:[{type:"button",label:"Banner",text:"Administrar Banner",full:!0,command:"open-hero-banner-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-hero-banner-config",{run(i){const a=i.getSelected();a&&ul(i,a)}}),t.BlockManager.add("hero-banner-block",{label:"Banner",category:"Banners",media:`<svg viewBox="0 0 32 32" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg>`,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}})}function yl(t){j.registerBlocks(Zt),j.registerBlocks(si),j.registerBlocks(ll),j.registerBlocks(_a),j.registerBlocks(ha),j.registerBlocks(mi),j.registerBlocks(xi),j.registerBlocks(Yi),j.registerBlocks(Wi),j.registerBlocks(Zi),j.registerBlocks(aa),j.registerBlocks(Si),j.registerBlocks(Sa),j.registerBlocks(er),j.registerBlocks(ji),j.registerBlocks(qi),j.registerBlocks(oa),j.registerBlocks(da),j.registerBlocks(za),j.registerBlocks(Ma),j.registerBlocks(Pa),j.registerBlocks(yr),j.registerBlocks(Sr),j.registerBlocks(Pr),j.registerBlocks(Vr),j.registerBlocks(ar),j.registerBlocks(Jr),j.registerBlocks(pl),j.applyToEditor(t),Kr(t),ol(t),pr(t),xl(t),hr(t),br(t),Fi(t),Ei(t),Hr(t),ba(t),Cr(t),Di(t),gl(t)}function vl(){const t=()=>window.location.reload();He({title:"Tu sesión ha expirado",description:"No se pudo guardar porque tu sesión terminó. Tu contenido se respaldó en este navegador; al recargar e iniciar sesión de nuevo se te ofrecerá recuperarlo.",icon:"ri-time-line",iconBg:"#fef3c7",iconColor:"#d97706",confirmLabel:"Recargar página",confirmColor:"#d97706",cancelLabel:"Recargar página",onConfirm:t,onCancel:t})}function wl(t,e,i){t.on("component:add",()=>e.markAsDirty()),t.on("component:remove",()=>e.markAsDirty()),t.on("component:update",()=>e.markAsDirty()),t.on("style:update",()=>e.markAsDirty());const a=document.getElementById("save-button");a&&a.addEventListener("click",async()=>{await kl(t,e,i,a)}),document.addEventListener("keydown",r=>{(r.ctrlKey||r.metaKey)&&r.key==="s"&&(r.preventDefault(),a&&!a.disabled&&a.click())})}async function kl(t,e,i,a){a.disabled=!0,a.innerHTML='<i class="ri-loader-4-line animate-spin"></i><span>Guardando...</span>';try{i.needsTitle()?await Bl(t,e,i):await It(t,e,i)}catch(r){r.isSessionExpired?vl():qt(r.message,"error")}finally{a.disabled=!1,a.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}}async function Bl(t,e,i){return new Promise((a,r)=>{Mt({title:"Título de la Página",description:"Ingresa un título descriptivo para identificar esta página",placeholder:"Ej: Acerca de Nosotros",icon:"ri-file-text-line",iconBg:"#dbeafe",iconColor:"#2563eb",confirmLabel:"Guardar",onConfirm:async l=>{if(!l?.trim()){r(new Error("El título es obligatorio"));return}try{await It(t,e,i,l),a()}catch(o){r(o)}},onCancel:()=>{r(new Error("Guardado cancelado"))}})})}async function It(t,e,i,a=null){const l={...e.getEditorContent(t),is_published:i.isPublished};a&&(l.title=a);const o=await e.savePage(t,l,i.storeUrl,i.getHttpMethod());o.success&&(e.markAsClean(),qt(o.message,"success"),!i.isEditMode&&o.page?(i.updatePageInfo(o),i.updateTitle(o.page.title)):a&&i.updateTitle(a))}function qt(t,e){typeof window.showNotification=="function"&&window.showNotification(t,e)}document.addEventListener("DOMContentLoaded",async()=>{const t=new Nt,e=new Wt;new Jt(t);const i=Rt(),a=new Promise(r=>{i.on("load",()=>{yl(i),Pt(i),Ht(),Ot(),Ft(i),Ut(i),Vt(i),Yt(i),Xt(i),Gt(i),El(i),Sl(i),Ll(i),setTimeout(()=>{i.runCommand("sw-visibility"),i.Panels.getButton("options","sw-visibility")?.set("active",!0)},100),r()})});if(await Promise.all([a,Cl(i)]),e.isEditMode)try{await t.loadPageContent(i,e.loadUrl),Pe("Contenido cargado correctamente","success"),$l(i,t,e)}catch(r){Pe("Error al cargar el contenido","error"),console.error(r)}wl(i,t,e)});function El(t){const e=[{cmd:"set-device-desktop",device:"Desktop"},{cmd:"set-device-tablet",device:"Tablet"},{cmd:"set-device-mobile",device:"Mobile"}];e.forEach(({cmd:i,device:a})=>{t.Commands.add(i,{run:r=>{r.setDevice(a),e.forEach(({cmd:l})=>{r.Panels.getButton("devices-c",l)?.set("active",l===i)})}})})}function $l(t,e,i){const a=e.constructor.getBackup(i.storeUrl);if(!a)return;const r=Math.round((Date.now()-a.timestamp)/6e4);He({title:"Se encontró un borrador sin guardar",description:`Hay cambios de hace ${r} min que no llegaron a guardarse (posiblemente por sesión expirada). ¿Quieres recuperarlos?`,icon:"ri-history-line",iconBg:"#dbeafe",iconColor:"#2563eb",confirmLabel:"Recuperar",cancelLabel:"Descartar",onConfirm:()=>{a.payload.components_json&&t.loadProjectData(JSON.parse(a.payload.components_json)),e.clearBackup(i.storeUrl),Pe("Borrador recuperado","success")},onCancel:()=>{e.clearBackup(i.storeUrl)}})}function Sl(t){t.Commands.add("canvas-clear",{run:e=>{He({title:"Limpiar canvas",description:"¿Estás seguro de que quieres eliminar todo el contenido del canvas? Esta acción no se puede deshacer.",icon:"ri-delete-bin-line",iconBg:"#fef2f2",iconColor:"#dc2626",confirmLabel:"Limpiar todo",confirmColor:"#dc2626",onConfirm:()=>{e.DomComponents.clear(),e.CssComposer.clear()}})}})}function Cl(t){return new Promise(e=>{const i=t.Canvas.getFrameEl();if(i?.contentDocument?.readyState==="complete"&&i.contentDocument.head?.childElementCount>0){e();return}const r=()=>{t.off("canvas:frame:load",r),e()};t.on("canvas:frame:load",r),setTimeout(()=>{t.off("canvas:frame:load",r),e()},3e3)})}function Ll(t){const e=t.Canvas.getFrameEl();if(!e?.contentDocument?.head)return;const i=e.contentDocument.createElement("style");i.id="gjs-dashed-fix",i.textContent="body,body.gjs-dashed{margin:0!important;padding:0 0 160px 0!important;}",e.contentDocument.head.appendChild(i)}function Pe(t,e="info"){typeof window.showNotification=="function"&&window.showNotification(t,e)}
