import{i as F,o as U,t as H,d as O,f as R,e as _,s as P,g as J,c as G,E as V,j as W,h as X}from"./editor-commands-Bq37dEX4.js";import"./_commonjsHelpers-CqkleIqs.js";function Q(){return F()}const Y="/bancaintegral",B=`
<style>
.ft-wrapper {
...
@media (max-width: 320px) {
    ...
    `).join("");return i.innerHTML=`
        ...
        `,i.querySelector(".ft-remove-section").onclick=()=>{y(),m.splice(s,1),k()},i.querySelector(".ft-btn-add-link").onclick=()=>{y(),e.links=e.links||[],e.links.push({label:"Nuevo enlace",href:"#",icon:""}),k()},i.querySelectorAll(".ft-remove-link").forEach(t=>{t.onclick=()=>{y();const r=parseInt(t.closest(".ft-link-row").dataset.linkIndex);e.links.splice(r,1),k()}}),i.querySelectorAll(".ft-link-href").forEach(t=>{t.closest("[style*='pointer-events:none']")||C(t)}),i.querySelectorAll(".ft-link-istext").forEach(t=>{t.addEventListener("change",()=>{const r=t.closest(".ft-link-row").querySelector(".ft-link-href");t.checked?(r.style.opacity="0.4",r.style.pointerEvents="none",r.value=""):(r.style.opacity="1",r.style.pointerEvents="auto")})}),i}function k(){f.innerHTML="",m.forEach((e,s)=>f.appendChild(T(e,s))),$(f,m,k)}k(),p.querySelector("#ft-logo-pick").addEventListener("click",()=>{U({type:"image",title:"Seleccionar logo",onSelect:e=>{p.querySelector("#ft-logo-url").value=e;let s=p.querySelector("#ft-logo-preview");if(!s||s.tagName==="DIV"){const i=document.createElement("img");i.id="ft-logo-preview",i.style.cssText="height:48px;max-width:160px;object-fit:contain;border-radius:0.375rem;border:1px solid #e2e8f0;padding:4px;background:#f8fafc;display:block;margin-bottom:0.5rem;",s?.replaceWith(i)??p.querySelector("#ft-logo-url").before(i),s=i}s.src=e,s.style.display="block"}})}),p.querySelector("#ft-add-section").onclick=()=>{y(),m.push({title:"Nueva Sección",links:[]}),k(),f.lastElementChild?.scrollIntoView({behavior:"smooth",block:"nearest"})};function z(){const e=p.querySelector("#ft-logo-url").value.trim(),s=p.querySelector("#ft-logo-alt").value.trim(),i=[];return f.querySelectorAll("[data-section-index]").forEach(n=>{const t=n.querySelector(".ft-section-title-input").value.trim(),r=[];n.querySelectorAll(".ft-link-row").forEach(u=>{const q=u.querySelector(".ft-link-istext")?.checked??!1;r.push({icon:u.querySelector(".ft-link-icon").value.trim(),label:u.querySelector(".ft-link-label").value.trim(),href:q?"":u.querySelector(".ft-link-href").value.trim(),isText:q})}),i.push({title:t,links:r})}),{logo_url:e,logo_alt:s,sections:i}}p.querySelector("#ft-modal-backup").onclick=()=>{y();const e=z(),s=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),i=URL.createObjectURL(s),n=new Date().toISOString().replace(/[:.]/g,"-").slice(0,19),t=document.createElement("a");t.href=i,t.download=`footer-backup-${n}.json`,document.body.appendChild(t),t.click(),t.remove(),URL.revokeObjectURL(i)},p.querySelector("#ft-modal-restore-input").onchange=e=>{const s=e.target.files?.[0];if(!s)return;const i=new FileReader;i.onload=n=>{let t;try{t=JSON.parse(n.target.result)}catch{const u=document.createElement("div");u.className="ft-confirm-overlay",u.innerHTML='<div class="ft-confirm-modal"><div class="ft-confirm-header"><i class="ri-error-warning-line" style="color:#ef4444;"></i><h3>Archivo inválido</h3></div><div class="ft-confirm-body"><p>El archivo seleccionado no es un JSON válido.</p></div><div class="ft-confirm-footer"><button class="ft-confirm-ok" style="background:#ef4444;">Cerrar</button></div></div>',document.body.appendChild(u),u.querySelector(".ft-confirm-ok").onclick=()=>u.remove(),e.target.value="";return}const r=document.createElement("div");r.className="ft-confirm-overlay",r.innerHTML=`
                ...
                </div>`,document.body.appendChild(r),r.querySelector(".ft-confirm-cancel").onclick=()=>{r.remove(),e.target.value=""},r.querySelector(".ft-confirm-ok").onclick=()=>{r.remove(),e.target.value="",o.addAttributes({"data-footer-config":JSON.stringify(t)}),o.components(A(t)+B),E(),N(a,o)}},i.readAsText(s)};const E=()=>d.remove();p.querySelector("#ft-modal-close").onclick=E,p.querySelector("#ft-modal-cancel").onclick=E,d.onclick=e=>{e.target===d&&E()},p.querySelector("#ft-modal-save").onclick=()=>{const e=z();o.addAttributes({"data-footer-config":JSON.stringify(e)}),o.components(A(e)+B),E()}}function Z(a){const o="footer-component";a.DomComponents.addType(o,{isComponent:l=>l.getAttribute?.("data-gjs-type")===o?{type:o}:!1,model:{defaults:{name:"Footer",tagName:"footer",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":o,class:"ft-wrapper","data-footer-config":JSON.stringify({logo_url:"",logo_alt:"Logo",sections:[{title:"Productos",links:[{label:"Créditos",href:"#",icon:""},{label:"Depósitos",href:"#",icon:""},{label:"Otros Servicios",href:"#",icon:""}]},{title:"Sobre Nosotros",links:[{label:"Historial",href:"#",icon:""},{label:"Misión y Visión",href:"#",icon:""},{label:"Red de Agencias",href:"#",icon:""}]},{title:"Contáctanos",links:[{label:"0000 - 0000",href:"tel:0000-0000",icon:"ri-phone-line"},{label:"Correo",href:"mailto:info@banco.com",icon:"ri-mail-line"},{label:"Dirección",href:"#",icon:"ri-map-pin-line"}]}]})},components:A({logo_url:"",logo_alt:"Logo",sections:[{title:"Productos",links:[{label:"Créditos",href:"#",icon:""},{label:"Depósitos",href:"#",icon:""}]},{title:"Sobre Nosotros",links:[{label:"Historial",href:"#",icon:""},{label:"Misión y Visión",href:"#",icon:""}]},{title:"Contáctanos",links:[{label:"0000-0000",href:"tel:0000",icon:"ri-phone-line"},{label:"Correo",href:"mailto:",icon:"ri-mail-line"}]}]})+B,script:K(),toolbar:[],traits:[{type:"button",label:"Footer",text:"Administrar Footer",full:!0,command:"open-footer-config"}]},init(){this.set("type",o),this.addAttributes({"data-gjs-type":o})}}}),a.Commands.add("open-footer-config",{run(l){const c=l.getSelected();c&&N(l,c)}}),a.Commands.add("insert-default-footer",{run(l){l.DomComponents.clear(),l.addComponents({type:o})}}),a.BlockManager.add("footer-block",{label:"Footer",category:"Footer",media:`<svg viewBox="0 0 32 32" width="32" height="32">
