...
${Qt}`}],st=function(){(function(){function t(i){if(!i||i.__pcInit)return;i.__pcInit=!0;var a=i.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,o=0,n=!1,d=0,s=0,c=0,m=null;a.querySelectorAll("img").forEach(function(p){p.setAttribute("draggable","false")}),setTimeout(function(){var p=a.scrollWidth-a.clientWidth;if(p<=0)return;var y=Math.min(60,p),L=null;function w(_){L||(L=_);var q=(_-L)/400;if(q<.5)a.scrollLeft=y*(q*2);else if(q<1)a.scrollLeft=y*(1-(q-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(w)}requestAnimationFrame(w)},400),a.scrollLeft=0;function g(){return a.scrollWidth-a.clientWidth}function u(p){return Math.max(0,Math.min(p,g()))}function h(){Math.abs(d)<.5||(d*=.92,a.scrollLeft=u(a.scrollLeft+d),m=requestAnimationFrame(h))}a.addEventListener("mousedown",function(p){p.button===0&&(m&&(cancelAnimationFrame(m),m=null),r=!0,n=!1,d=0,l=p.clientX,s=p.clientX,c=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",p.preventDefault())}),document.addEventListener("mousemove",function(p){if(r){var y=l-p.clientX;Math.abs(y)>3&&(n=!0);var L=Date.now(),w=L-c||1;d=(p.clientX-s)/w*16*-1,s=p.clientX,c=L,a.scrollLeft=u(o+y)}}),document.addEventListener("mouseup",function(p){r&&(r=!1,a.style.cursor="grab",n&&(p.stopPropagation(),m=requestAnimationFrame(h)))}),a.addEventListener("click",function(p){n&&(p.preventDefault(),p.stopPropagation(),n=!1)},!0);var $=0,k=0,x=0,v=0,b=0;a.addEventListener("touchstart",function(p){m&&(cancelAnimationFrame(m),m=null),$=p.touches[0].clientX,x=p.touches[0].clientX,v=Date.now(),k=a.scrollLeft,b=0},{passive:!0}),a.addEventListener("touchmove",function(p){var y=Date.now(),L=y-v||1,w=p.touches[0].clientX;b=(w-x)/L*16*-1,x=w,v=y;var _=$-w;a.scrollLeft=u(k+_)},{passive:!0}),a.addEventListener("touchend",function(){m=requestAnimationFrame(function p(){Math.abs(b)<.5||(b*=.92,a.scrollLeft=u(a.scrollLeft+b),m=requestAnimationFrame(p))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(i){delete i.__pcInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},ai=`(${st.toString()})();`,ri=`
...
@media(max-width:480px){.pc-card{flex:0 0 80vw;}}`;function li(t){const e=t.img||P("images/placeholder.svg"),i=t.title||"TÍTULO DEL PRODUCTO",a=t.desc||"Descripción breve del producto financiero.",r=t.href||"#",l=t.btn_label||"Solicitar";return`<div class="pc-card"><div class="pc-card-img-wrap"><img src="${e}" alt="${i}" class="pc-card-img"></div><div class="pc-card-body"><h3 class="pc-card-title">${i}</h3><p class="pc-card-desc">${a}</p></div><a href="${r}" class="pc-btn">${l}</a></div>`}function ct(t){const e=t.heading||"Créditos",i=t.subheading||"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",a=t.more_href||"#",r=t.more_label||"Ver más",l=t.show_more!==!1,n=(t.cards||[]).map(li).join(""),d=l?`<div class="pc-more-wrap"><a href="${a}" class="pc-more-btn">${r}</a></div>`:"";return`<section class="pc-section"><style>${ri}</style><div style="text-align:center;margin-bottom:2rem;"><h2 class="pc-section-heading">${e}</h2><p class="pc-section-subheading">${i}</p></div><div class="pc-carousel-wrap"><div class="pc-track">${n}</div></div>${d}</section>`}const Y={heading:"Créditos",subheading:"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CREDINVIERTE",desc:"Adquiere activos fijos",href:"#",btn_label:"Solicitar"},{img:"",title:"SOLUCIONES INTEGRALES",desc:"Financiamiento PYME",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDI-CONFIAMOS",desc:"Rápido y sin fiador",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDILÍNEA",desc:"Línea rotativa",href:"#",btn_label:"Solicitar"}]};function oi(t,e){const i=document.getElementById("pc-config-modal");if(i&&i.remove(),!document.getElementById("pc-modal-styles")){const s=document.createElement("style");s.id="pc-modal-styles",s.textContent=`
        ...
        </div>`,l.appendChild(o),document.body.appendChild(l),o.querySelectorAll(".pc-tab-btn").forEach(s=>{s.addEventListener("click",()=>{o.querySelectorAll(".pc-tab-btn").forEach(c=>c.classList.remove("active")),o.querySelectorAll(".pc-tab-panel").forEach(c=>c.classList.remove("active")),s.classList.add("active"),o.querySelector(`#pc-panel-${s.dataset.tab}`).classList.add("active")})}),o.querySelector("#pc-show-more").addEventListener("change",function(){r.show_more=this.checked,o.querySelector("#pc-more-fields").style.display=this.checked?"flex":"none"});function n(){const s=o.querySelector("#pc-cards-list");s.innerHTML="",r.cards.forEach((c,m)=>{const g=document.createElement("div");g.className="pc-card-config";const u=c.img?`<img class="pc-img-preview" src="${c.img}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>';g.innerHTML=`
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function Na(){if(document.getElementById("tam-img-modal"))return;const t=document.createElement("div");t.id="tam-img-modal",t.innerHTML=`
        ...
        <div class="tam-container">
        ...
        </div>`,document.body.appendChild(a);let r=null,l=null;function o(g){r=g;const u=g.get("tableData");l=u?JSON.parse(JSON.stringify(u)):te(3,3);const h=l.cols||3;l.rows=l.rows.map(($,k)=>Array.from({length:h},(v,b)=>$[b]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})),document.getElementById("tam-title").value=l.title||"",document.getElementById("tam-theme").value=g.get("tableTheme")||"blue",document.getElementById("tam-cols").value=l.cols||3,document.getElementById("tam-rows").value=l.rows.length||3,c(),m(),a.classList.add("open"),document.body.style.overflow="hidden"}function n(){a.classList.remove("open"),document.body.style.overflow="",r=null}function d(){l.title=document.getElementById("tam-title").value.trim(),l.cols=parseInt(document.getElementById("tam-cols").value)||3,l.headers=Array.from(document.querySelectorAll(".tam-header-input")).map(u=>({text:u.value,align:u.closest("th")?.querySelector(".tam-align-select")?.value||"center"})),document.querySelectorAll("#tam-tbody td.tam-cell:not(.is-spanned)").forEach(u=>{const h=parseInt(u.dataset.row),$=parseInt(u.dataset.col);l.rows[h]?.[$]&&(l.rows[h][$].text=u.querySelector(".tam-cell-input")?.value||"",l.rows[h][$].align=u.querySelector(".tam-align-select")?.value||"center",l.rows[h][$].isHeader=u.dataset.isheader==="1",l.rows[h][$].image=u.dataset.image||null)});const g=Qe(l.rows,l.cols);l.rows=l.rows.map((u,h)=>u.filter(($,k)=>!g[`${h}-${k}`]))}function s(){if(a.querySelector("#tam-rebuild-notice"))return;const u=document.createElement("div");u.id="tam-rebuild-notice",u.style.cssText="background:#fef9c3;border:1.5px solid #ca8a04;border-radius:0.5rem;padding:0.5rem 1rem;font-size:0.8rem;color:#92400e;display:flex;align-items:center;gap:0.5rem;margin:0 1.5rem 0;flex-shrink:0;",u.innerHTML='<i class="ri-error-warning-line"></i> Has modificado el colspan/rowspan. Haz clic en <strong style="margin:0 4px;">Reconstruir</strong> para aplicar los cambios de fusión.',a.querySelector(".tam-toolbar").after(u)}function c(){a.querySelector("#tam-rebuild-notice")?.remove()}function m(){const g=document.getElementById("tam-thead"),u=document.getElementById("tam-tbody"),h=l.cols,$=l.rows.length,k=Qe(l.rows,h);g.innerHTML=`<tr>${l.headers.map((x,v)=>`
            <th>
                <input class="tam-cell-input tam-header-input" value="${x.text||""}" placeholder="Col ${v+1}" style="font-weight:600;">
                <select class="tam-align-select" style="margin-top:4px;width:100%;font-size:0.7rem;padding:2px;">
            ...
            </th>`).join("")}</tr>`,u.innerHTML=l.rows.map((x,v)=>`<tr>${Array.from({length:h},(p,y)=>{const L=k[`${v}-${y}`];if(L)return`<td class="tam-cell is-spanned" data-row="${v}" data-col="${y}">
                        <div class="tam-spanned-label">Combinada con [${L}]</div>
                    </td>`;const w=x[y]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null},_=w.colspan||1,q=w.rowspan||1,T=_>1||q>1;return`<td class="tam-cell ${w.isHeader?"is-header-cell":""} ${w.image?"has-image":""} ${T?"has-span":""}"
                    data-row="${v}" data-col="${y}"
                    data-isheader="${w.isHeader?"1":"0"}"
                    data-colspan="${_}"
                    data-rowspan="${q}"
                    data-image="${w.image||""}">
                    ${w.image?`<img class="tam-cell-img-preview" src="${w.image}" alt="">`:""}
                    <textarea class="tam-cell-input" placeholder="Texto...">${w.text||""}</textarea>
                    ...
                    <div class="tam-cell-actions">
                        <button type="button" class="tam-cell-btn tam-cell-btn-header ${w.isHeader?"active":""}"
                            data-action="header" data-row="${v}" data-col="${y}">
                            ${w.isHeader?"✓ Etiqueta":"Etiqueta"}
                        </button>
                        <button type="button" class="tam-cell-btn tam-cell-btn-img"
                            data-action="image" data-row="${v}" data-col="${y}">
                            <i class="ri-image-line"></i> ${w.image?"Cambiar":"Imagen"}
                        </button>
                        ${w.image?`<button type="button" class="tam-cell-btn tam-cell-btn-clear" data-action="clear-image" data-row="${v}" data-col="${y}">✕ Quitar</button>`:""}
                        <div class="tam-cell-span-group">
                            <label title="Columnas que ocupa">CS</label>
                            <input type="number" class="tam-cell-span-input" min="1" max="${h-y}"
                                value="${_}" data-action="colspan" data-row="${v}" data-col="${y}">
                            <label title="Filas que ocupa">RS</label>
                            <input type="number" class="tam-cell-span-input" min="1" max="${$-v}"
                                value="${q}" data-action="rowspan" data-row="${v}" data-col="${y}">
                        </div>
                    </div>
                </td>`}).join("")}</tr>`).join(""),u.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(x=>{x.addEventListener("change",()=>{const v=parseInt(x.dataset.row),b=parseInt(x.dataset.col),p=Math.max(1,parseInt(x.value)||1);l.rows[v]?.[b]&&(x.dataset.action==="colspan"?l.rows[v][b].colspan=Math.min(p,h-b):l.rows[v][b].rowspan=Math.min(p,$-v),s())})}),u.querySelectorAll("button[data-action]").forEach(x=>{x.addEventListener("click",v=>{v.preventDefault(),v.stopPropagation();const b=x.dataset.action,p=parseInt(x.dataset.row),y=parseInt(x.dataset.col);if(!(isNaN(p)||isNaN(y)||!l.rows[p]?.[y])){if(b==="header"){l.rows[p][y].isHeader=!l.rows[p][y].isHeader;const L=u.querySelector(`td[data-row="${p}"][data-col="${y}"]`);L&&(L.dataset.isheader=l.rows[p][y].isHeader?"1":"0",L.classList.toggle("is-header-cell",l.rows[p][y].isHeader)),x.classList.toggle("active",l.rows[p][y].isHeader),x.textContent=l.rows[p][y].isHeader?"✓ Etiqueta":"Etiqueta";return}if(b==="image"){window.__openTableImagePicker&&window.__openTableImagePicker(L=>{l.rows[p][y].image=L;const w=u.querySelector(`td[data-row="${p}"][data-col="${y}"]`);if(w){w.dataset.image=L,w.classList.add("has-image");let _=w.querySelector(".tam-cell-img-preview");_||(_=document.createElement("img"),_.className="tam-cell-img-preview",w.insertBefore(_,w.firstChild)),_.src=L;const q=w.querySelector("[data-action=image]");if(q&&(q.innerHTML='<i class="ri-image-line"></i> Cambiar'),!w.querySelector("[data-action=clear-image]")){const T=document.createElement("button");T.type="button",T.className="tam-cell-btn tam-cell-btn-clear",T.dataset.action="clear-image",T.dataset.row=p,T.dataset.col=y,T.textContent="✕ Quitar",T.addEventListener("click",D=>{D.preventDefault(),D.stopPropagation(),l.rows[p][y].image=null,w.dataset.image="",w.classList.remove("has-image"),_.remove(),T.remove();const M=w.querySelector("[data-action=image]");M&&(M.innerHTML='<i class="ri-image-line"></i> Imagen')}),w.querySelector(".tam-cell-actions").appendChild(T)}}});return}b==="clear-image"&&(l.rows[p][y].image=null,m())}})})}document.getElementById("tam-close").addEventListener("click",n),document.getElementById("tam-cancel").addEventListener("click",n),a.addEventListener("click",g=>{g.target===a&&n()}),document.getElementById("tam-rebuild").addEventListener("click",()=>{const g=parseInt(document.getElementById("tam-cols").value)||3,u=parseInt(document.getElementById("tam-rows").value)||3;for(c(),d();l.headers.length<g;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,g),l.cols=g;l.rows.length<u;)l.rows.push(Array.from({length:g},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,u).map(h=>{for(;h.length<g;)h.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return h.slice(0,g)}),m()}),document.getElementById("tam-apply").addEventListener("click",()=>{d();const g=document.getElementById("tam-theme").value;r&&(r.set("tableData",JSON.parse(JSON.stringify(l))),r.set("tableTheme",g),r.addAttributes({"data-table-theme":g}),ze(r)),n()}),window.__openTableAdminModal=o}function ze(t){const e=t.get("tableData"),i=t.get("tableTheme")||"blue";e&&t.components(gt(pt(e,i),i))}function Pa(){return function(){}}const Ra=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:Ma,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<a href="#"
   ...
   class="dld-simple-${e}">
    ...
    <rect x="3" y="25" width="7" height="2.5" fill="#dee2e6" rx="0.5"/>
</svg>`;function sr(){return function(){const t=this,e="agencies-map-component",i="/api/agencies/active",a="agencies";let r=[],l=[],o={},n=null,d=[];const s=async()=>{try{c(),await g(),await $(),k(),L(),T(),D(),m()}catch(f){console.error("Error initializing map:",f),V("Error al cargar las agencias"),m()}};function c(){const f=t.querySelector(`.${e}-list`);f&&(f.innerHTML=`
                ...
                `);const B=t.querySelector(`.${e}-map-container`);B&&(B.style.opacity="0.5")}function m(){const f=t.querySelector(`.${e}-map-container`);f&&(f.style.transition="opacity 0.3s ease",f.style.opacity="1")}async function g(){try{const B=await(await fetch(i)).json(),S=a?B[a]:B;Array.isArray(S)?(r=S.filter(z=>z.latitude&&z.longitude&&!isNaN(z.latitude)&&!isNaN(z.longitude)),l=[...r],u()):(r=[],l=[])}catch(f){console.error("Error loading items:",f),r=[],l=[]}}function u(){const f=[...new Set(r.map(S=>S.zone).filter(Boolean))].sort(),B=[...new Set(r.map(S=>S.department).filter(Boolean))].sort();o={zone:f,department:B},setTimeout(()=>{const S=t.querySelector(`.${e}-filters-container`);S&&!S.hasChildNodes()&&(S.innerHTML=`
                    ...
                    `,h())},100)}function h(){const f=t.querySelector(`.${e}-zone-filter`),B=t.querySelector(`.${e}-department-filter`);f&&o.zone&&o.zone.forEach(S=>{const z=document.createElement("option");z.value=S,z.textContent=S,f.appendChild(z)}),B&&o.department&&o.department.forEach(S=>{const z=document.createElement("option");z.value=S,z.textContent=S,B.appendChild(z)})}async function $(){if(!document.getElementById("leaflet-css")){const f=document.createElement("link");f.id="leaflet-css",f.rel="stylesheet",f.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",document.head.appendChild(f)}if(typeof window.L>"u"&&await new Promise((f,B)=>{const S=document.createElement("script");S.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",S.onload=f,S.onerror=B,document.head.appendChild(S)}),typeof window.L<"u"&&window.L.Icon&&window.L.Icon.Default){const f=window.L.icon({iconUrl:"data:image/svg+xml;base64,"+btoa(`
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 36" width="24" height="36">
                            <path fill="#f0872a" d="M12 0C7.6 0 4 3.6 4 8c0 5.4 8 16 8 16s8-10.6 8-16c0-4.4-3.6-8-8-8z"/>
                            <circle cx="12" cy="8" r="3" fill="#fff"/>
                        </svg>
                    `),iconSize:[30,45],iconAnchor:[15,45],popupAnchor:[0,-45]});window.customOrangeIcon=f}}function k(){const f=t.querySelector(`.${e}-map`);if(!f||!window.L)return;f._leaflet_id&&f._map&&(f._map.remove(),delete f._map),n=window.L.map(f).setView([13.7942,-88.8965],8),window.L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(n),f._map=n,n.whenReady(function(){x(),setTimeout(()=>{n&&n.invalidateSize&&n.invalidateSize()},300)})}function x(){v(),b(),y()}function v(){d.forEach(f=>{f.marker&&n.removeLayer(f.marker)}),d=[]}function b(){l.forEach((f,B)=>{if(f.latitude&&f.longitude){const S=p(f),z=window.L.marker([f.latitude,f.longitude],{icon:window.customOrangeIcon||new window.L.Icon.Default}).addTo(n).bindPopup(S);d.push({marker:z,item:f,index:B})}})}function p(f){let B=`<div style="min-width: 200px;"><h4 style="font-weight: 700; margin-bottom: 12px; color: #0d3f6a; font-size: 16px; border-bottom: 2px solid #f0872a; padding-bottom: 8px;">${f.name}</h4>`;if(f.address&&(B+=`<p style="margin: 8px 0 0 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-map-pin-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${f.address}</span></p>`),f.municipality||f.department){const S=[f.municipality,f.department].filter(Boolean).join(", ");B+=`<p style="margin: 0 0 8px 0; font-size: 13px; color: #6b7280; padding-left: 24px;">${S}</p>`}return f.schedule&&(B+=`<p style="margin: 8px 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-time-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${f.schedule}</span></p>`),B+="</div>",B}function y(){if(l.length>0){const f=l.filter(B=>B.latitude&&B.longitude).map(B=>[B.latitude,B.longitude]);f.length>1?n.once("moveend",function(){setTimeout(()=>{try{n&&n._loaded&&typeof n.fitBounds=="function"&&n.fitBounds(f,{padding:[50,50],maxZoom:12,animate:!1})}catch(B){console.warn("Error fitting bounds:",B)}},100)}):f.length===1&&n.setView(f[0],14)}}function L(){const f=t.querySelector(`.${e}-list`);if(!f)return;if(l.length===0){_(f);return}const B=l.map((S,z)=>w(S,z)).join("");f.innerHTML=B,q()}function w(f,B){const S=f.phones&&f.phones.length>0?f.phones.map(E=>`
                ...
                <div class="${e}-item p-5 bg-white/10 border border-white/20 rounded-2xl cursor-pointer transition-all duration-200" data-item-index="${B}">
            ...
            `}function q(){const f=t.querySelectorAll(`.${e}-item`);f.forEach(B=>{B.addEventListener("click",S=>{if(S.target.closest(".agency-maps-btn"))return;S.preventDefault();const z=parseInt(B.dataset.itemIndex),E=l[z];if(!E)return;f.forEach(C=>{C.classList.remove("bg-white","border-secondary","selected-agency"),C.classList.add("bg-white/10","border-white/20");const U=C.querySelector(".agency-title"),pe=C.querySelectorAll("i"),ge=C.querySelectorAll(".agency-phone-link"),Se=C.querySelectorAll("p:not(:has(.agency-phone-link))"),Le=C.querySelector(".agency-maps-btn");U&&(U.classList.remove("text-secondary"),U.classList.add("text-white")),pe.forEach(Z=>{Z.classList.remove("text-secondary","text-gray-300","text-white"),Z.classList.add("text-primary")}),ge.forEach(Z=>{Z.classList.remove("text-secondary"),Z.classList.add("text-white")}),Se.forEach(Z=>{Z.classList.remove("text-secondary"),Z.classList.add("text-gray-200")}),Le&&(Le.classList.remove("bg-secondary"),Le.classList.add("bg-primary"))}),B.classList.remove("bg-white/10","border-white/20"),B.classList.add("bg-white","border-secondary","selected-agency");const A=B.querySelector(".agency-title"),X=B.querySelectorAll("i"),O=B.querySelectorAll(".agency-phone-link"),R=B.querySelectorAll("p:not(:has(.agency-phone-link))"),H=B.querySelector(".agency-maps-btn");if(A&&(A.classList.remove("text-white"),A.classList.add("text-secondary")),X.forEach(C=>{C.classList.remove("text-secondary","text-gray-300","text-white"),C.classList.add("text-primary")}),O.forEach(C=>{C.classList.remove("text-white"),C.classList.add("text-secondary")}),R.forEach(C=>{C.classList.remove("text-gray-200"),C.classList.add("text-secondary")}),H&&(H.classList.remove("bg-primary"),H.classList.add("bg-secondary")),n&&E&&n._loaded)try{n.flyTo([E.latitude,E.longitude],14,{animate:!0,duration:1});const C=d.find(U=>U.item.id===E.id);C&&C.marker&&C.marker.openPopup()}catch(C){console.warn("Error updating map view:",C)}})})}function T(){const f=t.querySelector(`.${e}-search-input`),B=t.querySelector(`.${e}-zone-filter`),S=t.querySelector(`.${e}-department-filter`),z=t.querySelector(`.${e}-no-results`),E={Occidental:["Ahuachapán","Santa Ana","Sonsonate"],Paracentral:["Chalatenango","Cuscatlán","La Paz","Cabañas","San Vicente"],Central:["La Libertad","San Salvador"],Oriental:["Usulután","San Miguel","Morazán","La Unión"]},A=()=>{if(!B||!S)return;const O=B.value,R=S.value;if(!O)S.innerHTML='<option value="">Todos los Departamentos</option>',[...new Set(r.map(C=>C.department).filter(Boolean))].sort().forEach(C=>{const U=document.createElement("option");U.value=C,U.textContent=C,S.appendChild(U)}),R&&(S.value=R);else{const H=E[O]||[];S.innerHTML='<option value="">Todos los Departamentos</option>',H.forEach(C=>{const U=document.createElement("option");U.value=C,U.textContent=C,S.appendChild(U)}),H.includes(R)&&(S.value=R)}},X=()=>{const O=f?f.value.toLowerCase().trim():"",R=B?B.value:"",H=S?S.value:"";l=r.filter(C=>{let U=!0,pe=!0,ge=!0;return O&&(U=Object.values(C).some(Se=>String(Se).toLowerCase().includes(O))),R&&(pe=C.zone===R),H&&(ge=C.department===H),U&&pe&&ge}),L(),x(),z&&z.classList.toggle("hidden",l.length>0)};f&&f.addEventListener("input",X),B&&B.addEventListener("change",()=>{A(),X()}),S&&S.addEventListener("change",X)}function D(){const f=t.querySelector("[data-title]");if(f){const z=M("map-title")||"Nuestras Agencias";f.textContent=z}const B=t.querySelector(`.${e}-search-input`);if(B){const z=M("search-placeholder")||"Buscar...";B.setAttribute("placeholder",z)}const S=t.querySelector(`.${e}-no-results`);if(S){const z=M("no-results-text")||"No se encontraron agencias";S.textContent=z}}function M(f){return t.closest(`[data-gjs-type="${e}"]`)?.getAttribute(f)}function V(f){const B=t.querySelector(`.${e}-list`);B&&(B.innerHTML=`
                    <div class="flex flex-col items-center justify-center p-12 text-center">
...
.mp-map-wrapper{height:320px;}
        ...
        </div>`,n.appendChild(d),document.body.appendChild(n),d.querySelectorAll(".mp-tab-btn").forEach(g=>{g.addEventListener("click",()=>{d.querySelectorAll(".mp-tab-btn").forEach(u=>u.classList.remove("active")),d.querySelectorAll(".mp-tab-panel").forEach(u=>u.classList.remove("active")),g.classList.add("active"),d.querySelector(`#mp-panel-${g.dataset.tab}`).classList.add("active")})});const s=d.querySelector("#mp-filters-list");function c(){s.innerHTML="",o.forEach((g,u)=>{const h=document.createElement("div");h.className="mp-filter-card",h.innerHTML=`
...
@media(max-width:768px){.bsk-buttons{flex-direction:column;}}`;function Er(){return function(){const t=this,e=t.ownerDocument??document,i="/adminintegral",a=(e.defaultView??window).location.origin,r=e.querySelector('meta[name="api-banners-url"]')?.content||`${a}${i}/api/banners/active`,l=["fill-blue","outline-blue","fill-orange","outline-orange","fill-white","outline-white"],o=".banner-wrapper{position:relative;width:100%;background:#003B71;overflow:hidden;}.banner-slide-container{position:relative;width:100%;user-select:none;cursor:grab;display:grid;}.banner-slide-container:active{cursor:grabbing;}.banner-slide{grid-area:1/1;opacity:0;pointer-events:none;transition:opacity 0.7s ease;visibility:hidden;display:flex;flex-direction:column;}.banner-slide.banner-slide--active{opacity:1;pointer-events:auto;visibility:visible;}.banner-slide-inner{position:relative;width:100%;flex:1;min-height:480px;display:flex;align-items:center;}.banner-bg{position:absolute;inset:0;z-index:0;}.banner-bg img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;}.banner-overlay{position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,59,113,0.85) 0%,rgba(0,59,113,0.65) 50%,rgba(0,59,113,0.2) 100%);z-index:1;}.banner-content{position:relative;z-index:10;display:flex;flex-direction:column;justify-content:center;padding:64px 64px 96px;max-width:60%;}.banner-category-badge{display:inline-block;margin-bottom:18px;padding:7px 20px;border-radius:999px;border:2px solid rgba(255,255,255,0.65);color:#fff;font-size:13px;font-weight:500;letter-spacing:0.04em;align-self:flex-start;}.banner-title{font-size:clamp(1.8rem,3.2vw,3rem);font-weight:800;color:#fff;line-height:1.15;margin:0 0 20px;}.banner-description{color:rgba(255,255,255,0.9);font-size:clamp(0.95rem,1.4vw,1.1rem);line-height:1.7;margin:0 0 36px;max-width:520px;}.banner-buttons{display:flex;flex-wrap:wrap;gap:16px;align-items:center;}.banner-btn{display:inline-block;padding:12px 32px;border-radius:999px;font-size:15px;font-weight:600;cursor:pointer;transition:background .2s,color .2s,border-color .2s;text-decoration:none;white-space:nowrap;line-height:1.4;box-sizing:border-box;}.banner-btn--fill-blue{background:#003B71;color:#ffffff;border:2px solid #003B71;}.banner-btn--fill-blue:hover{background:#002a52;border-color:#002a52;color:#ffffff;}.banner-btn--outline-blue{background:transparent;color:#003B71;border:2px solid #003B71;}.banner-btn--outline-blue:hover{background:#003B71;border-color:#003B71;color:#ffffff;}.banner-btn--fill-orange{background:#E97300;color:#ffffff;border:2px solid #E97300;}.banner-btn--fill-orange:hover{background:#c96200;border-color:#c96200;color:#ffffff;}.banner-btn--outline-orange{background:transparent;color:#E97300;border:2px solid #E97300;}.banner-btn--outline-orange:hover{background:#E97300;border-color:#E97300;color:#ffffff;}.banner-btn--fill-white{background:#ffffff;color:#003B71;border:2px solid #ffffff;}.banner-btn--fill-white:hover{background:#dce8f5;border-color:#dce8f5;color:#003B71;}.banner-btn--outline-white{background:transparent;color:#ffffff;border:2px solid #ffffff;}.banner-btn--outline-white:hover{background:#ffffff;border-color:#ffffff;color:#003B71;}.banner-dots-wrapper{display:none;}.banner-stripe{position:relative;width:100%;height:26px;background:#E97300;z-index:20;display:flex;align-items:center;justify-content:center;}.banner-dots{display:flex;gap:8px;align-items:center;}.banner-dot{width:10px;height:10px;border-radius:999px;border:none;cursor:pointer;background:rgba(255,255,255,0.5);transition:all 0.3s ease;padding:0;flex-shrink:0;}.banner-dot--active{width:28px;background:#ffffff;}.banner-empty{display:flex;align-items:center;justify-content:center;min-height:480px;color:rgba(255,255,255,0.5);font-size:14px;padding:40px;}@media(max-width:768px){.banner-slide-inner{min-height:340px;}.banner-bg img{object-position:right center;}.banner-content{max-width:100%;width:100%;padding:32px 24px 80px;}.banner-buttons{flex-wrap:wrap;gap:12px;}.banner-btn{flex:1 1 45%;min-width:140px;text-align:center;white-space:normal;word-break:break-word;}}@media(max-width:480px){.banner-btn{flex:1 1 100%;min-width:0;}}",n="@keyframes bsk-shimmer{0%{background-position:-600px 0}100%{background-position:600px 0}}.bsk-badge{width:120px;height:32px;margin-bottom:20px;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title{height:40px;margin-bottom:12px;border-radius:8px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title--short{width:60%;}.bsk-line{height:16px;margin-bottom:10px;border-radius:6px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-line--short{width:55%;}.bsk-buttons{display:flex;gap:16px;margin-top:36px;}.bsk-btn{height:48px;flex:1;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-bg-img{background:linear-gradient(90deg,rgba(255,255,255,0.04) 25%,rgba(255,255,255,0.09) 50%,rgba(255,255,255,0.04) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}@media(max-width:768px){.bsk-buttons{flex-direction:column;}}";(function(){if(!e.getElementById("banner-hero-styles")){const A=e.createElement("style");A.id="banner-hero-styles",A.textContent=o,e.head.appendChild(A)}if(!e.getElementById("banner-skeleton-styles")){const A=e.createElement("style");A.id="banner-skeleton-styles",A.textContent=n,e.head.appendChild(A)}})();let d=[],s=0,c=null,m=!1,g=0,u=0;const h=50,$=t.dataset.autoplay!=="false",k=t.dataset.category??"",x=t.querySelector(".banner-slide-container"),v=t.querySelector(".banner-stripe");if(!x||!v)return;function b(E){return l.indexOf(E)!==-1?E:E==="outline-blue"||E==="outline-orange"?"outline-white":"fill-white"}function p(E,A,X,O){const R=b(X),H=A?"a":"span",C=A?`href="${A}"${O?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${H} ${C} class="banner-btn banner-btn--${R}">${E}</${H}>`}async function y(){if(!t.__bannerLoading){t.__bannerLoading=!0,L();try{const E=await fetch(r,{headers:{Accept:"application/json"}});if(!E.ok){z();return}const A=await E.json();if(d=Array.isArray(A)?k?A.filter(X=>X.category===k):A:[],d.length===0){z();return}w(),V(),f(0,!1),$&&B()}catch{z()}finally{t.__bannerLoading=!1}}}function L(){x.innerHTML=`
                ...
                </div>`,v.innerHTML=""}function w(){x.innerHTML=d.map((E,A)=>`
                    ...
                    <div class="banner-slide-inner">
                        ...
                        <div class="banner-content">
                            ...
                            ${E.btn_primary_text||E.btn_secondary_text?`<div class="banner-buttons">
                                    ${E.btn_primary_text?p(E.btn_primary_text,E.btn_primary_url,E.btn_primary_style,E.btn_primary_external):""}
                                    ${E.btn_secondary_text?p(E.btn_secondary_text,E.btn_secondary_url,E.btn_secondary_style,E.btn_secondary_external):""}
                                </div>`:""}
                        </div>
                    </div>
                </div>`).join(""),_(),q()}function _(){x.addEventListener("mousedown",T),x.addEventListener("touchstart",T,{passive:!0}),x.addEventListener("mousemove",D),x.addEventListener("touchmove",D,{passive:!0}),x.addEventListener("mouseup",M),x.addEventListener("touchend",M),x.addEventListener("mouseleave",M)}function q(){d.forEach(E=>{const A=new Image;A.src=E.image_url})}function T(E){m=!0,g=E.touches?E.touches[0].clientX:E.clientX,u=0}function D(E){m&&(u=(E.touches?E.touches[0].clientX:E.clientX)-g)}function M(){m&&(m=!1,Math.abs(u)>=h&&(f(u<0?(s+1)%d.length:(s-1+d.length)%d.length),S()),u=0)}function V(){if(d.length<=1){v.innerHTML="";return}const E=e.createElement("div");E.className="banner-dots",d.forEach((A,X)=>{const O=e.createElement("button");O.className="banner-dot",O.type="button",O.dataset.index=String(X),O.setAttribute("aria-label",`Banner ${X+1}`),O.addEventListener("click",()=>{f(X),S()}),E.appendChild(O)}),v.innerHTML="",v.appendChild(E)}function f(E,A=!0){const X=x.querySelectorAll(".banner-slide"),O=t.querySelectorAll(".banner-dot");X.forEach((R,H)=>{const C=H===E;A||(R.style.transition="none"),R.classList.toggle("banner-slide--active",C),A||requestAnimationFrame(()=>{R.style.transition=""})}),O.forEach((R,H)=>R.classList.toggle("banner-dot--active",H===E)),s=E}function B(){d.length<=1||!$||(c=setInterval(()=>f((s+1)%d.length),5e3))}function S(){$&&(clearInterval(c),B())}function z(){clearInterval(c),x.innerHTML=`
                <div class="banner-slide banner-slide--active">
                    <div class="banner-empty">Sin contenido.</div>
                </div>`,v.innerHTML=""}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",y):y()}}function $r(t,e){const i=document.getElementById("banner-hero-config-modal");if(i&&i.remove(),!document.getElementById("bnr-modal-styles")){const h=document.createElement("style");h.id="bnr-modal-styles",h.textContent=`
        ...
        `,document.head.appendChild(h)}const a=e.getAttributes(),r=a["data-autoplay"]!=="false",l=a["data-category"]||"",o=document.createElement("div");o.id="banner-hero-config-modal",o.className="bnr-overlay";const n=document.createElement("div");n.className="bnr-modal",n.innerHTML=`
        ...
        </div>`,o.appendChild(n),document.body.appendChild(o);const d=n.querySelector("#bnr-autoplay"),s=n.querySelector("#bnr-autoplay-slider"),c=n.querySelector("#bnr-autoplay-knob"),m=()=>{s.style.background=d.checked?"#003B71":"#cbd5e1",c.style.left=d.checked?"21px":"3px"};m(),d.addEventListener("change",m);const g=n.querySelector("#bnr-category");(async()=>{try{const $=document.querySelector('meta[name="api-banners-url"]')?.content||`${window.location.origin}/adminintegral/api/banners/active`,k=await fetch($,{headers:{Accept:"application/json"}});if(!k.ok)return;const x=await k.json();if(!Array.isArray(x))return;[...new Set(x.map(b=>b.category).filter(Boolean))].sort().forEach(b=>{const p=document.createElement("option");p.value=b,p.textContent=b,g.appendChild(p)}),g.value=l}catch{}})();const u=()=>o.remove();n.querySelector("#bnr-modal-close").onclick=u,n.querySelector("#bnr-modal-cancel").onclick=u,o.onclick=h=>{h.target===o&&u()},n.querySelector("#bnr-modal-save").onclick=()=>{e.addAttributes({"data-autoplay":d.checked?"true":"false","data-category":g.value||""}),u()}}const Sr=[{id:"banner-hero",label:"Banner Slider",category:"Banners",media:wr,content:{type:"banner-hero-component"}}];function Lr(t){const e="banner-hero-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner Slider",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-autoplay":"true","data-category":""},components:`
...
`;function zr(){return function(){const t=this,e=t.ownerDocument??document,i=e.querySelector('meta[name="api-assets-url"]')?.content;if(!i)return;const a=`
.ast-section {
    width: 100%;
    background: #ffffff;
    padding: 3rem 4rem;
...
`;if(!e.getElementById("assets-block-styles")){const k=e.createElement("style");k.id="assets-block-styles",k.textContent=a,e.head.appendChild(k)}const r=t.querySelector("[data-ast-tabs]"),l=t.querySelector("[data-ast-content]");if(!r||!l)return;const o=t.dataset.defaultCategory||"";let n=[],d="";function s(k,x){return k?k.length>x?`${k.slice(0,x).trim()}...`:k:""}function c(k){const x=k.link_is_external?' target="_blank" rel="noopener noreferrer"':"",v=k.name||s(k.short_description,60),b=k.name||k.short_description||"Activo extraordinario";return`<a href="${k.link_url}"${x} class="ast-card">
                <img src="${k.image_url}" alt="${b}" class="ast-card-img" loading="lazy">
                <div class="ast-card-body">
                    <p class="ast-card-name">${v}</p>
                    ${k.name&&k.short_description?`<p class="ast-card-desc">${k.short_description}</p>`:""}
                </div>
            </a>`}function m(){const k=[],x=new Set;return n.forEach(v=>{x.has(v.category_slug)||(x.add(v.category_slug),k.push({slug:v.category_slug,name:v.category}))}),k.sort((v,b)=>v.name.localeCompare(b,"es",{sensitivity:"base"}))}function g(k,x){const v=x.length?x.map(c).join(""):'<div class="ast-empty">No hay activos extraordinarios disponibles en esta categoría.</div>';return`<div class="ast-group">
                <p class="ast-subtitle">${k}</p>
                <div class="ast-subtitle-stripe"></div>
                <div class="ast-grid">${v}</div>
            </div>`}function u(){if(d){const x=n.filter(b=>b.category_slug===d),v=x[0]?.category||m().find(b=>b.slug===d)?.name||"";l.innerHTML=g(v,x);return}const k=m();l.innerHTML=k.map(x=>g(x.name,n.filter(v=>v.category_slug===x.slug))).join("")}function h(){const x=['<button type="button" class="ast-tab ast-tab--active" data-tab-slug="">Todos</button>',...m().map(v=>`<button type="button" class="ast-tab" data-tab-slug="${v.slug}">${v.name}</button>`)].join("");if(r.innerHTML=x,r.querySelectorAll("[data-tab-slug]").forEach(v=>{v.addEventListener("click",()=>{r.querySelectorAll(".ast-tab").forEach(b=>b.classList.remove("ast-tab--active")),v.classList.add("ast-tab--active"),d=v.dataset.tabSlug,u()})}),o){const v=r.querySelector(`[data-tab-slug="${o}"]`);v&&v.click()}}async function $(){l.innerHTML='<div class="ast-empty">Cargando activos extraordinarios...</div>';try{const k=await fetch(i,{headers:{Accept:"application/json"}});if(!k.ok){l.innerHTML='<div class="ast-empty">No se pudieron cargar los activos extraordinarios.</div>';return}if(n=await k.json(),!Array.isArray(n)||n.length===0){r.innerHTML='<button type="button" class="ast-tab ast-tab--active">Todos</button>',l.innerHTML='<div class="ast-empty">No hay activos extraordinarios disponibles.</div>';return}h(),u()}catch{l.innerHTML='<div class="ast-empty">No se pudieron cargar los activos extraordinarios.</div>'}}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",$):$()}}const Ar=[{id:"assets-catalog",label:"Catálogo de Activos Extraordinarios",category:"Interactivos",media:_r,content:{type:"assets-catalog-component"}}];function Ir(t){const e="assets-catalog-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Catálogo de Activos Extraordinarios",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-default-category":"",class:"ast-section"},components:`
...
.hb-btn{width:100%;text-align:center;}
        ...
        </div>`,s.appendChild(c),document.body.appendChild(s);const g=`${document.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??""}/api/pages/search`;function u(b){if(b.dataset.autocompleteAttached)return;b.dataset.autocompleteAttached="true";const p=b.parentNode;(!p.style.position||p.style.position==="static")&&(p.style.position="relative");const y=document.createElement("ul");y.style.cssText="position:absolute;top:calc(100% + 2px);left:0;right:0;z-index:999999;background:#fff;border:1px solid #e2e8f0;border-radius:0.5rem;box-shadow:0 8px 24px rgba(0,0,0,0.1);list-style:none;margin:0;padding:0.25rem;max-height:200px;overflow-y:auto;display:none;",p.appendChild(y);let L=null;async function w(T){if(T.length<1){y.style.display="none";return}try{const M=await(await fetch(`${g}?q=${encodeURIComponent(T)}`,{headers:{Accept:"application/json","X-Requested-With":"XMLHttpRequest"}})).json();q(M,T)}catch{y.style.display="none"}}function _(T,D){return D?T.replace(new RegExp(`(${D.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")})`,"gi"),'<mark style="background:#fef3c7;color:#92400e;border-radius:2px;padding:0 1px;">$1</mark>'):T}function q(T,D){if(y.innerHTML="",!T.length){y.style.display="none";return}T.forEach(M=>{const V=document.createElement("li");V.style.cssText="padding:0.375rem 0.625rem;border-radius:0.375rem;cursor:pointer;display:flex;flex-direction:column;gap:0.125rem;",V.innerHTML=`<span style="font-size:0.8rem;font-weight:600;color:#1e293b;">${_(M.title,D)}</span><span style="font-size:0.7rem;color:#64748b;">/${M.slug}</span>`,V.addEventListener("mouseenter",()=>V.style.background="#f1f5f9"),V.addEventListener("mouseleave",()=>V.style.background=""),V.addEventListener("mousedown",f=>{f.preventDefault(),b.value=`${Nr}/${M.slug}`,b.dispatchEvent(new Event("input")),y.style.display="none"}),y.appendChild(V)}),y.style.display="block"}b.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>w(b.value.trim()),220)}),b.addEventListener("focus",()=>{b.select(),b.value.trim()&&w(b.value.trim())}),b.addEventListener("blur",()=>{setTimeout(()=>{y.style.display="none"},150)}),b.addEventListener("keydown",T=>{if(y.style.display==="none")return;const D=y.querySelectorAll("li"),M=y.querySelector("li.hb-ac-active");let V=Array.from(D).indexOf(M);if(T.key==="ArrowDown"){T.preventDefault(),M?.classList.remove("hb-ac-active");const f=D[V+1]||D[0];f?.classList.add("hb-ac-active"),f&&(f.style.background="#f1f5f9")}else if(T.key==="ArrowUp"){T.preventDefault(),M?.classList.remove("hb-ac-active");const f=D[V-1]||D[D.length-1];f?.classList.add("hb-ac-active"),f&&(f.style.background="#f1f5f9")}else T.key==="Enter"&&M?(T.preventDefault(),M.dispatchEvent(new MouseEvent("mousedown"))):T.key==="Escape"&&(y.style.display="none")})}u(c.querySelector("#hb-btn1-href")),u(c.querySelector("#hb-btn2-href"));let h=n.color||"white",$=d.color||"white";function k(b,p,y){const L=c.querySelector(`#${b}`);L.querySelectorAll("[data-color]").forEach(w=>{w.classList.toggle("hb-color-inactive",w.dataset.color!==p),w.addEventListener("click",()=>{L.querySelectorAll("[data-color]").forEach(_=>_.classList.toggle("hb-color-inactive",_.dataset.color!==w.dataset.color)),y(w.dataset.color)})})}k("hb-btn1-colors",h,b=>h=b),k("hb-btn2-colors",$,b=>$=b);function x(b,p,y){const L=c.querySelector(`#${b}`),w=c.querySelector(`#${p}`),_=c.querySelector(`#${y}`),q=()=>{w.style.background=L.checked?"#003B71":"#cbd5e1",_.style.left=L.checked?"21px":"3px"};q(),L.addEventListener("change",q)}x("hb-btn1-enabled","hb-btn1-slider","hb-btn1-knob"),x("hb-btn2-enabled","hb-btn2-slider","hb-btn2-knob"),c.querySelectorAll(".hb-tab-btn").forEach(b=>{b.addEventListener("click",()=>{c.querySelectorAll(".hb-tab-btn").forEach(p=>p.classList.remove("active")),c.querySelectorAll(".hb-tab-panel").forEach(p=>p.classList.remove("active")),b.classList.add("active"),c.querySelector(`#hb-panel-${b.dataset.tab}`).classList.add("active")})}),c.querySelector("#hb-bg-pick").addEventListener("click",()=>{$e({type:"image",title:"Seleccionar imagen de fondo",onSelect:b=>{c.querySelector("#hb-bg-url").value=b,c.querySelector("#hb-bg-preview").src=b}})}),c.querySelector("#hb-bg-url").addEventListener("input",b=>{c.querySelector("#hb-bg-preview").src=b.target.value});const v=()=>s.remove();c.querySelector("#hb-modal-close").onclick=v,c.querySelector("#hb-modal-cancel").onclick=v,s.onclick=b=>{b.target===s&&v()},c.querySelector("#hb-modal-save").onclick=()=>{const b={bg_image:c.querySelector("#hb-bg-url").value.trim()||Q.bg_image,title:c.querySelector("#hb-title").value.trim(),subtitle:c.querySelector("#hb-subtitle").value.trim(),btn_primary:{enabled:c.querySelector("#hb-btn1-enabled").checked,label:c.querySelector("#hb-btn1-label").value.trim(),href:c.querySelector("#hb-btn1-href").value.trim()||"#",color:h},btn_secondary:{enabled:c.querySelector("#hb-btn2-enabled").checked,label:c.querySelector("#hb-btn2-label").value.trim(),href:c.querySelector("#hb-btn2-href").value.trim()||"#",color:$}},y=e.getEl()?.querySelector("[id^='hb-root-']")?.id?.replace("hb-root-","")||"hb"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-hero-banner-config":JSON.stringify(b)}),e.components(bt(b,y)+mt),v()}}function Pr(t){const e="hero-banner-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-hero-banner-config":JSON.stringify(Q)},components:bt(Q)+mt,toolbar:[],traits:[{type:"button",label:"Banner",text:"Administrar Banner",full:!0,command:"open-hero-banner-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-hero-banner-config",{run(i){const a=i.getSelected();a&&Or(i,a)}}),t.BlockManager.add("hero-banner-block",{label:"Banner",category:"Banners",media:`<svg viewBox="0 0 32 32" width="32" height="32">
