/* empty css                   *//* empty css                    *//* empty css                          *//* empty css                           */import{o as Fe,M as Re,j as Ue,E as Ve,i as We,t as Ye,d as Xe,f as Ge,e as Je,s as Ze,g as Ke,c as Qe,b as et,a as tt,h as it}from"./editor-commands-Bq37dEX4.js";import{a as N}from"./url-DaqOO3yL.js";import"./_commonjsHelpers-CqkleIqs.js";class at{constructor(){this.pageId=this.getElementValue("page-id"),this.pageSlug=this.getElementValue("page-slug"),this.pageTitle=this.getPageTitle(),this.loadUrl=this.getElementValue("page-load-url"),this.storeUrl=this.getElementValue("page-store-url"),this.isPublished=this.getElementValue("page-is-published")==="1",this.isEditMode=!!this.pageId,this.appUrl=(document.querySelector('meta[name="app-url"]')?.content??"").replace(/\/$/,"")}getElementValue(e,t=""){const r=document.getElementById(e);return r?r.value.trim():t}getPageTitle(){const e=document.getElementById("editor-title");if(!e)return"";const r=e.textContent.match(/(?:Editando:|Nueva Página)\s*(.+)?/);return r&&r[1]?r[1].trim():""}updatePageInfo(e){if(e.page)if(this.pageId=e.page.id,this.pageSlug=e.page.slug,this.pageTitle=e.page.title,this.isEditMode=!0,document.getElementById("page-id").value=this.pageId,document.getElementById("page-slug").value=this.pageSlug,e.page.update_url?this.storeUrl=e.page.update_url:this.storeUrl=`${this.appUrl}/pages/${this.pageSlug}`,document.getElementById("page-store-url").value=this.storeUrl,e.page.load_url?this.loadUrl=e.page.load_url:this.loadUrl=`${this.appUrl}/pages/${this.pageSlug}/load`,document.getElementById("page-load-url").value=this.loadUrl,e.page.edit_url)window.history.replaceState(null,"",e.page.edit_url);else try{const t=new URL(window.location.href);t.pathname=t.pathname.replace(/\/pages\/create\/?$/,`/pages/${this.pageSlug}/edit`),window.history.replaceState(null,"",t.toString())}catch(t){console.error("Error updating browser URL:",t)}}updateTitle(e){this.pageTitle=e;const t=document.getElementById("editor-title");t&&(t.textContent=`Editando: ${e}`),document.title=`Editar: ${e} - Editor`}getHttpMethod(){return this.isEditMode?"PUT":"POST"}needsTitle(){return!this.isEditMode}}class rt{constructor(e){this.editorService=e,this.setupBackButton(),this.setupBeforeUnload()}setupBackButton(){const e=document.querySelector("#editor-navbar a[href]");e&&e.addEventListener("click",t=>{this.editorService.shouldPreventUnload()&&(t.preventDefault(),this.showUnsavedChangesModal(()=>{this.editorService.startNavigation(),window.location.href=e.href}))})}setupBeforeUnload(){window.addEventListener("beforeunload",e=>{if(this.editorService.shouldPreventUnload())return e.preventDefault(),e.returnValue="Tienes cambios sin guardar. ¿Estás seguro de que quieres salir?",e.returnValue})}showUnsavedChangesModal(e){const t=document.createElement("div");t.style.cssText=`
        ...
        `;const d=document.createElement("button");d.textContent="Salir sin guardar",d.style.cssText=`
            ...
            font-family: inherit;
        `,[c,d].forEach(f=>{f.addEventListener("mouseenter",()=>{f.style.opacity="0.85"}),f.addEventListener("mouseleave",()=>{f.style.opacity="1"})});const h=()=>t.remove();c.addEventListener("click",h),d.addEventListener("click",()=>{h(),e()}),t.addEventListener("click",f=>{f.target===t&&h()}),l.appendChild(c),l.appendChild(d),r.appendChild(a),r.appendChild(l),t.appendChild(r),document.body.appendChild(t)}}const lt="Básico";class ot{constructor(){this.blocks=new Map}registerBlock(e,t){this.blocks.has(t.category)||this.blocks.set(t.category,[]),this.blocks.get(t.category).push({id:e,...t})}registerBlocks(e){e.forEach(t=>{this.registerBlock(t.id,t)})}applyToEditor(e){this.blocks.forEach(t=>{t.forEach(r=>{const{id:a,...l}=r;e.BlockManager.add(a,l)})}),this.applyCollapseSettings(e),this.hideDefaultCategories(e)}applyCollapseSettings(e){setTimeout(()=>{e.BlockManager.getCategories().each(t=>{t.set("open",t.get("label")===lt)})},500)}hideDefaultCategories(e){setTimeout(()=>{const t=["Basic","Extra"];document.querySelectorAll(".gjs-block-category").forEach(r=>{const a=r.querySelector(".gjs-title");a&&t.includes(a.textContent.trim())&&(r.style.display="none")})},100)}}const L=new ot,nt=[{id:"heading1",label:"Título H1",category:"Básico",media:`<svg viewBox="0 0 32 32" width="32" height="32">
...
</svg>`;function Lt(i){const e="product-cards-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección de Productos",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-product-cards-config":JSON.stringify(M)},components:Me(M),traits:[{type:"button",label:"Productos",text:"Administrar Sección",full:!0,command:"open-product-cards-config"}],toolbar:[]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),i.Commands.add("open-product-cards-config",{run(t){const r=t.getSelected();r&&$t(t,r)}}),i.BlockManager.add("product-cards-block",{label:"Sección de productos",category:"Productos y Servicios",media:Ct,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),i.on("component:mount",t=>{t.getEl()?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>de(i),400))}),i.on("component:selected",t=>{const r=t.getEl();if(!r)return;const a=r.closest(`[data-gjs-type="${e}"]`);if(a&&!r.hasAttribute("data-gjs-type")){const c=i.getWrapper().find(`[data-gjs-type="${e}"]`).find(d=>d.getEl()===a);c&&setTimeout(()=>i.select(c),0)}}),i.on("canvas:render",()=>{setTimeout(()=>de(i),600)}),i.on("storage:end:load",()=>{setTimeout(()=>de(i),800)})}const St=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<\/script>`}],Ei=`<svg viewBox="0 0 32 32" width="32" height="32">
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
            ...
            <th colspan="${i.cols}" class="p-3 align-middle text-center text-base font-bold ${t.headerBg} ${t.headerText}">
        ...
        </tr>`,i.headers?.length&&(r+="<tr>",i.headers.forEach((c,d)=>{const h=d<i.headers.length-1?`border-r border-[${t.borderColor}]`:"";r+=`<th class="p-3 align-middle text-sm font-semibold ${t.subheaderBg} ${t.subheaderText} ${h} border-b border-[${t.borderColor}] text-${c.align||"center"}">${c.text||""}</th>`}),r+="</tr>"),r+="</thead>"):i.headers?.length&&(r+="<thead><tr>",i.headers.forEach((c,d)=>{const h=d<i.headers.length-1?`border-r border-[${t.borderColor}]`:"";r+=`<th class="p-3 align-middle text-sm font-semibold ${t.headerBg} ${t.headerText} ${h} border-b border-[${t.borderColor}] text-${c.align||"center"}">${c.text||""}</th>`}),r+="</tr></thead>"),r+="<tbody>";const a=i.rows.length,l={};return i.rows.forEach((c,d)=>{r+="<tr>";let h=0;c.forEach(f=>{for(;l[`${d}-${h}`];)h++;const b=f.colspan||1,w=f.rowspan||1;for(let u=d;u<d+w;u++)for(let S=h;S<h+b;S++)(u!==d||S!==h)&&(l[`${u}-${S}`]=!0);const m=b>1?`colspan="${b}"`:"",n=w>1?`rowspan="${w}"`:"",g=f.isHeader?t.labelBg:d%2===0?t.rowEvenBg:t.rowOddBg,v=f.isHeader?"font-semibold":"font-normal",z=f.isHeader?t.labelText:t.rowText,y=`text-${f.align||"center"}`,$=d+w>=a,C=h+b>=i.cols?"":`border-r border-[${t.borderColor}]`,B=$?"":`border-b border-[${t.borderColor}]`,j=`${C} ${B} p-3 align-middle text-sm ${g} ${v} ${z} ${y}`;f.image?r+=`<td ${m} ${n} class="${j}">
                ...
                </td>`:r+=`<td ${m} ${n} class="${j}">${f.text||""}</td>`,h+=b}),r+="</tr>"}),r+="</tbody></table>",r}function Z(i,e){return{title:"Título de la tabla",cols:i,headers:Array.from({length:i},(t,r)=>({text:`Columna ${r+1}`,align:"center"})),rows:Array.from({length:e},()=>Array.from({length:i},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})))}}function Oe(i,e){return`<div class="w-full overflow-x-auto rounded-2xl border-2 border-[${(fe[e]||fe.blue).borderColor}]">${i}</div>`}function Se(i,e){const t={};return i.forEach((r,a)=>{let l=0;r.forEach(c=>{for(;t[`${a}-${l}`];)l++;const d=Math.min(c.colspan||1,e-l),h=c.rowspan||1;for(let f=a;f<a+h;f++)for(let b=l;b<l+d;b++)(f!==a||b!==l)&&(t[`${f}-${b}`]=`${a}-${l}`);l+=d})}),t}const $i=`
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function Ci(){if(document.getElementById("tam-img-modal"))return;const i=document.createElement("div");i.id="tam-img-modal",i.innerHTML=`
        ...
        <div class="tam-container">
        ...
        </div>`,document.body.appendChild(r);let a=null,l=null;function c(m){a=m;const n=m.get("tableData");l=n?JSON.parse(JSON.stringify(n)):Z(3,3);const g=l.cols||3;l.rows=l.rows.map((v,z)=>Array.from({length:g},($,I)=>v[I]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})),document.getElementById("tam-title").value=l.title||"",document.getElementById("tam-theme").value=m.get("tableTheme")||"blue",document.getElementById("tam-cols").value=l.cols||3,document.getElementById("tam-rows").value=l.rows.length||3,b(),w(),r.classList.add("open"),document.body.style.overflow="hidden"}function d(){r.classList.remove("open"),document.body.style.overflow="",a=null}function h(){l.title=document.getElementById("tam-title").value.trim(),l.cols=parseInt(document.getElementById("tam-cols").value)||3,l.headers=Array.from(document.querySelectorAll(".tam-header-input")).map(n=>({text:n.value,align:n.closest("th")?.querySelector(".tam-align-select")?.value||"center"})),document.querySelectorAll("#tam-tbody td.tam-cell:not(.is-spanned)").forEach(n=>{const g=parseInt(n.dataset.row),v=parseInt(n.dataset.col);l.rows[g]?.[v]&&(l.rows[g][v].text=n.querySelector(".tam-cell-input")?.value||"",l.rows[g][v].align=n.querySelector(".tam-align-select")?.value||"center",l.rows[g][v].isHeader=n.dataset.isheader==="1",l.rows[g][v].image=n.dataset.image||null)});const m=Se(l.rows,l.cols);l.rows=l.rows.map((n,g)=>n.filter((v,z)=>!m[`${g}-${z}`]))}function f(){if(r.querySelector("#tam-rebuild-notice"))return;const n=document.createElement("div");n.id="tam-rebuild-notice",n.style.cssText="background:#fef9c3;border:1.5px solid #ca8a04;border-radius:0.5rem;padding:0.5rem 1rem;font-size:0.8rem;color:#92400e;display:flex;align-items:center;gap:0.5rem;margin:0 1.5rem 0;flex-shrink:0;",n.innerHTML='<i class="ri-error-warning-line"></i> Has modificado el colspan/rowspan. Haz clic en <strong style="margin:0 4px;">Reconstruir</strong> para aplicar los cambios de fusión.',r.querySelector(".tam-toolbar").after(n)}function b(){r.querySelector("#tam-rebuild-notice")?.remove()}function w(){const m=document.getElementById("tam-thead"),n=document.getElementById("tam-tbody"),g=l.cols,v=l.rows.length,z=Se(l.rows,g);m.innerHTML=`<tr>${l.headers.map((y,$)=>`
            <th>
            ...
            </th>`).join("")}</tr>`,n.innerHTML=l.rows.map((y,$)=>`<tr>${Array.from({length:g},(C,B)=>{const j=z[`${$}-${B}`];if(j)return`<td class="tam-cell is-spanned" data-row="${$}" data-col="${B}">
                        <div class="tam-spanned-label">Combinada con [${j}]</div>
                    </td>`;const u=y[B]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null},S=u.colspan||1,O=u.rowspan||1,T=S>1||O>1;return`<td class="tam-cell ${u.isHeader?"is-header-cell":""} ${u.image?"has-image":""} ${T?"has-span":""}"
                    data-row="${$}" data-col="${B}"
                ...
                </td>`}).join("")}</tr>`).join(""),n.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(y=>{y.addEventListener("change",()=>{const $=parseInt(y.dataset.row),I=parseInt(y.dataset.col),C=Math.max(1,parseInt(y.value)||1);l.rows[$]?.[I]&&(y.dataset.action==="colspan"?l.rows[$][I].colspan=Math.min(C,g-I):l.rows[$][I].rowspan=Math.min(C,v-$),f())})}),n.querySelectorAll("button[data-action]").forEach(y=>{y.addEventListener("click",$=>{$.preventDefault(),$.stopPropagation();const I=y.dataset.action,C=parseInt(y.dataset.row),B=parseInt(y.dataset.col);if(!(isNaN(C)||isNaN(B)||!l.rows[C]?.[B])){if(I==="header"){l.rows[C][B].isHeader=!l.rows[C][B].isHeader;const j=n.querySelector(`td[data-row="${C}"][data-col="${B}"]`);j&&(j.dataset.isheader=l.rows[C][B].isHeader?"1":"0",j.classList.toggle("is-header-cell",l.rows[C][B].isHeader)),y.classList.toggle("active",l.rows[C][B].isHeader),y.textContent=l.rows[C][B].isHeader?"✓ Etiqueta":"Etiqueta";return}if(I==="image"){window.__openTableImagePicker&&window.__openTableImagePicker(j=>{l.rows[C][B].image=j;const u=n.querySelector(`td[data-row="${C}"][data-col="${B}"]`);if(u){u.dataset.image=j,u.classList.add("has-image");let S=u.querySelector(".tam-cell-img-preview");S||(S=document.createElement("img"),S.className="tam-cell-img-preview",u.insertBefore(S,u.firstChild)),S.src=j;const O=u.querySelector("[data-action=image]");if(O&&(O.innerHTML='<i class="ri-image-line"></i> Cambiar'),!u.querySelector("[data-action=clear-image]")){const T=document.createElement("button");T.type="button",T.className="tam-cell-btn tam-cell-btn-clear",T.dataset.action="clear-image",T.dataset.row=C,T.dataset.col=B,T.textContent="✕ Quitar",T.addEventListener("click",Y=>{Y.preventDefault(),Y.stopPropagation(),l.rows[C][B].image=null,u.dataset.image="",u.classList.remove("has-image"),S.remove(),T.remove();const H=u.querySelector("[data-action=image]");H&&(H.innerHTML='<i class="ri-image-line"></i> Imagen')}),u.querySelector(".tam-cell-actions").appendChild(T)}}});return}I==="clear-image"&&(l.rows[C][B].image=null,w())}})})}document.getElementById("tam-close").addEventListener("click",d),document.getElementById("tam-cancel").addEventListener("click",d),r.addEventListener("click",m=>{m.target===r&&d()}),document.getElementById("tam-rebuild").addEventListener("click",()=>{const m=parseInt(document.getElementById("tam-cols").value)||3,n=parseInt(document.getElementById("tam-rows").value)||3;for(b(),h();l.headers.length<m;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,m),l.cols=m;l.rows.length<n;)l.rows.push(Array.from({length:m},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,n).map(g=>{for(;g.length<m;)g.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return g.slice(0,m)}),w()}),document.getElementById("tam-apply").addEventListener("click",()=>{h();const m=document.getElementById("tam-theme").value;a&&(a.set("tableData",JSON.parse(JSON.stringify(l))),a.set("tableTheme",m),a.addAttributes({"data-table-theme":m}),be(a)),d()}),window.__openTableAdminModal=c}function be(i){const e=i.get("tableData"),t=i.get("tableTheme")||"blue";e&&i.components(Oe(Ne(e,t),t))}function Si(){return function(){}}const ji=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:Ei,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<a href="#"
   ...
   class="dld-simple-${e}">
    ...
    <rect x="3" y="25" width="7" height="2.5" fill="#dee2e6" rx="0.5"/>
</svg>`;function Ji(){return function(){const i=this,e="agencies-map-component",t="/api/agencies/active",r="agencies";let a=[],l=[],c={},d=null,h=[];const f=async()=>{try{b(),await m(),await v(),z(),j(),T(),Y(),w()}catch(o){console.error("Error initializing map:",o),ae("Error al cargar las agencias"),w()}};function b(){const o=i.querySelector(`.${e}-list`);o&&(o.innerHTML=`
                ...
                `);const s=i.querySelector(`.${e}-map-container`);s&&(s.style.opacity="0.5")}function w(){const o=i.querySelector(`.${e}-map-container`);o&&(o.style.transition="opacity 0.3s ease",o.style.opacity="1")}async function m(){try{const s=await(await fetch(t)).json(),p=r?s[r]:s;Array.isArray(p)?(a=p.filter(x=>x.latitude&&x.longitude&&!isNaN(x.latitude)&&!isNaN(x.longitude)),l=[...a],n()):(a=[],l=[])}catch(o){console.error("Error loading items:",o),a=[],l=[]}}function n(){const o=[...new Set(a.map(p=>p.zone).filter(Boolean))].sort(),s=[...new Set(a.map(p=>p.department).filter(Boolean))].sort();c={zone:o,department:s},setTimeout(()=>{const p=i.querySelector(`.${e}-filters-container`);p&&!p.hasChildNodes()&&(p.innerHTML=`
...
@media(max-width:480px){
    .banner-btn{flex:1 1 100%;min-width:0;}
            ...
            `;const o=i.ownerDocument??document;if(!o.getElementById("banner-skeleton-styles")){const s=o.createElement("style");s.id="banner-skeleton-styles",s.textContent=`
                ...
                `,o.head.appendChild(s)}}function z(o){return t[o]?t[o]:o==="outline-blue"||o==="outline-orange"?t["outline-white"]:t["fill-white"]}function y(o,s,p,x){const E=z(p),q=s?"a":"span",F=s?`href="${s}"${x?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${q} ${F}
                class="banner-btn"
                data-bg="${E.bg}"
                data-color="${E.color}"
                ...
                ${o}
            </${q}>`}function $(){n.innerHTML=a.map((o,s)=>`
            ...
            `).join(""),I(),C(),B()}function I(){i.querySelectorAll(".banner-btn").forEach(o=>{const s=o.style.borderColor;o.addEventListener("mouseenter",()=>{o.style.background=o.dataset.hoverBg,o.style.color=o.dataset.hoverColor,o.style.borderColor=o.dataset.hoverBg}),o.addEventListener("mouseleave",()=>{o.style.background=o.dataset.bg,o.style.color=o.dataset.color,o.style.borderColor=s})})}function C(){n.addEventListener("mousedown",j),n.addEventListener("touchstart",j,{passive:!0}),n.addEventListener("mousemove",u),n.addEventListener("touchmove",u,{passive:!0}),n.addEventListener("mouseup",S),n.addEventListener("touchend",S),n.addEventListener("mouseleave",S)}function B(){a.forEach(o=>{const s=new Image;s.src=o.image_url})}function j(o){d=!0,h=o.touches?o.touches[0].clientX:o.clientX,f=0}function u(o){d&&(f=(o.touches?o.touches[0].clientX:o.clientX)-h)}function S(){d&&(d=!1,Math.abs(f)>=b&&(T(f<0?(l+1)%a.length:(l-1+a.length)%a.length),H()),f=0)}function O(){const o=i.querySelector(".banner-stripe");if(!o||a.length<=1)return;const s=document.createElement("div");s.className="banner-dots",a.forEach((p,x)=>{const E=document.createElement("button");E.className="banner-dot",E.dataset.index=String(x),E.setAttribute("aria-label",`Banner ${x+1}`),E.addEventListener("click",()=>{T(x),H()}),s.appendChild(E)}),o.innerHTML="",o.appendChild(s)}function T(o,s=!0){const p=n.querySelectorAll(".banner-slide"),x=i.querySelectorAll(".banner-dot");p.forEach((E,q)=>{const F=q===o;s||(E.style.transition="none"),E.classList.toggle("banner-slide--active",F),s||requestAnimationFrame(()=>{E.style.transition=""})}),x.forEach((E,q)=>{E.classList.toggle("banner-dot--active",q===o)}),l=o}function Y(){a.length<=1||!w||(c=setInterval(()=>{T((l+1)%a.length)},5e3))}function H(){w&&(clearInterval(c),Y())}function ae(){const o=i.querySelector(".banner-wrapper");o&&(o.innerHTML=`
