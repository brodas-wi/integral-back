import{i as B,t as C,d as j,f as N,e as I,s as q,g as z,c as T,E as A,j as M,h as H}from"./editor-commands-CXIv2y0g.js";import{o as U}from"./media-picker-CiKJ1Agb.js";import"./_commonjsHelpers-CqkleIqs.js";function _(){return B()}const S=`
<style>
.nb-wrapper {
...
if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",init);}else{init();}
    ...
    `,i.appendChild(n),document.body.appendChild(i),n.querySelectorAll(".nb-tab-btn").forEach(l=>{l.addEventListener("click",()=>{n.querySelectorAll(".nb-tab-btn").forEach(a=>a.classList.remove("active")),n.querySelectorAll(".nb-tab-panel").forEach(a=>a.classList.remove("active")),l.classList.add("active"),n.querySelector(`#nb-panel-${l.dataset.tab}`).classList.add("active")})}),n.querySelector("#nb-logo-pick").addEventListener("click",()=>{U({type:"image",title:"Seleccionar logo",onSelect:l=>{n.querySelector("#nb-logo-url").value=l;let a=n.querySelector("#nb-logo-preview");if(!a||a.tagName==="DIV"){const u=document.createElement("img");u.id="nb-logo-preview",u.style.cssText="height:48px;max-width:160px;object-fit:contain;border-radius:0.375rem;border:1px solid #e2e8f0;padding:4px;background:#f8fafc;display:block;margin-bottom:0.5rem;",a?.replaceWith(u)??n.querySelector("#nb-logo-url").before(u),a=u}a.src=l,a.style.display="block"}})});function f(){const l=n.querySelector("#nb-links-list");l.innerHTML="",b.forEach((a,u)=>{const m=document.createElement("div");if(m.className="nb-link-card",m.dataset.index=u,a.type==="submenu"){const d=(a.children||[]).map((v,k)=>`
                    ...
                    </div>`;m.querySelector(".nb-remove-link").onclick=()=>{b.splice(u,1),f()},m.querySelectorAll("[data-field]").forEach(d=>{d.addEventListener("input",()=>{a[d.dataset.field]=d.value})}),a.type==="submenu"&&(m.querySelector(".nb-add-child").onclick=()=>{a.children=a.children||[],a.children.push({label:"Nuevo enlace",href:"#",icon:""}),f()},m.querySelectorAll(".nb-remove-child").forEach(d=>{d.onclick=()=>{const v=parseInt(d.closest("[data-child]").dataset.child);a.children.splice(v,1),f()}}),m.querySelectorAll(".nb-submenu-item [data-field]").forEach(d=>{const v=parseInt(d.closest("[data-child]").dataset.child);d.addEventListener("input",()=>{a.children[v][d.dataset.field]=d.value})})),l.appendChild(m)})}function y(){const l=n.querySelector("#nb-actions-list");l.innerHTML="",o.forEach((a,u)=>{const m=document.createElement("div");m.className="nb-action-card",m.innerHTML=`
                <div class="nb-row">
                ...
                </div>`,m.querySelector(".nb-remove-action").onclick=()=>{o.splice(u,1),y()},m.querySelectorAll("[data-field]").forEach(d=>{d.addEventListener("input",()=>{a[d.dataset.field]=d.value}),d.addEventListener("change",()=>{a[d.dataset.field]=d.value})}),l.appendChild(m)})}f(),y(),n.querySelector("#nb-add-link").onclick=()=>{b.push({type:"link",label:"Nuevo enlace",href:"#"}),f()},n.querySelector("#nb-add-submenu").onclick=()=>{b.push({type:"submenu",label:"Menú",children:[{label:"Enlace",href:"#",icon:""}]}),f()},n.querySelector("#nb-add-action").onclick=()=>{o.push({label:"Botón",href:"#",style:"primary",icon:""}),y()};const g=()=>i.remove();n.querySelector("#nb-modal-close").onclick=g,n.querySelector("#nb-modal-cancel").onclick=g,i.onclick=l=>{l.target===i&&g()},n.querySelector("#nb-modal-save").onclick=()=>{const l={logo_url:n.querySelector("#nb-logo-url").value.trim(),logo_alt:n.querySelector("#nb-logo-alt").value.trim(),logo_text:n.querySelector("#nb-logo-text").value.trim(),links:b,actions:o},m=e.getEl()?.querySelector("[id^='nb-root-']")?.id?.replace("nb-root-","")||null||"nb"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-navbar-config":JSON.stringify(l)}),e.components(L(l,m)+S),g()}}function D(t){const e="navbar-component";t.DomComponents.addType(e,{isComponent:r=>r.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Navbar",tagName:"nav",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,class:"nb-wrapper","data-navbar-config":JSON.stringify({logo_url:"",logo_alt:"Logo",logo_text:"Logo",links:[{type:"link",label:"Sobre nosotros",href:"#"},{type:"link",label:"Créditos",href:"#"},{type:"link",label:"Depósitos",href:"#"},{type:"submenu",label:"Otros servicios",children:[{label:"Servicio 1",href:"#",icon:""},{label:"Servicio 2",href:"#",icon:""}]},{type:"link",label:"Contáctanos",href:"#"}],actions:[{label:"Ingresar",href:"#",style:"primary",icon:""}]})},components:L({logo_url:"",logo_alt:"Logo",logo_text:"Logo",links:[{type:"link",label:"Sobre nosotros",href:"#"},{type:"link",label:"Créditos",href:"#"},{type:"link",label:"Depósitos",href:"#"},{type:"submenu",label:"Otros servicios",children:[{label:"Servicio 1",href:"#",icon:""},{label:"Servicio 2",href:"#",icon:""}]},{type:"link",label:"Contáctanos",href:"#"}],actions:[{label:"Ingresar",href:"#",style:"primary",icon:""}]})+S,script:function(){},"script-props":[],toolbar:[],traits:[{type:"button",label:"Navbar",text:"Administrar Navbar",full:!0,command:"open-navbar-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-navbar-config",{run(r){const s=r.getSelected();s&&O(r,s)}}),t.BlockManager.add("navbar-block",{label:"Navbar",category:"Navbar",media:`<svg viewBox="0 0 32 32" width="32" height="32">
        ...
        </svg>`,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),P(t,e),G(t)}function P(t,e){t.on("storage:end:load",()=>{setTimeout(()=>$(t,e),800)}),t.on("component:mount",r=>{const s=r.getEl();s?.getAttribute?.("data-gjs-type")===e&&(r.set("type",e),setTimeout(()=>{const c=r.get("script");c&&typeof c=="function"&&c.call(s)},400))}),t.on("canvas:render",()=>{setTimeout(()=>$(t,e),600)})}function $(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(r=>{r.set("type",e);const s=r.getEl();if(s?.isConnected){const c=r.get("script");c&&typeof c=="function"&&c.call(s)}})}function G(t){t.on("load",()=>{const e=t.Canvas.getFrameEl();if(!e)return;const r=e.contentDocument?.head;if(r&&!r.querySelector("#navbar-component-css")){const s=document.createElement("style");s.id="navbar-component-css",s.textContent=`
            ...
            `,r.appendChild(s)}})}document.addEventListener("DOMContentLoaded",async()=>{const t=new A;let e=document.getElementById("navbar-id")?.value||"",r=document.getElementById("navbar-name")?.value||"",s=document.getElementById("navbar-load-url")?.value||"",c=document.getElementById("navbar-store-url")?.value||"";const x=document.getElementById("navbar-is-active")?.value==="1";let p=!!e;const b=_();if(D(b),b.on("load",()=>{C(b),j(),N(),I(b),q(b),z(b),T(b),J(b),setTimeout(()=>{b.runCommand("sw-visibility"),b.Panels.getButton("options","sw-visibility")?.set("active",!0)},100)}),p&&s)try{await t.loadPageContent(b,s),h("Navbar cargado correctamente","success")}catch{h("Error al cargar el navbar","error")}document.getElementById("save-button")?.addEventListener("click",async()=>{const i=document.getElementById("save-button");i.disabled=!0,i.innerHTML='<i class="ri-loader-4-line animate-spin"></i><span>Guardando...</span>';try{!p&&!r?M({title:"Nombre del Navbar",description:"Ingresa un nombre descriptivo para identificar este navbar.",placeholder:"Ej: Navbar Principal",icon:"ri-file-text-line",iconBg:"#dbeafe",iconColor:"#2563eb",confirmLabel:"Guardar",onConfirm:async n=>{if(!n?.trim()){h("El nombre es obligatorio","error"),i.disabled=!1,i.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>';return}try{await o(n)}catch(f){h(f.message,"error")}finally{i.disabled=!1,i.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}},onCancel:()=>{i.disabled=!1,i.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}}):(await o(r),i.disabled=!1,i.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>')}catch(n){h(n.message,"error"),i.disabled=!1,i.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}});async function o(i){const n=p?"PUT":"POST",f=t.getEditorContent(b),y=await t.savePage(b,{...f,name:i,is_active:x},c,n);if(y.success){if(t.markAsClean(),h(y.message,"success"),!p&&y.navbar){e=y.navbar.id,r=y.navbar.name,p=!0;const g=document.getElementById("navbar-id");g&&(g.value=e);const l=document.getElementById("navbar-name");l&&(l.value=r);const a=document.querySelector('meta[name="app-url"]'),u=a?a.content:"";c=c.endsWith("/navbars")?`${c}/${e}`:`${c.replace(/\/navbars\/?$/,"")}/navbars/${e}`;const d=document.getElementById("navbar-store-url");d&&(d.value=c),s=`${c}/load`;const v=document.getElementById("navbar-load-url");v&&(v.value=s);const k=document.getElementById("editor-title");k&&(k.textContent=`Editando Navbar: ${r}`);const w=`/navbars/edit/${e}/edit`,E=u?`${u}${w}`:w;window.history.replaceState({path:E},"",E)}else if(i){r=i;const g=document.getElementById("navbar-name");g&&(g.value=r);const l=document.getElementById("editor-title");l&&(l.textContent=`Editando Navbar: ${r}`)}}}});function J(t){t.Commands.add("canvas-clear",{run:e=>{H({title:"Limpiar canvas",description:"¿Estás seguro de que quieres eliminar todo el contenido del canvas? Esta acción no se puede deshacer.",icon:"ri-delete-bin-line",iconBg:"#fef2f2",iconColor:"#dc2626",confirmLabel:"Limpiar todo",confirmColor:"#dc2626",onConfirm:()=>{e.DomComponents.clear(),e.CssComposer.clear()}})}})}function h(t,e="info"){typeof window.showNotification=="function"&&window.showNotification(t,e)}
