...
.pb-curve svg{height:60px;}
...
</style>`;function $t(t,e){e=e||"pb"+Math.random().toString(36).slice(2,7);const i=t.bg_image||_("images/placeholder.svg"),a=Ie[t.theme]?t.theme:"blue",r=Ie[a],l=t.subtitle?`<p class="pb-subtitle">${t.subtitle}</p>`:"";return`<section id="pb-root-${e}" class="pb-section" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
        ...
        <div class="pb-content">
            <div class="pb-box">
                ...
                <div class="pb-box-inner">
                    <span class="pb-badge" style="background:${r.bg};color:${r.text};">${t.title||"Título del banner"}</span>
                    ${l}
                </div>
            </div>
        </div>
        <div class="pb-curve" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
            <svg viewBox="0 0 1440 320" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                <path fill="${r.bg}" d="M0,224L120,213.3C240,203,480,181,720,181.3C960,181,1200,203,1320,213.3L1440,224L1440,320L1320,320C1200,320,960,320,720,320C480,320,240,320,120,320L0,320Z"></path>
            </svg>
        </div>
