...
${Qt}`}],st=function(){(function(){function t(i){if(!i||i.__pcInit)return;i.__pcInit=!0;var a=i.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,o=0,n=!1,f=0,s=0,c=0,b=null;a.querySelectorAll("img").forEach(function(d){d.setAttribute("draggable","false")}),setTimeout(function(){var d=a.scrollWidth-a.clientWidth;if(d<=0)return;var x=Math.min(60,d),S=null;function v(j){S||(S=j);var q=(j-S)/400;if(q<.5)a.scrollLeft=x*(q*2);else if(q<1)a.scrollLeft=x*(1-(q-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(v)}requestAnimationFrame(v)},400),a.scrollLeft=0;function h(){return a.scrollWidth-a.clientWidth}function u(d){return Math.max(0,Math.min(d,h()))}function m(){Math.abs(f)<.5||(f*=.92,a.scrollLeft=u(a.scrollLeft+f),b=requestAnimationFrame(m))}a.addEventListener("mousedown",function(d){d.button===0&&(b&&(cancelAnimationFrame(b),b=null),r=!0,n=!1,f=0,l=d.clientX,s=d.clientX,c=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",d.preventDefault())}),document.addEventListener("mousemove",function(d){if(r){var x=l-d.clientX;Math.abs(x)>3&&(n=!0);var S=Date.now(),v=S-c||1;f=(d.clientX-s)/v*16*-1,s=d.clientX,c=S,a.scrollLeft=u(o+x)}}),document.addEventListener("mouseup",function(d){r&&(r=!1,a.style.cursor="grab",n&&(d.stopPropagation(),b=requestAnimationFrame(m)))}),a.addEventListener("click",function(d){n&&(d.preventDefault(),d.stopPropagation(),n=!1)},!0);var E=0,A=0,B=0,y=0,g=0;a.addEventListener("touchstart",function(d){b&&(cancelAnimationFrame(b),b=null),E=d.touches[0].clientX,B=d.touches[0].clientX,y=Date.now(),A=a.scrollLeft,g=0},{passive:!0}),a.addEventListener("touchmove",function(d){var x=Date.now(),S=x-y||1,v=d.touches[0].clientX;g=(v-B)/S*16*-1,B=v,y=x;var j=E-v;a.scrollLeft=u(A+j)},{passive:!0}),a.addEventListener("touchend",function(){b=requestAnimationFrame(function d(){Math.abs(g)<.5||(g*=.92,a.scrollLeft=u(a.scrollLeft+g),b=requestAnimationFrame(d))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(i){delete i.__pcInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},ai=`(${st.toString()})();`,ri=`
...
${ge}`},{id:"document-accordion-item",label:"Ítem de Acordeón",category:"Documentos",media:ui,content:`${je("Nombre de la sección",!1)}${ge}`}];function vi(t){const e="doc-download-button",i="doc-accordion-item";t.DomComponents.addType(e,{isComponent:a=>a.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Botón de Documento",tagName:"a",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,class:"dd-btn",href:"#"},components:`
                ...
                `,script:xi()},init(){this.set("type",i),this.addAttributes({"data-gjs-type":i})}}}),t.Commands.add("select-doc-download-file",{run(a){const r=a.getSelected();!r||r.get("type")!==e||$e({type:"document",title:"Seleccionar documento",onSelect:(l,o)=>{r.addAttributes({href:l});const n=r.find(".dd-btn-label")[0],f=o?.name||l.split("/").pop();n&&n.components(f)}})}}),wi(t,i)}function wi(t,e){t.on("storage:end:load",()=>{setTimeout(()=>Ne(t,e),800)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},400))}),t.on("component:clone",i=>{if(i.get("type")===e){const a=i.getEl();a&&(delete a.__ddAccBound,setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},400))}}),t.on("canvas:render",()=>{setTimeout(()=>Ne(t,e),600)})}function Ne(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}const dt=function(){(function(){function t(i){if(!i||i.__savInit)return;i.__savInit=!0;var a=i.querySelector(".sav-carousel-wrap");if(!a)return;a.scrollLeft=0;var r=!1,l=0,o=0,n=!1,f=0,s=0,c=0,b=null;a.querySelectorAll("img").forEach(function(d){d.setAttribute("draggable","false")}),setTimeout(function(){var d=a.scrollWidth-a.clientWidth;if(d<=0)return;var x=Math.min(60,d),S=null;function v(j){S||(S=j);var q=(j-S)/400;if(q<.5)a.scrollLeft=x*(q*2);else if(q<1)a.scrollLeft=x*(1-(q-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(v)}requestAnimationFrame(v)},400);function h(){return a.scrollWidth-a.clientWidth}function u(d){return Math.max(0,Math.min(d,h()))}function m(){Math.abs(f)<.5||(f*=.92,a.scrollLeft=u(a.scrollLeft+f),b=requestAnimationFrame(m))}a.addEventListener("mousedown",function(d){d.button===0&&(b&&(cancelAnimationFrame(b),b=null),r=!0,n=!1,f=0,l=d.clientX,s=d.clientX,c=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",d.preventDefault())}),document.addEventListener("mousemove",function(d){if(r){var x=l-d.clientX;Math.abs(x)>3&&(n=!0);var S=Date.now(),v=S-c||1;f=(d.clientX-s)/v*16*-1,s=d.clientX,c=S,a.scrollLeft=u(o+x)}}),document.addEventListener("mouseup",function(d){r&&(r=!1,a.style.cursor="grab",n&&(d.stopPropagation(),b=requestAnimationFrame(m)))}),a.addEventListener("click",function(d){n&&(d.preventDefault(),d.stopPropagation(),n=!1)},!0);var E=0,A=0,B=0,y=0,g=0;a.addEventListener("touchstart",function(d){b&&(cancelAnimationFrame(b),b=null),E=d.touches[0].clientX,B=d.touches[0].clientX,y=Date.now(),A=a.scrollLeft,g=0},{passive:!0}),a.addEventListener("touchmove",function(d){var x=Date.now(),S=x-y||1,v=d.touches[0].clientX;g=(v-B)/S*16*-1,B=v,y=x;var j=E-v;a.scrollLeft=u(A+j)},{passive:!0}),a.addEventListener("touchend",function(){b=requestAnimationFrame(function d(){Math.abs(g)<.5||(g*=.92,a.scrollLeft=u(a.scrollLeft+g),b=requestAnimationFrame(d))})},{passive:!0})}function e(){document.querySelectorAll(".sav-section").forEach(function(i){delete i.__savInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},ki=`(${dt.toString()})();`,Bi=`
...
`),n=Array.from({length:l},(f,s)=>`<div class="tabs-panel${s===0?" active":""} grid-cols-3 gap-5">
                            ${W()}
                            ${W()}
                            ${W()}
                            ${W()}
...
<\/script>`}],Ma=`<svg viewBox="0 0 32 32" width="32" height="32">
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
        ...
        </tr>`,t.headers?.length&&(a+="<tr>",t.headers.forEach((o,n)=>{const f=n<t.headers.length-1?`border-r border-[${i.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${i.subheaderBg} ${i.subheaderText} ${f} border-b border-[${i.borderColor}] text-${o.align||"center"}">${o.text||""}</th>`}),a+="</tr>"),a+="</thead>"):t.headers?.length&&(a+="<thead><tr>",t.headers.forEach((o,n)=>{const f=n<t.headers.length-1?`border-r border-[${i.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${i.headerBg} ${i.headerText} ${f} border-b border-[${i.borderColor}] text-${o.align||"center"}">${o.text||""}</th>`}),a+="</tr></thead>"),a+="<tbody>";const r=t.rows.length,l={};return t.rows.forEach((o,n)=>{a+="<tr>";let f=0;o.forEach(s=>{for(;l[`${n}-${f}`];)f++;const c=s.colspan||1,b=s.rowspan||1;for(let v=n;v<n+b;v++)for(let j=f;j<f+c;j++)(v!==n||j!==f)&&(l[`${v}-${j}`]=!0);const h=c>1?`colspan="${c}"`:"",u=b>1?`rowspan="${b}"`:"",m=s.isHeader?i.labelBg:n%2===0?i.rowEvenBg:i.rowOddBg,E=s.isHeader?"font-semibold":"font-normal",A=s.isHeader?i.labelText:i.rowText,B=`text-${s.align||"center"}`,y=n+b>=r,d=f+c>=t.cols?"":`border-r border-[${i.borderColor}]`,x=y?"":`border-b border-[${i.borderColor}]`,S=`${d} ${x} p-3 align-middle text-sm ${m} ${E} ${A} ${B}`;s.image?a+=`<td ${h} ${u} class="${S}">
                    <img src="${s.image}" alt="${s.text||""}" class="max-w-full max-h-20 h-auto object-contain block mx-auto">
                    ${s.text?`<span class="block mt-1 text-xs ${A}">${s.text}</span>`:""}
                </td>`:a+=`<td ${h} ${u} class="${S}">${s.text||""}</td>`,f+=c}),a+="</tr>"}),a+="</tbody></table>",a}function te(t,e){return{title:"Título de la tabla",cols:t,headers:Array.from({length:t},(i,a)=>({text:`Columna ${a+1}`,align:"center"})),rows:Array.from({length:e},()=>Array.from({length:t},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})))}}function ht(t,e){return`<div class="w-full overflow-x-auto rounded-2xl border-2 border-[${(Ee[e]||Ee.blue).borderColor}]">${t}</div>`}function Qe(t,e){const i={};return t.forEach((a,r)=>{let l=0;a.forEach(o=>{for(;i[`${r}-${l}`];)l++;const n=Math.min(o.colspan||1,e-l),f=o.rowspan||1;for(let s=r;s<r+f;s++)for(let c=l;c<l+n;c++)(s!==r||c!==l)&&(i[`${s}-${c}`]=`${r}-${l}`);l+=n})}),i}const Da=`
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function Na(){if(document.getElementById("tam-img-modal"))return;const t=document.createElement("div");t.id="tam-img-modal",t.innerHTML=`
        ...
        <div class="tam-container">
        ...
        </div>`,document.body.appendChild(a);let r=null,l=null;function o(h){r=h;const u=h.get("tableData");l=u?JSON.parse(JSON.stringify(u)):te(3,3);const m=l.cols||3;l.rows=l.rows.map((E,A)=>Array.from({length:m},(y,g)=>E[g]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})),document.getElementById("tam-title").value=l.title||"",document.getElementById("tam-theme").value=h.get("tableTheme")||"blue",document.getElementById("tam-cols").value=l.cols||3,document.getElementById("tam-rows").value=l.rows.length||3,c(),b(),a.classList.add("open"),document.body.style.overflow="hidden"}function n(){a.classList.remove("open"),document.body.style.overflow="",r=null}function f(){l.title=document.getElementById("tam-title").value.trim(),l.cols=parseInt(document.getElementById("tam-cols").value)||3,l.headers=Array.from(document.querySelectorAll(".tam-header-input")).map(u=>({text:u.value,align:u.closest("th")?.querySelector(".tam-align-select")?.value||"center"})),document.querySelectorAll("#tam-tbody td.tam-cell:not(.is-spanned)").forEach(u=>{const m=parseInt(u.dataset.row),E=parseInt(u.dataset.col);l.rows[m]?.[E]&&(l.rows[m][E].text=u.querySelector(".tam-cell-input")?.value||"",l.rows[m][E].align=u.querySelector(".tam-align-select")?.value||"center",l.rows[m][E].isHeader=u.dataset.isheader==="1",l.rows[m][E].image=u.dataset.image||null)});const h=Qe(l.rows,l.cols);l.rows=l.rows.map((u,m)=>u.filter((E,A)=>!h[`${m}-${A}`]))}function s(){if(a.querySelector("#tam-rebuild-notice"))return;const u=document.createElement("div");u.id="tam-rebuild-notice",u.style.cssText="background:#fef9c3;border:1.5px solid #ca8a04;border-radius:0.5rem;padding:0.5rem 1rem;font-size:0.8rem;color:#92400e;display:flex;align-items:center;gap:0.5rem;margin:0 1.5rem 0;flex-shrink:0;",u.innerHTML='<i class="ri-error-warning-line"></i> Has modificado el colspan/rowspan. Haz clic en <strong style="margin:0 4px;">Reconstruir</strong> para aplicar los cambios de fusión.',a.querySelector(".tam-toolbar").after(u)}function c(){a.querySelector("#tam-rebuild-notice")?.remove()}function b(){const h=document.getElementById("tam-thead"),u=document.getElementById("tam-tbody"),m=l.cols,E=l.rows.length,A=Qe(l.rows,m);h.innerHTML=`<tr>${l.headers.map((B,y)=>`
            <th>
                <input class="tam-cell-input tam-header-input" value="${B.text||""}" placeholder="Col ${y+1}" style="font-weight:600;">
                <select class="tam-align-select" style="margin-top:4px;width:100%;font-size:0.7rem;padding:2px;">
            ...
            </th>`).join("")}</tr>`,u.innerHTML=l.rows.map((B,y)=>`<tr>${Array.from({length:m},(d,x)=>{const S=A[`${y}-${x}`];if(S)return`<td class="tam-cell is-spanned" data-row="${y}" data-col="${x}">
                        <div class="tam-spanned-label">Combinada con [${S}]</div>
                    </td>`;const v=B[x]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null},j=v.colspan||1,q=v.rowspan||1,_=j>1||q>1;return`<td class="tam-cell ${v.isHeader?"is-header-cell":""} ${v.image?"has-image":""} ${_?"has-span":""}"
                    ...
                    <div class="tam-cell-actions">
                        <button type="button" class="tam-cell-btn tam-cell-btn-header ${v.isHeader?"active":""}"
                            data-action="header" data-row="${y}" data-col="${x}">
                            ${v.isHeader?"✓ Etiqueta":"Etiqueta"}
                        </button>
                        <button type="button" class="tam-cell-btn tam-cell-btn-img"
                            data-action="image" data-row="${y}" data-col="${x}">
                            <i class="ri-image-line"></i> ${v.image?"Cambiar":"Imagen"}
                        </button>
                        ${v.image?`<button type="button" class="tam-cell-btn tam-cell-btn-clear" data-action="clear-image" data-row="${y}" data-col="${x}">✕ Quitar</button>`:""}
                        <div class="tam-cell-span-group">
                            ...
                            <input type="number" class="tam-cell-span-input" min="1" max="${m-x}"
                                value="${j}" data-action="colspan" data-row="${y}" data-col="${x}">
                            <label title="Filas que ocupa">RS</label>
                            <input type="number" class="tam-cell-span-input" min="1" max="${E-y}"
                                value="${q}" data-action="rowspan" data-row="${y}" data-col="${x}">
                        </div>
                    </div>
                </td>`}).join("")}</tr>`).join(""),u.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(B=>{B.addEventListener("change",()=>{const y=parseInt(B.dataset.row),g=parseInt(B.dataset.col),d=Math.max(1,parseInt(B.value)||1);l.rows[y]?.[g]&&(B.dataset.action==="colspan"?l.rows[y][g].colspan=Math.min(d,m-g):l.rows[y][g].rowspan=Math.min(d,E-y),s())})}),u.querySelectorAll("button[data-action]").forEach(B=>{B.addEventListener("click",y=>{y.preventDefault(),y.stopPropagation();const g=B.dataset.action,d=parseInt(B.dataset.row),x=parseInt(B.dataset.col);if(!(isNaN(d)||isNaN(x)||!l.rows[d]?.[x])){if(g==="header"){l.rows[d][x].isHeader=!l.rows[d][x].isHeader;const S=u.querySelector(`td[data-row="${d}"][data-col="${x}"]`);S&&(S.dataset.isheader=l.rows[d][x].isHeader?"1":"0",S.classList.toggle("is-header-cell",l.rows[d][x].isHeader)),B.classList.toggle("active",l.rows[d][x].isHeader),B.textContent=l.rows[d][x].isHeader?"✓ Etiqueta":"Etiqueta";return}if(g==="image"){window.__openTableImagePicker&&window.__openTableImagePicker(S=>{l.rows[d][x].image=S;const v=u.querySelector(`td[data-row="${d}"][data-col="${x}"]`);if(v){v.dataset.image=S,v.classList.add("has-image");let j=v.querySelector(".tam-cell-img-preview");j||(j=document.createElement("img"),j.className="tam-cell-img-preview",v.insertBefore(j,v.firstChild)),j.src=S;const q=v.querySelector("[data-action=image]");if(q&&(q.innerHTML='<i class="ri-image-line"></i> Cambiar'),!v.querySelector("[data-action=clear-image]")){const _=document.createElement("button");_.type="button",_.className="tam-cell-btn tam-cell-btn-clear",_.dataset.action="clear-image",_.dataset.row=d,_.dataset.col=x,_.textContent="✕ Quitar",_.addEventListener("click",D=>{D.preventDefault(),D.stopPropagation(),l.rows[d][x].image=null,v.dataset.image="",v.classList.remove("has-image"),j.remove(),_.remove();const M=v.querySelector("[data-action=image]");M&&(M.innerHTML='<i class="ri-image-line"></i> Imagen')}),v.querySelector(".tam-cell-actions").appendChild(_)}}});return}g==="clear-image"&&(l.rows[d][x].image=null,b())}})})}document.getElementById("tam-close").addEventListener("click",n),document.getElementById("tam-cancel").addEventListener("click",n),a.addEventListener("click",h=>{h.target===a&&n()}),document.getElementById("tam-rebuild").addEventListener("click",()=>{const h=parseInt(document.getElementById("tam-cols").value)||3,u=parseInt(document.getElementById("tam-rows").value)||3;for(c(),f();l.headers.length<h;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,h),l.cols=h;l.rows.length<u;)l.rows.push(Array.from({length:h},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,u).map(m=>{for(;m.length<h;)m.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return m.slice(0,h)}),b()}),document.getElementById("tam-apply").addEventListener("click",()=>{f();const h=document.getElementById("tam-theme").value;r&&(r.set("tableData",JSON.parse(JSON.stringify(l))),r.set("tableTheme",h),r.addAttributes({"data-table-theme":h}),ze(r)),n()}),window.__openTableAdminModal=o}function ze(t){const e=t.get("tableData"),i=t.get("tableTheme")||"blue";e&&t.components(ht(pt(e,i),i))}function Pa(){return function(){}}const Ra=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:Ma,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<a href="#"
   ...
   class="dld-simple-${e}">
    ...
    <rect x="3" y="25" width="7" height="2.5" fill="#dee2e6" rx="0.5"/>
</svg>`;function sr(){return function(){const t=this,e="agencies-map-component",i="/api/agencies/active",a="agencies";let r=[],l=[],o={},n=null,f=[];const s=async()=>{try{c(),await h(),await E(),A(),S(),_(),D(),b()}catch(p){console.error("Error initializing map:",p),V("Error al cargar las agencias"),b()}};function c(){const p=t.querySelector(`.${e}-list`);p&&(p.innerHTML=`
                ...
                `);const w=t.querySelector(`.${e}-map-container`);w&&(w.style.opacity="0.5")}function b(){const p=t.querySelector(`.${e}-map-container`);p&&(p.style.transition="opacity 0.3s ease",p.style.opacity="1")}async function h(){try{const w=await(await fetch(i)).json(),$=a?w[a]:w;Array.isArray($)?(r=$.filter(T=>T.latitude&&T.longitude&&!isNaN(T.latitude)&&!isNaN(T.longitude)),l=[...r],u()):(r=[],l=[])}catch(p){console.error("Error loading items:",p),r=[],l=[]}}function u(){const p=[...new Set(r.map($=>$.zone).filter(Boolean))].sort(),w=[...new Set(r.map($=>$.department).filter(Boolean))].sort();o={zone:p,department:w},setTimeout(()=>{const $=t.querySelector(`.${e}-filters-container`);$&&!$.hasChildNodes()&&($.innerHTML=`
                    ...
                    `,m())},100)}function m(){const p=t.querySelector(`.${e}-zone-filter`),w=t.querySelector(`.${e}-department-filter`);p&&o.zone&&o.zone.forEach($=>{const T=document.createElement("option");T.value=$,T.textContent=$,p.appendChild(T)}),w&&o.department&&o.department.forEach($=>{const T=document.createElement("option");T.value=$,T.textContent=$,w.appendChild(T)})}async function E(){if(!document.getElementById("leaflet-css")){const p=document.createElement("link");p.id="leaflet-css",p.rel="stylesheet",p.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",document.head.appendChild(p)}if(typeof window.L>"u"&&await new Promise((p,w)=>{const $=document.createElement("script");$.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",$.onload=p,$.onerror=w,document.head.appendChild($)}),typeof window.L<"u"&&window.L.Icon&&window.L.Icon.Default){const p=window.L.icon({iconUrl:"data:image/svg+xml;base64,"+btoa(`
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 36" width="24" height="36">
                            <path fill="#f0872a" d="M12 0C7.6 0 4 3.6 4 8c0 5.4 8 16 8 16s8-10.6 8-16c0-4.4-3.6-8-8-8z"/>
                            <circle cx="12" cy="8" r="3" fill="#fff"/>
                        </svg>
                    `),iconSize:[30,45],iconAnchor:[15,45],popupAnchor:[0,-45]});window.customOrangeIcon=p}}function A(){const p=t.querySelector(`.${e}-map`);if(!p||!window.L)return;p._leaflet_id&&p._map&&(p._map.remove(),delete p._map),n=window.L.map(p).setView([13.7942,-88.8965],8),window.L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(n),p._map=n,n.whenReady(function(){B(),setTimeout(()=>{n&&n.invalidateSize&&n.invalidateSize()},300)})}function B(){y(),g(),x()}function y(){f.forEach(p=>{p.marker&&n.removeLayer(p.marker)}),f=[]}function g(){l.forEach((p,w)=>{if(p.latitude&&p.longitude){const $=d(p),T=window.L.marker([p.latitude,p.longitude],{icon:window.customOrangeIcon||new window.L.Icon.Default}).addTo(n).bindPopup($);f.push({marker:T,item:p,index:w})}})}function d(p){let w=`<div style="min-width: 200px;"><h4 style="font-weight: 700; margin-bottom: 12px; color: #0d3f6a; font-size: 16px; border-bottom: 2px solid #f0872a; padding-bottom: 8px;">${p.name}</h4>`;if(p.address&&(w+=`<p style="margin: 8px 0 0 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-map-pin-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${p.address}</span></p>`),p.municipality||p.department){const $=[p.municipality,p.department].filter(Boolean).join(", ");w+=`<p style="margin: 0 0 8px 0; font-size: 13px; color: #6b7280; padding-left: 24px;">${$}</p>`}return p.schedule&&(w+=`<p style="margin: 8px 0; font-size: 14px; display: flex; align-items: start; gap: 8px;"><i class="ri-time-line" style="color: #f0872a; font-size: 16px; margin-top: 2px;"></i><span style="color: #4b5563;">${p.schedule}</span></p>`),w+="</div>",w}function x(){if(l.length>0){const p=l.filter(w=>w.latitude&&w.longitude).map(w=>[w.latitude,w.longitude]);p.length>1?n.once("moveend",function(){setTimeout(()=>{try{n&&n._loaded&&typeof n.fitBounds=="function"&&n.fitBounds(p,{padding:[50,50],maxZoom:12,animate:!1})}catch(w){console.warn("Error fitting bounds:",w)}},100)}):p.length===1&&n.setView(p[0],14)}}function S(){const p=t.querySelector(`.${e}-list`);if(!p)return;if(l.length===0){j(p);return}const w=l.map(($,T)=>v($,T)).join("");p.innerHTML=w,q()}function v(p,w){const $=p.phones&&p.phones.length>0?p.phones.map(k=>`
            ...
            `}function q(){const p=t.querySelectorAll(`.${e}-item`);p.forEach(w=>{w.addEventListener("click",$=>{if($.target.closest(".agency-maps-btn"))return;$.preventDefault();const T=parseInt(w.dataset.itemIndex),k=l[T];if(!k)return;p.forEach(L=>{L.classList.remove("bg-white","border-secondary","selected-agency"),L.classList.add("bg-white/10","border-white/20");const U=L.querySelector(".agency-title"),pe=L.querySelectorAll("i"),he=L.querySelectorAll(".agency-phone-link"),Se=L.querySelectorAll("p:not(:has(.agency-phone-link))"),Le=L.querySelector(".agency-maps-btn");U&&(U.classList.remove("text-secondary"),U.classList.add("text-white")),pe.forEach(Z=>{Z.classList.remove("text-secondary","text-gray-300","text-white"),Z.classList.add("text-primary")}),he.forEach(Z=>{Z.classList.remove("text-secondary"),Z.classList.add("text-white")}),Se.forEach(Z=>{Z.classList.remove("text-secondary"),Z.classList.add("text-gray-200")}),Le&&(Le.classList.remove("bg-secondary"),Le.classList.add("bg-primary"))}),w.classList.remove("bg-white/10","border-white/20"),w.classList.add("bg-white","border-secondary","selected-agency");const z=w.querySelector(".agency-title"),X=w.querySelectorAll("i"),O=w.querySelectorAll(".agency-phone-link"),R=w.querySelectorAll("p:not(:has(.agency-phone-link))"),H=w.querySelector(".agency-maps-btn");if(z&&(z.classList.remove("text-white"),z.classList.add("text-secondary")),X.forEach(L=>{L.classList.remove("text-secondary","text-gray-300","text-white"),L.classList.add("text-primary")}),O.forEach(L=>{L.classList.remove("text-white"),L.classList.add("text-secondary")}),R.forEach(L=>{L.classList.remove("text-gray-200"),L.classList.add("text-secondary")}),H&&(H.classList.remove("bg-primary"),H.classList.add("bg-secondary")),n&&k&&n._loaded)try{n.flyTo([k.latitude,k.longitude],14,{animate:!0,duration:1});const L=f.find(U=>U.item.id===k.id);L&&L.marker&&L.marker.openPopup()}catch(L){console.warn("Error updating map view:",L)}})})}function _(){const p=t.querySelector(`.${e}-search-input`),w=t.querySelector(`.${e}-zone-filter`),$=t.querySelector(`.${e}-department-filter`),T=t.querySelector(`.${e}-no-results`),k={Occidental:["Ahuachapán","Santa Ana","Sonsonate"],Paracentral:["Chalatenango","Cuscatlán","La Paz","Cabañas","San Vicente"],Central:["La Libertad","San Salvador"],Oriental:["Usulután","San Miguel","Morazán","La Unión"]},z=()=>{if(!w||!$)return;const O=w.value,R=$.value;if(!O)$.innerHTML='<option value="">Todos los Departamentos</option>',[...new Set(r.map(L=>L.department).filter(Boolean))].sort().forEach(L=>{const U=document.createElement("option");U.value=L,U.textContent=L,$.appendChild(U)}),R&&($.value=R);else{const H=k[O]||[];$.innerHTML='<option value="">Todos los Departamentos</option>',H.forEach(L=>{const U=document.createElement("option");U.value=L,U.textContent=L,$.appendChild(U)}),H.includes(R)&&($.value=R)}},X=()=>{const O=p?p.value.toLowerCase().trim():"",R=w?w.value:"",H=$?$.value:"";l=r.filter(L=>{let U=!0,pe=!0,he=!0;return O&&(U=Object.values(L).some(Se=>String(Se).toLowerCase().includes(O))),R&&(pe=L.zone===R),H&&(he=L.department===H),U&&pe&&he}),S(),B(),T&&T.classList.toggle("hidden",l.length>0)};p&&p.addEventListener("input",X),w&&w.addEventListener("change",()=>{z(),X()}),$&&$.addEventListener("change",X)}function D(){const p=t.querySelector("[data-title]");if(p){const T=M("map-title")||"Nuestras Agencias";p.textContent=T}const w=t.querySelector(`.${e}-search-input`);if(w){const T=M("search-placeholder")||"Buscar...";w.setAttribute("placeholder",T)}const $=t.querySelector(`.${e}-no-results`);if($){const T=M("no-results-text")||"No se encontraron agencias";$.textContent=T}}function M(p){return t.closest(`[data-gjs-type="${e}"]`)?.getAttribute(p)}function V(p){const w=t.querySelector(`.${e}-list`);w&&(w.innerHTML=`
                    <div class="flex flex-col items-center justify-center p-12 text-center">
...
.mp-map-wrapper{height:320px;}
        ...
        `,document.head.appendChild(h)}const a=(()=>{try{return JSON.parse(e.getAttributes()["data-map-config"]||"{}")}catch{return{}}})(),r=a.title||fe.title,l=a.stats_text||fe.stats_text,o=JSON.parse(JSON.stringify(a.filters||fe.filters)),n=document.createElement("div");n.id="map-filter-config-modal",n.className="mp-overlay-modal";const f=document.createElement("div");f.className="mp-modal",f.innerHTML=`
        ...
        </div>`,n.appendChild(f),document.body.appendChild(n),f.querySelectorAll(".mp-tab-btn").forEach(h=>{h.addEventListener("click",()=>{f.querySelectorAll(".mp-tab-btn").forEach(u=>u.classList.remove("active")),f.querySelectorAll(".mp-tab-panel").forEach(u=>u.classList.remove("active")),h.classList.add("active"),f.querySelector(`#mp-panel-${h.dataset.tab}`).classList.add("active")})});const s=f.querySelector("#mp-filters-list");function c(){s.innerHTML="",o.forEach((h,u)=>{const m=document.createElement("div");m.className="mp-filter-card",m.innerHTML=`
...
@media(max-width:768px){.bsk-buttons{flex-direction:column;}}`;function Er(){return function(){const t=this,e=t.ownerDocument??document,i="/adminintegral",a=(e.defaultView??window).location.origin,r=e.querySelector('meta[name="api-banners-url"]')?.content||`${a}${i}/api/banners/active`,l=["fill-blue","outline-blue","fill-orange","outline-orange","fill-white","outline-white"],o=".banner-wrapper{position:relative;width:100%;background:#003B71;overflow:hidden;}.banner-slide-container{position:relative;width:100%;user-select:none;cursor:grab;display:grid;}.banner-slide-container:active{cursor:grabbing;}.banner-slide{grid-area:1/1;opacity:0;pointer-events:none;transition:opacity 0.7s ease;visibility:hidden;display:flex;flex-direction:column;}.banner-slide.banner-slide--active{opacity:1;pointer-events:auto;visibility:visible;}.banner-slide-inner{position:relative;width:100%;flex:1;min-height:480px;display:flex;align-items:center;}.banner-bg{position:absolute;inset:0;z-index:0;}.banner-bg img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;}.banner-overlay{position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,59,113,0.85) 0%,rgba(0,59,113,0.65) 50%,rgba(0,59,113,0.2) 100%);z-index:1;}.banner-content{position:relative;z-index:10;display:flex;flex-direction:column;justify-content:center;padding:64px 64px 96px;max-width:60%;}.banner-category-badge{display:inline-block;margin-bottom:18px;padding:7px 20px;border-radius:999px;border:2px solid rgba(255,255,255,0.65);color:#fff;font-size:13px;font-weight:500;letter-spacing:0.04em;align-self:flex-start;}.banner-title{font-size:clamp(1.8rem,3.2vw,3rem);font-weight:800;color:#fff;line-height:1.15;margin:0 0 20px;}.banner-description{color:rgba(255,255,255,0.9);font-size:clamp(0.95rem,1.4vw,1.1rem);line-height:1.7;margin:0 0 36px;max-width:520px;}.banner-buttons{display:flex;flex-wrap:wrap;gap:16px;align-items:center;}.banner-btn{display:inline-block;padding:12px 32px;border-radius:999px;font-size:15px;font-weight:600;cursor:pointer;transition:background .2s,color .2s,border-color .2s;text-decoration:none;white-space:nowrap;line-height:1.4;box-sizing:border-box;}.banner-btn--fill-blue{background:#003B71;color:#ffffff;border:2px solid #003B71;}.banner-btn--fill-blue:hover{background:#002a52;border-color:#002a52;color:#ffffff;}.banner-btn--outline-blue{background:transparent;color:#003B71;border:2px solid #003B71;}.banner-btn--outline-blue:hover{background:#003B71;border-color:#003B71;color:#ffffff;}.banner-btn--fill-orange{background:#E97300;color:#ffffff;border:2px solid #E97300;}.banner-btn--fill-orange:hover{background:#c96200;border-color:#c96200;color:#ffffff;}.banner-btn--outline-orange{background:transparent;color:#E97300;border:2px solid #E97300;}.banner-btn--outline-orange:hover{background:#E97300;border-color:#E97300;color:#ffffff;}.banner-btn--fill-white{background:#ffffff;color:#003B71;border:2px solid #ffffff;}.banner-btn--fill-white:hover{background:#dce8f5;border-color:#dce8f5;color:#003B71;}.banner-btn--outline-white{background:transparent;color:#ffffff;border:2px solid #ffffff;}.banner-btn--outline-white:hover{background:#ffffff;border-color:#ffffff;color:#003B71;}.banner-dots-wrapper{display:none;}.banner-stripe{position:relative;width:100%;height:26px;background:#E97300;z-index:20;display:flex;align-items:center;justify-content:center;}.banner-dots{display:flex;gap:8px;align-items:center;}.banner-dot{width:10px;height:10px;border-radius:999px;border:none;cursor:pointer;background:rgba(255,255,255,0.5);transition:all 0.3s ease;padding:0;flex-shrink:0;}.banner-dot--active{width:28px;background:#ffffff;}.banner-empty{display:flex;align-items:center;justify-content:center;min-height:480px;color:rgba(255,255,255,0.5);font-size:14px;padding:40px;}@media(max-width:768px){.banner-slide-inner{min-height:340px;}.banner-bg img{object-position:right center;}.banner-content{max-width:100%;width:100%;padding:32px 24px 80px;}.banner-buttons{flex-wrap:wrap;gap:12px;}.banner-btn{flex:1 1 45%;min-width:140px;text-align:center;white-space:normal;word-break:break-word;}}@media(max-width:480px){.banner-btn{flex:1 1 100%;min-width:0;}}",n="@keyframes bsk-shimmer{0%{background-position:-600px 0}100%{background-position:600px 0}}.bsk-badge{width:120px;height:32px;margin-bottom:20px;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title{height:40px;margin-bottom:12px;border-radius:8px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title--short{width:60%;}.bsk-line{height:16px;margin-bottom:10px;border-radius:6px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-line--short{width:55%;}.bsk-buttons{display:flex;gap:16px;margin-top:36px;}.bsk-btn{height:48px;flex:1;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-bg-img{background:linear-gradient(90deg,rgba(255,255,255,0.04) 25%,rgba(255,255,255,0.09) 50%,rgba(255,255,255,0.04) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}@media(max-width:768px){.bsk-buttons{flex-direction:column;}}";(function(){if(!e.getElementById("banner-hero-styles")){const z=e.createElement("style");z.id="banner-hero-styles",z.textContent=o,e.head.appendChild(z)}if(!e.getElementById("banner-skeleton-styles")){const z=e.createElement("style");z.id="banner-skeleton-styles",z.textContent=n,e.head.appendChild(z)}})();let f=[],s=0,c=null,b=!1,h=0,u=0;const m=50,E=t.dataset.autoplay!=="false",A=t.dataset.category??"",B=t.querySelector(".banner-slide-container"),y=t.querySelector(".banner-stripe");if(!B||!y)return;function g(k){return l.indexOf(k)!==-1?k:k==="outline-blue"||k==="outline-orange"?"outline-white":"fill-white"}function d(k,z,X,O){const R=g(X),H=z?"a":"span",L=z?`href="${z}"${O?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${H} ${L} class="banner-btn banner-btn--${R}">${k}</${H}>`}async function x(){if(!t.__bannerLoading){t.__bannerLoading=!0,S();try{const k=await fetch(r,{headers:{Accept:"application/json"}});if(!k.ok){T();return}const z=await k.json();if(f=Array.isArray(z)?A?z.filter(X=>X.category===A):z:[],f.length===0){T();return}v(),V(),p(0,!1),E&&w()}catch{T()}finally{t.__bannerLoading=!1}}}function S(){B.innerHTML=`
                ...
                </div>`,y.innerHTML=""}function v(){B.innerHTML=f.map((k,z)=>`
                    ...
                    <div class="banner-slide-inner">
                        ...
                        <div class="banner-content">
                            ...
                            ${k.btn_primary_text||k.btn_secondary_text?`<div class="banner-buttons">
                                    ${k.btn_primary_text?d(k.btn_primary_text,k.btn_primary_url,k.btn_primary_style,k.btn_primary_external):""}
                                    ${k.btn_secondary_text?d(k.btn_secondary_text,k.btn_secondary_url,k.btn_secondary_style,k.btn_secondary_external):""}
                                </div>`:""}
                        </div>
                    </div>
                </div>`).join(""),j(),q()}function j(){B.addEventListener("mousedown",_),B.addEventListener("touchstart",_,{passive:!0}),B.addEventListener("mousemove",D),B.addEventListener("touchmove",D,{passive:!0}),B.addEventListener("mouseup",M),B.addEventListener("touchend",M),B.addEventListener("mouseleave",M)}function q(){f.forEach(k=>{const z=new Image;z.src=k.image_url})}function _(k){b=!0,h=k.touches?k.touches[0].clientX:k.clientX,u=0}function D(k){b&&(u=(k.touches?k.touches[0].clientX:k.clientX)-h)}function M(){b&&(b=!1,Math.abs(u)>=m&&(p(u<0?(s+1)%f.length:(s-1+f.length)%f.length),$()),u=0)}function V(){if(f.length<=1){y.innerHTML="";return}const k=e.createElement("div");k.className="banner-dots",f.forEach((z,X)=>{const O=e.createElement("button");O.className="banner-dot",O.type="button",O.dataset.index=String(X),O.setAttribute("aria-label",`Banner ${X+1}`),O.addEventListener("click",()=>{p(X),$()}),k.appendChild(O)}),y.innerHTML="",y.appendChild(k)}function p(k,z=!0){const X=B.querySelectorAll(".banner-slide"),O=t.querySelectorAll(".banner-dot");X.forEach((R,H)=>{const L=H===k;z||(R.style.transition="none"),R.classList.toggle("banner-slide--active",L),z||requestAnimationFrame(()=>{R.style.transition=""})}),O.forEach((R,H)=>R.classList.toggle("banner-dot--active",H===k)),s=k}function w(){f.length<=1||!E||(c=setInterval(()=>p((s+1)%f.length),5e3))}function $(){E&&(clearInterval(c),w())}function T(){clearInterval(c),B.innerHTML=`
                <div class="banner-slide banner-slide--active">
                    <div class="banner-empty">Sin contenido.</div>
                </div>`,y.innerHTML=""}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",x):x()}}function $r(t,e){const i=document.getElementById("banner-hero-config-modal");if(i&&i.remove(),!document.getElementById("bnr-modal-styles")){const m=document.createElement("style");m.id="bnr-modal-styles",m.textContent=`
        ...
        </div>`,o.appendChild(n),document.body.appendChild(o);const f=n.querySelector("#bnr-autoplay"),s=n.querySelector("#bnr-autoplay-slider"),c=n.querySelector("#bnr-autoplay-knob"),b=()=>{s.style.background=f.checked?"#003B71":"#cbd5e1",c.style.left=f.checked?"21px":"3px"};b(),f.addEventListener("change",b);const h=n.querySelector("#bnr-category");(async()=>{try{const E=document.querySelector('meta[name="api-banners-url"]')?.content||`${window.location.origin}/adminintegral/api/banners/active`,A=await fetch(E,{headers:{Accept:"application/json"}});if(!A.ok)return;const B=await A.json();if(!Array.isArray(B))return;[...new Set(B.map(g=>g.category).filter(Boolean))].sort().forEach(g=>{const d=document.createElement("option");d.value=g,d.textContent=g,h.appendChild(d)}),h.value=l}catch{}})();const u=()=>o.remove();n.querySelector("#bnr-modal-close").onclick=u,n.querySelector("#bnr-modal-cancel").onclick=u,o.onclick=m=>{m.target===o&&u()},n.querySelector("#bnr-modal-save").onclick=()=>{e.addAttributes({"data-autoplay":f.checked?"true":"false","data-category":h.value||""}),u()}}const Sr=[{id:"banner-hero",label:"Banner Slider",category:"Banners",media:wr,content:{type:"banner-hero-component"}}];function Lr(t){const e="banner-hero-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner Slider",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-autoplay":"true","data-category":""},components:`
...
`;function zr(){return function(){const t=this,e=t.ownerDocument??document,i="/adminintegral",a=(e.defaultView??window).location.origin,r=e.querySelector('meta[name="api-assets-url"]')?.content||`${a}${i}/api/assets/active`,l=`
.ast-section {
    width: 100%;
    background: #ffffff;
    padding: 3rem 4rem;
...
`;if(!e.getElementById("assets-block-styles")){const y=e.createElement("style");y.id="assets-block-styles",y.textContent=l,e.head.appendChild(y)}const o=t.querySelector("[data-ast-tabs]"),n=t.querySelector("[data-ast-content]");if(!o||!n)return;const f=t.dataset.defaultCategory||"";let s=[],c="";function b(y,g){return y?y.length>g?`${y.slice(0,g).trim()}...`:y:""}function h(y){const g=y.link_is_external?' target="_blank" rel="noopener noreferrer"':"",d=y.name||b(y.short_description,60),x=y.name||y.short_description||"Activo extraordinario";return`<a href="${y.link_url}"${g} class="ast-card">
                <img src="${y.image_url}" alt="${x}" class="ast-card-img" loading="lazy">
                <div class="ast-card-body">
                    <p class="ast-card-name">${d}</p>
                    ${y.name&&y.short_description?`<p class="ast-card-desc">${y.short_description}</p>`:""}
                </div>
            </a>`}function u(){const y=[],g=new Set;return s.forEach(d=>{g.has(d.category_slug)||(g.add(d.category_slug),y.push({slug:d.category_slug,name:d.category}))}),y}function m(y,g){const d=g.length?g.map(h).join(""):'<div class="ast-empty">No hay activos extraordinarios disponibles en esta categoría.</div>';return`<div class="ast-group">
                <p class="ast-subtitle">${y}</p>
                <div class="ast-subtitle-stripe"></div>
                <div class="ast-grid">${d}</div>
            </div>`}function E(){if(c){const g=s.filter(x=>x.category_slug===c),d=g[0]?.category||u().find(x=>x.slug===c)?.name||"";n.innerHTML=m(d,g);return}const y=u();n.innerHTML=y.map(g=>m(g.name,s.filter(d=>d.category_slug===g.slug))).join("")}function A(){const g=['<button type="button" class="ast-tab ast-tab--active" data-tab-slug="">Todos</button>',...u().map(d=>`<button type="button" class="ast-tab" data-tab-slug="${d.slug}">${d.name}</button>`)].join("");if(o.innerHTML=g,o.querySelectorAll("[data-tab-slug]").forEach(d=>{d.addEventListener("click",()=>{o.querySelectorAll(".ast-tab").forEach(x=>x.classList.remove("ast-tab--active")),d.classList.add("ast-tab--active"),c=d.dataset.tabSlug,E()})}),f){const d=o.querySelector(`[data-tab-slug="${f}"]`);d&&d.click()}}async function B(){n.innerHTML='<div class="ast-empty">Cargando activos extraordinarios...</div>';try{const y=await fetch(r,{headers:{Accept:"application/json"}});if(!y.ok){n.innerHTML='<div class="ast-empty">No se pudieron cargar los activos extraordinarios.</div>';return}if(s=await y.json(),!Array.isArray(s)||s.length===0){o.innerHTML='<button type="button" class="ast-tab ast-tab--active">Todos</button>',n.innerHTML='<div class="ast-empty">No hay activos extraordinarios disponibles.</div>';return}A(),E()}catch{n.innerHTML='<div class="ast-empty">No se pudieron cargar los activos extraordinarios.</div>'}}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",B):B()}}const Ar=[{id:"assets-catalog",label:"Catálogo de Activos Extraordinarios",category:"Interactivos",media:_r,content:{type:"assets-catalog-component"}}];function Ir(t){const e="assets-catalog-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Catálogo de Activos Extraordinarios",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-default-category":"",class:"ast-section"},components:`
                ...
                `,script:zr(),toolbar:[],traits:[{type:"text",name:"data-default-category",label:"Categoría inicial (slug)",placeholder:"Déjalo vacío para mostrar 'Todos'"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",()=>{const i=this.getEl();if(!i)return;const a=this.get("script");a&&typeof a=="function"&&setTimeout(()=>a.call(i),100)})}}}),qr(t,e),Mr(t,e)}function qr(t,e){t.on("storage:end:load",()=>{setTimeout(()=>ot(t,e),1e3)}),t.on("component:mount",i=>{const a=i.getEl();a?.getAttribute?.("data-gjs-type")===e&&(i.set("type",e),setTimeout(()=>{const r=i.get("script");r&&typeof r=="function"&&r.call(a)},500))}),t.on("canvas:render",()=>{setTimeout(()=>ot(t,e),800)}),t.on("storage:start:store",()=>{t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e),i.addAttributes({"data-gjs-type":e})})})}function ot(t,e){t.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(i=>{i.set("type",e);const a=i.getEl();if(a?.isConnected){const r=i.get("script");r&&typeof r=="function"&&r.call(a)}})}function Mr(t,e){t.on("load",()=>{const i=t.Canvas.getFrameEl();if(!i)return;const a=i.contentDocument?.head;if(a){if(!a.querySelector("#assets-block-styles")){const r=document.createElement("style");r.id="assets-block-styles",r.textContent=Tr,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=`[data-gjs-type="${e}"] * { pointer-events: none !important; } [data-gjs-type="${e}"].gjs-selected, [data-gjs-type="${e}"].gjs-hovered { outline: 2px dashed rgba(240,135,42,0.6) !important; outline-offset: 2px; }`,a.appendChild(r)}}})}const Dr="/bancaintegral",mt=`
<style>
...
.hb-btn{width:100%;text-align:center;}
...
</style>`;function bt(t,e){e=e||"hb"+Math.random().toString(36).slice(2,7);const i=t.bg_image||P("images/placeholder.svg"),a=t.btn_primary||{},r=t.btn_secondary||{},l=a.color||"white",o=r.color||"white",n=a.enabled?`<a href="${a.href||"#"}" class="hb-btn hb-btn-${l}-solid">${a.label||"Conoce más"}</a>`:"",f=r.enabled?`<a href="${r.href||"#"}" class="hb-btn hb-btn-${o}-outline">${r.label||"Solicitar"}</a>`:"";return`<section id="hb-root-${e}" class="hb-section" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
            ...
            <div class="hb-tab-panel" id="hb-panel-buttons">
                ...
                <div class="hb-card">
                    <div class="hb-row" style="justify-content:space-between;margin-bottom:0.5rem;">
                        ...
                        <label class="hb-switch">
                            <input type="checkbox" id="hb-btn2-enabled" ${f.enabled!==!1?"checked":""}>
                    ...
                    <div style="display:flex;flex-direction:column;gap:0.75rem;">
                        <div>
                            <label class="hb-label" style="margin-bottom:0.375rem;">Texto</label>
                            <input id="hb-btn2-label" type="text" placeholder="Conoce más" value="${f.label||""}" class="hb-input">
                        </div>
                        <div style="position:relative;">
                            <label class="hb-label" style="margin-bottom:0.375rem;">URL</label>
                            <input id="hb-btn2-href" type="text" placeholder="URL o buscar página..." value="${f.href||"#"}" class="hb-input">
                        </div>
                        <div>
                            <label class="hb-label" style="margin-bottom:0.375rem;">Color</label>
        ...
        </div>`,s.appendChild(c),document.body.appendChild(s);const h=`${document.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??""}/api/pages/search`;function u(g){if(g.dataset.autocompleteAttached)return;g.dataset.autocompleteAttached="true";const d=g.parentNode;(!d.style.position||d.style.position==="static")&&(d.style.position="relative");const x=document.createElement("ul");x.style.cssText="position:absolute;top:calc(100% + 2px);left:0;right:0;z-index:999999;background:#fff;border:1px solid #e2e8f0;border-radius:0.5rem;box-shadow:0 8px 24px rgba(0,0,0,0.1);list-style:none;margin:0;padding:0.25rem;max-height:200px;overflow-y:auto;display:none;",d.appendChild(x);let S=null;async function v(_){if(_.length<1){x.style.display="none";return}try{const M=await(await fetch(`${h}?q=${encodeURIComponent(_)}`,{headers:{Accept:"application/json","X-Requested-With":"XMLHttpRequest"}})).json();q(M,_)}catch{x.style.display="none"}}function j(_,D){return D?_.replace(new RegExp(`(${D.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")})`,"gi"),'<mark style="background:#fef3c7;color:#92400e;border-radius:2px;padding:0 1px;">$1</mark>'):_}function q(_,D){if(x.innerHTML="",!_.length){x.style.display="none";return}_.forEach(M=>{const V=document.createElement("li");V.style.cssText="padding:0.375rem 0.625rem;border-radius:0.375rem;cursor:pointer;display:flex;flex-direction:column;gap:0.125rem;",V.innerHTML=`<span style="font-size:0.8rem;font-weight:600;color:#1e293b;">${j(M.title,D)}</span><span style="font-size:0.7rem;color:#64748b;">/${M.slug}</span>`,V.addEventListener("mouseenter",()=>V.style.background="#f1f5f9"),V.addEventListener("mouseleave",()=>V.style.background=""),V.addEventListener("mousedown",p=>{p.preventDefault(),g.value=`${Dr}/${M.slug}`,g.dispatchEvent(new Event("input")),x.style.display="none"}),x.appendChild(V)}),x.style.display="block"}g.addEventListener("input",()=>{clearTimeout(S),S=setTimeout(()=>v(g.value.trim()),220)}),g.addEventListener("focus",()=>{g.select(),g.value.trim()&&v(g.value.trim())}),g.addEventListener("blur",()=>{setTimeout(()=>{x.style.display="none"},150)}),g.addEventListener("keydown",_=>{if(x.style.display==="none")return;const D=x.querySelectorAll("li"),M=x.querySelector("li.hb-ac-active");let V=Array.from(D).indexOf(M);if(_.key==="ArrowDown"){_.preventDefault(),M?.classList.remove("hb-ac-active");const p=D[V+1]||D[0];p?.classList.add("hb-ac-active"),p&&(p.style.background="#f1f5f9")}else if(_.key==="ArrowUp"){_.preventDefault(),M?.classList.remove("hb-ac-active");const p=D[V-1]||D[D.length-1];p?.classList.add("hb-ac-active"),p&&(p.style.background="#f1f5f9")}else _.key==="Enter"&&M?(_.preventDefault(),M.dispatchEvent(new MouseEvent("mousedown"))):_.key==="Escape"&&(x.style.display="none")})}u(c.querySelector("#hb-btn1-href")),u(c.querySelector("#hb-btn2-href"));let m=n.color||"white",E=f.color||"white";function A(g,d,x){const S=c.querySelector(`#${g}`);S.querySelectorAll("[data-color]").forEach(v=>{v.classList.toggle("hb-color-inactive",v.dataset.color!==d),v.addEventListener("click",()=>{S.querySelectorAll("[data-color]").forEach(j=>j.classList.toggle("hb-color-inactive",j.dataset.color!==v.dataset.color)),x(v.dataset.color)})})}A("hb-btn1-colors",m,g=>m=g),A("hb-btn2-colors",E,g=>E=g);function B(g,d,x){const S=c.querySelector(`#${g}`),v=c.querySelector(`#${d}`),j=c.querySelector(`#${x}`),q=()=>{v.style.background=S.checked?"#003B71":"#cbd5e1",j.style.left=S.checked?"21px":"3px"};q(),S.addEventListener("change",q)}B("hb-btn1-enabled","hb-btn1-slider","hb-btn1-knob"),B("hb-btn2-enabled","hb-btn2-slider","hb-btn2-knob"),c.querySelectorAll(".hb-tab-btn").forEach(g=>{g.addEventListener("click",()=>{c.querySelectorAll(".hb-tab-btn").forEach(d=>d.classList.remove("active")),c.querySelectorAll(".hb-tab-panel").forEach(d=>d.classList.remove("active")),g.classList.add("active"),c.querySelector(`#hb-panel-${g.dataset.tab}`).classList.add("active")})}),c.querySelector("#hb-bg-pick").addEventListener("click",()=>{$e({type:"image",title:"Seleccionar imagen de fondo",onSelect:g=>{c.querySelector("#hb-bg-url").value=g,c.querySelector("#hb-bg-preview").src=g}})}),c.querySelector("#hb-bg-url").addEventListener("input",g=>{c.querySelector("#hb-bg-preview").src=g.target.value});const y=()=>s.remove();c.querySelector("#hb-modal-close").onclick=y,c.querySelector("#hb-modal-cancel").onclick=y,s.onclick=g=>{g.target===s&&y()},c.querySelector("#hb-modal-save").onclick=()=>{const g={bg_image:c.querySelector("#hb-bg-url").value.trim()||Q.bg_image,title:c.querySelector("#hb-title").value.trim(),subtitle:c.querySelector("#hb-subtitle").value.trim(),btn_primary:{enabled:c.querySelector("#hb-btn1-enabled").checked,label:c.querySelector("#hb-btn1-label").value.trim(),href:c.querySelector("#hb-btn1-href").value.trim()||"#",color:m},btn_secondary:{enabled:c.querySelector("#hb-btn2-enabled").checked,label:c.querySelector("#hb-btn2-label").value.trim(),href:c.querySelector("#hb-btn2-href").value.trim()||"#",color:E}},x=e.getEl()?.querySelector("[id^='hb-root-']")?.id?.replace("hb-root-","")||"hb"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-hero-banner-config":JSON.stringify(g)}),e.components(bt(g,x)+mt),y()}}function Or(t){const e="hero-banner-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-hero-banner-config":JSON.stringify(Q)},components:bt(Q)+mt,toolbar:[],traits:[{type:"button",label:"Banner",text:"Administrar Banner",full:!0,command:"open-hero-banner-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-hero-banner-config",{run(i){const a=i.getSelected();a&&Nr(i,a)}}),t.BlockManager.add("hero-banner-block",{label:"Banner",category:"Banners",media:`<svg viewBox="0 0 32 32" width="32" height="32">
        ...
        </svg>`,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}})}function Pr(t){I.registerBlocks(Dt),I.registerBlocks(Xt),I.registerBlocks(Sr),I.registerBlocks(oa),I.registerBlocks(Vi),I.registerBlocks(Kt),I.registerBlocks(ii),I.registerBlocks(_i),I.registerBlocks(Ai),I.registerBlocks(di),I.registerBlocks(ia),I.registerBlocks(hi),I.registerBlocks(yi),I.registerBlocks(Mi),I.registerBlocks(Pi),I.registerBlocks(ca),I.registerBlocks(ha),I.registerBlocks(ba),I.registerBlocks(za),I.registerBlocks(qa),I.registerBlocks(Ra),I.registerBlocks(tr),I.registerBlocks(or),I.registerBlocks(Sa),I.registerBlocks(ja),I.registerBlocks(cr),I.registerBlocks(ur),I.registerBlocks(Ar),I.applyToEditor(t),dr(t),xr(t),Lr(t),Or(t),Li(t),si(t),ir(t),Xi(t),Ha(t),vi(t),Ir(t)}function Rr(t,e,i){t.on("component:add",()=>e.markAsDirty()),t.on("component:remove",()=>e.markAsDirty()),t.on("component:update",()=>e.markAsDirty()),t.on("style:update",()=>e.markAsDirty());const a=document.getElementById("save-button");a&&a.addEventListener("click",async()=>{await Hr(t,e,i,a)}),document.addEventListener("keydown",r=>{(r.ctrlKey||r.metaKey)&&r.key==="s"&&(r.preventDefault(),a&&!a.disabled&&a.click())})}async function Hr(t,e,i,a){a.disabled=!0,a.innerHTML='<i class="ri-loader-4-line animate-spin"></i><span>Guardando...</span>';try{i.needsTitle()?await Fr(t,e,i):await ut(t,e,i)}catch(r){xt(r.message,"error")}finally{a.disabled=!1,a.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}}async function Fr(t,e,i){return new Promise((a,r)=>{vt({title:"Título de la Página",description:"Ingresa un título descriptivo para identificar esta página",placeholder:"Ej: Acerca de Nosotros",icon:"ri-file-text-line",iconBg:"#dbeafe",iconColor:"#2563eb",confirmLabel:"Guardar",onConfirm:async l=>{if(!l?.trim()){r(new Error("El título es obligatorio"));return}try{await ut(t,e,i,l),a()}catch(o){r(o)}},onCancel:()=>{r(new Error("Guardado cancelado"))}})})}async function ut(t,e,i,a=null){const l={...e.getEditorContent(t),is_published:i.isPublished};a&&(l.title=a);const o=await e.savePage(t,l,i.storeUrl,i.getHttpMethod());o.success&&(e.markAsClean(),xt(o.message,"success"),!i.isEditMode&&o.page?(i.updatePageInfo(o),i.updateTitle(o.page.title)):a&&i.updateTitle(a))}function xt(t,e){typeof window.showNotification=="function"&&window.showNotification(t,e)}document.addEventListener("DOMContentLoaded",async()=>{const t=new wt,e=new At;new It(t);const i=kt();if(i.on("load",()=>{Pr(i),Bt(i),Et(),$t(),St(i),Lt(i),Ct(i),jt(i),_t(i),Tt(i),Ur(i),Vr(i),Xr(i),setTimeout(()=>{i.runCommand("sw-visibility"),i.Panels.getButton("options","sw-visibility")?.set("active",!0)},100)}),e.isEditMode)try{await t.loadPageContent(i,e.loadUrl),nt("Contenido cargado correctamente","success")}catch(a){nt("Error al cargar el contenido","error"),console.error(a)}Rr(i,t,e)});function Ur(t){const e=[{cmd:"set-device-desktop",device:"Desktop"},{cmd:"set-device-tablet",device:"Tablet"},{cmd:"set-device-mobile",device:"Mobile"}];e.forEach(({cmd:i,device:a})=>{t.Commands.add(i,{run:r=>{r.setDevice(a),e.forEach(({cmd:l})=>{r.Panels.getButton("devices-c",l)?.set("active",l===i)})}})})}function Vr(t){t.Commands.add("canvas-clear",{run:e=>{zt({title:"Limpiar canvas",description:"¿Estás seguro de que quieres eliminar todo el contenido del canvas? Esta acción no se puede deshacer.",icon:"ri-delete-bin-line",iconBg:"#fef2f2",iconColor:"#dc2626",confirmLabel:"Limpiar todo",confirmColor:"#dc2626",onConfirm:()=>{e.DomComponents.clear(),e.CssComposer.clear()}})}})}function Xr(t){const e=t.Canvas.getFrameEl();if(!e?.contentDocument?.head)return;const i=e.contentDocument.createElement("style");i.id="gjs-dashed-fix",i.textContent="body,body.gjs-dashed{margin:0!important;padding:0 0 160px 0!important;}",e.contentDocument.head.appendChild(i)}function nt(t,e="info"){typeof window.showNotification=="function"&&window.showNotification(t,e)}
