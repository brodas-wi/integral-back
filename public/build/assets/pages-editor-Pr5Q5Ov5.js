...
${si}`}],bt=function(){(function(){function t(i){if(!i||i.__pcInit)return;i.__pcInit=!0;var a=i.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,o=0,p=!1,c=0,n=0,f=0,m=null;a.querySelectorAll("img").forEach(function(h){h.setAttribute("draggable","false")}),setTimeout(function(){var h=a.scrollWidth-a.clientWidth;if(h<=0)return;var E=Math.min(60,h),k=null;function S(B){k||(k=B);var j=(B-k)/400;if(j<.5)a.scrollLeft=E*(j*2);else if(j<1)a.scrollLeft=E*(1-(j-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(S)}requestAnimationFrame(S)},400),a.scrollLeft=0;function b(){return a.scrollWidth-a.clientWidth}function g(h){return Math.max(0,Math.min(h,b()))}function d(){Math.abs(c)<.5||(c*=.92,a.scrollLeft=g(a.scrollLeft+c),m=requestAnimationFrame(d))}a.addEventListener("mousedown",function(h){h.button===0&&(m&&(cancelAnimationFrame(m),m=null),r=!0,p=!1,c=0,l=h.clientX,n=h.clientX,f=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",h.preventDefault())}),document.addEventListener("mousemove",function(h){if(r){var E=l-h.clientX;Math.abs(E)>3&&(p=!0);var k=Date.now(),S=k-f||1;c=(h.clientX-n)/S*16*-1,n=h.clientX,f=k,a.scrollLeft=g(o+E)}}),document.addEventListener("mouseup",function(h){r&&(r=!1,a.style.cursor="grab",p&&(h.stopPropagation(),m=requestAnimationFrame(d)))}),a.addEventListener("click",function(h){p&&(h.preventDefault(),h.stopPropagation(),p=!1)},!0);var w=0,C=0,y=0,v=0,u=0;a.addEventListener("touchstart",function(h){m&&(cancelAnimationFrame(m),m=null),w=h.touches[0].clientX,y=h.touches[0].clientX,v=Date.now(),C=a.scrollLeft,u=0},{passive:!0}),a.addEventListener("touchmove",function(h){var E=Date.now(),k=E-v||1,S=h.touches[0].clientX;u=(S-y)/k*16*-1,y=S,v=E;var B=w-S;a.scrollLeft=g(C+B)},{passive:!0}),a.addEventListener("touchend",function(){m=requestAnimationFrame(function h(){Math.abs(u)<.5||(u*=.92,a.scrollLeft=g(a.scrollLeft+u),m=requestAnimationFrame(h))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(i){delete i.__pcInit,t(i)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},pi=`(${bt.toString()})();`,gi=`
...
@media(max-width:480px){.pc-card{flex:0 0 80vw;}}`;function hi(t){const e=t.img||_("images/placeholder.svg"),i=t.title||"TÍTULO DEL PRODUCTO",a=t.desc||"Descripción breve del producto financiero.",r=t.href||"#",l=t.btn_label||"Solicitar";return`<div class="pc-card"><div class="pc-card-img-wrap"><img src="${e}" alt="${i}" class="pc-card-img"></div><div class="pc-card-body"><h3 class="pc-card-title">${i}</h3><p class="pc-card-desc">${a}</p></div><a href="${r}" class="pc-btn">${l}</a></div>`}function ut(t){const e=t.heading||"Créditos",i=t.subheading||"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",a=t.more_href||"#",r=t.more_label||"Ver más",l=t.show_more!==!1,p=(t.cards||[]).map(hi).join(""),c=l?`<div class="pc-more-wrap"><a href="${a}" class="pc-more-btn">${r}</a></div>`:"";return`<section class="pc-section"><style>${gi}</style><div style="text-align:center;margin-bottom:2rem;"><h2 class="pc-section-heading">${e}</h2><p class="pc-section-subheading">${i}</p></div><div class="pc-carousel-wrap"><div class="pc-track">${p}</div></div>${c}</section>`}const H={heading:"Créditos",subheading:"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CREDINVIERTE",desc:"Adquiere activos fijos",href:"#",btn_label:"Solicitar"},{img:"",title:"SOLUCIONES INTEGRALES",desc:"Financiamiento PYME",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDI-CONFIAMOS",desc:"Rápido y sin fiador",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDILÍNEA",desc:"Línea rotativa",href:"#",btn_label:"Solicitar"}]};function mi(t,e){const i=document.getElementById("pc-config-modal");if(i&&i.remove(),!document.getElementById("pc-modal-styles")){const n=document.createElement("style");n.id="pc-modal-styles",n.textContent=`
        ...
        </div>`,l.appendChild(o),document.body.appendChild(l),o.querySelectorAll(".pc-tab-btn").forEach(n=>{n.addEventListener("click",()=>{o.querySelectorAll(".pc-tab-btn").forEach(f=>f.classList.remove("active")),o.querySelectorAll(".pc-tab-panel").forEach(f=>f.classList.remove("active")),n.classList.add("active"),o.querySelector(`#pc-panel-${n.dataset.tab}`).classList.add("active")})}),o.querySelector("#pc-show-more").addEventListener("change",function(){r.show_more=this.checked,o.querySelector("#pc-more-fields").style.display=this.checked?"flex":"none"});function p(){const n=o.querySelector("#pc-cards-list");n.innerHTML="",r.cards.forEach((f,m)=>{const b=document.createElement("div");b.className="pc-card-config";const g=f.img?`<img class="pc-img-preview" src="${f.img}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>';b.innerHTML=`
...
<\/script>`}],ar=`<svg viewBox="0 0 32 32" width="32" height="32">
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
            ...
            </tr>`),r&&t.headers?.length){const c=a?i.subheaderBg:i.headerBg,n=a?i.subheaderText:i.headerText;l+="<tr>",t.headers.forEach((f,m)=>{const b=m<t.headers.length-1?`border-r border-[${i.borderColor}]`:"";l+=`<th class="p-3 align-middle text-sm font-semibold ${c} ${n} ${b} border-b border-[${i.borderColor}] text-${f.align||"center"}">${f.text||""}</th>`}),l+="</tr>"}l+="</thead>"}l+="<tbody>";const o=t.rows.length,p={};return t.rows.forEach((c,n)=>{l+="<tr>";let f=0;c.forEach(m=>{for(;p[`${n}-${f}`];)f++;const b=m.colspan||1,g=m.rowspan||1;for(let j=n;j<n+g;j++)for(let A=f;A<f+b;A++)(j!==n||A!==f)&&(p[`${j}-${A}`]=!0);const d=b>1?`colspan="${b}"`:"",w=g>1?`rowspan="${g}"`:"",C=m.isHeader?`tbl-cell-highlight-${e}`:`tbl-cell-normal-${e}`,y="font-semibold",v=m.isHeader?i.labelText:i.rowText,u=`text-${m.align||"center"}`,h=n+g>=o,k=f+b>=t.cols?"":`border-r border-[${i.borderColor}]`,S=h?"":`border-b border-[${i.borderColor}]`,B=`${k} ${S} p-3 align-middle text-sm ${C} ${y} ${v} ${u}`;m.image?l+=`<td ${d} ${w} class="${B}">
                    <img src="${m.image}" alt="${m.text||""}" class="max-w-full max-h-20 h-auto object-contain block mx-auto">
                    ${m.text?`<span class="block mt-1 text-xs ${v}">${m.text}</span>`:""}
                </td>`:l+=`<td ${d} ${w} class="${B}">${m.text||""}</td>`,f+=b}),l+="</tr>"}),l+="</tbody></table>",l}function Q(t,e){return{title:"Título de la tabla",showTitleRow:!0,showHeaderRow:!0,cols:t,headers:Array.from({length:t},(i,a)=>({text:`Columna ${a+1}`,align:"center"})),rows:Array.from({length:e},()=>Array.from({length:t},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})))}}function rr(t){return`<style>
...
.tam-img-selected-info{font-size:0.8125rem;color:#64748b;}`;function or(){if(document.getElementById("tam-img-modal"))return;const t=document.createElement("div");t.id="tam-img-modal",t.className="tam-img-overlay",t.innerHTML=`
        ...
        <div class="tam-modal">
            ...
            <th>
                ...
                </td>`}).join("")}</tr>`).join(""),d.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(v=>{v.addEventListener("change",()=>{const u=parseInt(v.dataset.row),h=parseInt(v.dataset.col),E=Math.max(1,parseInt(v.value)||1);l.rows[u]?.[h]&&(v.dataset.action==="colspan"?l.rows[u][h].colspan=Math.min(E,w-h):l.rows[u][h].rowspan=Math.min(E,C-u),f())})}),d.querySelectorAll("button[data-action]").forEach(v=>{v.addEventListener("click",u=>{u.preventDefault(),u.stopPropagation();const h=v.dataset.action,E=parseInt(v.dataset.row),k=parseInt(v.dataset.col);if(!(isNaN(E)||isNaN(k)||!l.rows[E]?.[k])){if(h==="header"){l.rows[E][k].isHeader=!l.rows[E][k].isHeader;const S=d.querySelector(`td[data-row="${E}"][data-col="${k}"]`);S&&(S.dataset.isheader=l.rows[E][k].isHeader?"1":"0",S.classList.toggle("is-header-cell",l.rows[E][k].isHeader)),v.classList.toggle("active",l.rows[E][k].isHeader),v.textContent=l.rows[E][k].isHeader?"✓ Resaltar":"Resaltar";return}if(h==="image"){window.__openTableImagePicker&&window.__openTableImagePicker(S=>{l.rows[E][k].image=S;const B=d.querySelector(`td[data-row="${E}"][data-col="${k}"]`);if(B){B.dataset.image=S,B.classList.add("has-image");let j=B.querySelector(".tam-cell-img-preview");j||(j=document.createElement("img"),j.className="tam-cell-img-preview",B.insertBefore(j,B.firstChild)),j.src=S;const A=B.querySelector("[data-action=image]");if(A&&(A.innerHTML='<i class="ri-image-line"></i> Cambiar'),!B.querySelector("[data-action=clear-image]")){const q=document.createElement("button");q.type="button",q.className="tam-cell-btn tam-cell-btn-clear",q.dataset.action="clear-image",q.dataset.row=E,q.dataset.col=k,q.textContent="✕ Quitar",q.addEventListener("click",V=>{V.preventDefault(),V.stopPropagation(),l.rows[E][k].image=null,B.dataset.image="",B.classList.remove("has-image"),j.remove(),q.remove();const J=B.querySelector("[data-action=image]");J&&(J.innerHTML='<i class="ri-image-line"></i> Imagen')}),B.querySelector(".tam-cell-actions").appendChild(q)}}});return}h==="clear-image"&&(l.rows[E][k].image=null,b())}})})}document.getElementById("tam-close").addEventListener("click",c),document.getElementById("tam-cancel").addEventListener("click",c),a.addEventListener("click",g=>{g.target===a&&c()}),document.getElementById("tam-show-title-row").addEventListener("change",o),document.getElementById("tam-rebuild").addEventListener("click",()=>{const g=parseInt(document.getElementById("tam-cols").value)||3,d=parseInt(document.getElementById("tam-rows").value)||3;for(m(),n();l.headers.length<g;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,g),l.cols=g;l.rows.length<d;)l.rows.push(Array.from({length:g},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,d).map(w=>{for(;w.length<g;)w.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return w.slice(0,g)}),b()}),document.getElementById("tam-apply").addEventListener("click",()=>{n();const g=document.getElementById("tam-theme").value;r&&(r.set("tableData",JSON.parse(JSON.stringify(l))),r.set("tableTheme",g),r.addAttributes({"data-table-theme":g}),ze(r)),c()}),window.__openTableAdminModal=p}function ze(t){const e=t.get("tableData"),i=t.get("tableTheme")||"blue";e&&t.components(kt(wt(e,i),i))}function sr(){return function(){}}const cr=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:ar,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
@media(max-width:768px){.bsk-buttons{flex-direction:column;}}`;function Or(){return function(){const t=this,e=t.ownerDocument??document,i="/adminintegral",a=(e.defaultView??window).location.origin,r=e.querySelector('meta[name="api-banners-url"]')?.content||`${a}${i}/api/banners/active`,l=["fill-blue","outline-blue","fill-orange","outline-orange","fill-white","outline-white"],o=".banner-wrapper{position:relative;width:100%;background:#003B71;overflow:hidden;}.banner-slide-container{position:relative;width:100%;user-select:none;cursor:grab;display:grid;}.banner-slide-container:active{cursor:grabbing;}.banner-slide{grid-area:1/1;opacity:0;pointer-events:none;transition:opacity 0.7s ease;visibility:hidden;display:flex;flex-direction:column;}.banner-slide.banner-slide--active{opacity:1;pointer-events:auto;visibility:visible;}.banner-slide-inner{position:relative;width:100%;flex:1;min-height:480px;display:flex;align-items:center;}.banner-bg{position:absolute;inset:0;z-index:0;}.banner-bg img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;}.banner-overlay{position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,59,113,0.85) 0%,rgba(0,59,113,0.65) 50%,rgba(0,59,113,0.2) 100%);z-index:1;}.banner-content{position:relative;z-index:10;display:flex;flex-direction:column;justify-content:center;padding:64px 64px 96px;max-width:60%;}.banner-category-badge{display:inline-block;margin-bottom:18px;padding:7px 20px;border-radius:999px;border:2px solid rgba(255,255,255,0.65);color:#fff;font-size:13px;font-weight:500;letter-spacing:0.04em;align-self:flex-start;}.banner-title{font-size:clamp(1.8rem,3.2vw,3rem);font-weight:800;color:#fff;line-height:1.15;margin:0 0 20px;}.banner-description{color:rgba(255,255,255,0.9);font-size:clamp(0.95rem,1.4vw,1.1rem);line-height:1.7;margin:0 0 36px;max-width:520px;}.banner-buttons{display:flex;flex-wrap:wrap;gap:16px;align-items:center;}.banner-btn{display:inline-block;padding:12px 32px;border-radius:999px;font-size:15px;font-weight:600;cursor:pointer;transition:background .2s,color .2s,border-color .2s;text-decoration:none;white-space:nowrap;line-height:1.4;box-sizing:border-box;}.banner-btn--fill-blue{background:#003B71;color:#ffffff;border:2px solid #003B71;}.banner-btn--fill-blue:hover{background:#002a52;border-color:#002a52;color:#ffffff;}.banner-btn--outline-blue{background:transparent;color:#003B71;border:2px solid #003B71;}.banner-btn--outline-blue:hover{background:#003B71;border-color:#003B71;color:#ffffff;}.banner-btn--fill-orange{background:#E97300;color:#ffffff;border:2px solid #E97300;}.banner-btn--fill-orange:hover{background:#c96200;border-color:#c96200;color:#ffffff;}.banner-btn--outline-orange{background:transparent;color:#E97300;border:2px solid #E97300;}.banner-btn--outline-orange:hover{background:#E97300;border-color:#E97300;color:#ffffff;}.banner-btn--fill-white{background:#ffffff;color:#003B71;border:2px solid #ffffff;}.banner-btn--fill-white:hover{background:#dce8f5;border-color:#dce8f5;color:#003B71;}.banner-btn--outline-white{background:transparent;color:#ffffff;border:2px solid #ffffff;}.banner-btn--outline-white:hover{background:#ffffff;border-color:#ffffff;color:#003B71;}.banner-dots-wrapper{display:none;}.banner-stripe{position:relative;width:100%;height:26px;background:#E97300;z-index:20;display:flex;align-items:center;justify-content:center;}.banner-dots{display:flex;gap:8px;align-items:center;}.banner-dot{width:10px;height:10px;border-radius:999px;border:none;cursor:pointer;background:rgba(255,255,255,0.5);transition:all 0.3s ease;padding:0;flex-shrink:0;}.banner-dot--active{width:28px;background:#ffffff;}.banner-empty{display:flex;align-items:center;justify-content:center;min-height:480px;color:rgba(255,255,255,0.5);font-size:14px;padding:40px;}@media(max-width:768px){.banner-slide-inner{min-height:340px;}.banner-bg img{object-position:right center;}.banner-content{max-width:100%;width:100%;padding:32px 24px 80px;}.banner-buttons{flex-wrap:wrap;gap:12px;}.banner-btn{flex:1 1 45%;min-width:140px;text-align:center;white-space:normal;word-break:break-word;}}@media(max-width:480px){.banner-btn{flex:1 1 100%;min-width:0;}}",p="@keyframes bsk-shimmer{0%{background-position:-600px 0}100%{background-position:600px 0}}.bsk-badge{width:120px;height:32px;margin-bottom:20px;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title{height:40px;margin-bottom:12px;border-radius:8px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title--short{width:60%;}.bsk-line{height:16px;margin-bottom:10px;border-radius:6px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-line--short{width:55%;}.bsk-buttons{display:flex;gap:16px;margin-top:36px;}.bsk-btn{height:48px;flex:1;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-bg-img{background:linear-gradient(90deg,rgba(255,255,255,0.04) 25%,rgba(255,255,255,0.09) 50%,rgba(255,255,255,0.04) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}@media(max-width:768px){.bsk-buttons{flex-direction:column;}}";(function(){if(!e.getElementById("banner-hero-styles")){const x=e.createElement("style");x.id="banner-hero-styles",x.textContent=o,e.head.appendChild(x)}if(!e.getElementById("banner-skeleton-styles")){const x=e.createElement("style");x.id="banner-skeleton-styles",x.textContent=p,e.head.appendChild(x)}})();let c=[],n=0,f=null,m=!1,b=0,g=0;const d=50,w=t.dataset.autoplay!=="false",C=t.dataset.category??"",y=t.querySelector(".banner-slide-container"),v=t.querySelector(".banner-stripe");if(!y||!v)return;function u(s){return l.indexOf(s)!==-1?s:s==="outline-blue"||s==="outline-orange"?"outline-white":"fill-white"}function h(s,x,$,T){const M=u($),Y=x?"a":"span",Se=x?`href="${x}"${T?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${Y} ${Se} class="banner-btn banner-btn--${M}">${s}</${Y}>`}async function E(){if(!t.__bannerLoading){t.__bannerLoading=!0,k();try{const s=await fetch(r,{headers:{Accept:"application/json"}});if(!s.ok){ee();return}const x=await s.json();if(c=Array.isArray(x)?C?x.filter($=>$.category===C):x:[],c.length===0){ee();return}S(),J(),K(0,!1),w&&pe()}catch{ee()}finally{t.__bannerLoading=!1}}}function k(){y.innerHTML=`
        ...
        </div>`,o.appendChild(p),document.body.appendChild(o);const c=p.querySelector("#bnr-autoplay"),n=p.querySelector("#bnr-autoplay-slider"),f=p.querySelector("#bnr-autoplay-knob"),m=()=>{n.style.background=c.checked?"#003B71":"#cbd5e1",f.style.left=c.checked?"21px":"3px"};m(),c.addEventListener("change",m);const b=p.querySelector("#bnr-category");(async()=>{try{const w=document.querySelector('meta[name="api-banners-url"]')?.content||`${window.location.origin}/adminintegral/api/banners/active`,C=await fetch(w,{headers:{Accept:"application/json"}});if(!C.ok)return;const y=await C.json();if(!Array.isArray(y))return;[...new Set(y.map(u=>u.category).filter(Boolean))].sort().forEach(u=>{const h=document.createElement("option");h.value=u,h.textContent=u,b.appendChild(h)}),b.value=l}catch{}})();const g=()=>o.remove();p.querySelector("#bnr-modal-close").onclick=g,p.querySelector("#bnr-modal-cancel").onclick=g,o.onclick=d=>{d.target===o&&g()},p.querySelector("#bnr-modal-save").onclick=()=>{e.addAttributes({"data-autoplay":c.checked?"true":"false","data-category":b.value||""}),g()}}const Hr=[{id:"banner-hero",label:"Banner Slider",category:"Banners",media:Mr,content:{type:"banner-hero-component"}}];function Fr(t){const e="banner-hero-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner Slider",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-autoplay":"true","data-category":""},components:`
...
`;if(!e.getElementById("assets-block-styles")){const y=e.createElement("style");y.id="assets-block-styles",y.textContent=r,e.head.appendChild(y)}const l=t.querySelector("[data-ast-tabs]"),o=t.querySelector("[data-ast-content]");if(!l||!o)return;const p=t.dataset.defaultCategory||"";let c=[],n="";function f(y,v){return y?y.length>v?`${y.slice(0,v).trim()}...`:y:""}function m(y){const v=y.link_is_external?' target="_blank" rel="noopener noreferrer"':"",u=y.name||f(y.short_description,60),h=y.name||y.short_description||"Activo extraordinario";return`<a href="${y.link_url}"${v} class="ast-card">
                <img src="${y.image_url}" alt="${h}" class="ast-card-img" loading="lazy">
                <div class="ast-card-body">
                    <p class="ast-card-name">${u}</p>
                    ${y.name&&y.short_description?`<p class="ast-card-desc">${y.short_description}</p>`:""}
                </div>
            </a>`}function b(){const y=[],v=new Set;return c.forEach(u=>{v.has(u.category_slug)||(v.add(u.category_slug),y.push({slug:u.category_slug,name:u.category}))}),y.sort((u,h)=>u.name.localeCompare(h,"es",{sensitivity:"base"}))}function g(y,v){const u=v.length?v.map(m).join(""):'<div class="ast-empty">No hay activos extraordinarios disponibles en esta categoría.</div>';return`<div class="ast-group">
                <p class="ast-subtitle">${y}</p>
                <div class="ast-subtitle-stripe"></div>
                <div class="ast-grid">${u}</div>
            </div>`}function d(){if(n){const v=c.filter(h=>h.category_slug===n),u=v[0]?.category||b().find(h=>h.slug===n)?.name||"";o.innerHTML=g(u,v);return}const y=b();o.innerHTML=y.map(v=>g(v.name,c.filter(u=>u.category_slug===v.slug))).join("")}function w(){const v=['<button type="button" class="ast-tab ast-tab--active" data-tab-slug="">Todos</button>',...b().map(u=>`<button type="button" class="ast-tab" data-tab-slug="${u.slug}">${u.name}</button>`)].join("");if(l.innerHTML=v,l.querySelectorAll("[data-tab-slug]").forEach(u=>{u.addEventListener("click",()=>{l.querySelectorAll(".ast-tab").forEach(h=>h.classList.remove("ast-tab--active")),u.classList.add("ast-tab--active"),n=u.dataset.tabSlug,d()})}),p){const u=l.querySelector(`[data-tab-slug="${p}"]`);u&&u.click()}}async function C(){if(!a){l.innerHTML='<button type="button" class="ast-tab ast-tab--active">Todos</button>',o.innerHTML='<div class="ast-empty">Vista previa del catálogo (los datos reales se cargan en el sitio publicado).</div>';return}o.innerHTML=`
...
.hb-curve svg{height:70px;}
...
</style>`;function $t(t,e){e=e||"hb"+Math.random().toString(36).slice(2,7);const i=t.bg_image||_("images/placeholder.svg"),a=Ie[t.theme]?t.theme:"blue",r=Ie[a],l=t.subtitle?`<p class="hb-subtitle">${t.subtitle}</p>`:"";return`<section id="hb-root-${e}" class="hb-section" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
        ...
        <div class="hb-curve" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
            <svg viewBox="0 0 1440 200" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                <path fill="${r.bg}" d="M0,140L120,133.3C240,127,480,113,720,113.3C960,113,1200,127,1320,133.3L1440,140L1440,200L1320,200C1200,200,960,200,720,200C480,200,240,200,120,200L0,200Z"></path>
            </svg>
        </div>
        ...
        `,document.head.appendChild(g)}const a=(()=>{try{return JSON.parse(e.getAttributes()["data-hero-banner-config"]||"{}")}catch{return{}}})(),r=a.bg_image||G.bg_image,l=a.theme||G.theme,o=a.title||G.title,p=a.subtitle??G.subtitle,c=document.createElement("div");c.id="hero-banner-config-modal",c.className="hb-overlay";const n=document.createElement("div");n.className="hb-modal",n.innerHTML=`
        ...
        <div class="hb-modal-body">
            ...
            <div class="hb-tab-panel" id="hb-panel-content">
                <div class="hb-card">
                    ...
                    <input id="hb-title" type="text" placeholder="Título del banner" value="${o}" class="hb-input">
                </div>
                <div class="hb-card">
                    <label class="hb-label">Subtítulo (opcional)</label>
                    <textarea id="hb-subtitle" placeholder="Déjalo vacío si no quieres subtítulo" class="hb-input">${p}</textarea>
                </div>
            </div>
        ...
        </div>`,c.appendChild(n),document.body.appendChild(c);let f=Ie[l]?l:"blue";function m(){const g=n.querySelector("#hb-theme-colors");g.querySelectorAll("[data-theme]").forEach(d=>{d.classList.toggle("hb-theme-inactive",d.dataset.theme!==f),d.addEventListener("click",()=>{f=d.dataset.theme,g.querySelectorAll("[data-theme]").forEach(w=>w.classList.toggle("hb-theme-inactive",w.dataset.theme!==f))})})}m(),n.querySelectorAll(".hb-tab-btn").forEach(g=>{g.addEventListener("click",()=>{n.querySelectorAll(".hb-tab-btn").forEach(d=>d.classList.remove("active")),n.querySelectorAll(".hb-tab-panel").forEach(d=>d.classList.remove("active")),g.classList.add("active"),n.querySelector(`#hb-panel-${g.dataset.tab}`).classList.add("active")})}),n.querySelector("#hb-bg-pick").addEventListener("click",()=>{$e({type:"image",title:"Seleccionar imagen de fondo",onSelect:g=>{n.querySelector("#hb-bg-url").value=g,n.querySelector("#hb-bg-preview").src=g}})}),n.querySelector("#hb-bg-url").addEventListener("input",g=>{n.querySelector("#hb-bg-preview").src=g.target.value});const b=()=>c.remove();n.querySelector("#hb-modal-close").onclick=b,n.querySelector("#hb-modal-cancel").onclick=b,c.onclick=g=>{g.target===c&&b()},n.querySelector("#hb-modal-save").onclick=()=>{const g={bg_image:n.querySelector("#hb-bg-url").value.trim()||G.bg_image,theme:f,title:n.querySelector("#hb-title").value.trim(),subtitle:n.querySelector("#hb-subtitle").value.trim()},w=e.getEl()?.querySelector("[id^='hb-root-']")?.id?.replace("hb-root-","")||"hb"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-hero-banner-config":JSON.stringify(g)}),e.components($t(g,w)+Et),b()}}function tl(t){const e="hero-banner-component";t.DomComponents.addType(e,{isComponent:i=>i.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Banner",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-hero-banner-config":JSON.stringify(G)},components:$t(G)+Et,traits:[{type:"button",label:"Banner",text:"Administrar Banner",full:!0,command:"open-hero-banner-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),t.Commands.add("open-hero-banner-config",{run(i){const a=i.getSelected();a&&el(i,a)}}),t.BlockManager.add("hero-banner-block",{label:"Banner",category:"Banners",media:`<svg viewBox="0 0 32 32" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
