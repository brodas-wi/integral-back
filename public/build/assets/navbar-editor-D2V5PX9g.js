import{i as G,I as V,t as F,d as W,f as X,e as Y,s as K,g as Q,c as Z,E as ee,j as ne,h as te}from"./editor-commands-C7f79RQP.js";import{o as oe}from"./media-picker-CiKJ1Agb.js";import"./_commonjsHelpers-CqkleIqs.js";function ae(){return G()}const re=`(function(){
...
@media(max-width:992px){
    ...
    .nb-hamburger{display:flex;}
                ...
                </div>`}return`<a href="${p.href||"#"}" class="nb-mobile-link">${p.label||""}</a>`}).join(""),D=`<div class="nb-mobile-actions">
        ${w}
        ...
        <div class="nb-mobile-menu" id="nb-mobile-${t}">${T}${D}</div>
        ...
        </svg>`,activate:!0,content:{type:t,attributes:{"data-gjs-type":t}}}),ce(r,t),de(r)}function ce(r,t){r.on("storage:end:load",()=>{setTimeout(()=>O(r,t),800)}),r.on("component:mount",a=>{const s=a.getEl();s?.getAttribute?.("data-gjs-type")===t&&(a.set("type",t),setTimeout(()=>J(r,s),400))}),r.on("canvas:render",()=>{setTimeout(()=>O(r,t),600)})}function J(r,t){if(t?.isConnected)try{const a=r.Canvas.getFrameEl()?.contentDocument;if(!a)return;t.__nbInit&&delete t.__nbInit;const s=a.createElement("script");s.textContent=`(function(){
            function initNavbar(root){
                if(!root||root.__nbInit)return;
                root.__nbInit=true;
                var id=root.querySelector("[id^='nb-root-']")?.id?.replace("nb-root-","");
