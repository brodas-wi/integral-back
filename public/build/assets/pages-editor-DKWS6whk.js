/* empty css                   *//* empty css                    *//* empty css                          *//* empty css                           */import{o as ve,M as gt,j as mt,E as bt,i as ut,t as xt,d as yt,f as vt,e as wt,s as kt,g as Bt,c as Et,b as $t,a as St,h as Ct}from"./editor-commands-DULPa6UC.js";import{a as q}from"./url-DaqOO3yL.js";import"./_commonjsHelpers-CqkleIqs.js";class Lt{constructor(){this.pageId=this.getElementValue("page-id"),this.pageSlug=this.getElementValue("page-slug"),this.pageTitle=this.getPageTitle(),this.loadUrl=this.getElementValue("page-load-url"),this.storeUrl=this.getElementValue("page-store-url"),this.isPublished=this.getElementValue("page-is-published")==="1",this.isEditMode=!!this.pageId,this.appUrl=(document.querySelector('meta[name="app-url"]')?.content??"").replace(/\/$/,"")}getElementValue(e,t=""){const a=document.getElementById(e);return a?a.value.trim():t}getPageTitle(){const e=document.getElementById("editor-title");if(!e)return"";const a=e.textContent.match(/(?:Editando:|Nueva Página)\s*(.+)?/);return a&&a[1]?a[1].trim():""}updatePageInfo(e){if(e.page)if(this.pageId=e.page.id,this.pageSlug=e.page.slug,this.pageTitle=e.page.title,this.isEditMode=!0,document.getElementById("page-id").value=this.pageId,document.getElementById("page-slug").value=this.pageSlug,e.page.update_url?this.storeUrl=e.page.update_url:this.storeUrl=`${this.appUrl}/pages/${this.pageSlug}`,document.getElementById("page-store-url").value=this.storeUrl,e.page.load_url?this.loadUrl=e.page.load_url:this.loadUrl=`${this.appUrl}/pages/${this.pageSlug}/load`,document.getElementById("page-load-url").value=this.loadUrl,e.page.edit_url)window.history.replaceState(null,"",e.page.edit_url);else try{const t=new URL(window.location.href);t.pathname=t.pathname.replace(/\/pages\/create\/?$/,`/pages/${this.pageSlug}/edit`),window.history.replaceState(null,"",t.toString())}catch(t){console.error("Error updating browser URL:",t)}}updateTitle(e){this.pageTitle=e;const t=document.getElementById("editor-title");t&&(t.textContent=`Editando: ${e}`),document.title=`Editar: ${e} - Editor`}getHttpMethod(){return this.isEditMode?"PUT":"POST"}needsTitle(){return!this.isEditMode}}class jt{constructor(e){this.editorService=e,this.setupBackButton(),this.setupBeforeUnload()}setupBackButton(){const e=document.querySelector("#editor-navbar a[href]");e&&e.addEventListener("click",t=>{this.editorService.shouldPreventUnload()&&(t.preventDefault(),this.showUnsavedChangesModal(()=>{this.editorService.startNavigation(),window.location.href=e.href}))})}setupBeforeUnload(){window.addEventListener("beforeunload",e=>{if(this.editorService.shouldPreventUnload())return e.preventDefault(),e.returnValue="Tienes cambios sin guardar. ¿Estás seguro de que quieres salir?",e.returnValue})}showUnsavedChangesModal(e){const t=document.createElement("div");t.style.cssText=`
            position: fixed;
            inset: 0;
            z-index: 9999;
            display: flex;
        ...
        `;const p=document.createElement("button");p.textContent="Salir sin guardar",p.style.cssText=`
            ...
            font-family: inherit;
        `,[o,p].forEach(s=>{s.addEventListener("mouseenter",()=>{s.style.opacity="0.85"}),s.addEventListener("mouseleave",()=>{s.style.opacity="1"})});const d=()=>t.remove();o.addEventListener("click",d),p.addEventListener("click",()=>{d(),e()}),t.addEventListener("click",s=>{s.target===t&&d()}),l.appendChild(o),l.appendChild(p),a.appendChild(r),a.appendChild(l),t.appendChild(a),document.body.appendChild(t)}}const Tt="Básico";class _t{constructor(){this.blocks=new Map}registerBlock(e,t){this.blocks.has(t.category)||this.blocks.set(t.category,[]),this.blocks.get(t.category).push({id:e,...t})}registerBlocks(e){e.forEach(t=>{this.registerBlock(t.id,t)})}applyToEditor(e){this.blocks.forEach(t=>{t.forEach(a=>{const{id:r,...l}=a;e.BlockManager.add(r,l)})}),this.applyCollapseSettings(e),this.hideDefaultCategories(e)}applyCollapseSettings(e){setTimeout(()=>{e.BlockManager.getCategories().each(t=>{t.set("open",t.get("label")===Tt)})},500)}hideDefaultCategories(e){setTimeout(()=>{const t=["Basic","Extra"];document.querySelectorAll(".gjs-block-category").forEach(a=>{const r=a.querySelector(".gjs-title");r&&t.includes(r.textContent.trim())&&(a.style.display="none")})},100)}}const T=new _t,zt=[{id:"heading1",label:"Título H1",category:"Básico",media:`<svg viewBox="0 0 32 32" width="32" height="32">
...
</svg>`,D='<div class="col-cell"></div>',X=`
<style>
...
${X}`},{id:"columns-2",label:"2 Columnas",category:"Columnas",media:It,content:`
<div class="col-section">
...
${X}`},{id:"columns-3",label:"3 Columnas",category:"Columnas",media:Dt,content:`
<div class="col-section">
...
${X}`},{id:"columns-3-1",label:"2/3 — 1/3",category:"Columnas",media:Nt,content:`
<div class="col-section">
...
${X}`},{id:"columns-1-2",label:"1/4 — 1/4 — 1/2",category:"Columnas",media:Ot,content:`
<div class="col-section">
...
${X}`},{id:"columns-2-1",label:"1/2 — 1/4 — 1/4",category:"Columnas",media:Pt,content:`
<div class="col-section">
...
${X}`}],Ht=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,Yt=[{id:"about-section",label:"Nuestra Historia",category:"Contenido",media:Ht,content:`
...
${_e}`},{id:"about-mvv-section",label:"Misión, Visión y Valores",category:"Contenido",media:Ft,content:`
...
</li>`,Jt=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</svg>`,Kt=[{id:"mission-vision-values",label:"Misión, Visión y Valores",category:"Institucional",media:Jt,content:`
...
@media(max-width:480px){.pc-card{flex:0 0 80vw;}}`;function ei(i){const e=i.img||q("images/placeholder.svg"),t=i.title||"TÍTULO DEL PRODUCTO",a=i.desc||"Descripción breve del producto financiero.",r=i.href||"#",l=i.btn_label||"Solicitar";return`<div class="pc-card"><div class="pc-card-img-wrap"><img src="${e}" alt="${t}" class="pc-card-img"></div><div class="pc-card-body"><h3 class="pc-card-title">${t}</h3><p class="pc-card-desc">${a}</p></div><a href="${r}" class="pc-btn">${l}</a></div>`}function rt(i){const e=i.heading||"Créditos",t=i.subheading||"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",a=i.more_href||"#",r=i.more_label||"Ver más",l=i.show_more!==!1,p=(i.cards||[]).map(ei).join(""),d=l?`<div class="pc-more-wrap"><a href="${a}" class="pc-more-btn">${r}</a></div>`:"";return`<section class="pc-section"><style>${Zt}</style><div style="text-align:center;margin-bottom:2rem;"><h2 class="pc-section-heading">${e}</h2><p class="pc-section-subheading">${t}</p></div><div class="pc-carousel-wrap"><div class="pc-track">${p}</div></div>${d}</section>`}const H={heading:"Créditos",subheading:"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CREDINVIERTE",desc:"Adquiere activos fijos",href:"#",btn_label:"Solicitar"},{img:"",title:"SOLUCIONES INTEGRALES",desc:"Financiamiento PYME",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDI-CONFIAMOS",desc:"Rápido y sin fiador",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDILÍNEA",desc:"Línea rotativa",href:"#",btn_label:"Solicitar"}]};function ti(i,e){const t=document.getElementById("pc-config-modal");if(t&&t.remove(),!document.getElementById("pc-modal-styles")){const s=document.createElement("style");s.id="pc-modal-styles",s.textContent=`
...
</svg>`;function ai(i){const e="product-cards-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección de Productos",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-product-cards-config":JSON.stringify(H)},components:rt(H),script:at,"script-props":["data-product-cards-config"],traits:[{type:"button",label:"Productos",text:"Administrar Sección",full:!0,command:"open-product-cards-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),i.Commands.add("open-product-cards-config",{run(t){const a=t.getSelected();a&&ti(t,a)}}),i.BlockManager.add("product-cards-block",{label:"Sección de productos",category:"Productos y Servicios",media:ii,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),i.on("component:mount",t=>{t.getEl()?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>be(i),400))}),i.on("component:selected",t=>{const a=t.getEl();if(!a)return;const r=a.closest(`[data-gjs-type="${e}"]`);if(r&&!a.hasAttribute("data-gjs-type")){const o=i.getWrapper().find(`[data-gjs-type="${e}"]`).find(p=>p.getEl()===r);o&&setTimeout(()=>i.select(o),0)}}),i.on("canvas:render",()=>{setTimeout(()=>be(i),600)}),i.on("storage:end:load",()=>{setTimeout(()=>be(i),800)})}const ri=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
${ke}`},{id:"dual-card-dark",label:"Tarjeta azul oscuro",category:"Productos y Servicios",media:`<svg viewBox="0 0 32 32" width="32" height="32">
        ...
        </svg>`,content:`${ze}${ke}`},{id:"dual-card-light",label:"Tarjeta blanca",category:"Productos y Servicios",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
        ...
        </svg>`,content:`${Ae}${ke}`}],oi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<section class="cta-section">
    <div class="cta-img-wrap">
        <img src="${q("images/placeholder.svg")}" alt="Imagen CTA">
    </div>
...
@media(max-width:640px){.dd-btn-label{white-space:normal;}.dd-acc-title{white-space:normal;}}
</style>`,ci=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
    ...
    </div>`}function hi(){return function(){const i=this;if(i.__ddAccBound)return;i.__ddAccBound=!0;const e=i.querySelector(".dd-acc-header"),t=i.querySelector(".dd-acc-arrow");!e||!t||e.addEventListener("click",a=>{if(a.target.closest("a"))return;const r=i.classList.toggle("dd-acc-open");t.classList.toggle("ri-arrow-down-s-line",r),t.classList.toggle("ri-arrow-right-s-line",!r)})}}const gi=[{id:"document-download-section",label:"Sección de Documentos Descargables",category:"Documentos",media:ci,content:`
...
${se}`},{id:"document-download-button",label:"Botón de Documento",category:"Documentos",media:di,content:`${ue("Nombre_del_documento.pdf")}${se}`},{id:"document-accordion-section",label:"Sección de Documentos con Acordeón",category:"Documentos",media:fi,content:`
<section class="dd-section">
    <h2 class="text-4xl font-extrabold text-[#003B71]" contenteditable="true" data-gjs-type="text" data-gjs-editable="true">Titulo principal</h2>
    <div class="dd-stripe" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"></div>
...
${se}`},{id:"document-accordion-item",label:"Ítem de Acordeón",category:"Documentos",media:pi,content:`${Be("Nombre de la sección",!1)}${se}`}];function mi(i){const e="doc-download-button",t="doc-accordion-item";i.DomComponents.addType(e,{isComponent:a=>a.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Botón de Documento",tagName:"a",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,class:"dd-btn",href:"#"},components:`
                    <span class="dd-btn-left" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
                        <i class="ri-article-line dd-btn-icon-file" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"></i>
                ...
                `,script:hi()},init(){this.set("type",t),this.addAttributes({"data-gjs-type":t})}}}),i.Commands.add("select-doc-download-file",{run(a){const r=a.getSelected();!r||r.get("type")!==e||ve({type:"document",title:"Seleccionar documento",onSelect:(l,o)=>{r.addAttributes({href:l});const p=r.find(".dd-btn-label")[0],d=o?.name||l.split("/").pop();p&&p.components(d)}})}}),bi(i,t)}function bi(i,e){i.on("storage:end:load",()=>{setTimeout(()=>Ie(i,e),800)}),i.on("component:mount",t=>{const a=t.getEl();a?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},400))}),i.on("component:clone",t=>{if(t.get("type")===e){const a=t.getEl();a&&(delete a.__ddAccBound,setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},400))}}),i.on("canvas:render",()=>{setTimeout(()=>Ie(i,e),600)})}function Ie(i,e){i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e);const a=t.getEl();if(a?.isConnected){const r=t.get("script");r&&typeof r=="function"&&r.call(a)}})}const lt=function(){(function(){function i(t){if(!t||t.__savInit)return;t.__savInit=!0;var a=t.querySelector(".sav-carousel-wrap");if(!a)return;a.scrollLeft=0;var r=!1,l=0,o=0,p=!1,d=0,s=0,c=0,x=null;a.querySelectorAll("img").forEach(function(f){f.setAttribute("draggable","false")}),setTimeout(function(){var f=a.scrollWidth-a.clientWidth;if(f<=0)return;var y=Math.min(60,f),E=null;function v(L){E||(E=L);var _=(L-E)/400;if(_<.5)a.scrollLeft=y*(_*2);else if(_<1)a.scrollLeft=y*(1-(_-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(v)}requestAnimationFrame(v)},400);function b(){return a.scrollWidth-a.clientWidth}function u(f){return Math.max(0,Math.min(f,b()))}function g(){Math.abs(d)<.5||(d*=.92,a.scrollLeft=u(a.scrollLeft+d),x=requestAnimationFrame(g))}a.addEventListener("mousedown",function(f){f.button===0&&(x&&(cancelAnimationFrame(x),x=null),r=!0,p=!1,d=0,l=f.clientX,s=f.clientX,c=Date.now(),o=a.scrollLeft,a.style.cursor="grabbing",f.preventDefault())}),document.addEventListener("mousemove",function(f){if(r){var y=l-f.clientX;Math.abs(y)>3&&(p=!0);var E=Date.now(),v=E-c||1;d=(f.clientX-s)/v*16*-1,s=f.clientX,c=E,a.scrollLeft=u(o+y)}}),document.addEventListener("mouseup",function(f){r&&(r=!1,a.style.cursor="grab",p&&(f.stopPropagation(),x=requestAnimationFrame(g)))}),a.addEventListener("click",function(f){p&&(f.preventDefault(),f.stopPropagation(),p=!1)},!0);var B=0,j=0,m=0,k=0,h=0;a.addEventListener("touchstart",function(f){x&&(cancelAnimationFrame(x),x=null),B=f.touches[0].clientX,m=f.touches[0].clientX,k=Date.now(),j=a.scrollLeft,h=0},{passive:!0}),a.addEventListener("touchmove",function(f){var y=Date.now(),E=y-k||1,v=f.touches[0].clientX;h=(v-m)/E*16*-1,m=v,k=y;var L=B-v;a.scrollLeft=u(j+L)},{passive:!0}),a.addEventListener("touchend",function(){x=requestAnimationFrame(function f(){Math.abs(h)<.5||(h*=.92,a.scrollLeft=u(a.scrollLeft+h),x=requestAnimationFrame(f))})},{passive:!0})}function e(){document.querySelectorAll(".sav-section").forEach(function(t){delete t.__savInit,i(t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},ui=`(${lt.toString()})();`,xi=`
...
@media(max-width:480px){.sav-card{flex:0 0 75vw;}}`;function yi(i){const e=i.img||q("images/placeholder.svg"),t=i.title||"TÍTULO DEL PRODUCTO",a=i.desc?`<p class="sav-card-desc">${i.desc}</p>`:"",r=i.href||"#",l=i.btn_label||"Solicitar";return`<div class="sav-card"><div class="sav-card-img-wrap"><img src="${e}" alt="${t}" class="sav-card-img"></div><h3 class="sav-card-title">${t}</h3>${a}<a href="${r}" class="sav-btn">${l}</a></div>`}function ot(i){const e=i.heading||"Depósitos y Cuentas de Ahorro",t=i.subheading||"Productos diseñados para hacer crecer tu dinero de forma segura.",a=i.more_href||"#",r=i.more_label||"Ver más",l=i.show_more!==!1,p=(i.cards||[]).map(yi).join(""),d=q("images/brand-watermark.png"),s=l?`<div class="sav-more-wrap"><a href="${a}" class="sav-more-btn">${r}</a></div>`:"";return`<section class="sav-section"><style>${xi}</style><div class="sav-blue-box"><div class="sav-watermark"><img src="${d}" alt=""></div><div style="display:flex;flex-direction:column;gap:0.5rem;text-align:center;position:relative;z-index:1;"><h2 class="sav-heading">${e}</h2><p class="sav-subheading">${t}</p></div><div class="sav-carousel-wrap"><div class="sav-track">${p}</div></div>${s}</div></section>`}const F={heading:"Depósitos y Cuentas de Ahorro",subheading:"Productos diseñados para hacer crecer tu dinero de forma segura.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CUENTA DE AHORRO ESTÁNDAR",href:"#",btn_label:"Solicitar"},{img:"",title:"AHORRO RENTABLE",href:"#",btn_label:"Solicitar"},{img:"",title:"CUENTA DE AHORRO MÁS",href:"#",btn_label:"Solicitar"},{img:"",title:"DEPÓSITO DE PLAZO FIJO",href:"#",btn_label:"Solicitar"}]};function vi(i,e){const t=document.getElementById("sav-config-modal");if(t&&t.remove(),!document.getElementById("sav-modal-styles")){const s=document.createElement("style");s.id="sav-modal-styles",s.textContent=`
...
</svg>`;function ki(i){const e="savings-section-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección Fondo Azul",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-savings-config":JSON.stringify(F)},components:ot(F),script:lt,"script-props":["data-savings-config"],traits:[{type:"button",label:"Sección",text:"Administrar Sección",full:!0,command:"open-savings-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),i.Commands.add("open-savings-config",{run(t){const a=t.getSelected();a&&vi(t,a)}}),i.BlockManager.add("savings-section-block",{label:"Sección Fondo Azul",category:"Productos y Servicios",media:wi,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),i.on("component:mount",t=>{t.getEl()?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>xe(i),400))}),i.on("component:selected",t=>{const a=t.getEl();if(!a)return;const r=a.closest(`[data-gjs-type="${e}"]`);if(r&&!a.hasAttribute("data-gjs-type")){const l=i.getWrapper().find(`[data-gjs-type="${e}"]`).find(o=>o.getEl()===r);l&&setTimeout(()=>i.select(l),0)}}),i.on("canvas:render",()=>setTimeout(()=>xe(i),600)),i.on("storage:end:load",()=>setTimeout(()=>xe(i),800))}const De=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
</style>`,$i=[{id:"product-link-cards",label:"Tarjetas de productos con enlace",category:"Productos y Servicios",media:De,content:`
...
${Ee}`},{id:"product-link-card-orange",label:"Tarjeta producto naranja",category:"Productos y Servicios",media:De,media:Bi,content:`${K}${Ee}`},{id:"product-link-card-blue",label:"Tarjeta producto azul",category:"Productos y Servicios",media:Ei,content:`${Q}${Ee}`}],Si=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<a href="#" class="flex flex-col items-center text-center gap-4 no-underline il-link-item">
    <div class="w-16 h-16 rounded-full flex items-center justify-center shrink-0 il-icon-badge">
        <img src="${q("images/placeholder.svg")}" alt="" class="w-8 h-8 object-contain">
    </div>
...
</style>`,Li=[{id:"icon-links-strip",label:"Iconos con enlace",category:"Productos y Servicios",media:Si,content:`
...
${qe}`},{id:"icon-link-item",label:"Icono con enlace",category:"Productos y Servicios",media:Ci,content:`${Z}${qe}`}],ji=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<div class="ic-card flex items-center gap-4 sm:gap-5 md:gap-7 bg-white rounded-2xl shadow-md p-5 sm:p-6 md:p-8">
    <img src="${q("images/placeholder.svg")}" alt="Icono" class="ic-icon w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 flex-shrink-0 object-contain">
...
<section class="ic-section w-full bg-white flex flex-col gap-4 md:gap-6 p-6 sm:p-8 md:p-12 lg:px-16">
    ${$e("Título de la sección","Descripción breve del contenido asociado a este ícono, edítala directamente desde el lienzo.")}
    ${$e("Título de la sección","Descripción breve del contenido asociado a este ícono, edítala directamente desde el lienzo.")}
    ${$e("Título de la sección","Descripción breve del contenido asociado a este ícono, edítala directamente desde el lienzo.")}
</section>
${Ti}`,zi=[{id:"icon-cards-block",label:"Tarjetas con ícono",category:"Contenido",media:ji,content:_i()}],Ai=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
</style>`,Di=[{id:"promo-cta",label:"Promo con CTA y precio",category:"Llamadas a la acción",media:Ai,content:`
...
${Ii}`}],qi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<div class="fb-col-image">
    <div class="fb-img-wrap">
        <img src="${q("images/placeholder.svg")}" alt="Imagen" class="fb-img">
    </div>
</div>`,Ni=`
<style>
...
</style>`,Oe=i=>{const e=i?"fb-section-right":"fb-section-left",t=i?`<div class="fb-col-content">${Me}</div>${Ne}`:`${Ne}<div class="fb-col-content">${Me}</div>`;return`
<section class="${e}">
    <div class="fb-grid">
        ${t}
    </div>
</section>
${Ni}`},Oi=[{id:"feature-orange-img-right",label:"Sección naranja - imagen derecha",category:"Banners",media:Mi,content:Oe(!0)},{id:"feature-orange-img-left",label:"Sección naranja - imagen izquierda",category:"Banners",media:qi,content:Oe(!1)}],Pi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<style>${je}</style>`,Fi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</svg>`,Ui=[{id:"tabs-cards",label:"Sección con tabs",category:"Contenido",media:Pi,content:{type:"tabs-cards-component"}},{id:"tab-card-single",label:"Tarjeta de tab",category:"Contenido",media:Fi,content:`${R()}`}];function Vi(i){const e="tabs-cards-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección con tabs",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!0,removable:!0,attributes:{"data-gjs-type":e,"data-tab-count":"5"},components:Hi,script:Ri(),traits:[{type:"number",name:"data-tab-count",label:"Número de tabs (2-10)",min:2,max:10,changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",(t,a)=>{const r=parseInt(a["data-tab-count"]);isNaN(r)||this.updateTabCount(r)})},updateTabCount(t){const a=Math.min(10,Math.max(2,t)),r=l=>{const o=Array.from({length:l},()=>'<button class="tabs-btn inline-block px-6 py-2 rounded-full border-2 border-[#003B71] bg-transparent text-[#003B71] text-sm font-medium">Lorem Ipsum</button>').join(`
...
`);return`
            ...
            `,a.appendChild(r)}}})}const Wi=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</div>`,Qi=i=>{const e=i==="light";return`
<div class="flex flex-col gap-4">
    <h2 class="text-4xl font-bold leading-tight flex flex-wrap items-center gap-2">
...
${ra}`,la=[{id:"stats-strip-left",label:"Franja estadísticas - izquierda",category:"Heroes",media:ia,content:Re(!0)},{id:"stats-strip-right",label:"Franja estadísticas - derecha",category:"Heroes",media:aa,content:Re(!1)}],oa=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
<div class="flex flex-col items-center gap-4 text-center">
    <div class="w-20 h-20 rounded-full flex items-center justify-center shrink-0" style="background:#166EBE;">
        <img src="${q("images/placeholder.svg")}" alt="Icono" class="w-10 h-10 object-contain">
    </div>
...
${He}`},{id:"service-card-item",label:"Ítem de servicio con icono",category:"Productos y Servicios",media:na,content:`${te}${He}`}],ca=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
${Se}`},{id:"contact-info-col",label:"Contacto en columna",category:"Contacto",media:da,content:`
<section class="ci-section">
...
${Se}`},{id:"contact-info-item",label:"Ítem de contacto",category:"Contacto",media:fa,content:`
<section class="ci-section">
    <div class="ci-row-wrap">
        <div class="ci-pill-row">
            ${ie("ri-phone-fill","Contáctenos","(503)-2250-6090","tel:+50322506090")}
...
${Se}`}],ha=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#003B71" rx="2"/>
...
${Fe}`},{id:"rich-list-item",label:"Ítem de lista con descripción",category:"Contenido",media:ga,content:`
<section class="rl-section">
    <div class="rl-list">
        ${ae}
    </div>
...
<div class="pd-card items-center">
    <div class="w-12 h-12 rounded-full flex items-center justify-center shrink-0 pd-btn-orange">
        <img src="${q("images/placeholder.svg")}" alt="" class="w-6 h-6 object-contain">
    </div>
...
${pe}
${U}`},{id:"product-detail-cards-grid",label:"Detalle de producto con tarjetas",category:"Productos y Servicios",media:ya,content:`
<section class="w-full bg-white px-16 py-12">
    <div class="pd-asymmetric-grid">
        <div class="flex flex-col gap-5">
...
${pe}
${U}`},{id:"product-detail-three-col",label:"Detalle de producto (3 columnas)",category:"Productos y Servicios",media:wa,content:`
<section class="w-full bg-white px-16 py-12">
...
${ba}
${U}`},{id:"product-detail-header-grid",label:"Detalle de producto (encabezado + 2 columnas)",category:"Productos y Servicios",media:va,content:`
<section class="w-full bg-white px-16 py-12">
...
${pe}
${U}`},{id:"product-detail-bullet",label:"Ítem de ventaja",category:"Productos y Servicios",media:Ba,content:`
<ul class="list-none p-0 m-0 flex flex-col gap-3">
    ${C}
...
</div>`,La=[{id:"financing-section",label:"Sección de financiamiento",category:"Productos y Servicios",media:Ca,content:`
<section class="w-full bg-white px-16 py-12">
    <div class="flex flex-col gap-4">
...
${Ye}`},{id:"financing-card",label:"Tarjeta de financiamiento",category:"Productos y Servicios",media:Sa,content:`
<div class="fc-cards-grid">
    ${re("Lorem ipsum dolor sit amet consectetur adipiscing elit, sed do eiusmod")}
</div>
${Ye}`}],ja=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
<div class="ng-card">
    <div class="ng-card-logo">
        <img src="${q("images/placeholder.svg")}" alt="Logo" class="ng-logo-img">
    </div>
...
</div>`,_a=[{id:"news-grid-section",label:"Noticias y Publicaciones",category:"Contenido",media:ja,content:`
...
${We}`},{id:"news-card",label:"Tarjeta de noticia",category:"Contenido",media:Ta,content:`${le}${We}`}],za=`<svg viewBox="0 0 32 32" width="32" height="32">
...
<\/script>`}],Da=`<svg viewBox="0 0 32 32" width="32" height="32">
    ...
    <line x1="21" y1="2" x2="21" y2="29" stroke="#003B71" stroke-width="1" stroke-opacity="0.3"/>
            ...
            <th colspan="${i.cols}" class="p-3 align-middle text-center text-base font-bold ${t.headerBg} ${t.headerText}">
                ...
                </td>`:a+=`<td ${b} ${u} class="${E}">${s.text||""}</td>`,d+=c}),a+="</tr>"}),a+="</tbody></table>",a}function G(i,e){return{title:"Título de la tabla",cols:i,headers:Array.from({length:i},(t,a)=>({text:`Columna ${a+1}`,align:"center"})),rows:Array.from({length:e},()=>Array.from({length:i},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})))}}function st(i,e){return`<div class="w-full overflow-x-auto rounded-2xl border-2 border-[${(ye[e]||ye.blue).borderColor}]">${i}</div>`}function Ge(i,e){const t={};return i.forEach((a,r)=>{let l=0;a.forEach(o=>{for(;t[`${r}-${l}`];)l++;const p=Math.min(o.colspan||1,e-l),d=o.rowspan||1;for(let s=r;s<r+d;s++)for(let c=l;c<l+p;c++)(s!==r||c!==l)&&(t[`${s}-${c}`]=`${r}-${l}`);l+=p})}),t}const qa=`
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function Ma(){if(document.getElementById("tam-img-modal"))return;const i=document.createElement("div");i.id="tam-img-modal",i.innerHTML=`
...
.mp-map-wrapper{height:320px;}
}`;function nr(i){return String(i??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}const me='data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false"';function ct(i,e){return e=e||"mp"+Math.random().toString(36).slice(2,7),`<section id="mp-root-${e}" class="mp-section" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
        <p class="mp-stats" data-mp-stats ${me}>Cargando disponibilidad de agencias y puntos de pago...</p>
        <h2 class="mp-title" ${me}>${nr(i.title||"Horarios y Agencias:")}</h2>
        ...
        `,document.head.appendChild(d)}const r=(()=>{try{return JSON.parse(e.getAttributes()["data-map-config"]||"{}")}catch{return{}}})().title||Le.title,l=document.createElement("div");l.id="map-filter-config-modal",l.className="mp-overlay-modal";const o=document.createElement("div");o.className="mp-modal",o.innerHTML=`
        ...
        </div>`,l.appendChild(o),document.body.appendChild(l);const p=()=>l.remove();o.querySelector("#mp-modal-close").onclick=p,o.querySelector("#mp-modal-cancel").onclick=p,l.onclick=d=>{d.target===l&&p()},o.querySelector("#mp-modal-save").onclick=()=>{const d={title:o.querySelector("#mp-title").value.trim()},c=e.getEl()?.querySelector("[id^='mp-root-']")?.id?.replace("mp-root-","")||"mp"+Math.random().toString(36).slice(2,7);e.addAttributes({"data-map-config":JSON.stringify(d)}),e.components(ct(d,c)+`<style>${Te}</style>`),p()}}const dr=[{id:"map-filter-block",label:"Mapa con Filtros",category:"Interactivos",media:or,content:{type:"map-filter-component"}}];function fr(i){const e="map-filter-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Mapa con Filtros",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!1,selectable:!0,hoverable:!0,editable:!1,stylable:!1,resizable:!1,layerable:!0,highlightable:!1,attributes:{"data-gjs-type":e,"data-map-config":JSON.stringify(Le)},components:ct(Le)+`<style>${Te}</style>`,script:sr(),traits:[{type:"button",label:"Mapa con Filtros",text:"Administrar Mapa y Filtros",full:!0,command:"open-map-filter-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),i.Commands.add("open-map-filter-config",{run(t){const a=t.getSelected();a&&cr(t,a)}}),pr(i,e),hr(i,e)}function pr(i,e){i.on("storage:end:load",()=>{setTimeout(()=>Ze(i,e),1e3)}),i.on("component:mount",t=>{const a=t.getEl();a?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},500))}),i.on("component:clone",t=>{if(t.get("type")===e){const a=t.getEl();if(a){const r=a.querySelector("[data-mp-map]");r&&r._map&&(r._map.remove(),delete r._map,delete r.__mpMapInit),setTimeout(()=>{const l=t.get("script");l&&typeof l=="function"&&l.call(a)},500)}}}),i.on("canvas:render",()=>{setTimeout(()=>Ze(i,e),800)}),i.on("storage:start:store",()=>{i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e),t.addAttributes({"data-gjs-type":e})})})}function Ze(i,e){i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e);const a=t.getEl();if(a?.isConnected){const r=t.get("script");r&&typeof r=="function"&&r.call(a)}})}function hr(i,e){i.on("load",()=>{const t=i.Canvas.getFrameEl();if(!t)return;const a=t.contentDocument?.head;if(a){if(!a.querySelector("#leaflet-css")){const r=document.createElement("link");r.id="leaflet-css",r.rel="stylesheet",r.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",a.appendChild(r)}if(!a.querySelector("#mp-filter-styles")){const r=document.createElement("style");r.id="mp-filter-styles",r.textContent=Te,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=".leaflet-container{height:100%;width:100%;border-radius:inherit;z-index:0;}",a.appendChild(r)}}})}const gr=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
@media(max-width:768px){.bsk-buttons{flex-direction:column;}}`;function ur(){return function(){const i=this,e=i.ownerDocument??document,t="/adminintegral",a=(e.defaultView??window).location.origin,r=e.querySelector('meta[name="api-banners-url"]')?.content||`${a}${t}/api/banners/active`,l=["fill-blue","outline-blue","fill-orange","outline-orange","fill-white","outline-white"],o=".banner-wrapper{position:relative;width:100%;background:#003B71;overflow:hidden;}.banner-slide-container{position:relative;width:100%;user-select:none;cursor:grab;display:grid;}.banner-slide-container:active{cursor:grabbing;}.banner-slide{grid-area:1/1;opacity:0;pointer-events:none;transition:opacity 0.7s ease;visibility:hidden;display:flex;flex-direction:column;}.banner-slide.banner-slide--active{opacity:1;pointer-events:auto;visibility:visible;}.banner-slide-inner{position:relative;width:100%;flex:1;min-height:480px;display:flex;align-items:center;}.banner-bg{position:absolute;inset:0;z-index:0;}.banner-bg img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;}.banner-overlay{position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,59,113,0.85) 0%,rgba(0,59,113,0.65) 50%,rgba(0,59,113,0.2) 100%);z-index:1;}.banner-content{position:relative;z-index:10;display:flex;flex-direction:column;justify-content:center;padding:64px 64px 96px;max-width:60%;}.banner-category-badge{display:inline-block;margin-bottom:18px;padding:7px 20px;border-radius:999px;border:2px solid rgba(255,255,255,0.65);color:#fff;font-size:13px;font-weight:500;letter-spacing:0.04em;align-self:flex-start;}.banner-title{font-size:clamp(1.8rem,3.2vw,3rem);font-weight:800;color:#fff;line-height:1.15;margin:0 0 20px;}.banner-description{color:rgba(255,255,255,0.9);font-size:clamp(0.95rem,1.4vw,1.1rem);line-height:1.7;margin:0 0 36px;max-width:520px;}.banner-buttons{display:flex;flex-wrap:wrap;gap:16px;align-items:center;}.banner-btn{display:inline-block;padding:12px 32px;border-radius:999px;font-size:15px;font-weight:600;cursor:pointer;transition:background .2s,color .2s,border-color .2s;text-decoration:none;white-space:nowrap;line-height:1.4;box-sizing:border-box;}.banner-btn--fill-blue{background:#003B71;color:#ffffff;border:2px solid #003B71;}.banner-btn--fill-blue:hover{background:#002a52;border-color:#002a52;color:#ffffff;}.banner-btn--outline-blue{background:transparent;color:#003B71;border:2px solid #003B71;}.banner-btn--outline-blue:hover{background:#003B71;border-color:#003B71;color:#ffffff;}.banner-btn--fill-orange{background:#E97300;color:#ffffff;border:2px solid #E97300;}.banner-btn--fill-orange:hover{background:#c96200;border-color:#c96200;color:#ffffff;}.banner-btn--outline-orange{background:transparent;color:#E97300;border:2px solid #E97300;}.banner-btn--outline-orange:hover{background:#E97300;border-color:#E97300;color:#ffffff;}.banner-btn--fill-white{background:#ffffff;color:#003B71;border:2px solid #ffffff;}.banner-btn--fill-white:hover{background:#dce8f5;border-color:#dce8f5;color:#003B71;}.banner-btn--outline-white{background:transparent;color:#ffffff;border:2px solid #ffffff;}.banner-btn--outline-white:hover{background:#ffffff;border-color:#ffffff;color:#003B71;}.banner-dots-wrapper{display:none;}.banner-stripe{position:relative;width:100%;height:26px;background:#E97300;z-index:20;display:flex;align-items:center;justify-content:center;}.banner-dots{display:flex;gap:8px;align-items:center;}.banner-dot{width:10px;height:10px;border-radius:999px;border:none;cursor:pointer;background:rgba(255,255,255,0.5);transition:all 0.3s ease;padding:0;flex-shrink:0;}.banner-dot--active{width:28px;background:#ffffff;}.banner-empty{display:flex;align-items:center;justify-content:center;min-height:480px;color:rgba(255,255,255,0.5);font-size:14px;padding:40px;}@media(max-width:768px){.banner-slide-inner{min-height:340px;}.banner-bg img{object-position:right center;}.banner-content{max-width:100%;width:100%;padding:32px 24px 80px;}.banner-buttons{flex-wrap:wrap;gap:12px;}.banner-btn{flex:1 1 45%;min-width:140px;text-align:center;white-space:normal;word-break:break-word;}}@media(max-width:480px){.banner-btn{flex:1 1 100%;min-width:0;}}",p="@keyframes bsk-shimmer{0%{background-position:-600px 0}100%{background-position:600px 0}}.bsk-badge{width:120px;height:32px;margin-bottom:20px;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title{height:40px;margin-bottom:12px;border-radius:8px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-title--short{width:60%;}.bsk-line{height:16px;margin-bottom:10px;border-radius:6px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-line--short{width:55%;}.bsk-buttons{display:flex;gap:16px;margin-top:36px;}.bsk-btn{height:48px;flex:1;border-radius:999px;background:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.14) 50%,rgba(255,255,255,0.06) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}.bsk-bg-img{background:linear-gradient(90deg,rgba(255,255,255,0.04) 25%,rgba(255,255,255,0.09) 50%,rgba(255,255,255,0.04) 75%);background-size:600px 100%;animation:bsk-shimmer 1.6s infinite linear;}@media(max-width:768px){.bsk-buttons{flex-direction:column;}}";(function(){if(!e.getElementById("banner-hero-styles")){const w=e.createElement("style");w.id="banner-hero-styles",w.textContent=o,e.head.appendChild(w)}if(!e.getElementById("banner-skeleton-styles")){const w=e.createElement("style");w.id="banner-skeleton-styles",w.textContent=p,e.head.appendChild(w)}})();let d=[],s=0,c=null,x=!1,b=0,u=0;const g=50,B=i.dataset.autoplay!=="false",j=i.dataset.category??"",m=i.querySelector(".banner-slide-container"),k=i.querySelector(".banner-stripe");if(!m||!k)return;function h(n){return l.indexOf(n)!==-1?n:n==="outline-blue"||n==="outline-orange"?"outline-white":"fill-white"}function f(n,w,$,z){const P=h($),V=w?"a":"span",we=w?`href="${w}"${z?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${V} ${we} class="banner-btn banner-btn--${P}">${n}</${V}>`}async function y(){if(!i.__bannerLoading){i.__bannerLoading=!0,E();try{const n=await fetch(r,{headers:{Accept:"application/json"}});if(!n.ok){J();return}const w=await n.json();if(d=Array.isArray(w)?j?w.filter($=>$.category===j):w:[],d.length===0){J();return}v(),O(),N(0,!1),B&&oe()}catch{J()}finally{i.__bannerLoading=!1}}}function E(){m.innerHTML=`
                ...
                </div>`).join(""),L(),_()}function L(){m.addEventListener("mousedown",S),m.addEventListener("touchstart",S,{passive:!0}),m.addEventListener("mousemove",A),m.addEventListener("touchmove",A,{passive:!0}),m.addEventListener("mouseup",I),m.addEventListener("touchend",I),m.addEventListener("mouseleave",I)}function _(){d.forEach(n=>{const w=new Image;w.src=n.image_url})}function S(n){x=!0,b=n.touches?n.touches[0].clientX:n.clientX,u=0}function A(n){x&&(u=(n.touches?n.touches[0].clientX:n.clientX)-b)}function I(){x&&(x=!1,Math.abs(u)>=g&&(N(u<0?(s+1)%d.length:(s-1+d.length)%d.length),ne()),u=0)}function O(){if(d.length<=1){k.innerHTML="";return}const n=e.createElement("div");n.className="banner-dots",d.forEach((w,$)=>{const z=e.createElement("button");z.className="banner-dot",z.type="button",z.dataset.index=String($),z.setAttribute("aria-label",`Banner ${$+1}`),z.addEventListener("click",()=>{N($),ne()}),n.appendChild(z)}),k.innerHTML="",k.appendChild(n)}function N(n,w=!0){const $=m.querySelectorAll(".banner-slide"),z=i.querySelectorAll(".banner-dot");$.forEach((P,V)=>{const we=V===n;w||(P.style.transition="none"),P.classList.toggle("banner-slide--active",we),w||requestAnimationFrame(()=>{P.style.transition=""})}),z.forEach((P,V)=>P.classList.toggle("banner-dot--active",V===n)),s=n}function oe(){d.length<=1||!B||(c=setInterval(()=>N((s+1)%d.length),5e3))}function ne(){B&&(clearInterval(c),oe())}function J(){clearInterval(c),m.innerHTML=`
                <div class="banner-slide banner-slide--active">
                    <div class="banner-empty">Sin contenido.</div>
                </div>`,k.innerHTML=""}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",y):y()}}function xr(i,e){const t=document.getElementById("banner-hero-config-modal");if(t&&t.remove(),!document.getElementById("bnr-modal-styles")){const g=document.createElement("style");g.id="bnr-modal-styles",g.textContent=`
        ...
        <div class="bnr-modal-footer">
            ...
            <button id="bnr-modal-save" class="bnr-btn-save"><i class="ri-check-line"></i> Aplicar cambios</button>
                ...
                `,script:ur(),traits:[{type:"button",label:"Banner Slider",text:"Administrar Banner Slider",full:!0,command:"open-banner-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",()=>{const t=this.getEl();if(!t)return;const a=this.get("script");a&&typeof a=="function"&&setTimeout(()=>a.call(t),100)})}}}),i.Commands.add("open-banner-config",{run(t){const a=t.getSelected();a&&xr(t,a)}}),wr(i,e),kr(i,e)}function wr(i,e){i.on("storage:end:load",()=>{setTimeout(()=>et(i,e),1e3)}),i.on("component:mount",t=>{const a=t.getEl();a?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},500))}),i.on("component:clone",t=>{if(t.get("type")===e){const a=t.getEl();a&&setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},500)}}),i.on("canvas:render",()=>{setTimeout(()=>et(i,e),800)}),i.on("storage:start:store",()=>{i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e),t.addAttributes({"data-gjs-type":e})})})}function et(i,e){i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e);const a=t.getEl();if(a?.isConnected){const r=t.get("script");r&&typeof r=="function"&&r.call(a)}})}function kr(i,e){i.on("load",()=>{const t=i.Canvas.getFrameEl();if(!t)return;const a=t.contentDocument?.head;if(a){if(!a.querySelector("#banner-hero-styles")){const r=document.createElement("style");r.id="banner-hero-styles",r.textContent=mr,a.appendChild(r)}if(!a.querySelector("#banner-skeleton-styles")){const r=document.createElement("style");r.id="banner-skeleton-styles",r.textContent=br,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=`[data-gjs-type="${e}"] * { pointer-events: none !important; } [data-gjs-type="${e}"].gjs-selected, [data-gjs-type="${e}"].gjs-hovered { outline: 2px dashed rgba(240,135,42,0.6) !important; outline-offset: 2px; }`,a.appendChild(r)}}})}const Br=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
`;function $r(){return function(){const i=this,e=i.ownerDocument??document;e.defaultView;const t=e.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??"",a=e.querySelector('meta[name="api-assets-url"]')?.content||(t?`${t}/api/assets/active`:""),r=`
.ast-section {
    width: 100%;
    background: #ffffff;
    padding: 3rem 4rem;
...
`;if(!e.getElementById("assets-block-styles")){const m=e.createElement("style");m.id="assets-block-styles",m.textContent=r,e.head.appendChild(m)}const l=i.querySelector("[data-ast-tabs]"),o=i.querySelector("[data-ast-content]");if(!l||!o)return;const p=i.dataset.defaultCategory||"";let d=[],s="";function c(m,k){return m?m.length>k?`${m.slice(0,k).trim()}...`:m:""}function x(m){const k=m.link_is_external?' target="_blank" rel="noopener noreferrer"':"",h=m.name||c(m.short_description,60),f=m.name||m.short_description||"Activo extraordinario";return`<a href="${m.link_url}"${k} class="ast-card">
                ...
                </div>`;try{const m=await fetch(a,{headers:{Accept:"application/json"}});if(!m.ok){o.innerHTML='<div class="ast-empty">No se pudieron cargar los activos extraordinarios.</div>';return}if(d=await m.json(),!Array.isArray(d)||d.length===0){l.innerHTML='<button type="button" class="ast-tab ast-tab--active">Todos</button>',o.innerHTML='<div class="ast-empty">No hay activos extraordinarios disponibles.</div>';return}B(),g()}catch{o.innerHTML='<div class="ast-empty">No se pudieron cargar los activos extraordinarios.</div>'}}e.readyState==="loading"?e.addEventListener("DOMContentLoaded",j):j()}}const Sr=[{id:"assets-catalog",label:"Catálogo de Activos Extraordinarios",category:"Interactivos",media:Br,content:{type:"assets-catalog-component"}}];function Cr(i){const e="assets-catalog-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Catálogo de Activos Extraordinarios",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!1,removable:!0,attributes:{"data-gjs-type":e,"data-default-category":"",class:"ast-section"},components:`
                ...
                `,script:$r(),traits:[{type:"select",name:"data-default-category",label:"Categoría inicial",options:[{id:"",name:"Todas (mostrar 'Todos')"}],changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",()=>{const t=this.getEl();if(!t)return;const a=this.get("script");a&&typeof a=="function"&&setTimeout(()=>a.call(t),100)})}}}),jr(i,e),Tr(i,e),Lr(i,e)}async function Lr(i,e){try{const t=document.querySelector('meta[name="app-url"]')?.content?.replace(/\/$/,"")??"",a=await fetch(`${t}/api/asset-categories/all`,{headers:{Accept:"application/json"}});if(!a.ok)return;const r=await a.json();if(!Array.isArray(r)||r.length===0)return;const l=i.DomComponents.getType(e);if(!l)return;const p=l.model.prototype.defaults.traits.find(d=>d.name==="data-default-category");if(!p)return;p.options=[{id:"",name:"Todas (mostrar 'Todos')"},...r.map(d=>({id:d.slug,name:d.name}))]}catch{}}function jr(i,e){i.on("storage:end:load",()=>{setTimeout(()=>tt(i,e),1e3)}),i.on("component:mount",t=>{const a=t.getEl();a?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},500))}),i.on("canvas:render",()=>{setTimeout(()=>tt(i,e),800)}),i.on("storage:start:store",()=>{i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e),t.addAttributes({"data-gjs-type":e})})})}function tt(i,e){i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e);const a=t.getEl();if(a?.isConnected){const r=t.get("script");r&&typeof r=="function"&&r.call(a)}})}function Tr(i,e){i.on("load",()=>{const t=i.Canvas.getFrameEl();if(!t)return;const a=t.contentDocument?.head;if(a){if(!a.querySelector("#assets-block-styles")){const r=document.createElement("style");r.id="assets-block-styles",r.textContent=Er,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=`[data-gjs-type="${e}"] * { pointer-events: none !important; } [data-gjs-type="${e}"].gjs-selected, [data-gjs-type="${e}"].gjs-hovered { outline: 2px dashed rgba(240,135,42,0.6) !important; outline-offset: 2px; }`,a.appendChild(r)}}})}const _r="/bancaintegral",dt=`
<style>
...
.hb-btn{width:100%;text-align:center;}
...
</style>`;function ft(i,e){e=e||"hb"+Math.random().toString(36).slice(2,7);const t=i.bg_image||q("images/placeholder.svg"),a=i.btn_primary||{},r=i.btn_secondary||{},l=a.color||"white",o=r.color||"white",p=a.enabled?`<a href="${a.href||"#"}" class="hb-btn hb-btn-${l}-solid">${a.label||"Conoce más"}</a>`:"",d=r.enabled?`<a href="${r.href||"#"}" class="hb-btn hb-btn-${o}-outline">${r.label||"Solicitar"}</a>`:"";return`<section id="hb-root-${e}" class="hb-section" data-gjs-editable="false" data-gjs-selectable="false" data-gjs-hoverable="false">
    ...
    </section>`}const Y={bg_image:q("images/placeholder.svg"),title:"Cuenta de Ahorro Electrónica",subtitle:"Dale un giro digital a tus ahorros",btn_primary:{enabled:!0,label:"Abre tu cuenta",href:"#",color:"white"},btn_secondary:{enabled:!0,label:"Conoce más",href:"#",color:"white"}};function zr(i,e){const t=document.getElementById("hero-banner-config-modal");if(t&&t.remove(),!document.getElementById("hb-modal-styles")){const h=document.createElement("style");h.id="hb-modal-styles",h.textContent=`
        ...
        </svg>`,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}})}function Ir(i){T.registerBlocks(zt),T.registerBlocks(Rt),T.registerBlocks(yr),T.registerBlocks(la),T.registerBlocks(Ui),T.registerBlocks(Yt),T.registerBlocks(Kt),T.registerBlocks($i),T.registerBlocks(Li),T.registerBlocks(zi),T.registerBlocks(li),T.registerBlocks(ta),T.registerBlocks(si),T.registerBlocks(gi),T.registerBlocks(Di),T.registerBlocks(Oi),T.registerBlocks(sa),T.registerBlocks(pa),T.registerBlocks(ma),T.registerBlocks(_a),T.registerBlocks(Ia),T.registerBlocks(Pa),T.registerBlocks(er),T.registerBlocks(lr),T.registerBlocks($a),T.registerBlocks(La),T.registerBlocks(dr),T.registerBlocks(Sr),T.applyToEditor(i),fr(i),vr(i),Ar(i),ki(i),ai(i),tr(i),Vi(i),Ra(i),mi(i),Cr(i)}function Dr(i,e,t){i.on("component:add",()=>e.markAsDirty()),i.on("component:remove",()=>e.markAsDirty()),i.on("component:update",()=>e.markAsDirty()),i.on("style:update",()=>e.markAsDirty());const a=document.getElementById("save-button");a&&a.addEventListener("click",async()=>{await qr(i,e,t,a)}),document.addEventListener("keydown",r=>{(r.ctrlKey||r.metaKey)&&r.key==="s"&&(r.preventDefault(),a&&!a.disabled&&a.click())})}async function qr(i,e,t,a){a.disabled=!0,a.innerHTML='<i class="ri-loader-4-line animate-spin"></i><span>Guardando...</span>';try{t.needsTitle()?await Mr(i,e,t):await pt(i,e,t)}catch(r){ht(r.message,"error")}finally{a.disabled=!1,a.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}}async function Mr(i,e,t){return new Promise((a,r)=>{mt({title:"Título de la Página",description:"Ingresa un título descriptivo para identificar esta página",placeholder:"Ej: Acerca de Nosotros",icon:"ri-file-text-line",iconBg:"#dbeafe",iconColor:"#2563eb",confirmLabel:"Guardar",onConfirm:async l=>{if(!l?.trim()){r(new Error("El título es obligatorio"));return}try{await pt(i,e,t,l),a()}catch(o){r(o)}},onCancel:()=>{r(new Error("Guardado cancelado"))}})})}async function pt(i,e,t,a=null){const l={...e.getEditorContent(i),is_published:t.isPublished};a&&(l.title=a);const o=await e.savePage(i,l,t.storeUrl,t.getHttpMethod());o.success&&(e.markAsClean(),ht(o.message,"success"),!t.isEditMode&&o.page?(t.updatePageInfo(o),t.updateTitle(o.page.title)):a&&t.updateTitle(a))}function ht(i,e){typeof window.showNotification=="function"&&window.showNotification(i,e)}document.addEventListener("DOMContentLoaded",async()=>{const i=new bt,e=new Lt;new jt(i);const t=ut();if(t.on("load",()=>{Ir(t),xt(t),yt(),vt(),wt(t),kt(t),Bt(t),Et(t),$t(t),St(t),Nr(t),Or(t),Pr(t),setTimeout(()=>{t.runCommand("sw-visibility"),t.Panels.getButton("options","sw-visibility")?.set("active",!0)},100)}),e.isEditMode)try{await i.loadPageContent(t,e.loadUrl),it("Contenido cargado correctamente","success")}catch(a){it("Error al cargar el contenido","error"),console.error(a)}Dr(t,i,e)});function Nr(i){const e=[{cmd:"set-device-desktop",device:"Desktop"},{cmd:"set-device-tablet",device:"Tablet"},{cmd:"set-device-mobile",device:"Mobile"}];e.forEach(({cmd:t,device:a})=>{i.Commands.add(t,{run:r=>{r.setDevice(a),e.forEach(({cmd:l})=>{r.Panels.getButton("devices-c",l)?.set("active",l===t)})}})})}function Or(i){i.Commands.add("canvas-clear",{run:e=>{Ct({title:"Limpiar canvas",description:"¿Estás seguro de que quieres eliminar todo el contenido del canvas? Esta acción no se puede deshacer.",icon:"ri-delete-bin-line",iconBg:"#fef2f2",iconColor:"#dc2626",confirmLabel:"Limpiar todo",confirmColor:"#dc2626",onConfirm:()=>{e.DomComponents.clear(),e.CssComposer.clear()}})}})}function Pr(i){const e=i.Canvas.getFrameEl();if(!e?.contentDocument?.head)return;const t=e.contentDocument.createElement("style");t.id="gjs-dashed-fix",t.textContent="body,body.gjs-dashed{margin:0!important;padding:0 0 160px 0!important;}",e.contentDocument.head.appendChild(t)}function it(i,e="info"){typeof window.showNotification=="function"&&window.showNotification(i,e)}
