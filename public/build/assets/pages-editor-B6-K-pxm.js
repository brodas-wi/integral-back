/* empty css                   *//* empty css                    *//* empty css                          *//* empty css                           */import{o as Fe,M as Re,j as Ue,E as Ve,i as Ye,t as We,d as Xe,f as Ge,e as Je,s as Ze,g as Ke,c as Qe,b as et,a as tt,h as it}from"./editor-commands-Bq37dEX4.js";import{a as P}from"./url-DaqOO3yL.js";import"./_commonjsHelpers-CqkleIqs.js";class at{constructor(){this.pageId=this.getElementValue("page-id"),this.pageSlug=this.getElementValue("page-slug"),this.pageTitle=this.getPageTitle(),this.loadUrl=this.getElementValue("page-load-url"),this.storeUrl=this.getElementValue("page-store-url"),this.isPublished=this.getElementValue("page-is-published")==="1",this.isEditMode=!!this.pageId,this.appUrl=(document.querySelector('meta[name="app-url"]')?.content??"").replace(/\/$/,"")}getElementValue(e,t=""){const a=document.getElementById(e);return a?a.value.trim():t}getPageTitle(){const e=document.getElementById("editor-title");if(!e)return"";const a=e.textContent.match(/(?:Editando:|Nueva Página)\s*(.+)?/);return a&&a[1]?a[1].trim():""}updatePageInfo(e){if(e.page)if(this.pageId=e.page.id,this.pageSlug=e.page.slug,this.pageTitle=e.page.title,this.isEditMode=!0,document.getElementById("page-id").value=this.pageId,document.getElementById("page-slug").value=this.pageSlug,e.page.update_url?this.storeUrl=e.page.update_url:this.storeUrl=`${this.appUrl}/pages/${this.pageSlug}`,document.getElementById("page-store-url").value=this.storeUrl,e.page.load_url?this.loadUrl=e.page.load_url:this.loadUrl=`${this.appUrl}/pages/${this.pageSlug}/load`,document.getElementById("page-load-url").value=this.loadUrl,e.page.edit_url)window.history.replaceState(null,"",e.page.edit_url);else try{const t=new URL(window.location.href);t.pathname=t.pathname.replace(/\/pages\/create\/?$/,`/pages/${this.pageSlug}/edit`),window.history.replaceState(null,"",t.toString())}catch(t){console.error("Error updating browser URL:",t)}}updateTitle(e){this.pageTitle=e;const t=document.getElementById("editor-title");t&&(t.textContent=`Editando: ${e}`),document.title=`Editar: ${e} - Editor`}getHttpMethod(){return this.isEditMode?"PUT":"POST"}needsTitle(){return!this.isEditMode}}class rt{constructor(e){this.editorService=e,this.setupBackButton(),this.setupBeforeUnload()}setupBackButton(){const e=document.querySelector("#editor-navbar a[href]");e&&e.addEventListener("click",t=>{this.editorService.shouldPreventUnload()&&(t.preventDefault(),this.showUnsavedChangesModal(()=>{this.editorService.startNavigation(),window.location.href=e.href}))})}setupBeforeUnload(){window.addEventListener("beforeunload",e=>{if(this.editorService.shouldPreventUnload())return e.preventDefault(),e.returnValue="Tienes cambios sin guardar. ¿Estás seguro de que quieres salir?",e.returnValue})}showUnsavedChangesModal(e){const t=document.createElement("div");t.style.cssText=`
        ...
        `;const d=document.createElement("button");d.textContent="Salir sin guardar",d.style.cssText=`
            ...
            font-family: inherit;
        `,[s,d].forEach(f=>{f.addEventListener("mouseenter",()=>{f.style.opacity="0.85"}),f.addEventListener("mouseleave",()=>{f.style.opacity="1"})});const h=()=>t.remove();s.addEventListener("click",h),d.addEventListener("click",()=>{h(),e()}),t.addEventListener("click",f=>{f.target===t&&h()}),l.appendChild(s),l.appendChild(d),a.appendChild(r),a.appendChild(l),t.appendChild(a),document.body.appendChild(t)}}const lt="Básico";class ot{constructor(){this.blocks=new Map}registerBlock(e,t){this.blocks.has(t.category)||this.blocks.set(t.category,[]),this.blocks.get(t.category).push({id:e,...t})}registerBlocks(e){e.forEach(t=>{this.registerBlock(t.id,t)})}applyToEditor(e){this.blocks.forEach(t=>{t.forEach(a=>{const{id:r,...l}=a;e.BlockManager.add(r,l)})}),this.applyCollapseSettings(e),this.hideDefaultCategories(e)}applyCollapseSettings(e){setTimeout(()=>{e.BlockManager.getCategories().each(t=>{t.set("open",t.get("label")===lt)})},500)}hideDefaultCategories(e){setTimeout(()=>{const t=["Basic","Extra"];document.querySelectorAll(".gjs-block-category").forEach(a=>{const r=a.querySelector(".gjs-title");r&&t.includes(r.textContent.trim())&&(a.style.display="none")})},100)}}const _=new ot,nt=[{id:"heading1",label:"Título H1",category:"Básico",media:`<svg viewBox="0 0 32 32" width="32" height="32">
...
${xe}`}],qe=function(){(function(){function i(t){if(!t||t.__pcInit)return;t.__pcInit=!0;var a=t.querySelector(".pc-carousel-wrap");if(!a)return;var r=!1,l=0,s=0,d=!1,h=0,f=0,x=0,y=null;a.querySelectorAll("img").forEach(function(b){b.setAttribute("draggable","false")}),setTimeout(function(){var b=m();if(b<=0)return;var w=Math.min(80,b),S=null;function u(L){S||(S=L);var D=(L-S)/900;if(D<.5)a.scrollLeft=w*(D*2);else if(D<1)a.scrollLeft=w*(1-(D-.5)*2);else{a.scrollLeft=0;return}requestAnimationFrame(u)}requestAnimationFrame(u)},600),a.scrollLeft=0;function m(){return a.scrollWidth-a.clientWidth}function n(b){return Math.max(0,Math.min(b,m()))}function g(){Math.abs(h)<.5||(h*=.92,a.scrollLeft=n(a.scrollLeft+h),y=requestAnimationFrame(g))}a.addEventListener("mousedown",function(b){b.button===0&&(y&&(cancelAnimationFrame(y),y=null),r=!0,d=!1,h=0,l=b.clientX,f=b.clientX,x=Date.now(),s=a.scrollLeft,a.style.cursor="grabbing",b.preventDefault())}),document.addEventListener("mousemove",function(b){if(r){var w=l-b.clientX;Math.abs(w)>3&&(d=!0);var S=Date.now(),u=S-x||1;h=(b.clientX-f)/u*16*-1,f=b.clientX,x=S,a.scrollLeft=n(s+w)}}),document.addEventListener("mouseup",function(b){r&&(r=!1,a.style.cursor="grab",d&&(b.stopPropagation(),y=requestAnimationFrame(g)))}),a.addEventListener("click",function(b){d&&(b.preventDefault(),b.stopPropagation(),d=!1)},!0);var k=0,z=0,v=0,$=0,j=0;a.addEventListener("touchstart",function(b){y&&(cancelAnimationFrame(y),y=null),k=b.touches[0].clientX,v=b.touches[0].clientX,$=Date.now(),z=a.scrollLeft,j=0},{passive:!0}),a.addEventListener("touchmove",function(b){var w=Date.now(),S=w-$||1,u=b.touches[0].clientX;j=(u-v)/S*16*-1,v=u,$=w;var L=k-u;a.scrollLeft=n(z+L)},{passive:!0}),a.addEventListener("touchend",function(){y=requestAnimationFrame(function b(){Math.abs(j)<.5||(j*=.92,a.scrollLeft=n(a.scrollLeft+j),y=requestAnimationFrame(b))})},{passive:!0})}function e(){document.querySelectorAll(".pc-section").forEach(function(t){delete t.__pcInit,i(t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})()},Bt=`(${qe.toString()})();`,Et=`
...
@media(max-width:480px){.pc-card{flex:0 0 80vw;}}`;function $t(i){const e=i.img||P("images/placeholder.svg"),t=i.title||"TÍTULO DEL PRODUCTO",a=i.desc||"Descripción breve del producto financiero.",r=i.href||"#",l=i.btn_label||"Solicitar";return`<div class="pc-card"><div class="pc-card-img-wrap"><img src="${e}" alt="${t}" class="pc-card-img"></div><div class="pc-card-body"><h3 class="pc-card-title">${t}</h3><p class="pc-card-desc">${a}</p></div><a href="${r}" class="pc-btn">${l}</a></div>`}function Me(i){const e=i.heading||"Créditos",t=i.subheading||"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",a=i.more_href||"#",r=i.more_label||"Ver más",s=(i.cards||[]).map($t).join("");return`<section class="pc-section"><style>${Et}</style><div style="text-align:center;margin-bottom:2rem;"><h2 class="pc-section-heading">${e}</h2><p class="pc-section-subheading">${t}</p></div><div class="pc-carousel-wrap"><div class="pc-track">${s}</div></div><div class="pc-more-wrap"><a href="${a}" class="pc-more-btn">${r}</a></div></section>`}const N={heading:"Créditos",subheading:"Opciones de financiamiento diseñadas para hacer realidad tus proyectos.",more_href:"#",more_label:"Ver más",cards:[{img:"",title:"CREDINVIERTE",desc:"Adquiere activos fijos",href:"#",btn_label:"Solicitar"},{img:"",title:"SOLUCIONES INTEGRALES",desc:"Financiamiento PYME",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDI-CONFIAMOS",desc:"Rápido y sin fiador",href:"#",btn_label:"Solicitar"},{img:"",title:"CREDILÍNEA",desc:"Línea rotativa",href:"#",btn_label:"Solicitar"}]};function Ct(i,e){const t=document.getElementById("pc-config-modal");if(t&&t.remove(),!document.getElementById("pc-modal-styles")){const f=document.createElement("style");f.id="pc-modal-styles",f.textContent=`
        ...
        `,document.head.appendChild(f)}const a=(()=>{try{return JSON.parse(e.getAttributes()["data-product-cards-config"]||"{}")}catch{return{}}})(),r={heading:a.heading??N.heading,subheading:a.subheading??N.subheading,autoplay:a.autoplay??N.autoplay,more_href:a.more_href??N.more_href,more_label:a.more_label??N.more_label,cards:JSON.parse(JSON.stringify(a.cards??N.cards))},l=document.createElement("div");l.id="pc-config-modal",l.className="pc-overlay";const s=document.createElement("div");s.className="pc-modal",s.innerHTML=`
        ...
        <div class="pc-modal-footer">
            ...
            <button id="pc-modal-save" class="pc-btn-save"><i class="ri-check-line"></i> Aplicar cambios</button>
        </div>`,l.appendChild(s),document.body.appendChild(l),s.querySelectorAll(".pc-tab-btn").forEach(f=>{f.addEventListener("click",()=>{s.querySelectorAll(".pc-tab-btn").forEach(x=>x.classList.remove("active")),s.querySelectorAll(".pc-tab-panel").forEach(x=>x.classList.remove("active")),f.classList.add("active"),s.querySelector(`#pc-panel-${f.dataset.tab}`).classList.add("active")})});function d(){const f=s.querySelector("#pc-cards-list");f.innerHTML="",r.cards.forEach((x,y)=>{const m=document.createElement("div");m.className="pc-card-config";const n=x.img?`<img class="pc-img-preview" src="${x.img}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>';m.innerHTML=`
                ...
                <div class="pc-row">
                    <div id="pc-img-wrap-${y}">${n}</div>
                    <div style="flex:1;display:flex;flex-direction:column;gap:0.5rem;">
                        <input class="pc-input-sm" placeholder="URL de la imagen" value="${x.img||""}" data-field="img">
                        <button class="pc-pick-btn pc-pick-img"><i class="ri-image-line"></i> Seleccionar imagen</button>
                    </div>
                </div>
                <div>
                    <label class="pc-label">Título</label>
                    <input class="pc-input" placeholder="TÍTULO DEL PRODUCTO" value="${x.title||""}" data-field="title">
                </div>
                <div>
                    <label class="pc-label">Descripción</label>
                    <input class="pc-input" placeholder="Descripción breve" value="${x.desc||""}" data-field="desc">
                </div>
                <div class="pc-row">
                    <div style="flex:1;">
                        <label class="pc-label">URL del botón</label>
                        <input class="pc-input" placeholder="#" value="${x.href||"#"}" data-field="href">
                    </div>
                    <div style="flex:1;">
                        <label class="pc-label">Texto del botón</label>
                        <input class="pc-input" placeholder="Solicitar" value="${x.btn_label||"Solicitar"}" data-field="btn_label">
                    </div>
                </div>`,m.querySelectorAll("[data-field]").forEach(g=>{g.addEventListener("input",()=>{if(x[g.dataset.field]=g.value,g.dataset.field==="img"){const k=m.querySelector(`#pc-img-wrap-${y}`);k.innerHTML=g.value?`<img class="pc-img-preview" src="${g.value}" alt="">`:'<div class="pc-img-placeholder"><i class="ri-image-line"></i></div>'}})}),m.querySelector(".pc-pick-img").addEventListener("click",()=>{Fe({type:"image",title:"Seleccionar imagen de tarjeta",onSelect:g=>{x.img=g,m.querySelector("[data-field='img']").value=g,m.querySelector(`#pc-img-wrap-${y}`).innerHTML=`<img class="pc-img-preview" src="${g}" alt="">`}})}),m.querySelector(".pc-remove-card").addEventListener("click",()=>{r.cards.splice(y,1),d()}),f.appendChild(m)})}d(),s.querySelector("#pc-add-card").addEventListener("click",()=>{r.cards.push({img:"",title:"NUEVO PRODUCTO",desc:"Descripción del producto.",href:"#",btn_label:"Solicitar"}),d(),s.querySelector("#pc-cards-list").lastElementChild?.scrollIntoView({behavior:"smooth",block:"nearest"})});const h=()=>l.remove();s.querySelector("#pc-modal-close").addEventListener("click",h),s.querySelector("#pc-modal-cancel").addEventListener("click",h),l.addEventListener("click",f=>{f.target===l&&h()}),s.querySelector("#pc-modal-save").addEventListener("click",()=>{r.heading=s.querySelector("#pc-heading").value.trim()||N.heading,r.subheading=s.querySelector("#pc-subheading").value.trim()||N.subheading,r.more_label=s.querySelector("#pc-more-label").value.trim()||N.more_label,r.more_href=s.querySelector("#pc-more-href").value.trim()||"#",e.addAttributes({"data-product-cards-config":JSON.stringify(r)}),e.components(Me(r)),setTimeout(()=>de(i),300),h()})}function de(i){try{const e=i.Canvas.getFrameEl()?.contentDocument;if(!e)return;const t=e.getElementById("pc-runtime-script");t&&t.remove(),e.querySelectorAll(".pc-section").forEach(r=>{delete r.__pcInit});const a=e.createElement("script");a.id="pc-runtime-script",a.textContent=Bt,e.head.appendChild(a)}catch(e){console.warn("[ProductCards] Error reiniciando carrusel:",e)}}const St=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</svg>`;function Lt(i){const e="product-cards-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección de Productos",tagName:"div",draggable:!0,droppable:!1,removable:!0,copyable:!0,selectable:!0,hoverable:!0,editable:!1,highlightable:!1,attributes:{"data-gjs-type":e,"data-product-cards-config":JSON.stringify(N)},components:Me(N),script:qe,"script-props":["data-product-cards-config"],traits:[{type:"button",label:"Productos",text:"Administrar Sección",full:!0,command:"open-product-cards-config"}],toolbar:[]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),i.Commands.add("open-product-cards-config",{run(t){const a=t.getSelected();a&&Ct(t,a)}}),i.BlockManager.add("product-cards-block",{label:"Sección de productos",category:"Productos y Servicios",media:St,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}}),i.on("component:mount",t=>{t.getEl()?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>de(i),400))}),i.on("component:selected",t=>{const a=t.getEl();if(!a)return;const r=a.closest(`[data-gjs-type="${e}"]`);if(r&&!a.hasAttribute("data-gjs-type")){const s=i.getWrapper().find(`[data-gjs-type="${e}"]`).find(d=>d.getEl()===r);s&&setTimeout(()=>i.select(s),0)}}),i.on("canvas:render",()=>{setTimeout(()=>de(i),600)}),i.on("storage:end:load",()=>{setTimeout(()=>de(i),800)})}const jt=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</svg>`,Gt=[{id:"tabs-cards",label:"Sección con tabs",category:"Contenido",media:Vt,content:{type:"tabs-cards-component"}},{id:"tab-card-single",label:"Tarjeta de tab",category:"Contenido",media:Xt,content:`${q()}`}];function Jt(i){const e="tabs-cards-component";i.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Sección con tabs",tagName:"section",draggable:!0,droppable:!1,editable:!1,stylable:!1,resizable:!1,selectable:!0,hoverable:!0,layerable:!0,highlightable:!1,copyable:!0,removable:!0,attributes:{"data-gjs-type":e,"data-tab-count":"5"},components:Wt,script:Yt(),traits:[{type:"number",name:"data-tab-count",label:"Número de tabs (2-10)",min:2,max:10,changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",(t,a)=>{const r=parseInt(a["data-tab-count"]);isNaN(r)||this.updateTabCount(r)})},updateTabCount(t){const a=Math.min(10,Math.max(2,t)),r=l=>{const s=Array.from({length:l},()=>'<button class="tabs-btn inline-block px-6 py-2 rounded-full border-2 border-[#003B71] bg-transparent text-[#003B71] text-sm font-medium">Lorem Ipsum</button>').join(`
...
`);return`
            ...
            `,a.appendChild(r)}}})}const Qt=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
</style>`,oe=(i,e)=>{const t=ai(e),a=ri(),r=e==="dark"?"bg-[#003B71]":"bg-white",l=i?`<div>${t}</div><div>${a}</div>`:`<div class="split-img-mobile-first">${a}</div><div>${t}</div>`;return`
...
</svg>`,fe={blue:{headerBg:"bg-[#003B71]",headerText:"text-white",subheaderBg:"bg-[#e8f0f8]",subheaderText:"text-[#003B71]",borderColor:"#003B71",rowEvenBg:"bg-[#f4f7fb]",rowOddBg:"bg-white",rowText:"text-[#003B71]",labelBg:"bg-[#e8f0f8]",labelText:"text-[#003B71]"},orange:{headerBg:"bg-[#E97300]",headerText:"text-white",subheaderBg:"bg-[#fef3e8]",subheaderText:"text-[#E97300]",borderColor:"#E97300",rowEvenBg:"bg-[#fff8f2]",rowOddBg:"bg-white",rowText:"text-[#003B71]",labelBg:"bg-[#fef3e8]",labelText:"text-[#E97300]"}};function Ne(i,e){const t=fe[e]||fe.blue;let a='<table class="w-full border-collapse font-[Poppins,sans-serif] table-fixed">';i.title?(a+=`<thead><tr>
            <th colspan="${i.cols}" class="p-3 align-middle text-center text-base font-bold ${t.headerBg} ${t.headerText}">
                ${i.title}
            </th>
        </tr>`,i.headers?.length&&(a+="<tr>",i.headers.forEach((s,d)=>{const h=d<i.headers.length-1?`border-r border-[${t.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${t.subheaderBg} ${t.subheaderText} ${h} border-b border-[${t.borderColor}] text-${s.align||"center"}">${s.text||""}</th>`}),a+="</tr>"),a+="</thead>"):i.headers?.length&&(a+="<thead><tr>",i.headers.forEach((s,d)=>{const h=d<i.headers.length-1?`border-r border-[${t.borderColor}]`:"";a+=`<th class="p-3 align-middle text-sm font-semibold ${t.headerBg} ${t.headerText} ${h} border-b border-[${t.borderColor}] text-${s.align||"center"}">${s.text||""}</th>`}),a+="</tr></thead>"),a+="<tbody>";const r=i.rows.length,l={};return i.rows.forEach((s,d)=>{a+="<tr>";let h=0;s.forEach(f=>{for(;l[`${d}-${h}`];)h++;const x=f.colspan||1,y=f.rowspan||1;for(let u=d;u<d+y;u++)for(let L=h;L<h+x;L++)(u!==d||L!==h)&&(l[`${u}-${L}`]=!0);const m=x>1?`colspan="${x}"`:"",n=y>1?`rowspan="${y}"`:"",g=f.isHeader?t.labelBg:d%2===0?t.rowEvenBg:t.rowOddBg,k=f.isHeader?"font-semibold":"font-normal",z=f.isHeader?t.labelText:t.rowText,v=`text-${f.align||"center"}`,$=d+y>=r,b=h+x>=i.cols?"":`border-r border-[${t.borderColor}]`,w=$?"":`border-b border-[${t.borderColor}]`,S=`${b} ${w} p-3 align-middle text-sm ${g} ${k} ${z} ${v}`;f.image?a+=`<td ${m} ${n} class="${S}">
                ...
                </td>`:a+=`<td ${m} ${n} class="${S}">${f.text||""}</td>`,h+=x}),a+="</tr>"}),a+="</tbody></table>",a}function Z(i,e){return{title:"Título de la tabla",cols:i,headers:Array.from({length:i},(t,a)=>({text:`Columna ${a+1}`,align:"center"})),rows:Array.from({length:e},()=>Array.from({length:i},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})))}}function Pe(i,e){return`<div class="w-full overflow-x-auto rounded-2xl border-2 border-[${(fe[e]||fe.blue).borderColor}]">${i}</div>`}function Le(i,e){const t={};return i.forEach((a,r)=>{let l=0;a.forEach(s=>{for(;t[`${r}-${l}`];)l++;const d=Math.min(s.colspan||1,e-l),h=s.rowspan||1;for(let f=r;f<r+h;f++)for(let x=l;x<l+d;x++)(f!==r||x!==l)&&(t[`${f}-${x}`]=`${r}-${l}`);l+=d})}),t}const Ci=`
...
.tam-img-selected-info{font-size:0.8rem;color:#6b7280;}`;function Si(){if(document.getElementById("tam-img-modal"))return;const i=document.createElement("div");i.id="tam-img-modal",i.innerHTML=`
        ...
        </div>`,document.body.appendChild(i);let e=null,t=null;async function a(d=""){const h=document.getElementById("tam-img-grid");h.innerHTML='<div class="tam-img-loading"><div class="tam-img-spinner"></div><span>Cargando...</span></div>';try{const f=new URLSearchParams({type:"image",per_page:50});d&&f.append("search",d);const x=document.querySelector('meta[name="media-api-url"]')?.content??"/media/api",n=(await(await fetch(`${x}?${f}`,{headers:{"X-Requested-With":"XMLHttpRequest",Accept:"application/json"}})).json()).items||[];if(!n.length){h.innerHTML='<div class="tam-img-loading"><i class="ri-image-line" style="font-size:2rem;"></i><span>No se encontraron imágenes</span></div>';return}h.innerHTML="",n.forEach(g=>{const k=document.createElement("div");k.className="tam-img-card",k.innerHTML=`<img src="${g.url}" alt="${g.filename}"><p title="${g.filename}">${g.filename}</p>`,k.addEventListener("click",()=>{h.querySelectorAll(".tam-img-card").forEach(z=>z.classList.remove("selected")),k.classList.add("selected"),e=g.url,document.getElementById("tam-img-selected-info").textContent=`Seleccionada: ${g.filename}`,document.getElementById("tam-img-confirm").disabled=!1}),h.appendChild(k)})}catch{h.innerHTML='<div class="tam-img-loading"><i class="ri-error-warning-line" style="font-size:2rem;color:#f87171;"></i><span style="color:#dc2626;">Error al cargar imágenes</span></div>'}}function r(d){t=d,e=null,document.getElementById("tam-img-selected-info").textContent="Ninguna imagen seleccionada",document.getElementById("tam-img-confirm").disabled=!0,document.getElementById("tam-img-search-input").value="",i.classList.add("open"),a()}function l(){i.classList.remove("open"),e=null,t=null}document.getElementById("tam-img-close").addEventListener("click",l),document.getElementById("tam-img-cancel").addEventListener("click",l),document.getElementById("tam-img-confirm").addEventListener("click",()=>{e&&t&&(t(e),l())});let s;document.getElementById("tam-img-search-input").addEventListener("input",d=>{clearTimeout(s),s=setTimeout(()=>a(d.target.value),300)}),i.addEventListener("click",d=>{d.target===i&&l()}),window.__openTableImagePicker=r}function Li(i,e){if(document.getElementById("table-admin-modal"))return;const t=document.createElement("style");t.id="table-admin-modal-styles",t.textContent=Ci,document.head.appendChild(t),Si();const a=document.createElement("div");a.id="table-admin-modal",a.innerHTML=`
        <div class="tam-container">
        ...
        </div>`,document.body.appendChild(a);let r=null,l=null;function s(m){r=m;const n=m.get("tableData");l=n?JSON.parse(JSON.stringify(n)):Z(3,3);const g=l.cols||3;l.rows=l.rows.map((k,z)=>Array.from({length:g},($,j)=>k[j]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})),document.getElementById("tam-title").value=l.title||"",document.getElementById("tam-theme").value=m.get("tableTheme")||"blue",document.getElementById("tam-cols").value=l.cols||3,document.getElementById("tam-rows").value=l.rows.length||3,x(),y(),a.classList.add("open"),document.body.style.overflow="hidden"}function d(){a.classList.remove("open"),document.body.style.overflow="",r=null}function h(){l.title=document.getElementById("tam-title").value.trim(),l.cols=parseInt(document.getElementById("tam-cols").value)||3,l.headers=Array.from(document.querySelectorAll(".tam-header-input")).map(n=>({text:n.value,align:n.closest("th")?.querySelector(".tam-align-select")?.value||"center"})),document.querySelectorAll("#tam-tbody td.tam-cell:not(.is-spanned)").forEach(n=>{const g=parseInt(n.dataset.row),k=parseInt(n.dataset.col);l.rows[g]?.[k]&&(l.rows[g][k].text=n.querySelector(".tam-cell-input")?.value||"",l.rows[g][k].align=n.querySelector(".tam-align-select")?.value||"center",l.rows[g][k].isHeader=n.dataset.isheader==="1",l.rows[g][k].image=n.dataset.image||null)});const m=Le(l.rows,l.cols);l.rows=l.rows.map((n,g)=>n.filter((k,z)=>!m[`${g}-${z}`]))}function f(){if(a.querySelector("#tam-rebuild-notice"))return;const n=document.createElement("div");n.id="tam-rebuild-notice",n.style.cssText="background:#fef9c3;border:1.5px solid #ca8a04;border-radius:0.5rem;padding:0.5rem 1rem;font-size:0.8rem;color:#92400e;display:flex;align-items:center;gap:0.5rem;margin:0 1.5rem 0;flex-shrink:0;",n.innerHTML='<i class="ri-error-warning-line"></i> Has modificado el colspan/rowspan. Haz clic en <strong style="margin:0 4px;">Reconstruir</strong> para aplicar los cambios de fusión.',a.querySelector(".tam-toolbar").after(n)}function x(){a.querySelector("#tam-rebuild-notice")?.remove()}function y(){const m=document.getElementById("tam-thead"),n=document.getElementById("tam-tbody"),g=l.cols,k=l.rows.length,z=Le(l.rows,g);m.innerHTML=`<tr>${l.headers.map((v,$)=>`
            <th>
                ...
                <select class="tam-align-select" style="margin-top:4px;width:100%;font-size:0.7rem;padding:2px;">
            ...
            </th>`).join("")}</tr>`,n.innerHTML=l.rows.map((v,$)=>`<tr>${Array.from({length:g},(b,w)=>{const S=z[`${$}-${w}`];if(S)return`<td class="tam-cell is-spanned" data-row="${$}" data-col="${w}">
                        <div class="tam-spanned-label">Combinada con [${S}]</div>
                    </td>`;const u=v[w]||{text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null},L=u.colspan||1,D=u.rowspan||1,T=L>1||D>1;return`<td class="tam-cell ${u.isHeader?"is-header-cell":""} ${u.image?"has-image":""} ${T?"has-span":""}"
                    data-row="${$}" data-col="${w}"
                    ...
                    <div class="tam-cell-actions">
                        <button type="button" class="tam-cell-btn tam-cell-btn-header ${u.isHeader?"active":""}"
                            data-action="header" data-row="${$}" data-col="${w}">
                            ${u.isHeader?"✓ Etiqueta":"Etiqueta"}
                        </button>
                        <button type="button" class="tam-cell-btn tam-cell-btn-img"
                            data-action="image" data-row="${$}" data-col="${w}">
                            <i class="ri-image-line"></i> ${u.image?"Cambiar":"Imagen"}
                        </button>
                        ${u.image?`<button type="button" class="tam-cell-btn tam-cell-btn-clear" data-action="clear-image" data-row="${$}" data-col="${w}">✕ Quitar</button>`:""}
                        <div class="tam-cell-span-group">
                            <label title="Columnas que ocupa">CS</label>
                            <input type="number" class="tam-cell-span-input" min="1" max="${g-w}"
                                value="${L}" data-action="colspan" data-row="${$}" data-col="${w}">
                            <label title="Filas que ocupa">RS</label>
                            <input type="number" class="tam-cell-span-input" min="1" max="${k-$}"
                                value="${D}" data-action="rowspan" data-row="${$}" data-col="${w}">
                        </div>
                    </div>
                </td>`}).join("")}</tr>`).join(""),n.querySelectorAll("input[data-action=colspan], input[data-action=rowspan]").forEach(v=>{v.addEventListener("change",()=>{const $=parseInt(v.dataset.row),j=parseInt(v.dataset.col),b=Math.max(1,parseInt(v.value)||1);l.rows[$]?.[j]&&(v.dataset.action==="colspan"?l.rows[$][j].colspan=Math.min(b,g-j):l.rows[$][j].rowspan=Math.min(b,k-$),f())})}),n.querySelectorAll("button[data-action]").forEach(v=>{v.addEventListener("click",$=>{$.preventDefault(),$.stopPropagation();const j=v.dataset.action,b=parseInt(v.dataset.row),w=parseInt(v.dataset.col);if(!(isNaN(b)||isNaN(w)||!l.rows[b]?.[w])){if(j==="header"){l.rows[b][w].isHeader=!l.rows[b][w].isHeader;const S=n.querySelector(`td[data-row="${b}"][data-col="${w}"]`);S&&(S.dataset.isheader=l.rows[b][w].isHeader?"1":"0",S.classList.toggle("is-header-cell",l.rows[b][w].isHeader)),v.classList.toggle("active",l.rows[b][w].isHeader),v.textContent=l.rows[b][w].isHeader?"✓ Etiqueta":"Etiqueta";return}if(j==="image"){window.__openTableImagePicker&&window.__openTableImagePicker(S=>{l.rows[b][w].image=S;const u=n.querySelector(`td[data-row="${b}"][data-col="${w}"]`);if(u){u.dataset.image=S,u.classList.add("has-image");let L=u.querySelector(".tam-cell-img-preview");L||(L=document.createElement("img"),L.className="tam-cell-img-preview",u.insertBefore(L,u.firstChild)),L.src=S;const D=u.querySelector("[data-action=image]");if(D&&(D.innerHTML='<i class="ri-image-line"></i> Cambiar'),!u.querySelector("[data-action=clear-image]")){const T=document.createElement("button");T.type="button",T.className="tam-cell-btn tam-cell-btn-clear",T.dataset.action="clear-image",T.dataset.row=b,T.dataset.col=w,T.textContent="✕ Quitar",T.addEventListener("click",W=>{W.preventDefault(),W.stopPropagation(),l.rows[b][w].image=null,u.dataset.image="",u.classList.remove("has-image"),L.remove(),T.remove();const H=u.querySelector("[data-action=image]");H&&(H.innerHTML='<i class="ri-image-line"></i> Imagen')}),u.querySelector(".tam-cell-actions").appendChild(T)}}});return}j==="clear-image"&&(l.rows[b][w].image=null,y())}})})}document.getElementById("tam-close").addEventListener("click",d),document.getElementById("tam-cancel").addEventListener("click",d),a.addEventListener("click",m=>{m.target===a&&d()}),document.getElementById("tam-rebuild").addEventListener("click",()=>{const m=parseInt(document.getElementById("tam-cols").value)||3,n=parseInt(document.getElementById("tam-rows").value)||3;for(x(),h();l.headers.length<m;)l.headers.push({text:`Col ${l.headers.length+1}`,align:"center"});for(l.headers=l.headers.slice(0,m),l.cols=m;l.rows.length<n;)l.rows.push(Array.from({length:m},()=>({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null})));l.rows=l.rows.slice(0,n).map(g=>{for(;g.length<m;)g.push({text:"",align:"center",isHeader:!1,colspan:1,rowspan:1,image:null});return g.slice(0,m)}),y()}),document.getElementById("tam-apply").addEventListener("click",()=>{h();const m=document.getElementById("tam-theme").value;r&&(r.set("tableData",JSON.parse(JSON.stringify(l))),r.set("tableTheme",m),r.addAttributes({"data-table-theme":m}),be(r)),d()}),window.__openTableAdminModal=s}function be(i){const e=i.get("tableData"),t=i.get("tableTheme")||"blue";e&&i.components(Pe(Ne(e,t),t))}function ji(){return function(){}}const _i=[{id:"table-blue",label:"Tabla azul",category:"Interactivos",media:$i,content:{type:"table-component",attributes:{"data-table-theme":"blue"}}},{id:"table-orange",label:"Tabla naranja",category:"Interactivos",media:`<svg viewBox="0 0 32 32" width="32" height="32">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
            ...
            `,a.appendChild(r)}})}const Ai=`<svg viewBox="0 0 80 32" width="80" height="32">
...
<a href="#"
   ...
   class="dld-simple-${e}">
    ...
    <rect x="3" y="25" width="7" height="2.5" fill="#dee2e6" rx="0.5"/>
</svg>`;function Zi(){return function(){const i=this,e="agencies-map-component",t="/api/agencies/active",a="agencies";let r=[],l=[],s={},d=null,h=[];const f=async()=>{try{x(),await m(),await k(),z(),S(),T(),W(),y()}catch(o){console.error("Error initializing map:",o),ae("Error al cargar las agencias"),y()}};function x(){const o=i.querySelector(`.${e}-list`);o&&(o.innerHTML=`
                ...
                `);const c=i.querySelector(`.${e}-map-container`);c&&(c.style.opacity="0.5")}function y(){const o=i.querySelector(`.${e}-map-container`);o&&(o.style.transition="opacity 0.3s ease",o.style.opacity="1")}async function m(){try{const c=await(await fetch(t)).json(),p=a?c[a]:c;Array.isArray(p)?(r=p.filter(B=>B.latitude&&B.longitude&&!isNaN(B.latitude)&&!isNaN(B.longitude)),l=[...r],n()):(r=[],l=[])}catch(o){console.error("Error loading items:",o),r=[],l=[]}}function n(){const o=[...new Set(r.map(p=>p.zone).filter(Boolean))].sort(),c=[...new Set(r.map(p=>p.department).filter(Boolean))].sort();s={zone:o,department:c},setTimeout(()=>{const p=i.querySelector(`.${e}-filters-container`);p&&!p.hasChildNodes()&&(p.innerHTML=`
            ...
            `}function D(){const o=i.querySelectorAll(`.${e}-item`);o.forEach(c=>{c.addEventListener("click",p=>{if(p.target.closest(".agency-maps-btn"))return;p.preventDefault();const B=parseInt(c.dataset.itemIndex),C=l[B];if(!C)return;o.forEach(E=>{E.classList.remove("bg-white","border-secondary","selected-agency"),E.classList.add("bg-white/10","border-white/20");const A=E.querySelector(".agency-title"),re=E.querySelectorAll("i"),le=E.querySelectorAll(".agency-phone-link"),ge=E.querySelectorAll("p:not(:has(.agency-phone-link))"),he=E.querySelector(".agency-maps-btn");A&&(A.classList.remove("text-secondary"),A.classList.add("text-white")),re.forEach(U=>{U.classList.remove("text-secondary","text-gray-300","text-white"),U.classList.add("text-primary")}),le.forEach(U=>{U.classList.remove("text-secondary"),U.classList.add("text-white")}),ge.forEach(U=>{U.classList.remove("text-secondary"),U.classList.add("text-gray-200")}),he&&(he.classList.remove("bg-secondary"),he.classList.add("bg-primary"))}),c.classList.remove("bg-white/10","border-white/20"),c.classList.add("bg-white","border-secondary","selected-agency");const M=c.querySelector(".agency-title"),F=c.querySelectorAll("i"),X=c.querySelectorAll(".agency-phone-link"),R=c.querySelectorAll("p:not(:has(.agency-phone-link))"),O=c.querySelector(".agency-maps-btn");if(M&&(M.classList.remove("text-white"),M.classList.add("text-secondary")),F.forEach(E=>{E.classList.remove("text-secondary","text-gray-300","text-white"),E.classList.add("text-primary")}),X.forEach(E=>{E.classList.remove("text-white"),E.classList.add("text-secondary")}),R.forEach(E=>{E.classList.remove("text-gray-200"),E.classList.add("text-secondary")}),O&&(O.classList.remove("bg-primary"),O.classList.add("bg-secondary")),d&&C&&d._loaded)try{d.flyTo([C.latitude,C.longitude],14,{animate:!0,duration:1});const E=h.find(A=>A.item.id===C.id);E&&E.marker&&E.marker.openPopup()}catch(E){console.warn("Error updating map view:",E)}})})}function T(){const o=i.querySelector(`.${e}-search-input`),c=i.querySelector(`.${e}-zone-filter`),p=i.querySelector(`.${e}-department-filter`),B=i.querySelector(`.${e}-no-results`),C={Occidental:["Ahuachapán","Santa Ana","Sonsonate"],Paracentral:["Chalatenango","Cuscatlán","La Paz","Cabañas","San Vicente"],Central:["La Libertad","San Salvador"],Oriental:["Usulután","San Miguel","Morazán","La Unión"]},M=()=>{if(!c||!p)return;const X=c.value,R=p.value;if(!X)p.innerHTML='<option value="">Todos los Departamentos</option>',[...new Set(r.map(E=>E.department).filter(Boolean))].sort().forEach(E=>{const A=document.createElement("option");A.value=E,A.textContent=E,p.appendChild(A)}),R&&(p.value=R);else{const O=C[X]||[];p.innerHTML='<option value="">Todos los Departamentos</option>',O.forEach(E=>{const A=document.createElement("option");A.value=E,A.textContent=E,p.appendChild(A)}),O.includes(R)&&(p.value=R)}},F=()=>{const X=o?o.value.toLowerCase().trim():"",R=c?c.value:"",O=p?p.value:"";l=r.filter(E=>{let A=!0,re=!0,le=!0;return X&&(A=Object.values(E).some(ge=>String(ge).toLowerCase().includes(X))),R&&(re=E.zone===R),O&&(le=E.department===O),A&&re&&le}),S(),v(),B&&B.classList.toggle("hidden",l.length>0)};o&&o.addEventListener("input",F),c&&c.addEventListener("change",()=>{M(),F()}),p&&p.addEventListener("change",F)}function W(){const o=i.querySelector("[data-title]");if(o){const B=H("map-title")||"Nuestras Agencias";o.textContent=B}const c=i.querySelector(`.${e}-search-input`);if(c){const B=H("search-placeholder")||"Buscar...";c.setAttribute("placeholder",B)}const p=i.querySelector(`.${e}-no-results`);if(p){const B=H("no-results-text")||"No se encontraron agencias";p.textContent=B}}function H(o){return i.closest(`[data-gjs-type="${e}"]`)?.getAttribute(o)}function ae(o){const c=i.querySelector(`.${e}-list`);c&&(c.innerHTML=`
                    <div class="flex flex-col items-center justify-center p-12 text-center">
            ...
            `,a.appendChild(r)}})}const ia=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
...
@media(max-width:480px){
    .banner-btn{flex:1 1 100%;min-width:0;}
            ...
            `;const o=i.ownerDocument??document;if(!o.getElementById("banner-skeleton-styles")){const c=o.createElement("style");c.id="banner-skeleton-styles",c.textContent=`
                ...
                `,o.head.appendChild(c)}}function z(o){return t[o]?t[o]:o==="outline-blue"||o==="outline-orange"?t["outline-white"]:t["fill-white"]}function v(o,c,p,B){const C=z(p),M=c?"a":"span",F=c?`href="${c}"${B?' target="_blank" rel="noopener noreferrer"':""}`:"";return`<${M} ${F}
                class="banner-btn"
                data-bg="${C.bg}"
                data-color="${C.color}"
                ...
                ${o}
            </${M}>`}function $(){n.innerHTML=r.map((o,c)=>`
            ...
            `).join(""),j(),b(),w()}function j(){i.querySelectorAll(".banner-btn").forEach(o=>{const c=o.style.borderColor;o.addEventListener("mouseenter",()=>{o.style.background=o.dataset.hoverBg,o.style.color=o.dataset.hoverColor,o.style.borderColor=o.dataset.hoverBg}),o.addEventListener("mouseleave",()=>{o.style.background=o.dataset.bg,o.style.color=o.dataset.color,o.style.borderColor=c})})}function b(){n.addEventListener("mousedown",S),n.addEventListener("touchstart",S,{passive:!0}),n.addEventListener("mousemove",u),n.addEventListener("touchmove",u,{passive:!0}),n.addEventListener("mouseup",L),n.addEventListener("touchend",L),n.addEventListener("mouseleave",L)}function w(){r.forEach(o=>{const c=new Image;c.src=o.image_url})}function S(o){d=!0,h=o.touches?o.touches[0].clientX:o.clientX,f=0}function u(o){d&&(f=(o.touches?o.touches[0].clientX:o.clientX)-h)}function L(){d&&(d=!1,Math.abs(f)>=x&&(T(f<0?(l+1)%r.length:(l-1+r.length)%r.length),H()),f=0)}function D(){const o=i.querySelector(".banner-stripe");if(!o||r.length<=1)return;const c=document.createElement("div");c.className="banner-dots",r.forEach((p,B)=>{const C=document.createElement("button");C.className="banner-dot",C.dataset.index=String(B),C.setAttribute("aria-label",`Banner ${B+1}`),C.addEventListener("click",()=>{T(B),H()}),c.appendChild(C)}),o.innerHTML="",o.appendChild(c)}function T(o,c=!0){const p=n.querySelectorAll(".banner-slide"),B=i.querySelectorAll(".banner-dot");p.forEach((C,M)=>{const F=M===o;c||(C.style.transition="none"),C.classList.toggle("banner-slide--active",F),c||requestAnimationFrame(()=>{C.style.transition=""})}),B.forEach((C,M)=>{C.classList.toggle("banner-dot--active",M===o)}),l=o}function W(){r.length<=1||!y||(s=setInterval(()=>{T((l+1)%r.length)},5e3))}function H(){y&&(clearInterval(s),W())}function ae(){const o=i.querySelector(".banner-wrapper");o&&(o.innerHTML=`
                ...
                `,script:ra(),traits:[{type:"select",name:"data-autoplay",label:"Avance automático",options:[{id:"true",name:"Activado"},{id:"false",name:"Desactivado"}],changeProp:!1},{type:"select",name:"data-category",label:"Filtrar por categoría",options:[{id:"",name:"Todas las categorías"}],changeProp:!1}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e}),this.on("change:attributes",()=>{const t=this.getEl();if(!t)return;const a=this.get("script");a&&typeof a=="function"&&setTimeout(()=>a.call(t),100)})}}}),sa(i,e),ca(i,e),na(i,e)}async function na(i,e){try{const t=document.querySelector('meta[name="api-banners-url"]')?.content??"/api/banners/active",r=await(await fetch(t)).json();if(!Array.isArray(r))return;const l=[...new Set(r.map(f=>f.category).filter(Boolean))].sort();if(l.length===0)return;const s=i.DomComponents.getType(e);if(!s)return;const h=s.model.prototype.defaults.traits.find(f=>f.name==="data-category");if(!h)return;h.options=[{id:"",name:"Todas las categorías"},...l.map(f=>({id:f,name:f}))]}catch{}}function sa(i,e){i.on("storage:end:load",()=>{setTimeout(()=>Te(i,e),1e3)}),i.on("component:mount",t=>{const a=t.getEl();a?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},500))}),i.on("component:clone",t=>{if(t.get("type")===e){const a=t.getEl();a&&setTimeout(()=>{const r=t.get("script");r&&typeof r=="function"&&r.call(a)},500)}}),i.on("canvas:render",()=>{setTimeout(()=>Te(i,e),800)}),i.on("storage:start:store",()=>{i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e),t.addAttributes({"data-gjs-type":e})})})}function Te(i,e){i.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e);const a=t.getEl();if(a?.isConnected){const r=t.get("script");r&&typeof r=="function"&&r.call(a)}})}function ca(i,e){i.on("load",()=>{const t=i.Canvas.getFrameEl();if(!t)return;const a=t.contentDocument?.head;if(a){if(!a.querySelector("#banner-hero-styles")){const r=document.createElement("style");r.id="banner-hero-styles",r.textContent=aa,a.appendChild(r)}if(!a.querySelector(`#${e}-editor-css`)){const r=document.createElement("style");r.id=`${e}-editor-css`,r.textContent=`
                [data-gjs-type="${e}"] * { pointer-events: none !important; }
                [data-gjs-type="${e}"].gjs-selected,
                [data-gjs-type="${e}"].gjs-hovered {
            ...
            `,a.appendChild(r)}}})}const da=`<svg viewBox="0 0 32 32" width="32" height="32">
    <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
    <rect x="1" y="6" width="30" height="20" fill="#003B71" rx="2"/>
    <rect x="1" y="22" width="30" height="4" fill="#E97300" rx="0"/>
    <rect x="3" y="9" width="12" height="2" fill="rgba(255,255,255,0.9)" rx="1"/>
...
@media(max-width:480px){
    .bsingle-btn{flex:1 1 100%;min-width:0;}
            ...
            `,a.appendChild(r)}}})}function xa(i){_.registerBlocks(nt),_.registerBlocks(bt),_.registerBlocks(la),_.registerBlocks(ha),_.registerBlocks(di),_.registerBlocks(Gt),_.registerBlocks(kt),_.registerBlocks(Mt),_.registerBlocks(Ot),_.registerBlocks(Ht),_.registerBlocks(_t),_.registerBlocks(oi),_.registerBlocks(Tt),_.registerBlocks(Ut),_.registerBlocks(hi),_.registerBlocks(xi),_.registerBlocks(wi),_.registerBlocks(Ei),_.registerBlocks(_i),_.registerBlocks(Ui),_.registerBlocks(Gi),_.registerBlocks(Ki),_.applyToEditor(i),Qi(i),oa(i),pa(i),Lt(i),Vi(i),Jt(i),zi(i)}function ya(i,e,t){i.on("component:add",()=>e.markAsDirty()),i.on("component:remove",()=>e.markAsDirty()),i.on("component:update",()=>e.markAsDirty()),i.on("style:update",()=>e.markAsDirty());const a=document.getElementById("save-button");a&&a.addEventListener("click",async()=>{await va(i,e,t,a)}),document.addEventListener("keydown",r=>{(r.ctrlKey||r.metaKey)&&r.key==="s"&&(r.preventDefault(),a&&!a.disabled&&a.click())})}async function va(i,e,t,a){a.disabled=!0,a.innerHTML='<i class="ri-loader-4-line animate-spin"></i><span>Guardando...</span>';try{t.needsTitle()?await wa(i,e,t):await Oe(i,e,t)}catch(r){He(r.message,"error")}finally{a.disabled=!1,a.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}}async function wa(i,e,t){return new Promise((a,r)=>{Ue({title:"Título de la Página",description:"Ingresa un título descriptivo para identificar esta página",placeholder:"Ej: Acerca de Nosotros",icon:"ri-file-text-line",iconBg:"#dbeafe",iconColor:"#2563eb",confirmLabel:"Guardar",onConfirm:async l=>{if(!l?.trim()){r(new Error("El título es obligatorio"));return}try{await Oe(i,e,t,l),a()}catch(s){r(s)}},onCancel:()=>{r(new Error("Guardado cancelado"))}})})}async function Oe(i,e,t,a=null){const l={...e.getEditorContent(i),is_published:t.isPublished};a&&(l.title=a);const s=await e.savePage(i,l,t.storeUrl,t.getHttpMethod());s.success&&(e.markAsClean(),He(s.message,"success"),!t.isEditMode&&s.page?(t.updatePageInfo(s),t.updateTitle(s.page.title)):a&&t.updateTitle(a))}function He(i,e){typeof window.showNotification=="function"&&window.showNotification(i,e)}document.addEventListener("DOMContentLoaded",async()=>{const i=new Ve,e=new at;new rt(i);const t=Ye();if(t.on("load",()=>{xa(t),We(t),Xe(),Ge(),Je(t),Ze(t),Ke(t),Qe(t),et(t),tt(t),ka(t),Ba(t),Ea(t),setTimeout(()=>{t.runCommand("sw-visibility"),t.Panels.getButton("options","sw-visibility")?.set("active",!0)},100)}),e.isEditMode)try{await i.loadPageContent(t,e.loadUrl),De("Contenido cargado correctamente","success")}catch(a){De("Error al cargar el contenido","error"),console.error(a)}ya(t,i,e)});function ka(i){const e=[{cmd:"set-device-desktop",device:"Desktop"},{cmd:"set-device-tablet",device:"Tablet"},{cmd:"set-device-mobile",device:"Mobile"}];e.forEach(({cmd:t,device:a})=>{i.Commands.add(t,{run:r=>{r.setDevice(a),e.forEach(({cmd:l})=>{r.Panels.getButton("devices-c",l)?.set("active",l===t)})}})})}function Ba(i){i.Commands.add("canvas-clear",{run:e=>{it({title:"Limpiar canvas",description:"¿Estás seguro de que quieres eliminar todo el contenido del canvas? Esta acción no se puede deshacer.",icon:"ri-delete-bin-line",iconBg:"#fef2f2",iconColor:"#dc2626",confirmLabel:"Limpiar todo",confirmColor:"#dc2626",onConfirm:()=>{e.DomComponents.clear(),e.CssComposer.clear()}})}})}function Ea(i){const e=i.Canvas.getFrameEl();if(!e?.contentDocument?.head)return;const t=e.contentDocument.createElement("style");t.id="gjs-dashed-fix",t.textContent="body,body.gjs-dashed{margin:0!important;padding:0 0 160px 0!important;}",e.contentDocument.head.appendChild(t)}function De(i,e="info"){typeof window.showNotification=="function"&&window.showNotification(i,e)}
