import{i as T,t as q,d as j,f as L,e as $,s as F,g as A,c as B}from"./editor-commands-jJ4k4Gbt.js";import"./_commonjsHelpers-CqkleIqs.js";function I(){return T()}const S=`
<style>
.ft-wrapper {
...
<footer class="ft-wrapper">
...
</footer>`}function H(){return function(){this.querySelectorAll(".ft-section-toggle").forEach(e=>{e.addEventListener("click",()=>{const t=e.closest(".ft-section");t.classList.toggle("ft-open"),e.setAttribute("aria-expanded",t.classList.contains("ft-open"))})})}}function M(o,e){const t=document.getElementById("footer-config-modal");t&&t.remove();const i=(()=>{try{return JSON.parse(e.getAttributes()["data-footer-config"]||"{}")}catch{return{}}})(),l=i.sections||[{title:"Sección",links:[{label:"Enlace",href:"#",icon:""}]}],d=i.logo_url||"",s=i.logo_alt||"",n=document.createElement("div");n.id="footer-config-modal",n.style.cssText=`
    ...
    `,n.appendChild(r),document.body.appendChild(n);const f=r.querySelector("#ft-sections-container");function C(a,m){const c=document.createElement("div");c.style.cssText="background:#0f172a;border:1px solid #334155;border-radius:0.625rem;overflow:hidden;",c.dataset.sectionIndex=m;const y=(a.links||[]).map((u,g)=>`
        ...
        `,c.querySelector(".ft-remove-section").onclick=()=>{l.splice(m,1),p()},c.querySelector(".ft-add-link").onclick=()=>{a.links=a.links||[],a.links.push({label:"Nuevo enlace",href:"#",icon:""}),p()},c.querySelectorAll(".ft-remove-link").forEach(u=>{u.onclick=()=>{const g=parseInt(u.closest(".ft-link-row").dataset.linkIndex);a.links.splice(g,1),p()}}),c}function p(){f.innerHTML="",l.forEach((a,m)=>{f.appendChild(C(a,m))})}p(),r.querySelector("#ft-add-section").onclick=()=>{l.push({title:"Nueva Sección",links:[]}),p()};function z(){const a=r.querySelector("#ft-logo-url").value.trim(),m=r.querySelector("#ft-logo-alt").value.trim(),c=[];return f.querySelectorAll("[data-section-index]").forEach((y,u)=>{const g=y.querySelector(".ft-section-title-input").value.trim(),v=[];y.querySelectorAll(".ft-link-row").forEach(x=>{v.push({icon:x.querySelector(".ft-link-icon").value.trim(),label:x.querySelector(".ft-link-label").value.trim(),href:x.querySelector(".ft-link-href").value.trim()})}),c.push({title:g,links:v})}),{logo_url:a,logo_alt:m,sections:c}}const b=()=>n.remove();r.querySelector("#ft-modal-close").onclick=b,r.querySelector("#ft-modal-cancel").onclick=b,n.onclick=a=>{a.target===n&&b()},r.querySelector("#ft-modal-save").onclick=()=>{const a=z();e.addAttributes({"data-footer-config":JSON.stringify(a)});const m=E(a);e.components(m+S),b()}}function N(o){const e="footer-component";o.DomComponents.addType(e,{isComponent:t=>t.getAttribute?.("data-gjs-type")===e?{type:e}:!1,model:{defaults:{name:"Footer",tagName:"div",draggable:!1,droppable:!1,removable:!1,copyable:!1,selectable:!0,hoverable:!0,attributes:{"data-gjs-type":e,"data-footer-config":JSON.stringify({logo_url:"",logo_alt:"Logo",sections:[{title:"Productos",links:[{label:"Créditos",href:"#",icon:""},{label:"Depósitos",href:"#",icon:""},{label:"Otros Servicios",href:"#",icon:""}]},{title:"Sobre Nosotros",links:[{label:"Historial",href:"#",icon:""},{label:"Misión y Visión",href:"#",icon:""},{label:"Red de Agencias",href:"#",icon:""}]},{title:"Contáctanos",links:[{label:"0000 - 0000",href:"tel:0000-0000",icon:"ri-phone-line"},{label:"Correo",href:"mailto:info@banco.com",icon:"ri-mail-line"},{label:"Dirección",href:"#",icon:"ri-map-pin-line"}]}]})},components:E({logo_url:"",logo_alt:"Logo",sections:[{title:"Productos",links:[{label:"Créditos",href:"#",icon:""},{label:"Depósitos",href:"#",icon:""}]},{title:"Sobre Nosotros",links:[{label:"Historial",href:"#",icon:""},{label:"Misión y Visión",href:"#",icon:""}]},{title:"Contáctanos",links:[{label:"0000-0000",href:"tel:0000",icon:"ri-phone-line"},{label:"Correo",href:"mailto:",icon:"ri-mail-line"}]}]})+S,script:H(),toolbar:[{attributes:{class:"gjs-toolbar-item",title:"Configurar Footer"},label:'<i class="ri-settings-3-line"></i>',command:"open-footer-config"}]},init(){this.set("type",e),this.addAttributes({"data-gjs-type":e})}}}),o.Commands.add("open-footer-config",{run(t){const i=t.getSelected();i&&M(t,i)}}),o.Commands.add("insert-default-footer",{run(t){t.DomComponents.clear(),t.addComponents({type:e})}}),o.BlockManager.add("footer-block",{label:"Footer",category:"Footer",media:`<svg viewBox="0 0 32 32" width="32" height="32">
        ...
        </svg>`,content:{type:e}}),_(o,e),D(o)}function _(o,e){o.on("storage:end:load",()=>{setTimeout(()=>k(o,e),800)}),o.on("component:mount",t=>{const i=t.getEl();i?.getAttribute?.("data-gjs-type")===e&&(t.set("type",e),setTimeout(()=>{const l=t.get("script");l&&typeof l=="function"&&l.call(i)},400))}),o.on("canvas:render",()=>{setTimeout(()=>k(o,e),600)})}function k(o,e){o.getWrapper().find(`[data-gjs-type="${e}"]`).forEach(t=>{t.set("type",e);const i=t.getEl();if(i?.isConnected){const l=t.get("script");l&&typeof l=="function"&&l.call(i)}})}function D(o){o.on("load",()=>{const e=o.Canvas.getFrameEl();if(!e)return;const t=e.contentDocument?.head;if(t&&!t.querySelector("#footer-component-css")){const i=document.createElement("style");i.id="footer-component-css",i.textContent=`
                [data-gjs-type="footer-component"] {
                    outline: 2px dashed rgba(240,135,42,0.4);
                    outline-offset: 2px;
                }
            `,t.appendChild(i)}})}document.addEventListener("DOMContentLoaded",async()=>{const o=new EditorService,e=document.getElementById("footer-id")?.value||"",t=document.getElementById("footer-name")?.value||"",i=document.getElementById("footer-load-url")?.value||"",l=document.getElementById("footer-store-url")?.value||"",d=document.getElementById("footer-is-active")?.value==="1",s=!!e,n=I();if(n.on("load",()=>{N(n),q(n),j(),L(),$(n),F(n),A(n),B(n),setTimeout(()=>{n.runCommand("sw-visibility"),n.Panels.getButton("options","sw-visibility")?.set("active",!0)},100)}),s&&i)try{await o.loadPageContent(n,i),h("Footer cargado correctamente","success")}catch{h("Error al cargar el footer","error")}else n.on("load",()=>{setTimeout(()=>{n.runCommand("insert-default-footer")},300)});document.getElementById("save-button")?.addEventListener("click",async()=>{const r=document.getElementById("save-button");r.disabled=!0,r.innerHTML='<i class="ri-loader-4-line animate-spin"></i><span>Guardando...</span>';try{if(!s&&!t){const f=await P();if(!f){r.disabled=!1,r.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>';return}await w(n,o,l,"POST",f,d)}else await w(n,o,l,s?"PUT":"POST",t,d)}catch(f){h(f.message,"error")}finally{r.disabled=!1,r.innerHTML='<i class="ri-save-line"></i><span>Guardar</span>'}})});async function w(o,e,t,i,l,d){const s=e.getEditorContent(o),n=await e.savePage(o,{...s,name:l,is_active:d},t,i);n.success&&h(n.message,"success")}function P(){return new Promise(o=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;z-index:9999;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.5);";const t=document.createElement("div");t.style.cssText="background:#fff;border-radius:0.75rem;padding:1.5rem;max-width:24rem;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);",t.innerHTML=`
