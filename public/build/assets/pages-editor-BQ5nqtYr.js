...
.bc-plot{height:220px;gap:0.75rem;}
        ...
        </svg>`,activate:!0,content:{type:e,attributes:{"data-gjs-type":e}}})}function dr(t){t.BlockManager.add("bar-chart-section-block",{label:"Sección: Gráfico de Barras",category:"Gráficos",media:`<svg viewBox="0 0 32 32" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
            <rect width="32" height="32" fill="#f8f9fa" rx="2"/>
        ...
        </svg>`,activate:!0,content:`
<section class="w-full bg-white px-16 py-12">
    <div data-gjs-type="bar-chart-component" data-gjs-editable="false"></div>
</section>`})}const fr=`<svg viewBox="0 0 32 32" width="32" height="32">
