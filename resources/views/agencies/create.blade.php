      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="md:col-span-2">
          ...
          <textarea id="address" name="address" rows="2" required
            ...
            placeholder="Dirección completa de la agencia">{{ old('address') }}</textarea>
          @error('address')
          <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div class="md:col-span-2">
          ...
          <div id="phones-container">
            <div class="flex gap-2 mb-2">
              <input type="text" name="phones[]" value="{{ old('phones.0') }}" class="input-field flex-1"
        ...
        <div class="md:col-span-2">
          ...
          <p class="text-xs text-gray-600 mt-1">
            ...
            El mapa muestra El Salvador por defecto. Haz clic en cualquier punto o usa el botón "Obtener Coordenadas"
