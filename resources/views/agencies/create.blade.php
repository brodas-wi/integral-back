...
@section('page-title', 'Crear Nueva Agencia')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="address" name="address" rows="2" required
                            class="input-field @error('address') border-red-500 @enderror" placeholder="Dirección completa de la agencia">{{ old('address') }}</textarea>
                        @error('address')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
