                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select id="zone" name="zone" required
                            ...
                            @foreach ($zones as $zone)
                                <option value="{{ $zone }}"
                                    {{ old('zone', $agency->zone) == $zone ? 'selected' : '' }}>{{ $zone }}</option>
                            @endforeach
                        </select>
                        @error('zone')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="address" name="address" rows="2" required
                            class="input-field @error('address') border-red-500 @enderror" placeholder="Dirección completa de la agencia">{{ old('address', $agency->address) }}</textarea>
                        @error('address')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="schedule" name="schedule"
                            value="{{ old('schedule', $agency->schedule) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div id="phones-container">
                            @if ($agency->phones->count() > 0)
                                @foreach ($agency->phones as $phone)
                                    <div class="flex gap-2 mb-2">
                                        <input type="text" name="phones[]" value="{{ $phone->phone }}"
                                            class="input-field flex-1" placeholder="Ej: 2222-2222">
                                        <button type="button" class="btn-danger remove-phone-btn"
                            ...
                            @else
                                <div class="flex gap-2 mb-2">
                                    <input type="text" name="phones[]" class="input-field flex-1"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div
                            class="bg-gray-100 rounded-lg overflow-hidden border border-gray-300 agency-form-map-container">
