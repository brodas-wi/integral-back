                ...
                <div class="input-wrapper">
                    <div class="relative">
                        ...
                        <div class="absolute right-2 top-1/2 -translate-y-1/2 flex gap-1">
                            ...
                            <button 
                                type="button" 
                                onclick="generateSecurePassword('password')" 
                                class="p-1.5 text-gray-600 hover:text-primary transition-colors flex items-center justify-center"
                    ...
                    <p class="text-xs text-gray-600 mt-1">Deja este campo vacío si no deseas cambiar la contraseña. Si ingresas una nueva, debe contener al menos 8 caracteres, una mayúscula, una minúscula, un número y un carácter especial (@$!%*?&)</p>
                    @error('password')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
