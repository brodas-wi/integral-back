...
@section('title', 'Crear Punto de Pago')
@section('page-title', 'Crear Punto de Pago')
...
@section('content')
    <div class="max-w-4xl">
        ...
        <div class="card">
            <form action="{{ route('payment-points.store') }}" method="POST" id="paymentPointForm">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div class="md:col-span-2">
                        ...
                        <select id="correspondent" name="correspondent" required
                            ...
                            @foreach ($correspondents as $key => $name)
                                <option value="{{ $key }}" {{ old('correspondent') == $key ? 'selected' : '' }}>
                                    {{ $name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="affiliate" name="affiliate" value="{{ old('affiliate') }}" required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="branch" name="branch" value="{{ old('branch') }}" required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-xs text-gray-600 mt-1">
                            ...
                            El mapa muestra El Salvador por defecto. Haz clic en cualquier punto o usa el botón "Obtener
                            Coordenadas" para ubicar el punto de pago.
                        </p>
                    </div>
