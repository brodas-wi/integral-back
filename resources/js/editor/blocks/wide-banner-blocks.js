...
const WB_CSS = `
.wb-section{position:relative;width:100%;margin-inline:calc(50% - 50vw);aspect-ratio:25/5;min-height:220px;overflow:hidden;background:#0f1b33;display:flex;align-items:center;justify-content:center;box-sizing:border-box;}
