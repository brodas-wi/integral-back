...
.nb-top-action{display:flex;align-items:center;gap:0.5rem;text-decoration:none;color:#fff;font-size:0.8125rem;font-weight:700;letter-spacing:normal;text-transform:uppercase;transition:background 0.15s,color 0.15s;white-space:nowrap;border:1.5px solid #fff;border-radius:9999px;padding:0.5rem 1.25rem;background:transparent;}
.nb-top-action i{font-size:0.8125rem;color:#fff;transition:color 0.15s;}
...
.nb-nav-list{display:flex;align-items:center;gap:0.5rem;list-style:none;margin:0;padding:0;}
.nb-bottom-right{display:flex;align-items:center;padding:0.75rem 4rem 0.75rem 0;flex-shrink:0;width:auto;}
.nb-nav-item{position:static;}
.nb-nav-link{display:inline-flex;align-items:center;gap:0.375rem;padding:0.5rem 1.125rem;color:#E97300;text-decoration:none;font-size:0.9375rem;font-weight:600;transition:color 0.15s;white-space:nowrap;cursor:pointer;background:none;border:none;font-family:inherit;}
...
.nb-mobile-top-actions{display:flex;flex-direction:row;flex-wrap:wrap;justify-content:center;gap:0.5rem;background:#003B71;padding:0.75rem;}
...
.nb-mobile-banking{display:flex;flex-direction:row;flex-wrap:wrap;align-items:center;justify-content:center;gap:0.625rem;background:#003B71;padding:0.625rem 0.75rem;border-bottom:1px solid #f1f5f9;}
...
@media(max-width:1280px){
    ...
    .nb-bottom-right{padding:0.75rem 2.5rem 0.75rem 0;}
