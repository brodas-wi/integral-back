...
function buildFullBleedBannerHTML(data, uid) {
    ...
    const btnStyle = `display:inline-flex;align-items:center;justify-content:center;padding:clamp(0.625rem,1.5vw,0.875rem) clamp(1.5rem,3vw,2rem);border-radius:9999px;background:#E97300;color:#fff;font-weight:600;font-size:clamp(0.875rem,1.6vw,1rem);text-decoration:none;transition:background 0.2s ease,color 0.2s ease;white-space:nowrap;`;
