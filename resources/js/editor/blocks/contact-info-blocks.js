...
const CONTACT_ITEM = (icon, label, value, href) => `
<div class="flex items-center gap-5">
    <div class="ci-item__icon w-14 h-14 shrink-0">
        <img src="${assetUrl(`images/${icon}`)}" alt="" class="w-full h-full object-contain">
    </div>
...
<section class="ci-section">
    <div class="flex flex-col gap-6">
        ${CONTACT_ITEM("placeholder.svg", "Contáctenos", "(503)-2250-6090", "tel:+50322506090")}
        ${CONTACT_ITEM("placeholder.svg", "Correo", "servicio.cliente@bancointegral.com", "mailto:servicio.cliente@bancointegral.com")}
    </div>
</section>
${CONTACT_INFO_STYLES}`,
    },
