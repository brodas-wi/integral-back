...
.hb-bg.hb-gradient-on::before{content:"";position:absolute;inset:0;z-index:1;background:linear-gradient(270deg,rgba(0,59,113,0) 0%,#003B71 75%);}
...
.hb-box-inner{position:static;z-index:2;display:flex;flex-direction:column;gap:0.25rem;}
